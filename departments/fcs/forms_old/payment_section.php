...
if(isset($_GET["token"])){
	...
	if($check==1){
		...
		$reg_fees=$fcs->query("select reg_fees from fcs_form".$token." where user_id='$swr_id' and active='1'")->fetch_object()->reg_fees;
	}
}else{
	echo "<script>
			alert('Something went wrong!!!');
											...
											<div class="row">
												<div class="col-md-4 col-md-offset-4 box box-shadow" style="width:30%;padding-bottom:30px">
													...
													<p><b><u>Chalan Head</u></b><br/>
														0230- Labour and Employment ,<br/>103- Fee for inspection of Steam fcss<br/><br/>
													</p>
