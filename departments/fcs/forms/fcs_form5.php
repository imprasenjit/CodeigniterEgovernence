						...
						<div class="panel-body">
							...
							<table id="" class="table table-responsive">
								...
								<tr>
								   ...
								   <td><label class="radio-inline"><input type="radio" required="required" name="is_lic_prev" <?php if($is_lic_prev=="Y") echo "checked"; ?> value="Y"/> Yes </label>&nbsp;&nbsp;<label class="radio-inline"><input type="radio" name="is_lic_prev" required="required" <?php if($is_lic_prev=="N" || $is_lic_prev=="") echo "checked"; ?> value="N"/> No</label></td>
								</tr>
								<tr>									
