						...
						<div class="panel-body">
							...
							<table id="" class="table table-responsive">
										...
										<thead>
											...
											while($rows=$member_results->fetch_object()){ ?>
												<tr>
													...
													<td><input type="text" name="contact<?php echo $i;?>" class="form-control text-uppercase" validate="mibileNumber" maxlength="10" value="<?php echo $rows->contact; ?>" /></td>
												</tr>
											<?php $i++;
											} ?>
								...
								<tr>
								   ...
								   <td><label class="radio-inline"><input type="radio" required="required" name="is_lic_prev" <?php if($is_lic_prev=="Y") echo "checked"; ?> value="Y"/> Yes </label>&nbsp;&nbsp;<label class="radio-inline"><input type="radio" required="required" name="is_lic_prev" <?php if($is_lic_prev=="N" || $is_lic_prev=="") echo "checked"; ?> value="N"/> No</label></td>
								</tr>
								<tr>									
