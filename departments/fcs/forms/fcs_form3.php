						...
						<div class="panel-body">
							...
							<table id="" class="table table-responsive">
								...
								<tr>
								   ...
								   <td><label class="radio-inline"><input type="radio" name="is_lic_prev" <?php if($is_lic_prev=="Y") echo "checked"; ?>  required="required" value="Y"/> Yes </label>&nbsp;&nbsp;<label class="radio-inline"><input type="radio" name="is_lic_prev" required="required" <?php if($is_lic_prev=="N" || $is_lic_prev=="") echo "checked"; ?> value="N"/> No</label></td>
								</tr>
								<tr>									
								...
								<tr>									
									...
									<td><label class="radio-inline"><input type="radio" name="is_convicted" id="is_convicted" value="Y" required="required"  <?php if(isset($is_convicted) && $is_convicted=='Y') echo 'checked'; ?> /> Yes</label>
									<label class="radio-inline"><input type="radio" name="is_convicted"  value="N"  id="is_convicted" required="required" <?php if(isset($is_convicted) && $is_convicted=='N') echo 'checked'; ?> /> No</label></td>
								...
								<tr>									
									<td class="text-center" colspan="4">
										<button type="submit" name="save<?php echo $form;?>" class="btn btn-success submit1">Submit</button>
									</td>									
								</tr>
								</table>
								</form>
