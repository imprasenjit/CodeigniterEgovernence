...
$table_name=getTableName($dept,$form);
	...
	if($q->num_rows>0){				
		...
		$form_id=$results["form_id"];$father_name=$results["father_name"];$age=$results["age"];$caste=$results["caste"];$business_p_s=$results["business_p_s"];$name_lic=$results["name_lic"];$is_lic_prev=$results["is_lic_prev"];$trading=$results["trading"];$stocks=$results["stocks"];$suspension=$results["suspension"];
...
<html>
    ...
    <div style="text-align:center">
  			'.$assamSarkarLogo.'<hr>'.$form_name.'</h4>
	</div><br/> 
  	<table class="table table-bordered table-responsive">
		...
		<tr>
			...
			<tr align="center" >
				...
				<th align="center">As a wholesaler</th>
				<th align="center">As a Importer</th>
				<th align="center"> As a Retailer</th>
			</tr>';
		...
		<tr>
				<td colspan="2">I '.strtoupper($key_person).' declare that the particulars mentioned items no. 1 to 10 above are true to the best of my knowledge and notice has been cancelled therein.</td>
		</tr>
		<tr>
				<td colspan="2">I have carefully read the provision of the Assam Public Distribution of Articles Order 1982 and I/We are agree to abide by the authority under the aforesaid order.</td>
		</tr>';
