...
include "save_form.php";
	...
	$p=$formFunctions->executeQuery($dept,"select * from ".$table_name." where user_id='$swr_id' and active='0' ORDER BY form_id DESC LIMIT 1");
		if($p->num_rows>0){
			...
			$form_id=$results["form_id"];$license_no=$results["license_no"];$expiry_date=$results["expiry_date"];$license_stands=$results["license_stands"];$renewal_desired=$results["renewal_desired"];$details_action=$results["details_action"];
			...
			$form_id="";$license_no="";$expiry_date="";$license_stands="";$renewal_desired="";$details_action="";
			$address_s1="";$address_s2="";$address_d="";$address_p="";
        } 		
	}else{			
							...
							<table id="" class="table table-responsive">
								...
								<tr>									
									<td class="text-center" colspan="4">
										<button type="submit" name="save<?php echo $form;?>" class="btn btn-success submit16">Save & Next</button>
									</td>									
								</tr>
							</table>
							</form>
