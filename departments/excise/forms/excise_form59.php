			...
			<div class="panel-body">
				...
				<form name="myform1" class="submit1" id="myform1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
					<table id="" class="table table-responsive">
						...
						<tr>
							<td colspan="4">6. Address of the Applicant :</td>
						</tr>
						<tr>
					    ...
					    <tr>
								<td colspan="4">11. Proposed Site's Location :</td>
						</tr>
						<tr>
								<td>Plot No </td>
					   ...
					   <tr>
						...
						<tr>
							<td width="25%">15. Estimated quantity :</td>
						...
						<tr>
							...
							<td><label class="radio-inline"><input type="radio" name="is_servant" class="is_servant" value="Y"  <?php if(isset($is_servant) && $is_servant=='Y') echo 'checked'; ?> required="required" /> Yes</label>&nbsp;&nbsp;&nbsp;&nbsp;
							<label class="radio-inline"><input type="radio" class="is_servant" name="is_servant"  value="N" <?php if(isset($is_servant) && ($is_servant=='N' || $is_servant=='')) echo 'checked'; ?>/> No</label></td>
						</tr>
					<tr>
