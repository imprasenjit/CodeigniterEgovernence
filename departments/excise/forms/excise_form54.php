				...
				<form name="myform1" class="submit1" id="myform1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
					<table id="" class="table table-responsive">
						...
						<tr>
							...
							<td><input type="text" value="<?php echo $owner_age; ?>" class="form-control text-uppercase"  name="owner_age"></td>
						</tr>
						
						<tr>
							<td>4. Educational Qualification :</td>
							<td><input type="text" class="form-control text-uppercase" name="edu_quali" value="<?php echo $edu_quali; ?>"></td>
						</tr>
						<tr>
					...
					<tr>
						...
						<tr>
							<td class="text-center" colspan="4">
								<button type="submit" style="font-weight:bold" name="save54" class="btn btn-success submit1">Save and Next</button>
							</td>
						</tr>
					</table>
				</form>
