 ...
 $table_name=getTableName($dept,$form);
	...
	$results=$q->fetch_assoc();
		...
		$is_citizen=$results["is_citizen"];$is_criminal=$results["is_criminal"];$proposed_plant=$results["proposed_plant"];$apparatus_description=$results["apparatus_description"];$plant_site=$results["plant_site"];$ten_date=$results["ten_date"];$esti_quantity=$results["esti_quantity"];$is_servant=$results["is_servant"];$is_pollution=$results["is_pollution"];
			...
			if(!empty($results["bond_limit_a"])){
				$bond_limit_a=json_decode($results["bond_limit_a"]);
				if(isset($bond_limit_a->a)) $bond_limit_a=$bond_limit_a->a; 
    ...
    <div style="text-align:center">
  	...
  	<table class="table table-bordered table-responsive">
								...
								<tr>
									<td width="50%">5. Educational Qualification :</td>
									<td>'.strtoupper($edu_quali).'</td>
								</tr>
							    <tr>
									<td width="50%" valign="top">6. Address of the Applicant :</td>
									<td width="50%">
									<table class="table table-bordered table-responsive">
					...
					<tr>
							<td width="50%"> 7. Present and Past Occupation of the Applicant :</td>
							<td>'.strtoupper($pre_past_occupation).'</td>
					</tr>
					<tr>
							<td width="50%">8. Whether the Applicant is a citizen of India as defined in articles 5 & 8 of the Constitution :</td>
							<td>'.strtoupper($is_citizen).'</td>
					</tr>
					<tr>
							<td width="50%"> 9. Ever Convicted by a Criminal Court :</td>
							<td>'.strtoupper($is_criminal).'</td>
					</tr>
					<tr>
							<td width="50%">10. Purposed  of the proposed plant : </td>
							<td>'.strtoupper($proposed_plant).'</td>
					</tr>
					<tr>
						<td width="50%" valign="top">11. Proposed Site&#39;s Location :</td>
						<td width="50%">
						<table class="table table-bordered table-responsive">
							<tr>
					...
					<tr>
					      <td width="50%">12. Plant site :</td>
						  <td>'.strtoupper($plant_site).'</td> 
					</tr>
					<tr>
					      <td width="50%">13. Apparatus Description :</td>
					      <td>'.strtoupper($apparatus_description).'</td> 
					</tr>
					<tr>
					      <td width="50%">14. Tentative date :</td>
						  <td>'.strtoupper($ten_date).'</td> 
					</tr>
					<tr>
					      <td width="50%">15. Estimated quantity :</td>
