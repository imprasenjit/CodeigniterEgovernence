 ...
 $table_name=getTableName($dept,$form);
	...
	if($q->num_rows>0){	
		...
		$form_id=$results["form_id"];
			...
			if(!empty($results["bond_limit_a"])){
				...
				if(isset($bond_limit->a)) $bond_limit_a=$bond_limit->a; else $bond_limit_a="";
		...
		if($bond_limit_a=="A")
		{
		  $bond_limit_a="Bondlimit 50 Lakh</option>";
		}
		elseif($bond_limit_a=="B")
		{
		  $bond_limit_a="Bondlimit 50 Lakhto 1 crore";
		}
		elseif($bond_limit_a="C")
		  {
			 $bond_limit_a="Bondlimit above 1 crore";  
		  }
		  else{
    ...
    <div style="text-align:center">
  	...
  	<table class="table table-bordered table-responsive">
							    ...
							    <tr>
									<td valign="top">5. Address of the Applicant </td>
									<td>
									<table class="table table-bordered table-responsive">
					...
					<tr>
						<td valign="top">10. Proposed Site&#39;s Location</td>
						<td>
						<table class="table table-bordered table-responsive">
							<tr>
								  <td>Plot No. </td>
					...
					<tr>
					      <td>12. Apparatus Description </td>
					...
					<tr>
					      <td>14. Estimated quantity </td>
					      <td>'.strtoupper($esti_quantity).'</td> 
					</tr>
                  
                    <tr>
                        <td>15. Bond limit </td>
                        <td>'.strtoupper($bond_limit_a).'</td>
                    </tr>
