				...
				<form name="myform1" class="submit1" id="myform1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
					<table id="" class="table table-responsive">
						...
						<tr>
							...
							<td width="25%">3. Age of the applicant :</td>
							<td width="25%"><input type="text" value="<?php echo $owner_age; ?>" class="form-control text-uppercase"  name="owner_age" validate="onlyNumbers"></td>
						</tr>
						<tr>
							<td>4. Sex of Applicant :</td>
