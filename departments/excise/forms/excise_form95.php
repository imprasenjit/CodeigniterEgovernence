								...
								<form name="myform1" class="submit1" id="myform1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
                                       ...
                                       <td>District :<span class="mandatory_field">*</span> </td>
											...
											<td>Area type : <span class="mandatory_field">*</span></td>
											<td>
								    ...
								    <tr>
										...
										<tr>
											<td class="text-center" colspan="4">
												<button type="submit" style="font-weight:bold" name="save<?php echo $form; ?>" class="btn btn-success submit1">Save and Submit</button>
											</td>
										</tr>
									</table>
								</form>
