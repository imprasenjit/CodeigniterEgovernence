...
$table_name=getTableName($dept,$form);
    ...
    <div style="text-align:center">
  	...
  	<table class="table table-bordered table-responsive">
					...
					<tr>
							<td width="50%">1.Applicant Name :</td>
					...
					<tr>
						    <td width="50%">2. Education qualification of the applicant :</td>
						    <td>'.strtoupper($edu_quali).'</td>
					</tr>
					<tr>
					      <td width="50%">3. Age of the applicant(with proof of age): :</td>
						     <td>'.strtoupper($owner_age).'</td>
					</tr>
					<tr>
							<td width="50%" valign="top"> 4.Present Address :</td>
							<td width="50%">
							<table class="table table-bordered table-responsive">
					...
					<tr>
						<td width="50%" valign="top">5. Proposed Site&#39;s Location :</td>
						<td width="50%">
						<table class="table table-bordered table-responsive">
							<tr>
					...
					<tr>
					      <td width="50%">6. Proposed site name,Building for Retail shop :</td>
						  <td>'.strtoupper($proposed_site).'</td> 
					</tr>
					<tr>
					      <td width="50%">7. Your previous License No. held with Validity (if any) :</td>
					      <td>'.strtoupper($pre_license_no).'</td> 
					</tr>
					<tr>
					      <td width="50%">8. Previous License No. held by partner(s) with Validity (if any) :</td>
						  <td>'.strtoupper($proposed_site).'</td> 
					</tr>
					<tr>
					      <td width="50%">9. Tax Liabilities (if any) :</td>
					      <td>'.strtoupper($is_liabilities).'</td> 
					</tr>
					<tr>
					      <td width="50%">10. Trade License (if applicable) :</td>
						  <td>'.strtoupper($is_license).'</td> 
					</tr>
					<tr>
					      <td width="50%">11. Distance from Institutions :</td>
					      <td>'.strtoupper($site_distance_i).'</td> 
					</tr>
					<tr>
					      <td width="50%">12. Distance from National and State Highway. :</td>
						  <td>'.strtoupper($site_distance_s).'</td> 
					</tr>
					<tr>
					      <td width="50%">13. Distance from shop(similar) :</td>
					      <td>'.strtoupper($site_distance_sp).'</td> 
					</tr>
					<tr>
					      <td width="50%">14.  Caste : </td>
