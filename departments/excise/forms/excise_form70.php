	...
	$q=$formFunctions->executeQuery($dept,"select * from ".$table_name." where user_id='$swr_id' and active='1'");
		...
		$p=$formFunctions->executeQuery($dept,"select * from ".$table_name." where user_id='$swr_id' and active='0' ORDER BY form_id DESC LIMIT 1");
			if($p->num_rows>0){
				...
				$owner_age=$results["owner_age"];$edu_quali=$results["edu_quali"];$proposed_site=$results["proposed_site"];$event_license=$results["event_license"];
				...
				$pre_add_sn1="";$pre_add_sn2="";$pre_add_v="";$pre_add_d="";$pre_add_p="";$pre_add_mno="";
				$proposed_site="";$event_license="";$pre_license_no="";$previ_licno_validity="";$is_liabilities="";$is_license="";
							...
							<div class="panel-body">
								...
								<form name="myform1" class="submit1" id="myform1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
										...
										<tr>
										  <td>5. Purpose for opening,nature of the Business :</td>
                                       ...
                                       <td>District <span class="mandatory_field">*</span> </td>
										...
										<tr>
										   <td>6. Proposed site name,Building for wholesales shop : </td>
										   <td><input type="text" value="<?php echo $proposed_site; ?>" class="form-control text-uppercase" name="proposed_site" id="proposed_site" ></td>
										   <td>7. The date from which in the event of License  being granted to him : </td>
										   <td><input type="text" value="<?php echo $event_license; ?>" class="dob form-control text-uppercase" name="event_license" id="event_license" ></td>
										</tr>
										<tr>
										   <td>8. Your previous License No. held with Validity (if any) :</td>
											...
											<td>9. Previous License No. held by partner(s) with Validity (if any) :</td>
									   ...
									   <tr>
										 ...
										 <td>11. Trade License (if applicable) :</td>
								         <td>
									...
									<tr>
											<td width="25%">12. Distance from Institutions :</td>
											...
											<td width="25%">13. Distance from National and State Highway. :</td>
									...
									<tr>
											<td width="25%">14. Distance from shop(similar) :</td>
