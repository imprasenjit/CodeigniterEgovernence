    ...
    <div style="text-align:center">
  	...
  	<table class="table table-bordered table-responsive">
					...
					<tr>
					      ...
					      <td>'.strtoupper($event_license).'</td> 
					</tr>
					<tr>
					...
					<tr>
						  ...
						  <td>'.strtoupper($previ_licno_validity).'</td> 
					</tr>
					<tr>
					...
					<tr>
					      <td>12. Distance from Institutions :</td>
					      <td>'.strtoupper($site_distance_i).'</td> 
					</tr>
					<tr>
					      <td>13. Distance from National and State Highway. :</td>
						  <td>'.strtoupper($site_distance_s).'</td> 
					</tr>
					<tr>
					      <td>14. Distance from shop(similar) :</td>
