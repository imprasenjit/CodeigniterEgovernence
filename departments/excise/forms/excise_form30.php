			...
			<div class="panel-body">
				...
				<form name="myform1" class="submit1" id="myform1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
					<table id="" class="table table-responsive">
						...
						<tr>
								<td>Patta No :</td>
								<td><input type="date" class="form-control text-uppercase" name="site_loc[pt]" id="site_loc_pt" value="<?php echo $site_loc_pt;?>"></td>
								<td>City/Town :</td>
								<td><input type="date" class="form-control text-uppercase" name="site_loc[ct]" id="site_loc_ct" value="<?php echo $site_loc_ct;?>"></td>
						</tr>
						<tr>
