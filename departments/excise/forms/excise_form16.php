				...
				<form name="myform1" class="submit1" id="myform1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
					<table id="" class="table table-responsive">
						...
						<tr>
							...
							<td>
          					    <select name="sex_applicant" required="required" class="form-control text-uppercase">
										<option value=""> Please select</option>
										<option value="M" <?php if($sex_applicant=="M") echo "selected"; ?>> Male</option>
										<option value="F" <?php if($sex_applicant=="F") echo "selected"; ?>> Female</option>
								</select>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>10. Purpose of the proposed plant :</td>
