<?php
if(isset($form_id)){
	$part1=$dic->query("SELECT id FROM dic_form6_t1 WHERE form_id='$form_id'");
	$num = $part1->num_rows;
}else{
	$num=0;
}
...
<?php
if(isset($form_id)){
	$part2=$dic->query("SELECT id FROM dic_form6_t2 WHERE form_id='$form_id'");
	$num2 = $part2->num_rows; 
}else{
	$num2=0;
}
...
<?php
if(isset($form_id)){
	$part3=$dic->query("SELECT id FROM dic_form6_t3 WHERE form_id='$form_id'");
	$num3= $part3->num_rows;
}else{
	$num3=0;
}
...
<?php
if(isset($form_id)){
	$part4=$dic->query("SELECT id FROM dic_form6_t4 WHERE form_id='$form_id'");
	$num4 = $part4->num_rows;
}else{
	$num4=0;
}
...
<?php
if(isset($form_id)){
	$part5=$dic->query("SELECT id FROM dic_form6_t5 WHERE form_id='$form_id'");
	$num5= $part5->num_rows;
}else{
	$num5=0;
}
...
<?php
if(isset($form_id)){
	$part6=$dic->query("SELECT id FROM dic_form6_t6 WHERE form_id='$form_id'");
	$num6 = $part6->num_rows;
}else{
	$num6=0;
}
...
<?php
if(isset($form_id)){
	$part7=$dic->query("SELECT id FROM dic_form6_t7 WHERE form_id='$form_id'");
	$num7 = $part7->num_rows; 
}else{
	$num7=0;
}
...
<?php
if(isset($form_id)){
	$part8=$dic->query("SELECT id FROM dic_form6_t8 WHERE form_id='$form_id'");
	$num8= $part8->num_rows;
}else{
	$num8=0;
}
...
<?php
if(isset($form_id)){
	$part9=$dic->query("SELECT id FROM dic_form6_t9 WHERE form_id='$form_id'");
	$num9 = $part9->num_rows;
}else{
	$num9=0;
}
...
<?php
if(isset($form_id)){
	$part10=$dic->query("SELECT id FROM dic_form6_t10 WHERE form_id='$form_id'");
