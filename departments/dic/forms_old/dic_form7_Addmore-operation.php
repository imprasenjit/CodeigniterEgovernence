<?php
if(isset($form_id)){
	$part1=$dic->query("SELECT id FROM dic_form7_t1 WHERE form_id='$form_id'");
	$num = $part1->num_rows;
}else{
	$num=0;
}
...
<?php
if(isset($form_id)){
	$part2=$dic->query("SELECT id FROM dic_form7_t2 WHERE form_id='$form_id'");
	$num2= $part2->num_rows;
}else{
	$num2=0;
}
...
<?php
if(isset($form_id)){
	$part3=$dic->query("SELECT id FROM dic_form7_t3 WHERE form_id='$form_id'");
	$num3= $part3->num_rows;
}else{
	$num3=0;
}
