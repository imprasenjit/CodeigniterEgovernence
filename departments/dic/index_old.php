					...
					<?php while($rows=$form_names->fetch_object()){ ?>	
						<div class="col-md-4">
							...
							<div class="info-box-content">
								...
								<a href="<?php echo $server_url;?>dept_documents/dic/forms/form<?php echo $rows->form_no; ?>.pdf" target="_blank"><i class="fa fa-download"></i><strong>Download Sample form</strong></a></div>
								<div class=" col-md-6 small-box-footer btn btn-primary">
								<a href="../requires/terms.php?form=<?php echo $rows->form_no; ?>&dept=dic"><i class="fa fa-calendar"></i> <strong>Apply Online</strong></a></div>
							</div>						
						</div>
					<?php } ?>
				</div>
