...
<?php require_once "../../requires/header.php";   ?>
	  <?php include ("".$table_name."_Addmore_old.php"); ?>
								...
								<div class="tab-content">
									...
									<table class="table table-responsive table-bordered">
										...
										<tr>
												...
												<td>District</td>
                                                <td><input type="text" class="form-control text-uppercase" name="ins[dist]" value="<?php echo $ins_dist;?>"></td>
										...
										<table class="table table-bordered table-responsive">
											...
											<tr>
												...
												<tr>
													<td></td>
													<td>Total</td>
													<td><input  type="text" class="form-control text-uppercase" id="amount_fixedCapitala" name="capital_investment[tot1]" disabled="disabled" value="<?php echo $capital_investment_tot1=((int)$capital_investment_land1+(int)$capital_investment_sd1+(int)$capital_investment_fact1+(int)$capital_investment_ob1+(int)$capital_investment_items1+(int)$capital_investment_ei1+(int)$capital_investment_exp1); ?>"></td>
													<td><input  type="text" class="form-control text-uppercase" id="amount_fixedCapitalb" name="capital_investment[tot2]" disabled="disabled" value="<?php echo $capital_investment_tot2=((int)$capital_investment_land2+(int)$capital_investment_sd2+(int)$capital_investment_fact2+(int)$capital_investment_ob2+(int)$capital_investment_items2+(int)$capital_investment_ei2+(int)$capital_investment_exp2); ?>"></td>
													<td><input  type="text" class="form-control text-uppercase" id="amount_fixedCapitalc" name="capital_investment[tot3]" disabled="disabled" value="<?php echo $capital_investment_tot3=((int)$capital_investment_land3+(int)$capital_investment_sd3+(int)$capital_investment_fact3+(int)$capital_investment_ob3+(int)$capital_investment_items3+(int)$capital_investment_ei3+(int)$capital_investment_exp3); ?>"></td>
