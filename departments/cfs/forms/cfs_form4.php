...
if($q->num_rows<1){	 
	...
	if($p->num_rows>0){
		...
		$form_id="";
		$others_business="";$others_desgn="";$applicant_name="";$identity_proof="";$area="";$start_date="";$opening="";$closing="";$is_power="";$is_power_details="";$rupees="";$draft="";$fees="";$supply="";$turnover="";
		$corr_add_name="";$corr_add_address="";$corr_add_mobile="";$corr_add_tel="";$corr_add_fax="";$corr_add_email="";
		$business_a="";$business_b="";$business_c="";$business_d="";$business_e="";$business_f="";$business_g="";$business_h="";$business_i="";$business_j="";$business_k="";
		$designation_a="";$designation_b="";$designation_c="";$designation_d="";$designation_e="";		
	}
							...
							<div id="table1" class="tab-pane" role="tabpanel">
								<form name="myform1" id="myform1" class="submit1" method="post" compliance="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
										...
										<tr>
											<td>8. In case of renewal, Total Annual turnover from the food business, if existing, alongwith any supporting document(s) showing proof of income : </td>
											<td><input type="text" class="form-control text-uppercase" name="turnover" value="<?php echo $turnover; ?>"></td>
											<td>9. In case of new business - intended date of start : </td>
											<td><input type="text" class="dob form-control" name="start_date" value="<?php echo $start_date; ?>"></td>
										</tr>
										<tr>
											<td colspan="2">10. In case of seasonal business, state the opening and closing period of the year : </td>
										...
										<tr>
											<td>11. Source of water supply : <span class="mandatory_field">*</span></td>
											<td colspan="3">
										...
										<tr>
											<td>12. Whether any electric power is used in manufacture of the food items ? <span class="mandatory_field">*</span></td>
											<td>
										...
										<tr class="form-inline">
											<td colspan="4">13. I/We have forwarded a sum of Rs. &nbsp;<input type="text"  class="form-control text-uppercase" name="rupees" value="<?php echo $rupees;?>" >&nbsp; towards registration fees according to the provision of the Food Safety and Standards (Licensing and Registration) Regulations, 2011 vide :
											<br/>
