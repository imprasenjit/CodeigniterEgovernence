...
<table class="table table-bordered table-responsive">
	...
	<tr>
		<td>10. In case of seasonal business, state the opening and closing period of the year </td>
		<td>Opening period : '.strtoupper($opening).'<br/>Closing period : '.strtoupper($closing).'</td>	
	</tr>
	<tr>
		<td>11. Source of water supply </td>
		<td>'.strtoupper($supply).'</td>	
	</tr>
	<tr>
		<td>12. Whether any electric power is used in manufacture of the food items ?<br/>If yes, please state the exact HP used or sanctioned Electricity load : </td>
		<td>'.strtoupper($is_power).'<br/>'.strtoupper($is_power_details).'</td>
	</tr>
	<tr>
		<td colspan="2">13. I/We have forwarded a sum of Rs. &nbsp;'.strtoupper($rupees).'&nbsp; towards registration fees according to the provision of the Food Safety and Standards (Licensing and Registration) Regulations, 2011 vide : <br/>'.strtoupper($fees).'&nbsp;'.strtoupper($draft).'</td>
	</tr>
	';
