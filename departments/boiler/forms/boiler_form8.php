...
include "save_boiler_form.php";
		...
		if($q->num_rows>0)
		{
			...
			if($p->num_rows>0){
				...
				$form_id="";$esta_yr="";$classification_applied="";
									...
									<form name="myform1" id="myform1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
										<table id="" class="table table-responsive">
											...
											<tr>
												...
												<td><select name="classification_applied" required="required" class="form-control text-uppercase">
														
														<option value='SC' <?php if($classification_applied=='SC') echo "selected"; ?> >(a) Special Class ( For any Boiler Pressure)</option>
														<option value='C1' <?php if($classification_applied=='C1') echo "selected"; ?> >(b) Class I (For Boiler Pressure upto 125 kg.cm2)</option>
														<option value='C2' <?php if($classification_applied=='C2') echo "selected"; ?> >(c) Class II (For Boiler Pressure upto 40 kg./cm2)</option>
														<option value='C3' <?php if($classification_applied=='C3') echo "selected"; ?> >(d) Class III (For Boiler Pressure upto 17.5 kg/cm2)</option>
