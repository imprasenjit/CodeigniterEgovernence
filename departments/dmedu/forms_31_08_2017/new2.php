<?php
	...
	$key_person=$row1['Key_person'];$unit_name=$row1['Name'];$status_applicant=$row1['status_applicant'];$street_name1=$row1['Street_name1'];$street_name2=$row1['Street_name2'];$vill=$row1['Vill'];$dist=$row1['Dist'];$block=$row1['block'];$pincode=$row1['Pincode'];$mobile_no=$row1['Mobile_no'];
	$b_street_name1=$row1['b_street_name1'];$b_street_name2=$row1['b_street_name2'];
	 $b_vill=$row1['b_vill']; $b_dist=$row1['b_dist'];
    ...
    <div style="text-align:center">
  			'.$assamSarkarLogo.'<h4>FORM NO. - III</h4>
  			<h4>'.$form_name.'</h4>
		</div><br/> 
  	<table width="99%" align="center" class="table table-bordered table-responsive" style="margin:0px auto;border-collapse: collapse" border="1" >
				   ...
				   <tr>
					...
					<tr>
				         <td>7. Provisional Registration No. :</td>
				         <td>'.strtoupper($registration).'</td>
			       </tr>
				 <tr>

				 <td colspan="2"><font color="red"><b>Declaration.</b></font></td>
				 <tr>
				   <td width="2">1.&nbsp;&nbsp;I solemnly pledge myself to consecrate my life to the service of humanity.</td>
				 </tr>
				 <tr>
				  <td width="2">2.&nbsp;&nbsp;I will give to my teachers the respect and gratitude which is their due.</td>
				 </tr>
				 
				 <tr>
				  <td width="2">3.&nbsp;&nbsp;I will practise my profession with consciense and dignity.</td>
				 </tr>
				 <tr>
				  <td width="2">4.&nbsp;&nbsp;The health of my patient will be my first consideration.</td>
				 </tr>
				 <tr>
				  <td width="2">5.&nbsp;&nbsp;I will respect the secrets,which are confided in me.</td>
				 </tr>
				 <tr>
				   <td width="2">6.&nbsp;&nbsp;I will maintain by all means in my power,the honour and noble traditions of medical profession as laid down in the medical ethics.</td>
				 </tr>
				 <tr>
				   <td width="2">7.&nbsp;&nbsp;My collegues will be my brothers.</td>
				 </tr>
				 <tr>
				   <td width="2">8.&nbsp;&nbsp;I will not considerations of religion,nationality,race,party politics or social standing to intervene between my duty and my patient.</td>
				 </tr>
				 <tr>
				   <td width="2">9.&nbsp;&nbsp;I will maintain the utmost respect for human life from the time of conception.</td>
				 </tr>
				 <tr>
				  <td width="2">10.&nbsp;&nbsp;Even under threat,I will not use my medical knowledge contrary to the law of humanity:I make these promises solemnly,freely and upon my honour.</td>
				 </tr>
                 
				 
				
				<tr>
					<td ><font color="red"><b>List of documents to be enclosed.</b></font></td>
				</tr>					
				<tr>
			...
			<tr>
				<td valign="right" rowspan="2">Signature of Owner  : '.strtoupper($key_person).'
				<br/>Address  : '.strtoupper($street_name1).'
				</td>
