								...
								<div class="tab-content">
									...
									<form name="myform1" id="myform1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
										<table id="" class="table table-responsive">
											<tr>
												...
												<td>1st April of  &nbsp;<select id="Year" name="from_year" required="required" class="text-uppercase" >
														<?php if(empty($from_year)) echo "<option value=''>Choose a year</option>"; else echo "<option selected>".$from_year."</option>"; ?>
													</select>
												</td>
												<td>To<span class="mandatory_field">*</span> </td>
												<td>31st March of &nbsp;<select id="Year2" name="to_year" required="required" class="text-uppercase">
											...
											<tr>
												...
												<td><input type="text" value="<?php echo $owner_type; ?>" class="form-control text-uppercase"disabled></td>
											</tr>
											<tr>
												<td>4. Owner's Name</td>
												<td><input  type="text" value="<?php echo $owner_names; ?>" class="form-control text-uppercase"disabled></td>
											...
											<tr>
												<td>6. ULB</td>
												<td><input type="text" id="dma_ulb" name="ulb" value="<?php echo $ulb; ?>" class="form-control text-uppercase" ></td>
												
											</tr>
											<tr>
												<td>7 (a). Applicant's Date of Birth<span class="mandatory_field">*</span></td>
												<td><input type="datetime" name="dob" value="<?php echo $dob; ?>" id="dob" class="form-control text-uppercase" onchange="date_of_birth(this.id)" placeholder="DD/MM/YYYY" required="required" readonly="readonly" ></td>
												<td>7 (b). Applicant's Age</td>
												<td><input validate="onlyNumbers" type="text" readonly="readonly" id="owner_age" value="<?php echo $owner_age; ?>" name="owner_age" class="form-control text-uppercase"></td>
											</tr>
											<tr>
											...
											<tr>
												<td>Block/Ward No.</td>
												<td><input type="text" id="dma_ulb_copy" value="<?php echo $ulb; ?>" class="form-control text-uppercase" disabled></td>
												<td>Pincode</td>
											...
											<tr>
												<td>10 (a). Phone No.</td>
												<td><input type="text" class="form-control text-uppercase" name="mobile_no" value="<?php echo $b_landline_std." - ".$b_landline_no; ?>" disabled></td>
											...
											<tr>
												<td class="text-center" colspan="4">
													<button type="submit" style="font-weight:bold" name="save<?php echo $form; ?>a" class="btn btn-success submit1" onclick="return confirm('Do you really want to save the form ?')">Save and Next</button>
												</td>
											</tr>
										</table>
										</form>
									...
									<form name="myform1" id="myform1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
										<table id="" class="table table-responsive">
											...
											<tr class="Own">
												<td>11. DMA Holding No.<span class="mandatory_field">*</span> </td>
												...
												<td><input type="text" validate="letters" id="premises_details_b" required="required" name="premises_details[b]" value="<?php if($premises=="O" && $owner_type!="PR") echo $trade_name; else if($premises=="O" && $owner_type=="PR") echo $owner_name; else echo $premises_details_b; ?>" class="form-control text-uppercase"></td>										
											</tr>
											<tr class="Own">
												<td>13. (a) Rent Per Month<span class="mandatory_field">*</span>  <span id="per_value"> / value </span></td>
												<td id="rpm"><input type="text" required="required" value="<?php echo $premises_details_c; ?>" name="premises_details[c]" class="form-control text-uppercase" validate="onlyNumbers"></td>
											...
											<tr class="GodownExists">
												...
												<td><input type="text" name="godown_details[b]" id="godown_details_b" value="<?php echo $godown_details_b; ?>" class="form-control text-uppercase"validate="onlyNumbers"></td>									
											</tr>
											<tr class="GodownExists">
									...
									<form name="myform1" id="myform1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
										<table id="" class="table table-responsive">
											...
											<tr class="oldTrade">
												...
												<td><input type="text" value="<?php if($old_trade_details_b!="0000-00-00" && $old_trade_details_b!="") echo date("d-m-Y",strtotime($old_trade_details_b)); else echo "";?>" placeholder="DD-MM-YYYY" name="old_trade_details[b]" class="dobindia form-control text-uppercase old_trade_details" readonly="readonly"></td>
											</tr>
											<tr class="oldTrade">
												<td>19. 1st License Issue Date :</td>
												<td><input type="text" value="<?php if($old_trade_details_c!="0000-00-00" && $old_trade_details_c!="") echo date("d-m-Y",strtotime($old_trade_details_c)); else echo "";?>" placeholder="DD-MM-YYYY" name="old_trade_details[c]" class="dobindia form-control text-uppercase old_trade_details" readonly="readonly"></td>
												<td></td>
												<td></td>
											</tr>
											<tr>
									...
									<form name="myform1" id="myform1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
										<table id=""  class="table table-responsive">
											...
											<tr>
												...
												<td><input type="number" name="annual_income" required="required" value="<?php echo $annual_income; ?>" class="form-control text-uppercase"></td>
												<td>23. Income Tax Payable / Paid for <br/>the previous financial year (in Rupees)</td>
												<td><input type="number" value="<?php echo $it_payable; ?>" name="it_payable" class="form-control text-uppercase" ></td>
											</tr>
											<tr>
												<td>24. License</td>
												<td>
													<select name="license_type" class="form-control text-uppercase">
														<option <?php if($license_type=="G" || $license_type=="") echo "selected"; ?> value="G">Regular(1 Year)</option>
														<option <?php if($license_type=="P") echo "selected"; ?> value="P">Provisional(1 year)</option>						
													</select>
												</td>											
												<td></td>
												<td></td>
...
<script>
	...
	function display(){
		var abc = document.getElementById('dma_ulb').value;
		document.getElementById('dma_ulb_copy').value = abc;			
	}
