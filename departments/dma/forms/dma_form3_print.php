					...
					<tbody>
					 <tr>
						...
						<tr>
							...
							<td style="border:none"><strong>:</strong></td>
							<td style="border:none">'.date('d-m-Y',strtotime($today)).'</td>
						</tr>
