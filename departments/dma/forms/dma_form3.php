								...
								<form name="myform1" id="myform1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table class="table table-responsive">
										...
										<tr>
											...
											<td><input type="text" value="<?php echo $trade_name; ?>" class="form-control text-uppercase" disabled="disabled"/></td>
											<td></td>
											<td></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><input type="text" value="<?php echo $Type_of_ownership; ?>" class="form-control text-uppercase" disabled="disabled"/></td>
											<td></td>
											<td></td>
										</tr>
										<?php if($Type_of_ownership=="H"){ ?>
											<tr>
										...
										<?php }else if($Type_of_ownership=="PSU"){ ?>
											<tr>
