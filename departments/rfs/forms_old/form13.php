...
$check=$formFunctions->is_already_registered('rfs','13');
if($check==1){
	echo "<script>
	...
	echo "<script>				
				window.location.href = '".$server_url."departments/requires/courier_details.php?form=13&dept=rfs';
		</script>";
}else{
	$showtab="";
}
						...
						<div class="col-md-12">
							<div class="panel panel-primary">
								<div class="panel-heading">
									...
									<strong>Form No 6<br/><?php echo $form_name=$cms-> query("select form_name from rfs_form_names  where  form_no='13'")->fetch_object()->form_name; ?></strong>
								</h4>	
							    </div>
		...
		<tr>
			  ...
			  <tr>
					<td class="text-center" colspan="4">
						...
						<button type="submit13" class="btn btn-success" name="submit13" title="Save it and fill up the form later and Go to the Next Part" onclick="return confirm('Do you want to save..?')"> SUBMIT</button>
					</td>
					</tr>
					</table>
		  </form>
