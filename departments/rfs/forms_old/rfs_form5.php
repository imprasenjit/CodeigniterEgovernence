...
include "save_form_test.php";
	...
	if($previous_details->num_rows>0){
		...
		if($q->num_rows<1){	 ###EMPTY FORM DETAILS###
			...
			$file1=$results['file1'];$file2=$results['file2'];$file3=$results['file3'];$file4=$results['file4'];$file5=$results['file5'];$file6=$results['file6'];	$deed=$results['deed'];$date=$results['	date'];$place_deed=$results['place_deed'];$deed="";$date="";$place_deed="";
		
			################Courier details#################	
		}
	}else{
		$form_id="";$post_office="";$police_station="";$reg_date="";$reg_no="";$deed="";$date="";$place_deed="";$file1="";$file2="";$file3="";$file4="";$file5="";
		
		$q=$rfs->query("select * from rfs_form5 where user_id='$swr_id' and active='1'");
		$results=$q->fetch_assoc();

		if($q->num_rows>0){		
			$form_id=$results['form_id'];$post_office=$results['post_office'];$$place_deed=$results['place_deed']
		    $police_station=$results['police_station'];$reg_date=$results['reg_date'];
			$reg_no=$results['reg_no'];	$deed=$results['deed'];$date=$results['date'];
                         ...
                         <table class="table table-responsive">
					          ...
					          <tr>
							     ...
							     <td width="25%"> Deed No :</td>
								  <td class="25%"><input type="text" id="dob" name="place_deed"  class="form-control text-uppercase class_disable" value="<?php echo $deed; ?>" <?php if(empty($deed)) echo "required";?>></td>
					          
							    </tr>
							  <tr>
							       <td class="25%"> Date  :</td>
									<td class="25%"><input type="text" id="dob" name="date"  class="form-control text-uppercase class_disable" value="<?php echo $date; ?>" <?php if(empty($date)) echo "required";?>></td>
									
							  </tr>
							  <tr>
							       <td class="25%">Place of Deed Registration :</td>
									<td class="25%"><input type="text" id="dob" name="place_deed"  class="form-control text-uppercase class_disable" value="<?php echo $place_deed; ?>" <?php if(empty($place_deed)) echo "required";?>></td>
