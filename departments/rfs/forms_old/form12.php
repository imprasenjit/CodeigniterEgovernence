...
$check=$formFunctions->is_already_registered('rfs','12');
if($check==1){
	echo "<script>
	...
	echo "<script>				
				window.location.href = '".$server_url."departments/requires/courier_details.php?form=12&dept=rfs';
		</script>";
}else{
	$showtab="";
}
...
$email=$formFunctions->get_usermail($swr_id);
	...
	if($previous_details->num_rows>0){
		...
		$q=$rfs->query("select * from rfs_form12 where user_id='$swr_id' and active='1'");
						...
						<div class="col-md-12">
							<div class="panel panel-primary">
								<div class="panel-heading">
									...
									<strong>Form No 2<br/><?php echo $form_name=$cms-> query("select form_name from rfs_form_names  where  form_no='12'")->fetch_object()->form_name; ?></strong>
								</h4>	
							    </div>
