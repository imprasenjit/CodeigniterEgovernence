...
$sql=$rfs->query("select * from rfs_form1 where user_id='$swr_id' ");	
	...
	$sq=$rfs->query("select * from rfs_form8 where user_id='$swr_id' ");
        $ro=$sq->fetch_array();	
       $regn_no=$ro["regn_no"];
	...
	<!-- Content Wrapper. Contains page content -->
			<div class="content-wrapper">
				...
				<section class="content">
					...
					<div class="row">
                        ...
                        <strong> 
                        Form No VII<br>
                        Notice of withdrawal from, or remaining in, a partnership to be given under Section 63(2) of <br>
                        the act by a minor attaining majority<br>
                        [(See Section 63(2) and Rules 4(7)]<br>
                        Filling Fee : Rs. 1/-
                    </strong>
                    </h4>	
								</div>
			...
			<form name="myform1" id="myform1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                ...
                <tr>
                    <td colspan="2">
                        <p class="left50px">
                            Notice is hereby given, pursuant to Section 63(2) and Rule 4(7) of the Indian Partnership Act,1932, Of Changes in Names and Address of the partners of the firm M/S
                            <input type="text" class="" id="firm_name" value="<?php echo $firm_name;?>" name="firm_name" pattern="[a-zA-Z_/.\s]+$"  required/>
                            Regn. no
                            <input type="text" class="text-uppercase" id="regn_no" value="<?php echo strtoupper($regn_no);?>" name="regn_no" pattern="[a-zA-Z0-9]{1,}"  value=""required/>
                        </p>
                    </td>
                </tr>
                <tr>
            ...
            <p style="text-align:center">
			  <button type="submit" style="font-weight:bold" name="save8" class="btn btn-primary">Save </button>
               <button type="submit" class="btn btn-success" name="submit8" title="Save it and fill up the form later and Go to the Next Part" onclick="return confirm('Do you want to save..?')"> SUBMIT</button>
            </p>
        </form>
        </div>
			</div>
