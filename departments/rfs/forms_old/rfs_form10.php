...
$check=$formFunctions->is_already_registered('rfs','10');
if($check==1){
	echo "<script>
	...
	echo "<script>				
				window.location.href = '".$server_url."departments/requires/courier_details.php?form=10&dept=rfs';
		</script>";
}else{
	$showtab="";
}
...
$email=$formFunctions->get_usermail($swr_id);
	...
	if($previous_details->num_rows>0){
		...
		$form_id="";$post_office="";$police_station="";$reg_date="";$reg_no="";$file1="";$file2="";$file3="";$file4="";$file5="";$file6="";$propsociety="";
	  ...
	  <?php require '../../../user_area/includes/aside.php'; ?>
		<!-- Content Wrapper. Contains page content -->
				...
				<section class="content">
						...
						<div class="col-md-12">
							<div class="panel panel-primary">
								<div class="panel-heading">
									...
									<strong>Form No 6<br/><?php echo $form_name=$cms-> query("select form_name from rfs_form_names  where  form_no='10'")->fetch_object()->form_name; ?></strong>
								</h4>	
							    </div>
							<div class="panel-body">
							<ul class="nav nav-pills">
									  <li class="<?php echo $tabbtn1; ?>"><a data-toggle="tab" href="#table1">DETAILS OF THE SOCIETY</a></li>
									   <li class="<?php echo $tabbtn2; ?>"><a data-toggle="tab" href="#table2">UPLOAD</a>
									   </li>
				   ...
				   <td><input type="text" class="form-control text-uppercase" name="propsociety" value="<?php echo $propsociety; ?>" required/></td>
				   <td> <span class="soc_alert"></span> </td>
			      </tr> 
		...
		<tr>
			  ...
			  <tr>
					<td class="text-center" colspan="4">
						<a href="rfs_form10.php?tab=2" class="btn btn-primary">Go Back & Edit</a>										
						<button type="submit12" class="btn btn-success" name="submit12" title="Save it and fill up the form later and Go to the Next Part" onclick="return confirm('Do you want to save..?')"> SUBMIT</button>
					</td>
					</tr>
					</table>
		  </form>
