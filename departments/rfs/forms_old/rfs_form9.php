...
$check=$formFunctions->is_already_registered('rfs','9');
if($check==1){
	echo "<script>
	...
	echo "<script>				
				window.location.href = '".$server_url."departments/requires/courier_details.php?form=9&dept=rfs';
		</script>";
}else{
	$showtab="";
}
...
$email=$formFunctions->get_usermail($swr_id);
	...
	if($previous_details->num_rows>0){
		...
		$q=$rfs->query("select * from rfs_form9 where user_id='$swr_id' and active='1'");
		...
		if($q->num_rows<1){	 ###EMPTY FORM DETAILS###
			...
			$file7=$results['file7'];$file8=$results['file8'];
			################Courier details#################	
		}
	}else{
		$form_id="";$post_office="";$police_station="";$reg_date="";$reg_no="";$file1="";$file2="";$file3="";$file4="";$file5="";$file6="";$file7="";$file8="";$propsociety="";$b_mouza="";
...
<div class="wrapper">
	  ...
	  <?php require '../../../user_area/includes/aside.php'; ?>
						...
						<div class="col-md-12">
							<div class="panel panel-primary">
								<div class="panel-heading">
									...
									<strong>Form No 6<br/><?php echo $form_name=$cms-> query("select form_name from rfs_form_names  where  form_no='9'")->fetch_object()->form_name; ?></strong>
								</h4>	
							    </div>
		...
		<form name="myform" id="myform21" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">		  
		          ...
		          <tr>
					<td width="50%"> 1.Photocopy of Registration Certificate of society:</td>
					<td width="10%">
		    ...
		    <tr>
		    <td>2. An application for filling changes in the Managing Body and Constitution of the society under section 4,4A of the Societies registration act XXI of 1860:  </td>
		  ...
		  <tr>
				 <td>3.A list showing the name,address,occupation and designation of Executive Committee entrusted with the management of the affairs of the society:  
		 ...
		 <tr>
					<td>4.A copy of the rules of the society corrected up to date and certified to be a correct copy by not less than three members of the Governing body is submitted within 15 days of making such alteration:</td>
		...
		<tr>
					<td>5.Resolution regarding changes in the Managing Body and Constitution of the society under section 4,4A of the Societies Registration Act XXI of 1860:</td>
			...
			<tr>
					<td>6. An application for filling changes in the balance sheet and Auditor's Report of the society under section 4B of the S.R. Act XXI 1860: </td>
					...
					<td width="20%" id="mfile6-chiranjit"><?php if($file6!="" && $file6!="SC" && $file6!="NA"){ echo '<a href="'.$upload.$file6.'" target="_blank"><i class="fa fa-file-text" aria-hidden="true"></i> View</a>&emsp;<a href="#!" id="file6" onclick="enableField(this.id)"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>'; } else { echo "No File Selected"; } ?></td><td><input type="CheckBox" id="E1" class="file6" name="E1" <?php if($file6=="NA") echo "checked"; ?> <?php if($file6!="" && $file6!="NA") echo "disabled='disabled'"; ?> value='E1' onClick="checkData(this)">N/A</input></td>
					<td><input type="CheckBox" id="E2" class="file6 cd" name="E2" <?php if($file6=="SC") echo "checked"; ?> <?php if($file5!="" && $file6!="SC") echo "disabled='disabled'"; ?> value='E2' onClick="checkData(this)">S/C</input></td>
					
					
				</tr>
				<tr>
					<td>7.Within 30 days after holding of every Annual General Meeting there shall be filed  with the Registrar of Societies a copy of each of the balance sheet and Auditor's Report:   </td>
					...
					<td width="20%" id="mfile7-chiranjit"><?php if($file7!="" && $file7!="SC" && $file7!="NA"){ echo '<a href="'.$upload.$file7.'" target="_blank"><i class="fa fa-file-text" aria-hidden="true"></i> View</a>&emsp;<a href="#!" id="file7" onclick="enableField(this.id)"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>'; } else { echo "No File Selected"; } ?></td><td><input type="CheckBox" id="E1" class="file7" name="E1" <?php if($file7=="NA") echo "checked"; ?> <?php if($file7!="" && $file7!="NA") echo "disabled='disabled'"; ?> value='E1' onClick="checkData(this)">N/A</input></td>
					<td><input type="CheckBox" id="E2" class="file7 cd" name="E2" <?php if($file7=="SC") echo "checked"; ?> <?php if($file7!="" && $file7!="SC") echo "disabled='disabled'"; ?> value='E2' onClick="checkData(this)">S/C</input></td>
		      </tr>
			  <tr>
					<td>8. Resolution regarding acceptance and approval of the balance sheet and Auditor's Report of the society under section 4B of the S.R. Act XXI 1860: </td>
					...
					<td width="20%" id="mfile8-chiranjit"><?php if($file8!="" && $file8!="SC" && $file8!="NA"){ echo '<a href="'.$upload.$file8.'" target="_blank"><i class="fa fa-file-text" aria-hidden="true"></i> View</a>&emsp;<a href="#!" id="file8" onclick="enableField(this.id)"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>'; } else { echo "No File Selected"; } ?></td><td><input type="CheckBox" id="E1" class="file8" name="E1" <?php if($file8=="NA") echo "checked"; ?> <?php if($file8!="" && $file8!="NA") echo "disabled='disabled'"; ?> value='E1' onClick="checkData(this)">N/A</input></td>
					<td><input type="CheckBox" id="E2" class="file6 cd" name="E2" <?php if($file8=="SC") echo "checked"; ?> <?php if($file8!="" && $file8!="SC") echo "disabled='disabled'"; ?> value='E2' onClick="checkData(this)">S/C</input></td>
