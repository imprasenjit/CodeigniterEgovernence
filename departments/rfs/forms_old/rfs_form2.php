				...
				<section class="content">
						...
						<div class="col-md-12">
							<div class="panel panel-primary">
								<div class="panel-heading">
									...
									<strong>Form No II<br/><?php echo $form_name=$cms-> query("select form_name from rfs_form_names  where  form_no='2'")->fetch_object()->form_name; ?></strong>
								</h4>	
							    </div>
                         ...
                         <table class="table table-responsive">
                              ...
                              <td width="25%">1.  Date of Alteration :</td>
							     ...
							     <td width="25%">2.Alteration in the name of firm :</td>
							 ...
							 <tr>
							    <td>3.Alteration in the Principal Place of Business: </td>
					...
					<tr>
					  ...
					  <td><input type="text"  class="form-control text-uppercase" disabled value="<?php echo $b_email; ?>" ></td>
					          ...
					          <tr>
							    <td>3.Alteration in the Address  of any other place where the Firms carries its business: </td>
					           <td> <span class="soc_alert"></span> </td>
				            </tr>
							 <tr>
