...
if($check==1){
	...
	echo "<script>				
				window.location.href = '".$server_url."departments/requires/courier_details.php?form=4&dept=rfs';
		</script>";
}else{
	$showtab="";
}
...
include "save_form_test.php";
	...
	if($previous_details->num_rows>0){
		...
		if($q->num_rows<1){	 ###EMPTY FORM DETAILS###
			...
			$reg_no=$results['reg_no'];$deed=$results['deed'];$date=$results['date'];$place_deed=$results['place_deed'];$deed1=$results['deed1'];$date1=$results['date1'];$place_deed1=$results['place_deed1'];$certificate=$results['certificate'];$issue=$results['issue'];$date_issue=$results['date_issue'];		
	...
	<div class="wrapper">
	  ...
	  <?php require '../../../user_area/includes/aside.php'; ?>
		<!-- Content Wrapper. Contains page content -->
						...
						<div class="col-md-12">
							<div class="panel panel-primary">
								<div class="panel-heading">
									...
									<strong>Form No VI<br/><?php echo $form_name=$cms-> query("select form_name from rfs_form_names  where  form_no='4'")->fetch_object()->form_name; ?></strong>
								</h4>	
							    </div>
                         ...
                         <table class="table table-responsive">
						       <tr>
							    <td>1.Changes in the name and address of the Partners of the Firm:
								</tr>
								<tr>
                             ...
                             <th>Address of the Partners</th>
						       ...
						       <tr>
							    <td>2. Registration Deed of Partnership : </td>
					           <td> <span class="soc_alert"></span> </td>
				            </tr>
						    <tr>
						      <td> Deed No. :</td><td><input type="text"  class="form-control" value="" <?php echo $deed; ?>" ></td>
					          <td> Date : </td><td><input type="text"  class="form-control text-uppercase"  value="<?php echo 	$date; ?>" ></td>
							   <td> Place of Deed Registration: </td><td><input type="text"  class="form-control text-uppercase"  value="<?php echo 	$place_deed; ?>" ></td>
						    </tr> 
					     
					   
					        <tr>
					           <td>3.Rectification Registration Deed of Partnership : </td>
					           <td> <span class="soc_alert"></span> </td>
				            </tr>
						    <tr>
						      <td> Deed No.:</td><td><input type="text"  class="form-control" disabled value="<?php echo $deed1; ?>" ></td>
					          <td> Date : </td><td><input type="text"  class="form-control text-uppercase" disabled value="<?php echo 	$date1; ?>" ></td>
						      <td>Place of Deed Registration:</td><td><input type="text"  class="form-control text-uppercase" disabled value="<?php echo 	$place_deed1; ?>" ></td>
                          </tr>	
						  
            						  
						     <tr>
							 
					           <td>4.Certificate of Sales tax or Income tax : </td>
					           <td> <span class="soc_alert"></span> </td>
				            </tr>
						    <tr>
					          ...
					          <td> Issued by : </td><td><input type="text"  class="form-control text-uppercase"  value="<?php echo 	$issue; ?>" ></td>
						        <td> Date of issue : </td><td><input type="text"  class="form-control text-uppercase"  value="<?php echo $date_issue; ?>" ></td>
						   </tr> 
		    ...
		    <tr>
		    <td>Form No. IV signed by the partners and witnessed by either a judicial Magistrate or a Chartered Accountant .  </td>
		 ...
		 <tr>
					<td>Certified copy of Registration Deed of Partnership:</td>
		...
		<tr>
					<td>Registration Deed of Rectification: </td>
				...
				<tr>
					 <td>Land document of Principal Place of business.If not Land Agreement/Affidavit from the owner: </td>
				...
				<tr>
					 <td>Land document of any other place of business.If not Land Agreement/Affidavit from the house owner.: </td>
					...
					<td><input type="CheckBox" id="G2" class="file7 cd" name="G2" <?php if($file7=="SC") echo "checked"; ?> <?php if($file7!="" && $file6!="SC") echo "disabled='disabled'"; ?> value='G2' onClick="checkData(this)">S/C</input></td>
			   </tr>
              <tr>
				...
				<tr>
					 <td>General Index Register Number(GIR number): </td>
					      <td><select trigger="FileModal" class="file6" id="file6" <?php if($file10!="" || $file10=="SC" || $file10=="NA") echo "disabled='disabled'"; ?>>
							<option value="0" selected="selected">Select</option>
							<option value="1">From E-Locker</option>
							<option value="2">From PC</option>
						</select>
					...
					<td><input type="CheckBox" id="J1" class="file=10" name="J1" <?php if($file10=="NA") echo "checked"; ?> <?php if($file10!="" && $file10!="NA") echo "disabled='disabled'"; ?> value='J1' onClick="checkData(this)">N/A</input></td>
				...
				<tr>
					...
					<td><input type="CheckBox" id="F2" class="file11 cd" name="K2" <?php if($file11=="SC") echo "checked"; ?> <?php if($file11!="" && $file11!="SC") echo "disabled='disabled'"; ?> value='K2' onClick="checkData(this)">S/C</input></td>
			   </tr>	
			   <tr>
			  ...
			  <tr>
					<td class="text-center" colspan="4">
						<a href="rfs_form4.php?tab=2" class="btn btn-primary">Go Back & Edit</a>										
