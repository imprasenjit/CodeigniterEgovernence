...
if(!isset($form_id) && !isset($_GET["ui"]) &&  !isset($_GET["token"]) && !isset($_GET["uain"])){
	...
	if($q->num_rows>0){	
		...
		/*if($is_witness=="Y") $is_witness="Yes";
		else $is_witness="No";*/
	}
	if($date_general_meeting!="0000-00-00" && $date_general_meeting!=""){
		$date_general_meeting=date('d-m-Y',strtotime($date_general_meeting));
	}else{
...
$printContents='<!DOCTYPE html>
	...
	<title>Form '.$form.'</title>
		...
		<table class="table table-bordered table-responsive">		
			...
			<tr>
				<td>2. The specimen signatures of all the executive members have been witness by :</td>
				<td>'.strtoupper($specimen).'</td>
			</tr>
			<tr>
			...
			<tr>
				<td valign="top">4. Address of the Society </td>
				<td width="50%">
				<table class="table table-bordered table-responsive">
					<tr>
						<td>Mouza</td>
			...
			<tr>
				<td colspan="2">6. A statement showing the details of grant receipt from Central Government/State Government and other agencies during the preceding 3 years from the date of renewal application.</td>
			</tr>
			<tr>
				<td colspan="2">
				<table class="table table-bordered table-responsive">
			...
			<tr>
				<td colspan="2">7. Photographs of the President & Secretary: </td>
			</tr>
			<tr>
				<td>President</td>	
