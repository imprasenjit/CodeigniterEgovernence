...
include("save_form.php");
	...
	if($q->num_rows<1){	 
		...
		if($p->num_rows>0){
			...
			$form_id="";
			$soc_reg_no="";$date_of_registration="";$post_office="";$police_station="";
			$bank_detail_no="";$bank_detail_bank="";$bank_detail_branch="";$bank_detail_type="";$bank_detail_holding="";
			$photo_president="";$photo_secretary="";$meeting_date="";
		}
	}else{
										...
										<form name="myform1" id="myform1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
											<table class="table table-responsive">
												...
												<tr>
													...
													<td width="25%">4. Date of meeting for renewal </td>
													<td width="25%">
														<input type="text" class="dobindia form-control text-uppercase" name="meeting_date" value="<?php echo date('d-m-Y',strtotime($meeting_date));?>">
													</td>
													<!--<td width="25%">4. Date of Establishment<input type="text" class="form-control text-uppercase" disabled value="<?php //echo $date_of_commencement;?>"  ></td>-->
												</tr>
												<tr>
												...
												<tr>
													<td colspan="4">7. A statement showing the details of grant receipt from Central Government/State Government and other agencies during the preceding 3 years from the date of renewal application.</td>
												</tr>
												<tr>
													<td colspan="4">
												...
												<tr>
													<td colspan="4">9. Photographs of the President & Secretary: </td>
												</tr>
												<tr>
													<td>(a) President</td>
													<td>
														<input type="button" upload="file" class="file btn btn-info" id="fl" value="Browse">
														<input type="hidden" name="photo_president" value="<?php echo $photo_president; ?>" id="mfl" readonly="readonly" />
														<span id="tdfl"><?php if($photo_president=="") echo "No File Selected"; else echo '&nbsp;&nbsp;&nbsp;<a href="'.$upload.$photo_president.'" target="_blank"> View </a>'; ?> </span>
													</td>
													<td>(b) Secretary</td>
													<td>
														<input type="button" upload="file" class="file btn btn-info" id="fl1" value="Browse">
														<input type="hidden" name="photo_secretary" value="<?php echo $photo_secretary; ?>" id="mfl1" readonly="readonly" />
														<span id="tdfl1"><?php if($photo_secretary=="") echo "No File Selected"; else echo '&nbsp;&nbsp;&nbsp;<a href="'.$upload.$photo_secretary.'" target="_blank"> View </a>'; ?> </span>
													</td>
												</tr>
												<tr>
