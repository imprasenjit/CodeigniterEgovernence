...
include("save_form.php");
	...
	if($q->num_rows<1){	 
		...
		if($p->num_rows>0){
			...
			$form_id=$results["form_id"];$date_of_registration=$results["date_of_registration"];$post_office=$results["post_office"];$police_station=$results["police_station"];$proposed_society=$results["proposed_society"];
		}else{
			$form_id="";
			$date_of_registration="";$post_office="";$police_station="";$proposed_society="";
		}
	}else{
									...
									<div id="table1" class="tab-pane" role="tabpanel">
										<form name="myform1" id="myform1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
											<table class="table table-responsive">
												...
												<tr>
													<td>6. Proposed Name of the Society</td>
													<td><input type="text" class="form-control text-uppercase" name="proposed_society" value="<?php  echo $proposed_society; ?>"/></td>
													<td></td>
													<td></td>
												</tr>
												<tr>
