							...
							<div class="panel-body">
								...
								<table class="table table-responsive ">									
									...
									<tr>
										...
										<td><textarea type="text" class="form-control text-uppercase" name="tools"><?php echo $tools;?></textarea>255 Characters Only</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><textarea type="text" class="form-control text-uppercase" name="is_loan_detail"><?php echo $is_loan_detail;?></textarea>255 Characters Only</td>
									...
									<tr>										
										<td class="text-center" colspan="4">
											...
											<button type="submit" class="btn btn-success submit1" name="save1" title="Save it and fill up the form later and Go to the Next Part"  onclick="return confirm('Do you really want to save the form ?')" >Save and Next</button>
