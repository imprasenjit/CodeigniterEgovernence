							...
							<div class="panel-body">
								...
								<table class="table table-responsive">
									...
									<tr>
										...
										<td width="25%"><textarea class="form-control text-uppercase" name="manu_details"><?php echo $manu_details;?></textarea></td>
										<td width="25%"></td>
										<td width="25%"></td>
										<td></td>
									</tr>
									...
									<tr>
										<td class="text-center" colspan="4">
											<button type="submit" name="save6" value="Save and Submit" class="btn btn-success submit1" title="Save it, if you want to complete it later" rel="tooltip" onclick="return confirm('Do you want to save..?')" >Save &amp; next</button>
										</td>
									</tr>
								</table>
								</form>
