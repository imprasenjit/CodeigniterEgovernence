...
if(!isset($form_id) && !isset($_GET["ui"]) &&  !isset($_GET["token"]) && !isset($_GET["uain"])){
	...
	$shop_reg_date =$results['shop_reg_date'];
		...
		$tax_reg_no =$results['tax_reg_no'];$state =$results['state'];$license_fee =$results['license_fee'];$license_fee_words =$results['license_fee_words'];
		$license_fee_date =$results['license_fee_date'];
