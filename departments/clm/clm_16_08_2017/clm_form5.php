							...
							<div class="panel-body">
								...
								<table class="table table-responsive">
									...
									<tr>
										...
										if($member_results->num_rows==0){
											...
											<tr>
												...
												<td><input type="text" name="contact<?php echo $i;?>" class="form-control text-uppercase" validate="onlyNumbers" maxlength="10" pattern="[0-9]{10,11}" title="Please enter 10 digit number" value="" ></td>
											</tr>
											<?php } ?>
										...
										while($rows=$member_results->fetch_object()){ ?>
											<tr>
												...
												<td><input type="text" name="contact<?php echo $i;?>" class="form-control text-uppercase" validate="onlyNumbers" pattern="[0-9]{10,11}" title="Please enter 10 digit number" value="<?php echo $rows->contact; ?>" /></td>
											</tr>
										<?php $i++;
										} ?>
									...
									<tr>
										...
										&emsp;&emsp;&emsp;I/We have deposited the Scheduled licence fees of Rs. <input type="text" class="form-control1 text-uppercase" name="lic_fee" validate="onlyNumbers" value="<?php echo $lic_fee;?>"> (Rupees <input type="text" class="form-control1 text-uppercase" name="lic_fee_words" validate="letters" value="<?php echo $lic_fee_words;?>">) to the Sub- Treasury/ Bank on <input type="text" class=" dobindia form-control1 text-uppercase" name="bank_sub_date" value="<?php if($bank_sub_date!="0000-00-00" && $bank_sub_date!="") echo date("d-m-Y",strtotime($bank_sub_date)); else echo ""; ?>" placeholder="DD-MM-YYYY" readonly="readonly"> and the original challan is enclosed.</br>All the information furnished above is true to the best of my/ our knowledge.
										</td>
									</tr>
									<tr>
										<td >
									...
									<tr>
										<td class="text-center" colspan="4">
											<button type="submit" name="save5" value="Save and Submit" class="btn btn-success submit1" title="Save it, if you want to complete it later" rel="tooltip" onclick="return confirm('Do you want to save..?')" >Save &amp; Next</button>
										</td>
									</tr>
								</table>
								</form>
