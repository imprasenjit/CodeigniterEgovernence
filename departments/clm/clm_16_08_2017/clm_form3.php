								...
								<table class="table table-responsive ">									
									...
									<tr>
										...
										if($member_results->num_rows==0){
											...
											<tr>
												...
												<td><input type="text" name="contact<?php echo $i;?>" class="form-control text-uppercase" validate="onlyNumbers" maxlength="10"pattern="[0-9]{10,13}" title="Please enter 10 digit number" value="<?php echo $contact; ?>" ></td>
											</tr>
											<?php } ?>
									...
									<tr>										
										<td class="text-center" colspan="4">
											<button type="submit" class="btn btn-success submit1" name="save3" title="Save it and fill up the form later and Go to the Next Part"  onclick="return confirm('Do you really want to save the form ?')" >Save and Next</button>
										</td>									
									</tr>
								</table>
								</form>
