...
$newData="DOIACGOA|".$sentCustomerID."|NA|".$certificate_fees."|NA|NA|NA|INR|NA|R|doiacgoa|NA|NA|F|".$industryName."|".$financialYear."|PCB001|".$txDateTime."|".$formName."|NA|NA|".$returnUrl;
