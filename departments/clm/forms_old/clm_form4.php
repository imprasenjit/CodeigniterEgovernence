						...
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								...
								<table class="table table-responsive">
									...
									<tr>
										<td width="25%">4.(a) Type of weights and measures which are manufactured as per license granted: </td>
										<td width="25%"><input type="text" class="form-control text-uppercase" name="type_weight" value="<?php echo $type_weight;?>"></td>
									...
									<tr>
										...
										<td width="25%"><input type="text" class="dob form-control text-uppercase" name="shop_reg_date" value="<?php echo $shop_reg_date;?>"></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<?php echo strtoupper($status_applicant); ?><br/>
										Signature and Designation </td>
									</tr>
									<tr>
										<td class="text-center" colspan="4">
											<button type="submit" name="save4" value="Save and Submit" class="btn btn-success" title="Save it, if you want to complete it later" rel="tooltip" onclick="return confirm('Do you want to save..?')" >Save &amp; next</button>
										</td>
									</tr>
								</table>
							</form>
