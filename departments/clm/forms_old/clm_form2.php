						...
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								...
								<table class="table table-responsive ">									
									<tr>
									    <td width="25%">1. Name of the manufacturing concern seeking the license :</td>
									...
									<tr>
										<td width="25%">3. (a) Whether premises are owned /rented / taken on lease duly supported by documents:</td>
										...
										<td width="25%"><input type="text" class="dob form-control text-uppercase" value="<?php echo $date_of_commencement;?>" disabled="disabled"></td>
									</tr>
									<tr>
									...
									<tr>
										...
										if($member_results->num_rows==0){
											...
											<tr>
												...
												<td><input type="text" name="contact<?php echo $i;?>" class="form-control text-uppercase" maxlength="13" validate="onlyNumbers" value="<?php echo $contact; ?>" ></td>
											</tr>
											<?php } ?>
									...
									<tr>
										<td width="25%">Date :</td>
										<td width="25%"><input type="text" class="dob form-control text-uppercase" name="fact[reg_date]" readonly="readonly" value="<?php echo $fact_reg_date;?>"></td>
									...
									<tr>
										...
										<td>7. The type of weights and measures proposed to be repaired. :</td><td width="25%"><input type="text" class="form-control text-uppercase" name="weights_measure" validate="specialChar" value="<?php echo $weights_measure;?>"  ></td>			
									</tr>
									<tr>
									...
									<tr>
										<td >14. Have you applied previously for a repairer’s licence.:</td>
									...
									<tr>										
										<td class="text-center" colspan="4">
											<button type="submit" class="btn btn-success" name="save2" title="Save it and fill up the form later and Go to the Next Part"  onclick="return confirm('Do you really want to save the form ?')" >Save and Next</button>
										</td>									
									</tr>
								</table>
								</form>
