						...
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								...
								<table class="table table-responsive">
									<tr>
										<td width="25%">1. Form of appeal against an order of a </td>
									...
									<tr>
										...
										<tr>
											...
											<td >(b) Date:</td>
											<td><input type="text" class="dob form-control text-uppercase" placeholder="DD/MM/YYYY" name="order_date" readonly="readonly" value="<?php echo $order_date;?>"></td>
										</tr>
										<tr>
											<td width="25%">
												4. Whether the appellant desires to be heard in person or through an authorized representative:
											</td>                                
											<td>
												<select required="required" name="auth_representative">
											...
											<td width="25%">5. Grounds of appeal.</td>
									...
									<tr>										
										<td class="text-center" colspan="4">
											<button type="submit" class="btn btn-success" name="save10" title="Save it and fill up the form later and Go to the Next Part"  onclick="return confirm('Do you really want to save the form ?')" >Save and Next</button>
										</td>									
									</tr>
								</table>
								</form>
