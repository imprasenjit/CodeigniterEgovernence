							...
							<div class="panel-body">
								...
								<table id="tab1" class="table table-responsive">
									<tr>
										...
										<input type="text" class="form-control" value="<?php echo strtoupper($b_dist); ?>" disabled> (name and address of the company) has been nominated by the company by a Resolution passed at their meeting held on <input type="text" class="dob form-control" value="<?php echo strtoupper($meeting_date) ?>"> at <input type="text" class="form-control" value="<?php echo strtoupper($meeting_place) ?>"> to be 
									...
									<tr>
									   <td colspan="4" class="form-inline">
									   &emsp;&emsp;&emsp;&emsp;Shri/Smt./Ms<input type="text" class="form-control" disabled value="<?php echo strtoupper($key_person) ?>">Designation<input type="text" class="form-control" disabled value="<?php echo strtoupper($status_applicant); ?>"> has accepted the said nomination and copy of said acceptance is enclosed herewith.
									   </td>
									</tr>
								...
								<tr>
									...
									<td></td>
									<td align="right"> <label><?php echo strtoupper($key_person); ?></label><br/>
									Director of</br>(Name of the company)
									</td>
								</tr>
								<tr>
