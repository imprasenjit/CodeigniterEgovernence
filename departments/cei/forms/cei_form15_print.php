...
if(!isset($css)){
      ...
      <table class="table table-bordered table-responsive">
  		<tr>  				
			...
			Sub : Renewal of working license for the lift installed at &nbsp;<b>'.strtoupper($install_at).' </b><br/><br/>
			Sir,<br/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;With reference to the above, it is stated that the working license in respect of lift installed &nbsp;<b>'.strtoupper($install_lift).'</b>&nbsp; is sent herewith for renewal thereof as required under section 6 of the Assam Lifts and Escalators Act, 2006 and it is requested to return the same after renewal.<br/><br/>
			<br/> </td>
		</tr>
       	';
