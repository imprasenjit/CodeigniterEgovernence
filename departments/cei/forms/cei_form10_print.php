...
if(!isset($form_id) && !isset($_GET["ui"]) &&  !isset($_GET["token"]) && !isset($_GET["uain"])){
	...
	if(!isset($css)){
		...
		//';
			...
			$printContents=$printContents.' 
			<tr>
				<td valign="top" width="40%">Date : <b>'.date('d-m-Y',strtotime($results["sub_date"])).' </b></td>
				<td align="right">Name of the authorized person : <b>'.strtoupper($auth_person).'</b><br>Authorization number : <b>'.strtoupper($auth_no).'</b></td>
			</tr>
		</table>';
