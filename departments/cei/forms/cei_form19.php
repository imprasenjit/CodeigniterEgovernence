...
include "save_cei_form.php";
	...
	if($q->num_rows<1){	
		...
		if($p->num_rows>0){
			...
			$is_solvency=$results["is_solvency"];$details_of_staff=$results["details_of_staff"];$workshop_details=$results["workshop_details"];$testing_details=$results["testing_details"];$safety_details=$results["safety_details"];$facility_details=$results["facility_details"];$remarks=$results["remarks"];$is_lift_esc=$results["is_lift_esc"];
			
		}else{
			$form_id="";
			$is_certificate="";$certificate_number="";$certificate_date="";$maintance="";$contract_reg_no="";
			$is_solvency="";$details_of_staff="";$workshop_details="";$testing_details="";$safety_details="";$facility_details="";$remarks="";$is_lift_esc="";
		}		
	}else{
							...
							<div class="panel-body">
								...
								<table class="table table-responsive table-bordered">	
									...
									<tr>
										...
										<td><label class="radio-inline"><input required="required" type="radio" checked="checked" name="is_certificate" value="Y"  <?php if((isset($is_certificate) ) AND ($is_certificate=='Y')) echo 'checked'; ?> /> Yes</label>&nbsp;&nbsp;&nbsp;&nbsp;
