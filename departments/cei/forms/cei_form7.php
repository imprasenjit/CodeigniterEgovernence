							...
							<div class="panel-body">
								...
								<table class="table table-responsive table-bordered">									
									...
									<tr>
										...
										<td>District :<span class="mandatory_field">*</span></td>
                                        <td>
                                        <input type="text" class="form-control text-uppercase" value="<?php echo strtoupper($premise_addr_dist);?>"   name="premise_addr[dist]">    
                                        </td>
								...
								<table id="" class="table table-responsive">	
									...
									<tr>
										<td width="25%">Name :</td>
										<td width="25%"><input type="text" class="form-control text-uppercase"   name="makers_addr[name]" value="<?php echo $makers_addr_name; ?>" validate="letters"></td>
										<td width="25%"></td>
										<td width="25%"></td>								
									</tr>
									<tr>
									...
									<tr>
										...
										<td><input type="text" class="form-control text-uppercase" name="travel_dist" validate="decimal" value="<?php echo  $travel_dist; ?>"></td>
									</tr>
									<tr>
									...
									<tr>
										<td class="text-center" colspan="4">
											<a href="cei_form7.php?tab=1" type="button" class="btn btn-primary">Go Back & Edit</a>	
								...
								<table id="" class="table table-responsive">	
									...
									<tr>
										<td class="text-center" colspan="4">
											<a href="cei_form7.php?tab=2" type="button" class="btn btn-primary">Go Back & Edit</a>	
