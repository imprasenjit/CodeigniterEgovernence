							...
							<div class="panel-body">
								...
								<table class="table table-responsive table-bordered">									
									<tr>
										...
										Sub : Renewal of working license for the escalator installed at <input type="text" id="field1" onkeyup="display()" class="form-control1 text-uppercase" name="install_at" value="<?php echo $install_at; ?>"> <br/><br/>
										Sir,<br/><br/>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;With reference to the above, it is stated that the working license in respect of escalator installed <input  type="text" id="field2" class="form-control1 text-uppercase" name="install_lift" value="<?php echo $install_lift; ?>" readonly="readonly"> is sent herewith for renewal thereof as required under section 6 of the Assam Lifts and Escalators Act, 2006 and it is requested to return the same after renewal.<br/><br/>
										</td>
									</tr>								
									<tr>
