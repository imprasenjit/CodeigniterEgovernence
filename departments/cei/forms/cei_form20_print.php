...
if(!isset($form_id) && !isset($_GET["ui"]) &&  !isset($_GET["token"]) && !isset($_GET["uain"])){
	...
	$form_id=$results['form_id'];	
		...
		$payment_mode =$results['payment_mode'];$offline_challan =$results['offline_challan'];$is_lift_esc =$results['is_lift_esc'];	
	...
	if(!isset($css)){
		...
		<table class="table table-bordered table-responsive">
			...
			<tr>  				
				<td>3. Business Address (Details about possession)</td>
				<td>
					<table class="table table-bordered table-responsive">
					<tr>
							<td>Street Name 1</td>
