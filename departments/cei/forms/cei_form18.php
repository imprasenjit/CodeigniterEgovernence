							...
							<div class="panel-body">
								...
								<table class="table table-responsive table-bordered">									
									<tr>
										...
										As  required  by  rule  9  of  the  Assam  Lifts  and  Escalators  Rules,  2010  I/We hereby    certify    that    the   escalator(s)    installed    at     &nbsp;<input type="text" validate="specialChar" class="form-control1 text-uppercase" name="lift" value="<?php echo $lift; ?>">&nbsp;And    owned by&nbsp;<input type="text" validate="letters" class="form-control1 text-uppercase" name="owned" value="<?php echo $owned; ?>">&nbsp;is under my/our maintenance. <br/><br/>
														
										The installation of the aforesaid escalator satisfies the entire requirement as laid  down  under  the  Assam  Lifts  and  Escalators  Act,  2006  and  the  rules  thereunder.  I/We maintain logbook as required under Rule 9(j) of the Assam Lifts and Escalators Rules, 2010. 
										</td>
									</tr>								
									<tr>
										<td colspan="2">Date : <b><?php echo date('d-m-Y',strtotime($today)); ?><b></td>
										<td colspan="2" align="right">Name of the authorized person: <label><input type="text" class="form-control1 text-uppercase" name="auth_person" validate="letters" value="<?php echo $auth_person; ?>"></label><br/>
										 Authorization number:&nbsp;<input type="text" class="form-control1 text-uppercase" name="auth_no" validate="specialChar" value="<?php echo $auth_no; ?>"></td>
									</tr>		
									<tr>										
