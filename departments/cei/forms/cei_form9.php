						...
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								...
								<table class="table table-responsive table-bordered">									
									...
									<tr>
										<td>Email Id:</td>
										<td><input type="email" class="form-control" name="local_agent[email]" validate="jsonObj" value="<?php echo  $local_agent_email; ?>"></td>
										<td></td>
										<td></td>
									</tr>
									...
									<tr>
										<td>Email Id:</td>
										<td><input type="email" class="form-control" validate="jsonObj" name="escalator_install[email]" value="<?php echo  $escalator_install_email; ?>"></td>
										<td></td>
										<td></td>
									</tr>
									<tr>
								...
								<table id="" class="table table-responsive">	
									...
									<tr>
										<td>7. The rated speed of the escalator(meter per second)<span class="mandatory_field">*</span></td>
										<td><input type="text" class="form-control text-uppercase" required="required" name="rated_speed"  validate="decimal" value="<?php echo  $rated_speed; ?>"> </td>
									...
									<tr>
										...
										<td><input type="text" class="form-control text-uppercase" validate="onlyNumbers" name="num_of_person" validate="onlyNumbers"  value="<?php echo  $num_of_person; ?>"></td>
									...
									<tr>
										...
										<td ><input type="text" class="form-control text-uppercase" name="vertical_rise"  validate="onlyNumbers" value="<?php echo  $vertical_rise; ?>"></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><input type="text" class="dob form-control text-uppercase" name="commencement_dt" value="<?php echo  $commencement_dt; ?>" readonly="readonly"></td>
										<td>16. Proposed date of completion of work </td>
										<td ><input type="text" class="dob form-control text-uppercase" name="completion_dt"  value="<?php echo  $completion_dt; ?>" readonly="readonly"></td>
									</tr>
									<tr>
									...
									<tr>
										<td class="text-center" colspan="4">
											<a href="cei_form9.php?tab=1" type="button" class="btn btn-primary">Go Back & Edit</a>	
