...
include "save_form.php";
	...
	if($q->num_rows>0){	
		...
		########## Part 2#####
		$connect_type=$results["connect_type"];$pay_mode=$results["pay_mode"];$comm_mode=$results["comm_mode"];$gps_point=$results["gps_point"];
		...
		if($p->num_rows>0){
			...
			$form_id="";
			####### Part 1######
			$fat_name="";$documents="";$institutional="";$commercial="";$industrial="";$other="";$occu_pro="";
			$pro_add_byelane="";$pro_add_area="";$pro_add_col_name="";$pro_add_nl="";$pro_add_road="";$pro_add_holding_no="";
			$property_type="";$property_type_sub_category="";$residential="";$residential_other="";  $institutional=""; $commercial=""; $industrial="";$tot_per_a="";$tot_per_m="";$other="";
			########## Part 2#####
			$connect_type="";$pay_mode="";$comm_mode="";$gps_point="";
			$is_connection_a="";$is_connection_b="";
			$is_arrear_a="";$is_arrear_b="";
			$declaration_a="";$declaration_b="";$declaration_c="";$declaration_d="";$declaration_e="";
		}
									...
									<form name="myform1" id="myform1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
										<table id="" class="table table-responsive">
											...
											<tr>
												...
												<td>d) Please select the relevant option and furnish supporting document for the same :<span class="mandatory_field">*</span> </td></td>
											...
											<tr>
												...
												<td>Area</td>
												<td><input type="text" id="bill_area" class="form-control text-uppercase" name="b_add[j]" value="<?php if(empty($bill_area)) echo $pro_add_area; else echo $bill_area; ?>"></td>
											</tr>
											<tr>
												<td>Nearest Landmark 	</td>
											...
											<tr>
												<td>Pincode</td>
												<td><input type="text" id="bill_pincode" class="form-control text-uppercase" name="b_add[m]" value="<?php if(empty($bill_pincode)) echo $b_pincode; else echo $bill_pincode; ?>" validate="pincode" maxlength="6"></td>
												<td>Mobile no.</td>
									...
									<form name="myform1" id="myform1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
										<table id="" class="table table-responsive">
											...
											<tr>
												...
												<td width="25%">
													<label class="radio-inline"><input type="radio" name="is_connection_a" class="is_connection_a" value="Y" <?php if (isset($is_connection_a) && ($is_connection_a=='Y')) echo 'checked'; ?> > Yes </label>
													<label class="radio-inline"><input type="radio" name="is_connection_a" class="is_connection_a" value="N" <?php if(isset($is_connection_a) && (($is_connection_a=='N') || ($is_connection_a==''))) echo 'checked'; ?> >&nbsp;No </label></td>
												<td width="25%">Please specify along with Consumer No.: </td>
												<td width="25%"><input type="text" class="form-control text-uppercase" name="is_connection_b" id="is_connection_b" value="<?php echo $is_connection_b;?>"></td>
											</tr>
											<tr>
											...
											<tr>
												<td >a. Preferred Mode of Payment :  </td>
												<td><select name="pay_mode" value="<?php echo $pay_mode;?>" class="form-control text-uppercase" >
													<option value="">Please Select</option>
													<option value="CA" <?php if($pay_mode=="CA") echo "selected";?> >Cash</option>
													<option value="CQ" <?php if($pay_mode=="CQ") echo "selected";?>>Cheque</option>
													<option value="DD" <?php if($pay_mode=="DD") echo "selected";?>>Demand Draft</option>
													<option value="OP" <?php if($pay_mode=="OP") echo "selected";?>>Online payment (Internet Banking / Credit Card / Debit Card)</option>
												</select></td>
												<td>b. Preferred Mode of Communication : </td>		
