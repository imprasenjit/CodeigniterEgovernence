...
include "save_form1.php";
	...
	$p=$formFunctions->executeQuery($dept,"select * from ".$table_name." where user_id='$swr_id' and active='0' ORDER BY form_id DESC LIMIT 1");
		if($p->num_rows>0){
			...
			$name_of_village="";$name_of_range="";$schedule_patta_no="";$schedule_area="";$schedule_desc="";$schedule_felling_series="";$schedule_district2="";
		} 
	}else{	
							...
							<div class="panel-body">
								...
								<form name="myform1" id="myform1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
										...
										<tr>
											<td colspan="4">23. Schedule giving description of the area applied for :</td>
										</tr>
										<tr>
											<td>a. Name of village :</td>
										...
										<tr>
											<td colspan="4">c. Dag and Patta Numbers and area of each field or part thereof :</td>
										</tr>
										<tr>
											<td>Dag and Patta No :</td>
