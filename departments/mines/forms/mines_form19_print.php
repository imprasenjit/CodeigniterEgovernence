...
if(!isset($form_id) && !isset($_GET["ui"]) &&  !isset($_GET["token"]) && !isset($_GET["uain"])){
	...
	$assamSarkarLogo=$formFunctions->getAssamSarkarLogo($server_url);
		...
		<tr>
			<td colspan="2"><strong>Schedule giving description of the area applied for</strong></td>
		</tr>
		<tr>
			<td valign="top">1. Name of village, Sub-Division and District :</td>
			<td>
			<table class="table table-bordered table-responsive">
				<tr>
						<td width="50%">Name of village :</td>
				...
				<tr>
						<td>District :</td>
						<td>'.strtoupper($schedule_district1).'</td>
				</tr>
				</table>
			</td>
		</tr>
		...
		<tr>  				
			<td valign="top" >2. In the case of forest land, the name of the range and Division :</td>
			<td>'.strtoupper($name_of_range).'</td>
		</tr>
		<tr>
			<td valign="top">3. Dag and Patta Numbers and area of each field or part thereof :</td>
			<td>
			<table class="table table-bordered table-responsive">
				<tr>
						<td width="50%">3.1. Patta No :</td>
						<td>'.strtoupper($schedule_patta_no).'</td>
				</tr>
				<tr>
						<td>Area :</td>
						<td>'.strtoupper($schedule_area).'</td>
				</tr>
				<tr>
