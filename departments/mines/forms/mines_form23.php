...
if($q->num_rows<1){
	...
	if($p->num_rows>0){
		...
		$form_id="";
		$father_name="";$partner_name="";$partner_add="";$place_of_business="";$financial_status="";$purpose="";$mineral_name="";$procured_name="";$procured_add="";$period_from_dt="";$period_to_dt="";$reg_no="";$reg_date="";
	} 
}else{	
								...
								<form name="myform1" id="myform1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
										<tr>
											...
											<td width="25%"><input type="text" class="form-control text-uppercase"  disabled="disabled" readonly="readonly"  value="<?php echo $status_applicant; ?>" ></td>
										</tr>
										<tr>
										...
										<tr>
											<td colspan="4">11. In case of renewal, the number and date of original registration :</td>
										</tr>
										<tr>
											<td>Number :</td>
											<td><input type="text" class="form-control text-uppercase" name="reg_no" value="<?php echo $reg_no; ?>"></td>
											<td>Date :</td>
											<td><input type="text" class="dob form-control text-uppercase" name="reg_date" placeholder="Registration Date" value="<?php echo $reg_date; ?>"></td>
										</tr>	
										<tr>
