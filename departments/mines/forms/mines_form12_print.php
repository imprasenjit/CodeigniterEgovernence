...
if(!isset($form_id) && !isset($_GET["ui"]) &&  !isset($_GET["token"]) && !isset($_GET["uain"])){
	...
	$assamSarkarLogo=$formFunctions->getAssamSarkarLogo($server_url);
		...
		<tr>  				
			<td valign="top" width="50%">Address of the applicant :</td>
			<td>
			<table class="table table-bordered table-responsive">
				<tr>
						<td >Street Name1 :</td>
		...
		<tr>  				
			<td valign="top" >If so give details :?</td>
			<td>
			<table class="table table-bordered table-responsive">
				<tr>
		...
		<tr>  				
			<td valign="top" >8. Details of the area for which mining lease is required :</td>
			<td>
			<table class="table table-bordered table-responsive">
				<tr>
		...
		<tr>  				
			<td valign="top" >9. Is the area applied for ML and as :- <br/>described at (viii) above or part thereof comes under any mining granted to the applicant earlier. If yes, :</td>
			<td>
			<table class="table table-bordered table-responsive">
				<tr>
