...
<html>
    <head>
        <title>Application Form || EODB ASSAM</title>
        <link rel="icon" href="<?= $server_url.'public/'; ?>imgs/favicon.ico" type="image/ico">
        <link rel="stylesheet" type="text/css" href="<?= $server_url.'public/'; ?>bootstrap-3.3.7/css/bootstrap.min.css" />
        <link rel="stylesheet" type="text/css" href="<?= $server_url.'public/'; ?>font-awesome-4.7.0/css/font-awesome.min.css" />
        <link rel="stylesheet" type="text/css" href="<?= $server_url.'public/'; ?>css/animate.css" />
        <link rel="stylesheet" type="text/css" href="<?= $server_url.'public/'; ?>css/AdminLTE.min.css" />
        <link rel="stylesheet" type="text/css" href="<?= $server_url.'public/'; ?>css/datetimepicker.css" />
        <link rel="stylesheet" type="text/css" href="<?= $server_url.'public/'; ?>css/skins/_all-skins.min.css" />
        <link rel="stylesheet" type="text/css" href="<?= $server_url.'public/'; ?>css/users.css" />
        <link rel="stylesheet" type="text/css" href="<?= $server_url.'public/'; ?>css/userarea.css" />
        <link rel="stylesheet" type="text/css" href="<?= $server_url.'public/'; ?>css/jquery-ui.css" />
        <script type="text/javascript" src="<?= $server_url.'public/'; ?>js/jquery-3.2.1.min.js"></script>
        <script type="text/javascript" src="<?= $server_url.'public/'; ?>bootstrap-3.3.7/js/bootstrap.min.js"></script>
        <script type="text/javascript" src="<?= $server_url.'public/'; ?>js/notify.min.js"></script>
        <script type="text/javascript" src="<?= $server_url.'public/'; ?>js/jquery-ui.js"></script>
    </head>
                ...
                <nav class="navbar navbar-static-top" role="navigation">
                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            <?php if (isset($ci->session->unit_id)) { ?>
                                <li class="hidden-xs">
                                ...
                                <li data-toggle="tooltip" data-placement="bottom" title="Official Messages from the Department "  class="dropdown messages-menu">
                                    <a href="<?= base_url('../../users/dashboard/viewallmessages/' . $ci->session->unit_id . ''); ?>">
                                ...
                                <li  class="dropdown messages-menu">
                                    <a href="#!"  data-toggle="dropdown" class="dropdown-toggle">
                                        ...
                                        <span class="label label-warning"><?php echo ""; //$total_application; ?></span>
                                    </a>
                                    <ul class="dropdown-menu" style="width: 220px;">     
                                        <li style="padding: 7px 0 7px 0;" data-toggle="tooltip" data-placement="left" title="All your submitted application forms are shown here for easy tracking and current status" class="user-body">
                                            <a href="<?= base_url("../../users/dashboard/viewallsubmittedapplications/" . $ci->session->unit_id . ""); ?>"><i class="fa fa-database pull-right"></i>Submitted Applications</a>
                                        </li>     
                                        <li style="padding: 7px 0 7px 0;" data-toggle="tooltip" data-placement="left" title="All your incomplete application forms are shown here for edit and submit." class="user-body">
                                            <a href="<?= base_url("../../users/dashboard/viewallincompleteapplications/" . $ci->session->unit_id . ""); ?>"><i class="fa fa-database pull-right"></i>Incomplete Applications</a>
                                        </li>  
                                    </ul>
                                </li>
                                <li data-toggle="tooltip" data-placement="bottom" title="E-Locker contains your uploaded documents for easy access." class="dropdown messages-menu">
                                    <!-- Menu toggle button -->
                                    <a  href="<?= base_url("../../users/dashboard/elocker/" . $unit_id . ""); ?>" class="">
                                ...
                                <li class="dropdown user user-menu">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                        ...
                                        <span class="hidden-xs"><?= $ci->session->user_name; ?></span>
                                    </a>
                                    <ul class="dropdown-menu" style="width: 220px;">
                                        <li class="user-body">
                                        ...
                                        <li class="user-body">
                                            <a href="<?= base_url("../../users/dashboard/changepassword/" . $ci->session->unit_id . ""); ?>" ><i class="fa fa-cog pull-right"></i>Change Password</a>        
                                        </li>
                                        <li class="user-body">	
