						...
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								...
								<table id="" class="table table-responsive">
									...
									<tr>
										<td colspan="4">Sir,<br/>I/We hereby give notice that I intend to erect/re-erect or to make alteration in the House No&nbsp;&nbsp;<input type="text" value="<?php echo $house_number; ?>" name="house_number" >&nbsp;&nbsp;situated at Road &nbsp;&nbsp;<input type="text" value="<?php echo $situ_road; ?>" name="situ_road" >&nbsp;&nbsp;of &nbsp;&nbsp;<input type="text" value="<?php echo $of; ?>" name="of" >&nbsp;&nbsp; area of Ward No&nbsp;&nbsp;<input type="text" value="<?php echo $area_ward; ?>" name="area_ward" >&nbsp;&nbsp;in Dag No&nbsp;&nbsp;<input type="text" value="<?php echo $dag_no; ?>" name="dag_no" >Patta No&nbsp;&nbsp;<input type="text" value="<?php echo $patta_no; ?>" name="patta_no" >of Revenue Village&nbsp;&nbsp;<input type="text" value="<?php echo $rev_village; ?>" name="rev_village" >Mouza&nbsp;&nbsp;<input type="text" value="<?php echo $mouza; ?>" name="mouza" >and in accordance with the Building Byelaws of Guwahati and I forward herewith, the following plans and specifications duly signed by me and &nbsp;&nbsp;<input type="text" value="<?php echo $signed; ?>" name="signed" >&nbsp;&nbsp;(Name in block letters)of the Registered Technical Personal, Registration No.&nbsp;&nbsp;<input type="text" value="<?php echo $regis_no; ?>" name="regis_no" >who have prepared the plans, statements/documents.<td>
									</tr>
								...
								<tr>
									...
									<td><input type="text" class="form-control text-uppercase" name="appli[father]" value="<?php echo $appli_father; ?>"></td>
									<td>Mother Name :</td>
									<td><input type="text" class="form-control text-uppercase"  name="appli[mother]" value="<?php echo $appli_mother; ?>"></td>
								</tr>
								<tr>
									...
									<td><input type="text" class="form-control text-uppercase"  name="appli[mob]" value="<?php echo $appli_mob; ?>"></td>
								</tr>
								<tr>
									<td>PAN No. :</td>
