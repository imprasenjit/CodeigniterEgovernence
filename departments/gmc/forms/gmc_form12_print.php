...
<table class="table table-bordered table-responsive">
	...
	<tr>
		<td colspan="4">Sir,<br/>&nbsp;&nbsp;&nbsp;&nbsp;We hereby inform you that the work of execution of the building as per approved plan, working drawing and structural drawings has reached the first storey level and is executed under our supervision.<br/>We declare that the amended plan is not necessary at this stage.</td>
	</tr>';
