							...
							<div id="table1" class="tab-pane" role="tabpanel">
								<form name="myform14" id="myformFT1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
									<table class="table table-responsive">
										<tr>
											<td colspan="4">Plinth Stage / In case of basement casting of basement slab</td>
										</tr>
										<tr>
										...
										<tr>
											<td colspan="4"><br/>Sir,<br/>&nbsp;&nbsp;&nbsp;&nbsp;We hereby inform you that the work of execution of the building as per approved plan, working drawing and structural drawings has reached the plinth level and is executed under our supervision. We declare that the amended plan is not necessary at this stage.<br/><br/>Yours faithfully,</td>
										</tr>
										<tr>
