		...
		<table class="table table-bordered table-responsive">
			...
			<tr><td colspan="2" height="45px" align="center"><b>I. DETAILS OF THE TRADE/OWNER </b></td></tr>
			 <tr>
				...
				<tr>
					<td valign="top">                GMC Zone/ Ward No.             </td>
					<td>				'.strtoupper($gmc_zone).'-('.strtoupper($gmc_zone_name).')            </td>
				</tr>
				<tr>
					<td colspan="2">
					<table class="table table-bordered table-responsive">
					<tr><td width="25%"> (a) Applicant&apos;s Date of Birth :</td><td width="25%">'.strtoupper($results["dob"]).'</td><td width="25%">(b) Applicant&apos;s Age :</td><td width="25%">'.strtoupper($results["owner_age"]).'</td>
					</tr>
					</table>
					</td>
				</tr>
				...
				<tr>
					<td colspan="2">
					<table class="table table-bordered table-responsive">
					<tr><td width="25%"> (a) Phone No. </td><td width="25%">'.strtoupper($landline_std).'-'.strtoupper($landline_no).'</td> 
					<td width="25%">(b) Mobile No. </td><td width="25%">+91 '.strtoupper($mobile_no).'</td></tr>
					</table>
					</td>
				</tr>
				...
				
				{
					$printContents=$printContents.'
				 <tr>
					<td valign="top" width="35%">         GMC Holding No.             </td>
				...
				$printContents=$printContents.'	
				<tr><td colspan="2" height="45px" align="center"><b>III. GODOWN EXISTS </b></td></tr>
				<tr>
				...
				$printContents=$printContents.'<tr><td colspan="2" height="45px" align="center"><b>IV. OLD TRADE LICENSE DETAILS </b></td></tr>
				<tr>
				...
				$printContents=$printContents.'<tr><td colspan="2" height="45px" align="center"><b>V. OTHER DETAILS </b></td></tr>
				<tr>
				...
				<tr>
					<td valign="top" >                License:(Regural /Provisional (1 Year))            </td>
