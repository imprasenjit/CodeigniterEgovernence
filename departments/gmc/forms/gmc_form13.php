...
if($q->num_rows<1){	 
	...
	if($p->num_rows>0){
		...
		$form_id="";$ref_no="";$submit_dt="";$storey="";$eng_sign="";$eng_name="";$eng_address="";$dev_sign="";$dev_name="";$dev_address="";
	}	
}else{	
								...
								<form name="myform14" id="myformFT1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
									<table class="table table-responsive">
										...
										<tr class="form-inline">
											<td colspan="4"><br/>Sir,<br/>&nbsp;&nbsp;&nbsp;&nbsp;We hereby inform you that the work of execution of the building as per approved plan, working drawing and structural drawings has reached &nbsp;<input type="text"  class="form-control text-uppercase" name="storey" value="<?php echo $storey;?>" >&nbsp; storey level and is executed under our supervision.<br/>We declare that the amended plan is not necessary at this stage.<br/><br/>Yours faithfully,</td>
										</tr>
										<tr>
