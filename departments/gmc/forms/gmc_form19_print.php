...
if(!isset($form_id) && !isset($_GET["ui"]) &&  !isset($_GET["token"]) && !isset($_GET["uain"])){
	...
	$assamSarkarLogo=$formFunctions->getAssamSarkarLogo($server_url);
		...
		<tbody>			
		 ...
		 <tr>
			<td width="50%"> (b) Name of owners of adjoining land : </td>
			<td>
			 <table class="table table-bordered table-responsive">
			...
			<tr>
				<td colspan="2">I request that the construction may be approved and permission accorded to me to execute the work. I hereby also declare that contents of the above application and the enclosures are true and correct to my/our knowledge. No part of it is false and nothing has been concealed there from.</td>
			</tr>
