	...
	<table class="table table-bordered">
		...
		<?php while($rows=$form_names->fetch_object()){?>
			<tr>
				...
				<td><a href="<?php echo $server_url?>dept_documents/forest/forms/form1.pdf" target="_blank"><i class="fa fa-download" aria-hidden="true"></i>
					Download</a>
				</td>
				<?php } ?>
				<?php if($rows->form_no==2){ ?>
				<td><a href="<?php echo $server_url?>dept_documents/forest/forms/form2.pdf" target="_blank"><i class="fa fa-download" aria-hidden="true"></i>
					Download</a>
				</td>
				<?php } ?>
			</tr>
