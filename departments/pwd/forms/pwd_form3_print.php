		...
		<td colspan="2">
			<table class="table table-bordered table-responsive">
				<tr>
					...
					<td width="40%" align="center">Financial Year</td>
		...
		<td colspan="2">
			<table class="table table-bordered table-responsive">
				<tr>
					...
					<td width="30%" align="center">Prime/Sub Contractor</td>
					<td width="30%" align="center">Project Name</td>
					<td width="30%" align="center">Details</td>
				</tr>';
		...
		<td colspan="2">
			<table class="table table-bordered table-responsive">
				<tr>
					...
					<td width="30%" align="center">Qualification</td>
	...
	<tr>
		<td colspan="2">
			<table class="table table-bordered table-responsive">
				<tr>
					<td width="10%" align="center">Sl. No.</td>
					<td width="30%" align="center">Type of Equipment</td>
					<td width="30%" align="center">Numbers Owned</td>
		...
		<td colspan="2">
			<table class="table table-bordered table-responsive">
				<tr>
					...
					<td width="50%" align="center">Turnover(INR)</td>
				</tr>';
	...
	<tr>
		<td colspan="2">
			<table class="table table-bordered table-responsive">
				<tr>
					<td width="10%" align="center">Sl. No.</td>
					<td width="30%" align="center">Employer</td>
					<td width="30%" align="center">Cause of Dispute</td>
