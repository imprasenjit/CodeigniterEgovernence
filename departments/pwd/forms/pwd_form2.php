									...
									<tr>
										...
										if($member_results->num_rows==0){
											...
											<tr>
												...
												<td><input type="text" name="age<?php echo $i;?>" class="form-control text-uppercase" value="" /></td>
										...
										while($rows=$member_results->fetch_object()){ ?>
											<tr>
												<td><?php echo $i; ?></td>
												<td><input type="text" name="name<?php echo $i;?>" readonly="readonly" class="form-control text-uppercase" value="<?php echo $owners[$i-1]; ?>" /></td>
												<td><input type="text" name="age<?php echo $i;?>" class="form-control text-uppercase" value="<?php echo $rows->age; ?>" /></td>
											...
											<?php
												...
												if($num2>0){
													...
													<tr>
														...
														<td><input id="text2D<?php echo $count;?>"  class=" form-control text-uppercase" value="<?php echo $row_2["quantity"]; ?>"name="text2D<?php echo $count;?>"  size="10" ></td>
														<td><input id="text2E<?php echo $count;?>"  class=" form-control text-uppercase" value="<?php echo $row_2["fin_year"]; ?>"name="text2E<?php echo $count;?>"  size="10" ></td>
												   </tr>
												<?php $count++; } 
												}else{
													$i=1; ?>
													<tr>
														...
														<td><input id="text2D1" size="10" class="form-control text-uppercase" name="text2D1"></td>	
														<td><input id="text2E1" size="10" class="form-control text-uppercase" name="text2E1"></td>
											...
											<table name="objectTable6" id="objectTable6" class="table table-responsive text-center">
												...
												<?php
													...
													if($num6>0){
													  ...
													  while($row_6=$part6->fetch_array()){	?>
														<tr>
															...
															<td><input id="text6B<?php echo $count;?>" class="form-control text-uppercase" value="<?php echo $row_6["financial_year"]; ?>" name="text6B<?php echo $count;?>"  size="10"></td>												
													...
													<tr>
														...
														<td><input id="text6B1" size="10" class="form-control text-uppercase" name="text6B1"></td>
