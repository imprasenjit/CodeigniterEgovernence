...
include "save_form.php";
	...
	if($q->num_rows<1){	 
		...
		if($p->num_rows>0){ 
			...
			//$category_class_a="";
			$category_class="";
			$financial_det_year="";$gst_no="";$pan_no="";
							...
							<form name="myform1" id="myform1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
								<table class="table table-responsive table-bordered">									
									...
									<tr>
										...
										<td><input type="text" class="form-control text-uppercase" name="category_class" value="Class III" required="required" disabled></td>
										<!--<td><select class="form-control text-uppercase" name="category_class[a]">
										<option value="">Please Select</option>
										<option value="Class 1A" <?php if($category_class_a=="Class 1A") echo "selected";?> >Class 1A</option>
										<option value="Class 1B" <?php if($category_class_a=="Class 1B") echo "selected";?>>Class 1B</option>
										<option value="Class 1C" <?php if($category_class_a=="Class 1C") echo "selected";?>>Class 1C</option>
										</select></td>-->
