  ...
  if(!isset($css)){
	...
	table {	border-spacing: 0;border-collapse: collapse;table-layout: fixed;width:1000px;border: 1px solid black;}table, th, td {border: 1px solid black;}</style>
      ...
      <table class="table table-bordered table-responsive">
  		<tr>  				
			<td colspan="2">
			1. I/We <b>'.strtoupper($Name_of_owner).' </b> of <b>'.strtoupper($unit_name).'</b>&nbsp;,Hereby apply for the grant/renewal of a license to manufacture Ayurvedic (including Siddha) or Unani drugs on the premises situated at <b>'.strtoupper($vill).'</b>.
			</td>
		</tr>
