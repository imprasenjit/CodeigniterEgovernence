...
if($q->num_rows<1){
	$p=$formFunctions->executeQuery($dept,"select * from ".$table_name." where user_id='$swr_id' and active='0' ORDER BY form_id DESC LIMIT 1") or die($ayush->error);
	if($p->num_rows>0){
						...
						<div class="panel-body">
							...
							<div class="tab-content">
								...
								<table class="table table-responsive table-bordered">	
									<tr>
									   <td colspan="4">
										1. I/We &nbsp;&nbsp;<?php echo strtoupper($owner_names); ?>&nbsp;&nbsp;of &nbsp;&nbsp;<?php echo strtoupper($unit_name); ?> &nbsp;&nbsp;Hereby apply for the grant/renewal of a license to manufacture Ayurvedic(including Siddha) or Unani drugs on the premises situated at &nbsp;&nbsp;<?php echo strtoupper($unit_details); ?>
										</td>
									</tr>
									<tr>
					       ...
					       <div id="table2" class="tab-pane <?php echo $tabbtn2; ?>" role="tabpanel">
							<form name="my_form" id="my_form" class="submit1" method="post" ction="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                                ...
                                <tr>
									 ...
									 <td><label class="radio-inline"><input type="radio" name="is_license" id="is_license_y" <?php if($is_license=="F") echo "checked"; ?> value="F"/> Fresh </label>&nbsp;&nbsp;<label class="radio-inline"><input type="radio" class="radio-inline" name="is_license" <?php if($is_license=="N" || $is_license=="") echo "checked"; ?> id="is_license_n" value="R"/> Renewal</label></td>
								 </tr>
                             <tr>									
                                ...
                                <tr>
									...
									<tr>
									  <td colspan="4">The applicant shall inform the Licensing Authority if the agency is terminated any time during which the license in force.</td>
									</tr>
									<tr>
									  ...
									  <option value='Manufacturer' <?php if($licensing_authority_b=='Manufacturer') echo "selected"; ?> >(k) Manufacturer </option>									
									 </select>
									 </td>
