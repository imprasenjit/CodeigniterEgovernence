							...
							<div class="panel-body">
								...
								<table class="table table-responsive table-bordered">	
									<tr>
									   ...
									   <td colspan="4">
										1. I/We &nbsp;&nbsp;<?php echo strtoupper($owner_names); ?> &nbsp;&nbsp;of &nbsp;&nbsp;<?php echo strtoupper($unit_name); ?> &nbsp;&nbsp;Hereby apply for the grant of a license to manufacture Ayurvedic(including Siddha) or Unani drugs on the premises situated at &nbsp;&nbsp;<?php echo strtoupper($unit_details); ?>
										</td>
									</tr>
									<tr>
