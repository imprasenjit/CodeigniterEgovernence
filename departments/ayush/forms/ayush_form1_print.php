...
<table class="table table-bordered table-responsive">
	...
	<tr>
		<td colspan="2">1.<b>'.strtoupper($key_person).','.strtoupper($status_applicant).' </b> hereby declare that the words “Ayurvedic/Unani/Proprietary medicine” shall be printed prominently one each label of Ayurvedic/Unani Medicine which will be manufactured by M/S.  <b>'.strtoupper($unit_name).'</b>
		</td>				
	</tr>					
	<tr>
		<td colspan="2">2. Certified that there is no resemblance of the product of M/S. <b>'.strtoupper($unit_name).' </b> <br/> 
	...
	<tr>
		<td colspan="2">3. Certified that I will abide by the D & C Act., 1940 and D & C Rules 1945 and I will not violate the DMR & objectionable Advertisement Act. 1954 ad I follow G.M.P. Guidelines.
		</td>					
	</tr>		
	<tr>
		<td colspan="2">4. Certified that , the information given in this application is true and correct to the best of my knowledge and I have not furnished my false information with a view to obtain Ayurvedic/Unani drug manufacturing license.
		</td>				
	</tr>
	<tr>
