						...
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								...
								<table class="table table-responsive table-bordered">	
									<tr>
									   <td colspan="4">
										1. I/We, &nbsp;&nbsp;<?php echo strtoupper($Name_of_owner); ?>&nbsp; of &nbsp;<?php echo strtoupper($unit_name); ?>&nbsp;&nbsp;hereby apply for the grant/renewal of a license to manufacture Ayurvedic(including Siddha) or Unani drugs on the premises situated at &nbsp;&nbsp;<?php echo strtoupper($vill); ?>.
										</td>
									</tr>
									<tr>
