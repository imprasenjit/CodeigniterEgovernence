					...
					<div id="table1" class="tab-pane <?php echo $tabbtn1; ?>" role="tabpanel">
						<form name="myform1" class="submit1" id="myform1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                         <table class="table table-responsive">
								<tr>
									<td colspan="2">(1) The purpose (Residence, Office, Restaurant, Hotel, Dharamshala, School, Hostel,Cinema, Shop, Factory. Others) for which it is intended to be used </td>
									<td><input type="text"  class="dob form-control text-uppercase"></td>
								</tr>
								<tr>
									<td colspan="4">(2) Details of Area on respective floor are given below</td>
								</tr>
								<tr>
									<td colspan="5">
								...
								<tr>
									<td>(a) Approximate number of inhabitants proposed to be accommodated &nbsp;&nbsp;&nbsp;&nbsp;</td>
									<td><input type="text" class="form-control text-upercase" ></td>
									<td>(b) The number of Latrine. Urinals, Kitchens. Baths to be provided. &nbsp;&nbsp;&nbsp;&nbsp;</td>
									<td><input type="text" class="form-control text-upercase" ></td>		
                             </tr>
							    <tr>
									<td>(c) The source of water to be used in the construction </td>
									<td><input type="text" class="form-control text-upercase" ></td>
									<td>(d) Distance from public sewer (if any) &nbsp;&nbsp;&nbsp;&nbsp;</td>
									<td><input type="text" class="form-control text-upercase" ></td>		
                             </tr>
							 <tr>
									<td>(e) The materials to be used in construction walls/ Columns/ Foundations/ Roof/ Floors&nbsp;&nbsp;&nbsp;&nbsp;</td>
									<td><input type="text" class="form-control text-upercase" ></td>
							</tr>
							<tr>
									<td>Name of owner(in block letters):</td>
								...
								<tr>
									<td colspan="4" class="form-inline">
					                  ...
					                  (4) The period of construction valid up to <input type="text"  class="dob form-control text-uppercase">as per the lease condition/further extension of the time for construction granted by the leaser is valid upto<input type="text"  class="dob form-control text-uppercase"> Time construction obtained form the Competent Authority.
									</td>
								</tr>
								<tr>
									<td>(5) Size of dwelling unit is not more than</td>
									<td><input type="text"  class="form-control text-uppercase"</td>
								</tr>
								<tr>
									<td>Name of Architect/Engineer/supervisor(in block letters):</td>
									<td><input type="text" class="form-control text-uppercase"></td>
								</tr>
					           <tr>
