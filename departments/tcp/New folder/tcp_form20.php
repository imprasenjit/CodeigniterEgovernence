					...
					<div id="table1" class="tab-pane <?php echo $tabbtn1; ?>" role="tabpanel">
						<form name="myform1" class="submit1" id="myform1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                         <table class="table table-responsive">
								...
								<tr>
									<td colspan="4">(For all categories of buildings)</td>
								</tr>
				
								<tr>
									<td width="25%"> (A) Plot area:</td>
								...
								<tr>
								   <td>(I) Existing plinth Area (if any) : </td>
								   <td><input type="text"  class="form-control text-uppercase" ></td>
									<td>(II) Proposed plinth Area :</td>
									<td><input type="text"  class="form-control text-uppercase"  ></td>
								</tr>
								<tr>
									<td>(C) Floor area showing detail calculation of each floor (Existing + Proposed):</td>
									<td><input type="text"  class="form-control text-uppercase"  ></td>
									<td>(D) Detail of mezzanine floor area:</td>
									<td><input type="text"  class="form-control text-uppercase"  ></td>
								</tr>
								<tr>
									<td>(E) Deduction showing detail calculation of each floor (Existing + Proposed):</td>
									<td><input type="text"  class="form-control text-uppercase"  ></td>
									<td>(F) Total floor area after deduction (Existing + Proposed):</td>
									<td><input type="text"  class="form-control text-uppercase"  ></td>
									
								</tr>
								<tr>
									<td>(G) Total floor area before deduction (Existing + Proposed):</td>
									<td><input type="text"  class="form-control text-uppercase"  ></td>
									<td>(H) Coverage (Existing + Proposed):</td>
									<td><input type="text"  class="form-control text-uppercase"  ></td>
								</tr>
								<tr>
									<td>(I) Floor Area Ratio (FAR) (Existing + Proposed):</td>
									<td><input type="text"  class="form-control text-uppercase" ></td>
								</tr>
							    <tr>
