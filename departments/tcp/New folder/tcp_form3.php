									 ...
									 <table class="table table-responsive">
											<tr>
												<td colspan="4" class="form-inline">
													I hereby authorize Mr./Mrs. &nbsp; <input type="text"  class="form-control text-uppercase">&nbsp;to collect the sanction whose signature is verified below.
												</td>
											</tr>
											<tr>
												<td colspan="4">Specimen signature of</td>
											</tr>
											<tr>
												<td width="25%">MR</td>
											...
											<tr>
												...
												<td></td>
												<td></td>
												<td align="right"> <strong><?php echo strtoupper($key_person);?></strong><br/>Signature of authorized person/owner/Registered Architect</td>
											</tr>
											<tr>
