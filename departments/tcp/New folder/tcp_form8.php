                         ...
                         <table class="table table-responsive">
								...
								<tr>
									<td colspan="4" class="form-inline">
										...
										&nbsp;<input type="text"  class="form-control text-uppercase"><br/>
										Sir<br/>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;We hereby inform you that the work of execution of the building as per approved plan, working drawing and structural drawings has reached &nbsp;<input type="text"  class="form-control text-uppercase">&nbsp;storey level and is executed under our supervision.<br/>
								...
								<tr>
									...
									<td>Signature of the Construction Engineer on Record
									</td>
									<td>Date:<strong><? echo date('d-m-Y',strtotime($today));?></strong></td>
									<td>Signature of the Owner/Development/Builder</td>
								</tr>
								<tr>
