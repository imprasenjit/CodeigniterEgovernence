						...
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h4 class="text-center text-bold" >
									<?php echo $form_name=$cms->query("select form_name from tcp_form_names where form_no='4'")->fetch_object()->form_name; ?>
								</h4>	
							</div>
                         ...
                         <table class="table table-responsive">
								<tr>
									<td colspan="4" class="form-inline">
										To<br/>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;File No &nbsp;<input type="text"  class="form-control text-uppercase"><br/>
											Sir,<br/>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;With reference to your application No.<input type="text"  class="form-control text-uppercase"> &nbsp;Dated &nbsp;<input type="text"  class="dob form-control text-uppercase">&nbsp;for the grant of sanction for the erection of building/execution of work in House No. &nbsp;<input type="text"  class="form-control text-uppercase">&nbsp;Plot No&nbsp;<input type="text"  class="form-control text-uppercase">&nbsp;Block No&nbsp;<input type="text"  class="form-control text-uppercase">&nbsp;Scheme&nbsp;<input type="text"  class="form-control text-uppercase">&nbsp; situated at&nbsp;<input type="text"  class="form-control text-uppercase">&nbsp;I have you inform you that building permit under relevant provisions of the Act of &nbsp;<input type="text"  class="form-control text-uppercase">&nbsp;has been refused on &nbsp;<input type="text"  class="form-control text-uppercase">&nbsp;on the following grounds.
									</td>
								</tr>
								<tr>
									...
									<td></td>
									<td></td>
									<td align="right">Your faithfully, <br/><strong>Authority Name</strong></td>
								</tr>
								<tr>
