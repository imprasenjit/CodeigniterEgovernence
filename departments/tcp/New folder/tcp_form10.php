						...
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h4 class="text-center text-bold" >
									<?php echo $form_name=$cms->query("select form_name from tcp_form_names where form_no='10'")->fetch_object()->form_name; ?>
								</h4>	
							</div>
                         ...
                         <table class="table table-responsive">
								...
								<tr>
									<td colspan="4" class="form-inline">
										...
										2. The building/s has/have been constructed as per approved plan and design as per detailed architectural drawings and specifications prepared by Architect on Record.<br/>
								...
								<tr>
									...
									<td>Date:<strong><? echo date('d-m-Y',strtotime($today));?></strong></td>
									<td>Signature of Architect on Record</td>
								</tr>
								<tr>
