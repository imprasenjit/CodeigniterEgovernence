                         ...
                         <table class="table table-responsive">
								<tr>
									<td colspan="4" class="form-inline">
										Subject: Self Certification of ground based tower/composite structure (roof top tower + building) for communication network.<br/>
										File No &nbsp;<input type="text"  class="form-control text-uppercase"><br/>
										
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;It is certified that the Ground based tower/composite structure (roof top tower + Building), a part of our communication network and located at &nbsp;<input type="text"  class="form-control text-uppercase"> &nbsp;conforms to &nbsp;<input type="text"  class="dob form-control text-uppercase">&nbsp;GR issued by TEC, DoT/design approved by &nbsp;<input type="text"  class="form-control text-uppercase">&nbsp;(name and address of the institute, etc.). The tower/composite structure (rooftop tower + building) falling under seismic zone&nbsp;<input type="text"  class="form-control text-uppercase">&nbsp;is compliant to the latest BIS code IS 1893 and other provisions envisaged in the instructions issued by DoT from time to time. The relevant particulars are as per datasheet enclosed.
									</td>
								</tr>
								...
								<tr>
									...
									<td></td>
									<td></td>
									<td align="right">Signature <br/><strong>Authorised signatory</strong></td>
								</tr>
								<tr>
