						...
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h4 class="text-center text-bold" >
									<?php echo $form_name=$cms->query("select form_name from tcp_form_names where form_no='15'")->fetch_object()->form_name; ?>
								</h4>	
							</div>
					...
					<div id="table1" class="tab-pane <?php echo $tabbtn1; ?>" role="tabpanel">
						<form name="myform1" class="submit1" id="myform1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                         <table class="table table-responsive">
								<tr>
									<td colspan="4">1 Address of the building</td>
								</tr>
								<tr>
									<td width="25%">Name of the building</td>
									<td width="25%"><input type="text" class="form-control text-upercase" ></td>
									<td width="25%">Plot number</td>
									<td width="25%"><input type="text" class="form-control text-upercase" ></td>
								</tr>								
								<tr>
									<td>Sub plot number</td>
									<td><input type="text" class="form-control text-upercase" ></td>
									<td></td>
									<td></td>
								</tr>
								<tr>
									<td colspan="4">TPS scheme</td>
								</tr>
								<tr>
									<td>a. Name</td>
									<td><input type="text" class="form-control text-upercase" ></td>
								...
								<tr>
									<td>Locality/ Township</td>
									<td><input type="text" class="form-control text-upercase" ></td>
									<td>District</td>
									<td><input type="text" class="form-control text-upercase" ></td>
								</tr>
								<tr>
									<td>2. Name of owner</td>
									<td><input type="text" class="form-control text-upercase" ></td>
									<td>3. Name of Builder on record</td>
									<td><input type="text" class="form-control text-upercase" ></td>
								</tr>
								<tr>
									<td>4. Name of Architect/ Engineer on record</td>
									<td><input type="text" class="form-control text-upercase" ></td>
									<td>5. Name of Structural engineer on record</td>
									<td><input type="text" class="form-control text-upercase" ></td>
								</tr>
								<tr>
									<td>6. Use of the Building</td>
									<td><input type="text"  class="form-control text-uppercase"></td>
									<td>7. Number of storeys above ground level (including storeys to be added later, if any)</td>
									<td><input type="text"  class="form-control text-uppercase"></td>
								</tr>
								<tr>
									<td>8. Number of basements below ground level</td>
									<td><input type="text"  class="form-control text-uppercase"></td>
									<td></td>
									<td></td>
								</tr>
								<tr>
									<td colspan="4">9. Type of structure</td>
								</tr>
								<tr>
								...
								<tr>
									<td>RCC frame and Shear walls</td>
									<td><input type="text"  class="form-control text-uppercase"></td>
									<td>Steel frame</td>
									<td><input type="text"  class="form-control text-uppercase"></td>
								</tr>
								<tr>
									<td colspan="4">10 Soil data</td>
								</tr>
								<tr>
									<td>Type of soil</td>
									<td><input type="text"  class="form-control text-uppercase"></td>
									<td>Design safe bearing capacity</td>
									<td><input type="text"  class="form-control text-uppercase"></td>
								</tr>
								<tr>
									<td colspan="4">11. Dead loads (unit weight adopted)</td>
								</tr>
								<tr>
									<td>Earth</td>
									<td><input type="text"  class="form-control text-uppercase"></td>
								...
								<tr>
									...
									<td><input type="text"  class="form-control text-uppercase"></td>
									<td>Other fill materials</td>
									<td><input type="text"  class="form-control text-uppercase"></td>
								</tr>
								<tr>
									<td colspan="4">12. Imposed (live) loads</td>
								</tr>
								<tr>
									<td>Piazza floor accessible to Fire Tender</td>
									<td><input type="text"  class="form-control text-uppercase"></td>
									<td>Piazza Floor not accessible to Fire tender</td>
									<td><input type="text"  class="form-control text-uppercase"></td>
								</tr>
								<tr>
									<td>Floor loads</td>
