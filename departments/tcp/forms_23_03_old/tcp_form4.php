...
$check=$formFunctions->is_already_registered('tcp','4');
if($check==1){
	echo "<script>
	...
	echo "<script>				
				window.location.href = '".$server_url."departments/requires/courier_details.php?form=4&dept=tcp';
		</script>";
}else if($check==3){
...
include "save_tcp_form.php";
		...
		$q=$tcp->query("select * from tcp_form4 where user_id='$swr_id' and active='1'") or die($tcp->error);
                         ...
                         <table class="table table-responsive">
								...
								<tr>
									<td colspan="4" class="form-inline">
										...
										Sir<br/>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;We hereby inform you that the work of execution of the building as per approved plan, working drawing and structural drawings has reached &nbsp;<input type="text"  class="form-control text-uppercase" name="drawings"  value=<?php $drawings;?>>&nbsp;storey level and is executed under our supervision.<br/>
								...
								<tr>
									...
									<button type="submit" class="btn btn-success submit1" name="save4" title="Save it and fill up the form later and Go to the Next Part"  onclick="return confirm('Do you want to save..?')" >Save and Next</button>
									</td>
								</tr>									
							</table>
						</form>
