...
$check=$formFunctions->is_already_registered('tcp','5');
if($check==1){
	echo "<script>
	...
	echo "<script>				
				window.location.href = '".$server_url."departments/requires/courier_details.php?form=5&dept=tcp';
		</script>";
}else if($check==3){
...
include "save_tcp_form.php";
		...
		$q=$tcp->query("select * from tcp_form5 where user_id='$swr_id' and active='1'") or die($tcp->error);
		$results=$q->fetch_array();
		if($q->num_rows<1){	
			$form_id="";
			$ref_no="";$submit_dt="";$receive_dt="";$officer_name="";$add_line1="";$add_line2="";$engineer="";$engineer_address="";$owner_name="";$owner_address="";$drawings="";
						...
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h4 class="text-center text-bold" >
									<?php echo $form_name=$cms->query("select form_name from tcp_form_names where form_no='5'")->fetch_object()->form_name; ?>
								</h4>	
							</div>
                         ...
                         <table class="table table-responsive">
								...
								<tr>
									<td colspan="4" class="form-inline">
										...
										Sir,<br/>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;We hereby inform you that the work of execution of the building as per approved plan, working drawing and structural drawings has reached &nbsp;<input type="text"  class="form-control text-uppercase" name="drawings"  value=<?php echo $drawings;?>>&nbsp;storey level and is executed under our supervision.<br/>
								...
								<tr>
									...
									<button type="submit" class="btn btn-success submit1" name="save5" title="Save it and fill up the form later and Go to the Next Part"  onclick="return confirm('Do you want to save..?')" >Save and Next</button>
									</td>
								</tr>									
							</table>
						</form>
