...
$query="select save_mode from tcp_form1 where user_id='$swr_id' and active='1' and save_mode!='C'";
...
include "save_tcp_form.php";
	...
	$q=$tcp->query("select * from tcp_form1 where user_id='$swr_id' and active='1' and save_mode='D'") or die($tcp->error);
