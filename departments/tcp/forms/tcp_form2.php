...
include "save_tcp_form.php";
	...
	if($q->num_rows<1){	
		...
		if($p->num_rows>0){
			...
			$form_id="";
			$ref_uain="";$ownername="";$location="";$submit_dt="";$receive_dt="";$officer_name="";$add_line1="";$add_line2="";$engineer="";$engineer_address="";$development_name="";$development_address="";
		}
	}else{			
									...
									<form name="myform1" class="submit1" id="myform1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
										...
										<table class="table table-responsive" id="form_table">
											...
											<tr>
												...
												<td><input type="text"  class=" form-control text-uppercase" validate="letters" name="development_name" value="<?php echo $development_name;?>"></td>
