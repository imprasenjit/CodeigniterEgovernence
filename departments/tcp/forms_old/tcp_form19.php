                         ...
                         <table class="table table-responsive">
								<tr>
									<td colspan="4" class="form-inline">
										To <br/>
										 <input type="text"  class="dob form-control text-uppercase"> <br/><br/><input type="text"  class="dob form-control text-uppercase"> <br/><br/><input type="text"  class="dob form-control text-uppercase">
									</td>
			                  <tr>
									<td colspan="4" class="form-inline">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;We hereby apply for enrolment of our Group or Agency in the name and style as mentioned below, as competent technical personnel to do the various works of schemes Building Permit and supervision in the <input type="text"  class="dob form-control text-uppercase"></td>
								</tr>
								<tr>
									<td colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;We do hereby also declare that we shall follow and shall abide by all the Rules and Regulations now in force and that may be framed from time to time. Name of the group and persons associated with personal bio-data are as follows-</td>
								</tr>
				              <tr>
								...
								<tr>
									<td>2.Present and Permanent address</td>
								</tr>
								<tr>
								...
								<tr>
								 ...
								 <tr>
									<td width="25%"> 3.Name of persons associated with his/ her personal capacity
