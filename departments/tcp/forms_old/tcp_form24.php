                         ...
                         <table class="table table-responsive">
								...
								<tr>
									<td colspan="4" class="form-inline">
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;With reference to your notice of completion dated <input type="text"  class="form-control text-uppercase"> I hereby certify that building, as per description below certified plan at Plot No <input type="text" class="form-control text-uppercase"> Block No <input type="text" class="form-control text-uppercase"> whose plans were sanctioned vide No  <input type="text"  class="form-control text-uppercase">  as been inspected with reference to
                                   building bye-law in respect to the structural safety, fire safety, hygienic and sanitary conditions inside and in the surroundings and is declared fit for occupation and release of regular water and electricity connection. The description of the construction work completed is given as under:-
								  </td>
								</tr>
							   <tr>
									<td>Description of Construction Work Block-wise/Building wise</td>
							    </tr>
								<tr>
									<td>1. Location of Building</td>
									<td><input type="text" class="form-control text-upercase"></td>
									<td>2. Details of completed work floor wise</td>
								   <td><textarea class="form-control text-uppercase" maxlength="255" ></textarea></td>
								</tr>
								    <td>3. Enclosed : As-built plan</td>
									<td><input type="text" class="form-control text-upercase"></td>
								</tr>
								<tr>
								    <td colspan="4">Note: NOC issued from the fire services to be renewed each year, failing which the occupancy certificate shall lapse</td>
								</tr>
						       <tr>
