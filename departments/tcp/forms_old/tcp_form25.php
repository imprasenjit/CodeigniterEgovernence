				...
				<div class="tab-content">
					<div id="table1" class="tab-pane <?php echo $tabbtn1; ?>" role="tabpanel">
						<form name="myform1" class="submit1" id="myform1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
						 ...
						 <tr>
									<td width="25%">No. F. ( ) Bldg.</td>
									<td width="25%"><input type="text"  class="form-control text-uppercase"></td>
									<td width="25%">Date:</td>
									<td width="25%"><input type="text"  class="dob form-control text-uppercase"></td></td>
								</tr>
								<tr>
									<td>Subject: Occupancy Certificate in respect </td>
								</tr>
								<tr>
									<td width="25%">Plot No</td>
									<td width="25%"><input type="text" class="form-control text-upercase"></td>
									<td width="25%">Block No</td>
									<td width="25%"><input type="text" class="form-control text-upercase"></td>
								</tr>
								<tr>
									<td width="25%">Scheme</td>
									<td><input type="text" class="dob form-control text-upercase"></td>
									<td></td>
									<td></td>
								</tr>
								<tr>
								...
								<tr>
									<td width="25%">(1.) With reference to your letter dated</td>
									<td width="25%"><input type="text" class="dob form-control text-upercase"></td>
									<td width="25%">(2.) With reference to your Notice of Completion dated/td>
								    <td width="25%"><input type="text" class="dob form-control text-uppercas"></td>
								</tr>
								<tr>
									<td width="25%">(3.) In continuation to this office letter of even </td>
									<td width="25%"><input type="text" class="form-control text-upercase"></td>
									<td width="25%">Date</td>
								     <td width="25%"><input type="text" class="dob form-control text-uppercas"></td>
								</tr>
								<tr>
								    <td colspan="4">On the subject noted above, I am directed to inform you that your case has been examined and occupancy certificate is rejected for the reason as given below:</td>
								</tr>
								<tr>
									<td colspan="4">(1) I am directed to request you to comply with the following : </td>
								</tr>
								<tr>
								    <td colspan="4">(a) Submission of the following document :</td>
								</tr>
								<tr>
								    <td colspan="4">1.</td>
								</tr>
								...
								<tr>
								    <td colspan="4">(b) Rectification of the following deviations :</td>
								</tr>
								<tr>
								    <td colspan="4">1.</td>
								</tr>
								...
								<tr>
									<td colspan="4">(c) The following items can be regularized on payment of compounding fee noted against each :</td>
								</tr>
								<tr>
									<td colspan="5">
										<table class="table table-responsive table-bordered">
											...
											<tr>
											    <td>Sl. No.</td>
												<td>Item</td>
												<td>Rate of Compounding fee</td>
												<td>Amount of Compounding fee in Rs.</td>
							              </tr>
											<tr>
								...
								<tr>
									<td>Total Compounding fee Rs.</td>
									<td><input type="text" class="form-control text-upercase"></td>
								</tr>
								<tr>
									<td colspan="4">(2) Cheques will not be accepted and only cash payment will be accepted. </td>
								</tr>
								<tr>
									<td colspan="4" class="form-inline">
										
					                  3) You are, therefore, requested to do the needful by <input type="text"  class="form-control text-uppercase"> ailing which your request for the issue of Occupancy Certificate will be rejected without any further reference to you and necessary action under the law will be initiated.
									</td>
								</tr>
								<tr>
									<td colspan="4">(4) Please quote your file number while sending the reply of the letters.</td>
								</tr>
						       <tr>
