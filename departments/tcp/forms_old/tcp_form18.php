                         ...
                         <table class="table table-responsive">
								<tr>
									<td colspan="4" class="form-inline">
										To <br/>
										The Chairman,</br> <input type="text"  class="dob form-control text-uppercase"></br> </br><input type="text"  class="dob form-control text-uppercase"> 
									</td>
								</tr>
			                  <tr>
									...
									<input type="text"  class="dob form-control text-uppercase"></td>
								</tr>
								<tr>
									<td colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;I do hereby also declare that I shall follow and shall abide by all the Rules and Regulations now in force and that may be framed from time.</td>
								...
								<tr>
									<td>Qualification:<br/>(Certificate to be enclosed)</td>
								...
								<tr>
									<td colspan="4" class="form-inline">
										...
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;I deposit herewith annual enrolment fees of Rs. <input type="text"  class="dob form-control text-uppercase">(Rupees)<input type="text"  class="dob form-control text-uppercase"> only in cash as required.
									</td>
								<tr>
