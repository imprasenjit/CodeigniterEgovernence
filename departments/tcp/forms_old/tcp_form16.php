						...
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h4 class="text-center text-bold" >
									<?php echo $form_name=$cms->query("select form_name from tcp_form_names where form_no='16'")->fetch_object()->form_name; ?>
								</h4>	
							</div>
                         ...
                         <table class="table table-responsive">
								...
								<tr>
									<td colspan="4" class="form-inline">
										...
										&nbsp;<input type="text"  class="form-control text-uppercase"><br/><br/>
										Sir,<br/><br/>
								...
								<tr>
									...
									<td>(Developer's / Builder's Signature)
									</td>
									<td>Date:<strong><? echo date('d-m-Y',strtotime($today));?></strong></td>
									<td align="right">(Owner's Signature)</td>
								</tr>
								<tr>
