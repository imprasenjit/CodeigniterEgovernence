                         ...
                         <table class="table table-responsive">
								<tr>
									<td colspan="4" class="form-inline">
										To <br/>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ref : Proposed work of <input type="text"  class="dob form-control text-uppercase">(Title of the project) Dag No. <input type="text"  class="dob form-control text-uppercase"> Patta No.<input type="text"  class="dob form-control text-uppercase">of Revenue Village<input type="text"  class="dob form-control text-uppercase"> under <input type="text"  class="dob form-control text-uppercase"> Mouza situated at <input type="text"  class="dob form-control text-uppercase">
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td colspan="4">I am a Registered Structural Engineer (RSE). This is to certify that I have been appointed as the Structural Engineer on record to prepare the Structural design basis report, detailed structural design and detailed structural drawings for above mentioned project. I am fully conversant of my duties and responsibilities under the Regulations and assure that I shall fulfill them in all respects.<br/>

									I have prepared and signed a structural design basis report SDBR).<br/><br/> 
									<b>I undertake to carry out a detailed structural design and prepare detailed structural drawings of the proposed building as per the latest Indian Standard Specifications, and as indicated in the Structural design basis report.<b><br/><br/>
									<b>I undertake to supply the owner and the supervisor the detailed structural drawings. If my services are terminated, I undertake to intimate the Authority in writing.<b></td>
								</tr>
								<tr>
									<td>Reg. No.</td>
									<td><input type="text"  class="form-control text-uppercase"  ></td>
