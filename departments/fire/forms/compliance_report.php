...
if(isset($_POST["comply"])){
	...
	$update_applications=$mysqli->query("update applications_up set current_status='CRL',process_date='$reply_date' where uain='$token'");
	
	if($comply_report && $update_applications){
		echo "<script>
