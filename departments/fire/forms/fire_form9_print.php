...
<table class="table table-bordered table-responsive"> 
	...
	<tr>
		<td colspan="2%">Sir,<br/> I/We, '.strtoupper($key_person).'&nbsp; on behalf of &nbsp;'.strtoupper($unit_name).'&nbsp;apply for N.O.C. in respect of Fire Safety Measures under "Assam Fire Service Rules 1989" for the purpose of Existing/ Proposed Storage &amp; Handling of Explosives. Required documents/ information as per formate furnished below.</td>
	</tr>
	<tr>
	...
	<tr>
		<td>5. Classification of explosives for which NOC is needed</td>
	...
	<tr>
		<td>18. Details of the personnel trained in basic fire fighting (training certificate)</td>
		<td>Name : '.strtoupper($row['details_p_t']).'<br/> Sl No : '.strtoupper($row['sl_c_details']).'</td>
	</tr>
	<tr>
