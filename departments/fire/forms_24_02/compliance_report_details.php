						...
						<div class="panel-body">
							<div class="col-md-12">
								...
								<table class="table table-responsive table-bordered">
									...
									<tr class="received_fire_safety_class">
										<td colspan="4" class="success text-center">COMPLIANCE REPORT OF FIRE SAFETY MEASURES SUGGESTIONS</td>
									</tr>
									<tr class="received_fire_safety_class">
										<td colspan="4">
										<p>To,<br/>
