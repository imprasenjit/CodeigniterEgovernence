		...
		<tr>
			...
			<tr>
				...
				<td><?php $dstresult=$mysqli->query("SELECT * FROM district WHERE district !='' GROUP BY district ASC") OR die("Error : ".$mysqli->error); ?>
					<select name="p_o_addr[dist]" class="form-control text-uppercase" id="dist2"  required="required">
				...
				<tr>
					<td> Block</td>
					<td>
						<select name="p_o_addr[blk]" class="form-control text-uppercase" required="required" id="block2" >										
