...
if($check==1){
	...
	$row=$q->fetch_assoc();
	$surround_prop_e="";$surround_prop_w="";$surround_prop_n="";$surround_prop_s="";$os_width_e="";$os_width_w="";$os_width_n="";$os_width_s="";$distance_motor="";$width_road="";$parking="";$arrange_cook="";$distance_electric="";$fire_name="";$fire_std="";$fire_land="";$fire_details="";$s_no="";$license_name="";$license_no="";$other_info="";$water_details="";$personnel_details="";$license_authority="";$file1="";$file2="";$file3="";$file4="";$owner_name="";$purpose_erect="";$total_area="";$two_wheeler="";$four_wheeler="";
...
<?php require '../../../user_area/includes/css.php';?>
  ...
  <tr>
    <td colspan="4">13. Name of the nearest Fire Station and telephone number:</td>
      ...
      <tr>
        <td>Name</td>
        <td><input type="text"  class="form-control text-uppercase"  name="fire_name" placeholder="Name of Fire Station" id="fire_name" value="<?php  echo $fire_name; ?>"/></td>
        </tr>
        <tr>
