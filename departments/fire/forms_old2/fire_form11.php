...
if($check==1){
   ...
   {$dept="fire";
	...
	$unit_details="Street Name : ".strtoupper($b_street_name1)."  ".strtoupper($b_street_name2)."\nVill/Town : ".strtoupper($b_vill)." , ".strtoupper($b_dist)."\nPin Code : ".$b_pincode."\nMobile Number : +91 ".$b_mobile_no."\nPhone Number : ".$b_landline_std."-".$b_landline_no;
	    ...
	    $row=$q->fetch_assoc();
		$file2="";$holding_no="";$letter_no="";$renewal_year1="";$renewal_year2="";$letter_valid_date="";$letter_date="";
		if($q->num_rows>0){  
		$holding_no=$row['holding_no'];$letter_no=$row['letter_no'];$renewal_year1=$row['renewal_year1'];$renewal_year2=$row['renewal_year2'];$letter_valid_date=$row['letter_valid_date'];$letter_date=$row['letter_date'];$file2=$row['file2'];  
...
<?php require '../../../user_area/includes/css.php';?>
  ...
  <?php require '../../../user_area/includes/aside.php'; ?>
						...
						<div class="col-md-12">
							<div class="panel panel-primary">
								...
								<div class="panel-body">
									...
									<form name="myform1" id="myform1" class="form-group submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data"><table id="" class="table table-responsive">
					             <tr>
										<td colspan="4" class="form-inline">
										&emsp;&emsp;I/We &nbsp;<strong><?php echo strtoupper($key_person); ?></strong> &nbsp;on behalf of&nbsp; <strong><?php echo strtoupper($owner_name); ?></strong>&nbsp; located at &nbsp;<strong><?php  echo $from; ?></strong> &nbsp;holding No.&nbsp;  <input type="text" class="fo" name="holding_no" id="textfield3" required="required" placeholder="Holding No" value="<?php  echo $holding_no; ?>"/>&nbsp; District &nbsp; <strong><?php  echo strtoupper($dist); ?></strong>,&nbsp;  State &nbsp; <strong><?php  echo strtoupper($block); ?></strong> &nbsp; do hereby inform you  that No Objection Certificate (N.O.C.) issued vide your Letter No./UAIN &nbsp; <input type="text" name="letter_no" id="textfield6" style="width:200px;" required="required" placeholder="Letter No" value="<?php if($uain!="" && $previous_noc!="") {echo $uain; } else {echo $letter_no;}?>"/><font color="red">*</font>&nbsp; Dated &nbsp;<input type="text"  name="letter_date" class="dob" readonly="readonly"  placeholder="MM/DD/YYYY" value="<?php  echo $letter_date;?>"/><font color="red">*</font> &nbsp;valid up to &nbsp; <input type="text" name="letter_valid_date" id="textfield8" readonly="readonly" placeholder="MM/DD/YYYY"  class="dob" value="<?php echo $letter_valid_date;?>"/><font color="red">*</font> &nbsp;(Copy of N.O.C. is Enclosed) and is due for renewal for a period of another 1(One) Year 
										
	                               with effect from 1<sup>st</sup> of April  &nbsp;<input type="text" class="fo"  required="required" id="textfield9" name="renewal_year1" readonly="readonly" value="<?php if(empty($renewal_year1)==false)  echo $renewal_year1; else echo date('Y');?>"/> to 31<sup>st</sup>  of March &nbsp; <input class="fo"  type="text" id="textfield10" required="required" name="renewal_year2" readonly="readonly"  value="<?php if(empty($renewal_year2)==false)  echo $renewal_year2; else echo date('Y',strtotime('+1 year')); ?>" />.
                                   </td>								   
									</tr> 
	...
	<tr>
	<th>In this connection it is submitted that-</th>
	</tr>
	<tr>
	...
	<tr>
	<td>
		&#42; You are requested kindly to take necessary action for grant of Renewal of N.O.C. for the above premises/building.
		</td>
	</tr>
	</table>
...
<form name="myform1" id="myform1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
	<table  id=""  class="table table-responsive" >										
				...
				<tr>
					...
					<td width="10%">
					<select trigger="FileModal" id="file2" class="file2" <?php if($file2!="" || $file2=="SC" || $file2=="NA") echo "disabled='disabled'"; ?>>
							<option value="0" selected="selected">Select</option>
							<option value="1">From E-Locker</option>
							<option value="2">From PC</option>
						</select>
					<input type="hidden" name="mfile2" value="<?php if($file2!="") echo $file2; ?>" id="mfile2" readonly="readonly"/>					
					</td>
					...
					<td width="10%"><input type="CheckBox" id="B1" class="file2" name="B1" <?php if($file2=="NA") echo "checked"; ?>  value='B1' <?php if($file2!="" && $file2!="NA") echo "disabled"; ?> onClick="checkData(this)">N/A</input></td>
					<td width="20%"><input type="CheckBox" id="B2" class="file2 cd" name="B2" <?php if($file2=="SC") echo "checked"; ?> value='B2' <?php if($file2!="" && $file2!="SC") echo "disabled"; ?> onClick="checkData(this)">S/C</input></td>	
