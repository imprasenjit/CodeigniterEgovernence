...
if($check==1){
	...
	$access_premises="";$provision_segregate="";$size_exit="";$fire_name="";$fire_details="";$water_details="";$personnel_details="";
	...
	if($q->num_rows>0){   
		...
		if(empty($row['os_width']==false)){
		    ...
		    $chemical_stored=$row["chemical_stored"];$quantity_stored=$row["quantity_stored"];$type_storage=$row["type_storage"];
				...
				$fire_name=$row["fire_name"];$fire_details=$row["fire_details"];$water_details=$row["water_details"];$personnel_details=$row["personnel_details"];$s_no=$row["s_no"];$license_no=$row["license_no"];
...
<?php require '../../../user_area/includes/css.php';?>
  ...
  <tr>
    ...
    <td><input type="text1" class="form-control text-uppercase"  name="fire_name" placeholder="name of the nearest fire station" id="fire_name" value="<?php echo $fire_name;?>"/></td>
