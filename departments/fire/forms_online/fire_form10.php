	...
	<table  id=""  class="table table-responsive" >										
				...
				<tr>
					<td class="text-center" colspan="4">
						...
						<button type="submit" class="btn btn-success submit1" name="submit10" title="Save it and fill up the form later and Go to the Next Part" onclick="return confirm('Do you want to save..?')">Save & Next</button>
					</td>
					</tr>
					        </table>
	 </form>
