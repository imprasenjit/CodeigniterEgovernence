...
$row1=$formFunctions->fetch_swr($swr_id);
		...
		$place_occurrence=json_decode($row["place_occurrence"]);
		...
		$occupant_address=json_decode($row["occupant_address"]);
		$occupant_address_village= $occupant_address->vt;
		$occupant_address_ward= $occupant_address->w;
		$occupant_name= $occupant_address->name;
		...
		$fire_desc=json_decode($row["fire_desc"]);
			...
			<tr>
				<td>
					 <table width="99%" align="center" class="table table-bordered table-responsive" style="margin:0px auto;border-collapse: collapse" border="0" >  
						<tr>	
							<td colspan="2">To<br/>&nbsp;&nbsp;The Director,<br/>&nbsp;&nbsp;Fire &amp; Emergency Services, Assam<br/></td>
						</tr>
						<tr>
