...
$table_name=getTableName($dept,$form);
	...
	$form_id=$_GET["ui"];
	$q=$formFunctions->executeQuery($dept,"select * from ".$table_name."  where user_id='$swr_id' and form_id='$form_id' and form_id=form_id");
	}else if(isset($_GET["uain"])){
		$uain=$_GET["uain"];
		$q=$formFunctions->executeQuery($dept,"select * from ".$table_name."  where user_id='$swr_id' and uain='$uain' and form_id=form_id");	
		...
		<tr>
			<td colspan="2">
				...
				<tr>
					...
					<th width="10%">Academic Qualifications , training previous teaching experience, if any</th>
					<th width="20%">Subject being taught at present</th>
