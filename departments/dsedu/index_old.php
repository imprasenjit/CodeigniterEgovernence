						...
						<div class="col-md-4">
							<div class="info-box bg-aqua-active">							
								...
								<div class="col-md-6 small-box-footer btn btn-primary">								
									<a class="text-bold" href="<?php echo $server_url?>dept_documents/dsedu/forms/TradeLicenceAppForm.pdf" target="_blank"><i class="fa fa-download"></i> Download Sample form</a>
								</div>
								<div class="col-md-6 small-box-footer btn btn-primary">			
									<a class="text-bold" href="../requires/terms.php?form=<?php echo $rows->form_no; ?>&dept=dsedu"><i class="fa fa-calendar"></i> Apply Online</a>
								</div>
							</div>							
						</div>
					<?php }
					if($rows->form_no==2){ ?>
						<div class="col-md-4">
							<div class="info-box bg-aqua-active">							
								...
								<div class="col-md-6 small-box-footer btn btn-primary">								
									<a class="text-bold" href="<?php echo $server_url?>dept_documents/dsedu/forms/dsedu_form2.pdf" target="_blank"><i class="fa fa-download"></i> Download Sample form</a>
								</div>
								<div class="col-md-6 small-box-footer btn btn-primary">			
									<a class="text-bold" href="../requires/terms.php?form=<?php echo $rows->form_no; ?>&dept=dsedu"><i class="fa fa-calendar"></i> Apply Online</a>
								</div>
