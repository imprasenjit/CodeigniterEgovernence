<?php
if(isset($form_id)){
	$part1=$dsedu->query("SELECT id FROM dsedu_form2_t1 WHERE form_id='$form_id'");
	$num = $part1->num_rows;
}else{
	$num=0;
}
...
<?php
if(isset($form_id)){
	$part2=$dsedu->query("SELECT id FROM dsedu_form2_t2 WHERE form_id='$form_id'");
	$num2= $part2->num_rows;
}else{
	$num2=0;
}
...
<script>
	...
	function addMore3(){
		...
		t7.style="";
		t7.size="20";	
		t7.placeholder="Part Time/Full Time";
