					...
					<div class="col-md-12">
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								...
								<form name="myform1" id="stage_form" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
										...
										<tr>
										<td>Email:</td>
											<td><input type="text" class="form-control text-uppercase" disabled="disabled" readonly="readonly" value="<?php echo $b_email; ?>"></td>
										</tr>
										<tr>
										...
										<tr>
											<td colspan="3">4. Whether registered under the Registration  of  Societies  Act 1860. (Copies of audited accounts	for last 3 years are to be enclosed).If yes?  Please enclose  a   copy  of  the  Registration Certificate.<span class="mandatory_field">*</span></td>
											<td><label class="radio-inline"><input type="radio" name="is_registration" id="is_registration" value="Y"  <?php if(isset($is_registration) && $is_registration=='Y') echo 'checked'; ?> /> Yes</label>
											<label class="radio-inline"><input type="radio" name="is_registration"  value="N"  id="is_registration" <?php if(isset($is_registration) && $is_registration=='N') echo 'checked'; ?> /> No</label></td>
										</tr>
										<tr>
											...
											<td>6.Stage(s) of Education  proposed to be imparted ?<span class="mandatory_field">*</span></td>
											<td>
												<?php 
													if($education_stage!=""){
								...
								<form name="myform1" id="myform1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
										...
										<tr>
											...
											<td>
											<label class="radio-inline"><input type="radio" name="semi_residential[a]" class="semi_residential_a" value="Y"  <?php if(isset($semi_residential_a) && $semi_residential_a=='Yes') echo 'checked'; ?> /> Yes</label>
											<label class="radio-inline"><input type="radio" class="semi_residential_a"  value="N"  name="semi_residential[a]" <?php if(isset($semi_residential_a) && ($semi_residential_a=='No' || $semi_residential_a=='')) echo 'checked'; ?>  /> No</label>
											</td>
