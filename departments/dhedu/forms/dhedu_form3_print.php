...
$table_name=getTableName($dept,$form);
	...
	<table class="table table-bordered table-responsive">
		...
		<tr>
			<td colspan="2">
				...
				<tr>
					...
					<th>Average attendance in each section during the last 6 months</th>
				</tr>';
		...
		<tr>
			<td>31. Whether admission in the school is open to all without any discrimination based on religion,caste, race, place of birth or any</td>
			<td>'.strtoupper($is_admission).' </td>
		</tr>
		<tr>
			<td>32. Whether any religious instruction is imparted and if so, whether it is compulsory?</td>
