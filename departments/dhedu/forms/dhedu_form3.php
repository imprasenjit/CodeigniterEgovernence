...
include "save_form.php";
	...
	if($q->num_rows<1){	
		...
		if($p->num_rows>0){
			...
			$name_of_indiv="";$location="";$date_of_prior="";$date_of_reg="";$education_stage="";$stage_of_edu="";$steam_n_subjects="";$medium_of_ins="";$recognized_school="";$is_institution="";$constitution="";$is_scheme="";$camp_area="";$type_of_building="";$accomodation="";$no_n_size="";$drinking_water="";$total_area="";$sources_of_fund="";$reserved_fund="";$mothly_income="";$monthly_expen="";
							...
							<div class="panel-body">
								...
								<table class="table table-responsive">
									...
									<tr>
										...
										<td width="25%"><label class="radio-inline"><input type="radio" name="is_admission" id="is_admission" value="Y"  <?php if($is_admission=="" || $is_admission=='Y' ) echo 'checked'; ?> /> Yes</label>
										...
										<td width="25%"><label class="radio-inline"><input type="radio" name="is_religious" id="is_religious" value="Y"  <?php if($is_religious=="" || $is_religious=='Y') echo 'checked'; ?> /> Yes</label>
									...
									<tr>
										...
										<td width="25%"><label class="radio-inline"><input type="radio" name="is_manage" id="is_manage" value="Y"  <?php if($is_manage=="" || $is_manage=='Y') echo 'checked'; ?> /> Yes</label>
									...
									<tr>
										...
										<td><input  type="text" name="other_info" maxlength="255" value="<?php echo $other_info; ?>" class="form-control text-uppercase"></td>
									</tr>											
									<tr>
