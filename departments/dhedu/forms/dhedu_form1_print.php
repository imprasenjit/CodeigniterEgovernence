...
$table_name=getTableName($dept,$form);
	...
	<table class="table table-bordered table-responsive">		
		<tr>  				
			<td valign="top">1.  Name of the Organization/ Individual/Group of individuals/ Society/ Trust :</td>
		...
		<tr>
			<td colspan="2">
				<table class="table table-bordered table-responsive">
					...
					$results1=$formFunctions->executeQuery($dept,"select * from ".$table_name."_members where form_id='$form_id'") or die("Error : ".$dhedu->error);
					$sl=1;
		...
		<tr>
			...
			<td align="right"> <strong>'.strtoupper($key_person).'</strong><br/>Signature of Authorized Signatory</td>				
		</tr>						
	</table>';
?>
