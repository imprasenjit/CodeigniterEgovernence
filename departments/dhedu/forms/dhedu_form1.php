...
include "save_form.php";
	...
	if($q->num_rows<1){	
		...
		if($p->num_rows>0){
			...
			$form_id="";$is_="";$inst_location="";$measure_land="";$land_status="";$instutition_names="";$proposed_scheme="";$is_residential="";$capacity="";$academic="";$ins_name="";$funds="";$fee_structure="";$finan_status="";$project_cost="";$time_frame="";$dist2="";$pin2="";$parking="";
			$is_registration="";
			$is_nonResidential_a="";$is_nonResidential_b="";
			$semi_residential_a="";$semi_residential_b="";$education_stage="";
		}
	}else{	
								...
								<form name="myform1" id="stage_form" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
										...
										<thead>
											...
											<?php 
											$member_results=$formFunctions->executeQuery($dept,"select * from ".$table_name."_members where form_id='$form_id'") or die("Error : ".$dhedu->error);					
										...
										<tr>
											...
											<td><label class="radio-inline"><input type="radio" name="is_registration" required="required"  id="is_registration" value="Y"  <?php if(isset($is_registration) && $is_registration=='Y') echo 'checked'; ?> /> Yes</label>
											<label class="radio-inline"><input type="radio" name="is_registration"  required="required"  value="N"  id="is_registration" <?php if(isset($is_registration) && ($is_registration=='N' || $is_registration=='')) echo 'checked'; ?> /> No</label></td>
										</tr>
										<tr>
