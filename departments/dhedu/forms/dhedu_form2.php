...
include "save_form.php";
	...
	if($q->num_rows<1){	
		...
		if($p->num_rows>0){
			...
			$land_a="";$land_b="";
			$board_result_a="";$board_result_b="";$board_result_c="";$education_stage="";$edu_level="";
		}
	}else{
								...
								<form name="myform2" id="stage_form" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
										...
										<tr>
											...
											<option value="Others" <?php if($affil=="Others") echo "selected";?>>Others</option>
											</select></td>
								...
								<form name="myform2" id="myform2" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
										...
										<tr>
											...
											<td><textarea class="form-control text-uppercase" name="other_info" maxlength="255"><?php echo $other_info;?></textarea>255 character only</td>
											<td></td>
											<td></td>
										</tr>
										<tr>
