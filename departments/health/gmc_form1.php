...
include "save_form.php";
	...
	$gmc_zone=$row1['b_block'];$id_proof_doc=$row1['id_proof_doc'];
	$sector_classes_b=$row1['sector_classes_b'];
	
	if($b_dist!="KAMRUP METROPOLITAN"){
		echo "<script>
						...
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h4 class="text-center text-bold" >
									Application for issue of Trade License (General)
								</h4>	
							</div>
							<div class="panel-body">
								...
								<form name="myform1" id="myform1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
										...
										<tr>
											...
											<td><input validate="specialChar" type="text" value="<?php echo $full_name; ?>" class="form-control text-uppercase" disabled></td>
										...
										<tr>
											...
											<td><input validate="specialChar" type="text" value="<?php echo $owner_name; ?>" class="form-control text-uppercase"disabled></td>
										...
										<tr>
											<td>10 (a). Phone No.</td>
											<td><input type="text" class="form-control text-uppercase" name="mobile_no" value="<?php echo $std_code." - ".$phone_no; ?>" disabled></td>
								...
								<form name="myform1" id="myform1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
										...
										<tr class="Own">
											<td>13. (a) Rent Per Month<span id="per_value"> / value </span><span class="mandatory_field">*</span></td>
								...
								<form name="myform1" id="myform1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
										...
										<tr class="oldTrade">
											...
											<td>18. Date of Issue (Most Recent)<span class="mandatory_field">*</span></td>
											<td><input type="text" value="<?php echo $old_trade_details_b;?>" name="old_trade_details[b]" class="dob form-control text-uppercase old_trade_details"></td>
										</tr>
										<tr class="oldTrade">
											<td>19. 1st License Issue Date :<span class="mandatory_field">*</span></td>
											<td><input type="text" value="<?php echo $old_trade_details_c;?>" name="old_trade_details[c]" class="dob form-control text-uppercase old_trade_details"></td>
											<td></td>
											<td></td>
										</tr>
										<tr>										
								...
								<form name="myform1" id="myform1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id=""  class="table table-responsive">
										...
										<tr>										
										    <td class="text-center" colspan="4">
												<a type="button" href="<?php echo $table_name;?>.php?tab=3" class="btn btn-primary avoid_me submit1">Go Back & Edit</a>
