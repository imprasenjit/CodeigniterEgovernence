...
<script type="text/javascript">
        ...
        cell2.appendChild(t2);
		var cell3=row.insertCell(2);		
		var array1 = ["Doctors","Nursing staff","Para-medical staff","Pharmacists","Administrative staff","Others"];
		var array1a = ["D","N","P","PH","A","O"];

		//Create and append select list
		var t3 = document.createElement("select");
		t3.setAttribute("id", "tbC"+index4);
		t3.setAttribute("name", "tbC"+index4);
		t3.className = "form-control text-uppercase";
		cell3.appendChild(t3);
