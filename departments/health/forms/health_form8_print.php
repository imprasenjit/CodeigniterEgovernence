...
if(!isset($css)){
		...
		<table class="table table-bordered table-responsive">		
			...
			<tr>
				<td valign="top" width="50%"><b>(A) EYE BANK & Institution affiliated Ophthalmic/General Hospital</b></td>
				<td>
					<table class="table table-bordered table-responsive">
				
						<tr>
							<td width="50%">1. Name :</td>
							<td>'.strtoupper($eye_bnk_name).'</td>
						</tr>
						<tr>
							<td width="50%">2. Address :</td>
							<td>'.strtoupper($eye_bnk_ad).'</td>
						</tr>
						<tr>
							<td width="50%">3. Government / Private / Voluntary :</td>
							<td>'.strtoupper($is_eye_bnk_gov).'</td>
						</tr>
						<tr>
							<td width="50%">4. Teaching / Non teaching :</td>
							<td>'.strtoupper($is_teaching).'</td>
						</tr>
						<tr>
							<td width="50%">5. IEC for Eye Donation :</td>
			...
			<tr>
				...
				<td valign="top" width="50%"><b>(A) RETRIEVAL CENTER – A Centre affiliated to an EYE Bank</b></td>
				<td>
					<table class="table table-bordered table-responsive">
