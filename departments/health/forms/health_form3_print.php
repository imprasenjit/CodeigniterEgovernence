...
if(!isset($css)){
		...
		<table class="table table-bordered table-responsive">
			...
			<tr>
				<td width="50%">Data about facilities available in the hospital :</td>
			...
			<tr>
				<td colspan="2">
					<table class="table table-bordered table-responsive">
						<tr>
							<td valign="top">1. Nephrologist :</td>
							<td>'.strtoupper($is_nephrologist).'</td>
							<td valign="top">2. Neurologist :</td>
							<td>'.strtoupper($is_neurologist).'</td>
						</tr>
						<tr>
							<td valign="top">3. Neuro-Surgeon :</td>
							<td>'.strtoupper($is_neuro_surgeon).'</td>
							<td valign="top">4. Urologist :</td>
							<td>'.strtoupper($is_urologist).'</td>
						</tr>
						<tr>
							<td valign="top">5. G.I. Surgeon :</td>
							<td>'.strtoupper($is_surgeon).'</td>
							<td valign="top">6. Paediatrician :</td>
							<td>'.strtoupper($is_paediatrician).'</td>
						</tr>
						<tr>
							<td valign="top">7. Physiotherapist :</td>
							<td>'.strtoupper($is_physiotherapist).'</td>
							<td valign="top">8. Social Worker :</td>
							<td>'.strtoupper($is_social).'</td>
						</tr>
						<tr>
							<td valign="top">9. Immunologists :</td>
							<td>'.strtoupper($is_immunologists).'</td>
							<td valign="top">10. Cardiologist :</td>
							<td>'.strtoupper($is_cardiologist).'</td>
						</tr>
						<tr>
							<td valign="top">11. Respiratory physician :</td>
							<td>'.strtoupper($is_respiratory).'</td>
							<td valign="top">12. Others :</td>
