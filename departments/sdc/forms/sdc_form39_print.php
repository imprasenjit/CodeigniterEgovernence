...
if(!isset($form_id) && !isset($_GET["ui"]) &&  !isset($_GET["token"]) && !isset($_GET["uain"])){
	...
	<table class="table table-bordered table-responsive">
		<tr>
			<td colspan="2">1.I/We  &nbsp;<b>'.strtoupper($auth_person).'</b>&nbsp; of &nbsp;<b>'.strtoupper($unit_name).'</b>&nbsp;  &nbsp;hereby apply for the grant/renewal of a licence to manufacture on the premises situated at&nbsp;<b>'.strtoupper($dist).'</b>&nbsp;the undermentioned drugs, being drugs specified in Schedules X  not specified in Drugs and Cosmetics Rules 1945.</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="25%">'.strtoupper($prev_issue_date).'</td>
		</tr>';
