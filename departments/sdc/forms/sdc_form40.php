...
include "save_form3.php";
	...
	if($q->num_rows<1){	
		...
		if($p->num_rows>0){
			...
			$form_id=$results["form_id"];$auth_person=$results["auth_person"];$drug_name=$results["drug_name"];$inspection_date=$results["inspection_date"];$prev_lic_no=$results["prev_lic_no"];
			...
			$form_id="";$auth_person="";$drug_name="";$inspection_date="";$prev_issue_date="";$prev_lic_no="";
		}
	}else{			
