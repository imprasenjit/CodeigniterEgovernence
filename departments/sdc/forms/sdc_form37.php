...
include "save_form3.php";
	...
	if($q->num_rows<1){	
		...
		if($p->num_rows>0){
			...
			$form_id=$results["form_id"];$auth_person=$results["auth_person"];$location=$results["location"];$names_of_drugs=$results["names_of_drugs"];$prev_lic_no=$results["prev_lic_no"];
			...
			$form_id="";$auth_person="";$location="";$names_of_drugs="";$particulars="";$prev_lic_no="";$prev_issue_date="";
		}
	}else{			
												...
												<table name="objectTable1" id="objectTable1" class="table table-bordered table-responsive text-center" >
													...
													<?php
														...
														if($num>0){
														  ...
														  while($row_1=$part1->fetch_array()){	?>
															<tr>
																...
																<td><input id="txtB<?php echo $count;?>" class="form-control text-uppercase" validate="letters" value="<?php echo $row_1["name"]; ?>" validate="specialChar" name="txtB<?php echo $count;?>" size="10"></td>
														...
														<tr>
															...
															<td><input id="txtD1" size="10" validate="specialChar"  class="form-control text-uppercase" name="txtD1"></td>	
														</tr>
														<?php } ?>														
													</table>
													<div>				
