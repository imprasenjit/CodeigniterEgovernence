...
if(isset($_GET["form_no"])){
	$_SESSION["form"]=$form=$_GET["form_no"];
}else{
...
$from=strtoupper($street_name1)." \n".strtoupper($street_name2)."\nVill/Town : ".strtoupper($vill).",\nDistrict : ".strtoupper($dist)."\nPin Code : ".$pincode."\nMobile Number : +91 ".$mobile_no."\nPhone Number : ".$b_landline_std."-".$b_landline_no;
	...
	if($q->num_rows<1){	
		...
		if($p->num_rows>0){
			...
			$form_id=$results["form_id"];$drug_licence_no=$results["drug_licence_no"];$issue_dt=$results["issue_dt"];$expiry_dt=$results["expiry_dt"];$nm_person_incharge=$results["nm_person_incharge"];$edu_qualification=$results["edu_qualification"];$pharmacist_incharge=$results["pharmacist_incharge"];$pharmacist_reg_no=$results["pharmacist_reg_no"];$reg_no_validity=$results["reg_no_validity"];
		}else{
			$form_id="";$drug_licence_no="";$issue_dt="";$expiry_dt="";$nm_person_incharge="";$edu_qualification="";$pharmacist_incharge="";$pharmacist_reg_no="";$reg_no_validity="";
		}
	}else{			
							...
							<div id="table1" class="tab-pane" role="tabpanel">
								<form name="myform1" id="myformBT5" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data" >
									<table class="table table-responsive">
										...
										<tr>
											<td colspan="4">4. Name & Address of the Proprietor</td>
										</tr>
										<tr>
										...
										<tr>
										  <td colspan="4">7.Name of Person incharge and Educational Qualification :</td>
										</tr>
										
										<tr>
										    <td>Name of Person incharge :</td>
											<td><input type="text" class="form-control text-uppercase" name="nm_person_incharge"  value="<?php echo $nm_person_incharge;?>" ></td>
										    <td>Educational Qualification :</td>
											<td><input type="text" class="form-control text-uppercase" name="edu_qualification"  value="<?php echo $edu_qualification;?>" ></td>
										</tr>
										<tr>
											<td>8.Name of the pharmacist incharge :</td>
											<td><input type="text" class="form-control text-uppercase" name="pharmacist_incharge"  value="<?php echo $pharmacist_incharge;?>" ></td>
										</tr>
										<tr>
										  <td colspan="4">9.Pharmacist registration No and validity  :</td>
										</tr>
										<tr>
										  <td>Pharmacist registration No :</td>
										  <td><input type="text" class="form-control text-uppercase" name="pharmacist_reg_no"  value="<?php echo $pharmacist_reg_no;?>" ></td>
										  <td>Validity :</td>
										  <td><input type="text" class="dob form-control text-uppercase" name="reg_no_validity"  value="<?php echo $reg_no_validity;?>" ></td>
										</tr>
										<tr>
											<td>Date :</td>
										...
										<tr>
											...
											<td class="text-center" colspan="2">
												<button type="submit" style="font-weight:bold" name="save_sdc_retention_retail" class="btn btn-success">Submit</button>
											</td>
											<td></td>
										</tr>
									</table>
