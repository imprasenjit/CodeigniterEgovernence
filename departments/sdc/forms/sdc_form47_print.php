...
if(!isset($form_id) && !isset($_GET["ui"]) &&  !isset($_GET["token"]) && !isset($_GET["uain"])){
	...
	if($q->num_rows > 0){
		...
		$form_id=$results["form_id"];$auth_person=$results["auth_person"];$cosmetics_names=$results["cosmetics_names"];$prev_lic_no=$results["prev_lic_no"];
	...
	<table class="table table-bordered table-responsive">
		<tr>
			<td colspan="2">1.I/We  &nbsp;'.strtoupper($auth_person).'&nbsp; of M/s&nbsp;'.strtoupper($unit_name).'&nbsp; hereby apply for the grant renewal of a licence to manufacture on the premises situated at&nbsp;'.strtoupper($b_dist).'</td>
		</tr>
		<tr>
