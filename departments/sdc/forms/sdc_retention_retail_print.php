...
if(!isset($form_id) && !isset($_GET["ui"]) &&  !isset($_GET["token"]) && !isset($_GET["uain"])){
	...
	<table class="table table-bordered table-responsive">
			...
			<tr>
			    <td colspan="2">7.Name of Person incharge and Educational Qualification :</td>
			</tr>
			<tr>
				<td>Name of Person incharge :</td>
				<td>'.strtoupper($nm_person_incharge).'</td>
			</tr>
			<tr>
				<td>Educational Qualification :</td>
				<td>'.strtoupper($edu_qualification).'</td>
			</tr>
			<tr>
				<td>8.Name of the pharmacist incharge :</td>
				<td>'.strtoupper($pharmacist_incharge).'</td>
			</tr>
			<tr>
			    <td colspan="2">9.Pharmacist registration No and validity  :</td>
			</tr>
			<tr>
				<td>Pharmacist registration No :</td>
				<td>'.strtoupper($pharmacist_reg_no).'</td>
			</tr>
			<tr>
				<td>Validity :</td>
				<td>'.strtoupper($reg_no_validity).'</td>
			</tr>
