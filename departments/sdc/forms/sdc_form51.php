...
include "save_form4.php";
	...
	if($q->num_rows<1){	
		...
		if($p->num_rows>0){
			...
			$form_id=$results["form_id"];$drugs_name=$results["drugs_name"];$auth_person=$results["auth_person"];$prev_lic_no=$results["prev_lic_no"];
			...
			$form_id="";$drugs_name="";$auth_person="";$prev_lic_no="";$prev_issue_date="";
		}
	}else{			
