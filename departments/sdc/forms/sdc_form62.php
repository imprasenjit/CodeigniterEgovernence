											...
											<table name="objectTable1" id="objectTable1" class="table table-responsive text-center">
												...
												if($num>0){
													...
													<tr>
														...
														<td><input value="<?php echo $row_1["strength"]; ?>" id="txtD<?php echo $count;?>"  class="form-control text-uppercase" size="10" name="txtD<?php echo $count;?>"></td>
														<td><input value="<?php echo $row_1["claim"]; ?>" id="txtE<?php echo $count;?>"  class="form-control text-uppercase" size="10" name="txtE<?php echo $count;?>"></td>
														<td><input value="<?php echo $row_1["existing_brand"]; ?>" id="txtF<?php echo $count;?>"  class="form-control text-uppercase" size="10" name="txtF<?php echo $count;?>"></td>
													</tr>	
													<?php $count++; } 
												}else{	?>
												<tr>
