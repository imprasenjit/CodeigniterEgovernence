...
if($q->num_rows > 0){
	...
	$form_id=$results["form_id"];$auth_person=$results["auth_person"];$location=$results["location"];$homoeopathic=$results["homoeopathic"];$prev_lic_no=$results["prev_lic_no"];
