...
$from=strtoupper($street_name1)." \n".strtoupper($street_name2)."\nVill/Town : ".strtoupper($vill).",\nDistrict : ".strtoupper($dist)."\nPin Code : ".$pincode."\nMobile Number : +91 ".$mobile_no."\nPhone Number : ".$b_landline_std."-".$b_landline_no;
	...
	if($q->num_rows<1){	
		...
		if($p->num_rows>0){
			...
			$form_id=$results["form_id"];$prev_lic_no=$results["prev_lic_no"];$prev_lic_no2=$results["prev_lic_no2"];$prev_issue_date=$results["prev_issue_date"];$qualified_person_name=$results["qualified_person_name"];$qualified_reg_no=$results["qualified_reg_no"];
		}else{
			$form_id="";$prev_lic_no="";$prev_lic_no2="";$prev_issue_date="";$qualified_person_name="";$qualified_reg_no="";
		}
	}else{			
							...
							<div id="table1" class="tab-pane" role="tabpanel">
								<form name="myform1" id="myformBT5" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data" >
									<table class="table table-responsive">
										<tr>
											<td width="25%"> 1. Name and address of the Applicant :</td>
											...
											<td width="25%"><input type="text" class="form-control text-uppercase" name="onbehalf" id="onbehalf"  value="<?php echo $mobile_no;?>" disabled="disabled"></td>
										</tr>
										<tr>
										...
										<tr>
											<td colspan="4">2. Name and address of the Business :</td>
										</tr>
										<tr>
											<td width="25%"> Name</td>
										...
										<tr>
										   <td colspan="4">3. Previous License No and Date :</td>
										</tr>
										<?php if($form==27 || $form==28 || $form==31){ ?>
										<tr>
											<td>Previous License No <?php echo $lic_for_form1;?></td>
											<td><input type="text" class="form-control text-uppercase" name="prev_lic_no"  value="<?php echo $prev_lic_no;?>" ></td>
											<td>Previous License No <?php echo $lic_for_form2;?></td>
											<td><input type="text" class="form-control text-uppercase" name="prev_lic_no2"  value="<?php echo $prev_lic_no2;?>" ></td>
										</tr>
										<tr>
											<td>Date of Issue</td>
											<td><input type="text" class="dob form-control text-uppercase" name="prev_issue_date"  value="<?php echo $prev_issue_date;?>" ></td>
											<td colspan="2"></td>
										</tr>											
										<?php }else{ ?>
										<tr>
											<td>Previous License No</td>
											<td><input type="text" class="form-control text-uppercase" name="prev_lic_no"  value="<?php echo $prev_lic_no;?>" ></td>
											<td>Date of Issue</td>
											<td><input type="text" class="dob form-control text-uppercase" name="prev_issue_date"  value="<?php echo $prev_issue_date;?>" ></td>
										</tr>
										...
										<?php } ?>
										<tr>
											<td>Name of Qualified Person in Charge <?php if($form=="28" || $form=="30"){ echo "(Pharmacist)";}?></td>
											<td><input type="text" class="form-control text-uppercase" name="qualified_person_name"  value="<?php echo $qualified_person_name;?>" ></td>
											<td>Registration No.</td>
											<td><input type="text" class="form-control text-uppercase" name="qualified_reg_no"  value="<?php echo $qualified_reg_no;?>" ></td>
										</tr>
										<tr>
												<td>Date :</td>
										...
										<tr>
											...
											<td class="text-center" colspan="2">
												<button type="submit" style="font-weight:bold" name="save_sdc_retention" class="btn btn-success">Submit</button>
											</td>
											<td></td>
										</tr>
									</table>
