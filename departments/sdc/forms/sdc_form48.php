...
include "save_form4.php";
	...
	if($q->num_rows<1){	
		...
		if($p->num_rows>0){
			...
			$form_id=$results["form_id"];$auth_person=$results["auth_person"];$cosmetics_names=$results["cosmetics_names"];$co_name=$results["co_name"];
			...
			$form_id="";$auth_person="";$cosmetics_names="";$co_name="";$prev_issue_date="";
		}
	}else{			
