...
include "save_form3.php";
	...
	if($q->num_rows<1){	
		...
		if($p->num_rows>0){
			...
			$form_id="";$auth_person="";$location="";$homoeopathic="";$prev_issue_date="";$prev_lic_no="";
		}
	}else{			
