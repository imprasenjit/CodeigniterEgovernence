...
if(!isset($form_id) && !isset($_GET["ui"]) &&  !isset($_GET["token"]) && !isset($_GET["uain"])){
	...
	if($q->num_rows > 0){
		...
		$form_id=$results["form_id"];$auth_person=$results["auth_person"];$drug_name=$results["drug_name"];$fee=$results["fee"];$acc_no=$results["acc_no"];
	...
	<table class="table table-bordered table-responsive">
		<tr>
			<td colspan="2">1.I/We  &nbsp;'.strtoupper($auth_person).'&nbsp; of &nbsp;'.strtoupper($unit_name).'&nbsp; hereby apply for the grant/renewal of a licence to manufacture on the premises situated at&nbsp;'.strtoupper($b_dist).'&nbsp; the following drugs of the than those specified in [Schedules C, C(1) and X] to the Drugs and Cosmetics Rules, 1945.</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2">3. Names, qualifications and experience of technical staff employed for manufacture and testing.</td>
		</tr>
		<tr>
			<td colspan="2">
		<table class="table table-bordered table-responsive">
