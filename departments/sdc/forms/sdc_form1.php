...
include "save_form.php";
	...
	if($q->num_rows<1){	
		...
		if($p->num_rows>0){
			...
			$form_id=$results["form_id"];$location=$results["location"];$category=$results["category"];$particulars=$results["particulars"];$auth_person=$results["auth_person"];
			...
			$form_id="";$location="";$category="";$particulars="";$auth_person="";
			$supervision_n1="";$supervision_n2="";$supervision_q1="";$supervision_q2="";$supervision_reg="";
		}
	}else{			
							...
							<div id="table1" class="tab-pane" role="tabpanel">
								<form name="myform1" class="submit1" id="myform1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table class="table table-responsive">
										...
										<tr>
											<td>Name of the Qualified/Competent person :</td>
...
<script>/* ---------------------Block all after submit operation-------------------- */
