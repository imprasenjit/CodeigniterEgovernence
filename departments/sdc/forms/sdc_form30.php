...
include "save_form2.php";
	...
	if($q->num_rows<1){	
		...
		if($p->num_rows>0){
			...
			$form_id=$results["form_id"];$auth_person=$results["auth_person"];$category=$results["category"];$particulars=$results["particulars"];$prev_lic_no=$results["prev_lic_no"];
			...
			$form_id="";$auth_person="";$category="";$particulars="";$prev_lic_no="";$prev_issue_date="";
			$supervision_n1="";$supervision_n2="";$supervision_q1="";$supervision_q2="";
		}
	}else{			
								...
								<div id="table1" class="tab-pane" role="tabpanel">
									<form name="myform1" class="submit1" id="myform1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
										<table class="table table-responsive">
											...
											<tr>
												<td>3. Category of drugs to be sold. :</td>
