...
include "save_form4.php";
	...
	if($q->num_rows<1){	
		...
		if($p->num_rows>0){
			...
			$other_drugs="";$products="";$antibiotics="";$vitamins="";$parental="";$suture="";$photometer="";$test_animal="";$microbiological="";$homoeopathic="";$cosmetics="";$testing="";$drugs="";$prev_apprv_no="";$prev_issue_date="";
		}
	}else{			
								...
								<div id="table1" class="tab-pane" role="tabpanel">
									<form name="myform1" class="submit1" id="myform1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
										<table class="table table-responsive">
											...
											<tr>
												<td>Approval No. :</td>
												<td><input class="form-control text-uppercase" name="prev_apprv_no" value="<?=$prev_apprv_no;?>" required="required"/></td>
												<td>Issue date :</td>
