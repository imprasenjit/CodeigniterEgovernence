...
if(!isset($form_id) && !isset($_GET["ui"]) &&  !isset($_GET["token"]) && !isset($_GET["uain"])){
	...
	<table class="table table-bordered table-responsive">
		...
		<tr>			
			<td colspan="2">2. The names, qualifications and experience of the expert actually connected with the manufacture and testing of specified products in the manufacturing premises.</td>
		</tr>
		<tr>
