...
if(!empty($results["uain"])){
	...
	<table class="table table-bordered table-responsive">
		<tr>
			<td colspan="2">1.I/We  &nbsp;'.strtoupper($auth_person).'&nbsp; of M/s&nbsp;'.strtoupper($unit_name).'&nbsp; hereby apply for grant/renewal of a loan licence to manufacture cosmetics, for sale, on the premises situated at&nbsp;&nbsp;'.strtoupper($b_dist).'&nbsp;&nbsp;the following cosmetics.</td>
		</tr>
		<tr>
		...
		<tr>			
			<td colspan="2">3. The names, qualifications and experience of the staff actually connected with the manufacturing and testing of the specified products in the manufacturing premises :</td>
		</tr>
		<tr>
			<td colspan="2">
			<table class="table table-bordered table-responsive">
