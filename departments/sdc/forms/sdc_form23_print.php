...
if(!empty($results["uain"])){
	...
	<table class="table table-bordered table-responsive">
		...
		<tr>
			<td>3. Names, qualifications and experience of expert staff employed for testing and the person-incharge of testing. :</td>
		...
		<tr>
			<td width="50%">4.  List of testing equipment provided</td>
