...
if(!isset($form_id) && !isset($_GET["ui"]) &&  !isset($_GET["token"]) && !isset($_GET["uain"])){
	...
	if($q->num_rows > 0){
		...
		$form_id=$results["form_id"];$auth_person=$results["auth_person"];$licence=$results["licence"];$name_incharge=$results["name_incharge"];
	}
	...
	<table class="table table-bordered table-responsive">
		...
		<tr>
			...
			<td width="25%">Name :  '.strtoupper($name_incharge).'</td>
		</tr>';
