...
if(isset($_POST["save21"])) {	
	...
	if(empty($_POST["mfile1"]) || empty($_POST["mfile2"]) || empty($_POST["mfile3"]) || empty($_POST["mfile4"]) || empty($_POST["mfile5"]) || empty($_POST["mfile6"]) || empty($_POST["mfile7"]) || empty($_POST["mfile8"])
	|| empty($_POST["mfile9"]) || empty($_POST["mfile10"]) || $_POST["mfile1"]=='2' || $_POST["mfile2"]=='2' || $_POST["mfile3"]=='2' || $_POST["mfile4"]=='2' || $_POST["mfile5"]=='2' || $_POST["mfile6"]=='2' || $_POST["mfile7"]=='2' || $_POST["mfile8"]=='2' || $_POST["mfile9"]=='2' || $_POST["mfile10"]=='2' || $_POST["mfile1"]=='3' || $_POST["mfile2"]=='3' || $_POST["mfile3"]=='3' || $_POST["mfile4"]=='3' || $_POST["mfile5"]=='3' || $_POST["mfile6"]=='3' || $_POST["mfile7"]=='3' || $_POST["mfile8"]=='3' || $_POST["mfile9"]=='3' || $_POST["mfile10"]=='3'){
		echo "<script>
			alert('Error in file / You didnot select any option.');
	...
	$row=$sql->fetch_array();
	if($sql->num_rows<1){   ////////////table is empty//////////////				
	       $query=$sdc->query("insert into sdc_form21(user_id,sub_date,location,supervision,category,particulars,reg_fees, file1, file2, file3, file4, file5, file6, file7, file8, file9, file10) values ('$swr_id','$today', '$location','$supervision', '$category', '$particulars', '$reg_fees', '$file1', '$file2', '$file3', '$file4', '$file5', '$file6', '$file7', '$file8', '$file9', '$file10')") OR die("Error: ".$sdc->error);
	}else{  ////////////table is not empty//////////////
			$form_id=$row["form_id"];	
			$query=$sdc->query("update sdc_form21 set sub_date='$today', location='$location', supervision='$supervision', category='$category', particulars='$particulars', reg_fees='$reg_fees', file1='$file1', file2='$file2', file3='$file3', file4='$file4', file5='$file5', file6='$file6', file7='$file7', file8='$file8', file9='$file9', file10='$file10' where form_id=$form_id") OR die("Error: ".$sdc->error);
	}	
	if($query){
		$formFunctions->insert_incomplete_forms('sdc','21'); //sdc-- dept name and 1 -- form no
		echo "<script>
				alert('Successfully Saved..');
...
if(isset($_POST["save2"])){		
	...
	if($sql->num_rows<1){   ////////////table is empty//////////////				
			$query=$sdc->query("insert into sdc_form2(user_id,sub_date,location,situated,drug_name,particulars,dealer,reg_fees, file1, file2, file3, file4, file5, file6, file7, file7, file8) values ('$swr_id','$today', '$location', '$situated', '$drug_name', '$particulars', '$dealer','$reg_fees', '$file1', '$file2', '$file3', '$file4', '$file5', '$file6', '$file7', '$file8')") OR die("Error: ".$sdc->error);
	}else{
		$form_id=$row["form_id"];	
		$query=$sdc->query("update sdc_form2 set sub_date='$today', location='$location',  situated='$situated',drug_name='$drug_name', particulars='$particulars', dealer='$dealer',reg_fees='$reg_fees', file1='$file1', file2='$file2', file3='$file3', file4='$file4', file5='$file5', file6='$file6', file7='$file7', file8='$file8' where form_id=$form_id") OR die("Error: ".$sdc->error);
	}				
	if($query){
...
$query=$sdc->query("insert into sdc_form3(user_id,sub_date,reg_no,catrgories,reg_fees,storage_acc,file1,file2,file3,file4,file5,file6) values ('$swr_id','$today', '$reg_no', '$catrgories', '$reg_fees','$storage_acc', '$file1', '$file2', '$file3', '$file4', '$file5', '$file6')") OR die("Error: ".$sdc->error);
	}else{
		$form_id=$row["form_id"];	
		$query=$sdc->query("update sdc_form3 set sub_date='$today', reg_no='$reg_no',  catrgories='$catrgories',reg_fees='$reg_fees',storage_acc='$storage_acc', file1='$file1', file2='$file2', file3='$file3', file4='$file4', file5='$file5', file6='$file6' where form_id=$form_id") OR die("Error: ".$sdc->error);
	}				
	if($query){
...
if(isset($_POST["save4"])){		
	...
	if($sql->num_rows<1){   ////////////table is empty//////////////				
			$query=$sdc->query("insert into sdc_form4(user_id,sub_date,licence,name_incharge,reg_fees, file1, file2, file3, file4, file5, file6, file7) values ('$swr_id','$today', '$licence', '$name_incharge','$reg_fees', '$file1', '$file2', '$file3', '$file4', '$file5', '$file6', '$file7')") OR die("Error: ".$sdc->error);
	}else{
		$form_id=$row["form_id"];	
		$query=$sdc->query("update sdc_form4 set sub_date='$today', licence='$licence',  name_incharge='$name_incharge',reg_fees='$reg_fees', file1='$file1', file2='$file2', file3='$file3', file4='$file4', file5='$file5', file6='$file6', file7='$file7' where form_id=$form_id") OR die("Error: ".$sdc->error);
	}				
	if($query){
...
if(isset($_POST["save5"])){		
	...
	if($sql->num_rows<1){   ////////////table is empty//////////////				
			$query=$sdc->query("insert into sdc_form5(user_id,sub_date,category,supervision,particulars,reg_fees, file1,file2,file3,file4,file5,file6) values ('$swr_id','$today', '$category', '$supervision', '$particulars', '$reg_fees', '$file1', '$file2', '$file3', '$file4', '$file5', '$file6')") OR die("Error: ".$sdc->error);
	}else{
		$form_id=$row["form_id"];	
		$query=$sdc->query("update sdc_form5 set sub_date='$today',  category='$category', supervision='$supervision',  particulars='$particulars', reg_fees='$reg_fees', file1='$file1', file2='$file2', file3='$file3', file4='$file4', file5='$file5', file6='$file6' where form_id=$form_id") OR die("Error: ".$sdc->error);
	}				
	if($query){
...
if(isset($_POST["save6"])){		
	...
	$row=$sql->fetch_array();			
	if($sql->num_rows<1){   ////////////table is empty//////////////				
			$query=$sdc->query("insert into sdc_form6(user_id,sub_date,drug_name,reg_fees, file1, file2, file3, file4, file5, file6, file7, file8, file9)  values ('$swr_id','$today', '$drug_name', '$reg_fees', '$file1', '$file2', '$file3', '$file4', '$file5', '$file6', '$file7', '$file8', '$file9')") OR die("Error: ".$sdc->error);
			$form_id=$sdc->insert_id;
	}else{
		$form_id=$row["form_id"];	
		$query=$sdc->query("update sdc_form6 set sub_date='$today', drug_name='$drug_name', reg_fees='$reg_fees', file1='$file1', file2='$file2', file3='$file3', file4='$file4', file5='$file5', file6='$file6', file7='$file7', file8='$file8', file9='$file9' where form_id=$form_id") OR die("Error: ".$sdc->error);		
	}				
	if($query){
...
if(isset($_POST["save7"])){		
	...
	$row=$sql->fetch_array();			
	if($sql->num_rows<1){   ////////////table is empty//////////////				
			$query=$sdc->query("insert into sdc_form7(user_id,sub_date,co_name,drug_name,reg_fees, file1, file2, file3, file4, file5, file6, file7, file8, file9, file10) values ('$swr_id','$today', '$co_name', '$drug_name','$reg_fees', '$file1', '$file2', '$file3', '$file4', '$file5', '$file6', '$file7', '$file8', '$file9', '$file10')") OR die("Error: ".$sdc->error);
			$form_id=$sdc->insert_id;
	}else{
		$form_id=$row["form_id"];	
		$query=$sdc->query("update sdc_form7 set sub_date='$today', co_name='$co_name', drug_name='$drug_name',reg_fees='$reg_fees', file1='$file1',file2='$file2', file3='$file3', file4='$file4', file5='$file5', file6='$file6', file7='$file7', file8='$file8', file9='$file9', file10='$file10' where form_id=$form_id") OR die("Error: ".$sdc->error);		
	}				
	if($query){
...
if(isset($_POST["save8"])) {	
	...
	$row=$sql->fetch_array();
	if($sql->num_rows<1){   ////////////table is empty//////////////				
	       $query=$sdc->query("insert into sdc_form8(user_id,sub_date,location,names_of_drugs,reg_fees, file1, file2, file3, file4, file5, file6, file7, file8) values ('$swr_id','$today', '$location','$names_of_drugs','$reg_fees', '$file1', '$file2', '$file3', '$file4', '$file5', '$file6', '$file7', '$file8')") OR die("Error: ".$sdc->error);
		   $form_id=$sdc->insert_id;
	}else{  ////////////table is not empty//////////////
			$form_id=$row["form_id"];	
			$query=$sdc->query("update sdc_form8 set sub_date='$today', location='$location', names_of_drugs='$names_of_drugs',reg_fees='$reg_fees', file1='$file1', file2='$file2', file3='$file3', file4='$file4', file5='$file5', file6='$file6', file7='$file7', file8='$file8' where form_id=$form_id") OR die("Error: ".$sdc->error);
	}	
	if($query){
...
if(isset($_POST["save9"])) {	
	...
	$row=$sql->fetch_array();
	if($sql->num_rows<1){   ////////////table is empty//////////////				
	      $query=$sdc->query("insert into sdc_form9(user_id,sub_date,licence_no,location,homoeopathic,reg_fees, file1, file2, file3, file4, file5, file6, file7) values ('$swr_id','$today', '$licence_no','$location','$homoeopathic','$reg_fees', '$file1', '$file2', '$file3', '$file4', '$file5', '$file6', '$file7')") OR die("Error: ".$sdc->error);
		   $form_id=$sdc->insert_id;
	}else{  ////////////table is not empty//////////////
			$form_id=$row["form_id"];	
			$query=$sdc->query("update sdc_form9 set sub_date='$today', licence_no='$licence_no', location='$location', homoeopathic='$homoeopathic',reg_fees='$reg_fees' file1='$file1', file2='$file2', file3='$file3', file4='$file4', file5='$file5', file6='$file6', file7='$file7' where form_id=$form_id") OR die("Error: ".$sdc->error);
	}	
	if($query){
...
if(isset($_POST["save10"])) {	
	...
	$row=$sql->fetch_array();
	if($sql->num_rows<1){   ////////////table is empty//////////////				
	       $query=$sdc->query("insert into sdc_form10(user_id,sub_date,drug,reg_fees, file1, file2, file3, file4, file5, file6, file7, file8) values ('$swr_id','$today', '$drug','$reg_fees', '$file1', '$file2', '$file3', '$file4', '$file5', '$file6', '$file7', '$file8')") OR die("Error: ".$sdc->error);
		   $form_id=$sdc->insert_id;
	}else{  ////////////table is not empty//////////////
			$form_id=$row["form_id"];	
			$query=$sdc->query("update sdc_form10 set sub_date='$today', drug='$drug',reg_fees='$reg_fees', file1='$file1', file2='$file2', file3='$file3', file4='$file4', file5='$file5', file6='$file6', file7='$file7', file8='$file8' where form_id=$form_id") OR die("Error: ".$sdc->error);
	}	
	if($query){
...
if(isset($_POST["save11"])){		
	...
	$row=$sql->fetch_array();			
	if($sql->num_rows<1){   ////////////table is empty//////////////				
			$query=$sdc->query("insert into sdc_form11(user_id,sub_date,drug_name,inspection_date,reg_fees, file1, file2, file3, file4, file5, file6, file7, file8) values ('$swr_id','$today', '$drug_name','$inspection_date','$reg_fees', '$file1', '$file2', '$file3', '$file4', '$file5', '$file6', '$file7', '$file8')") OR die("Error: ".$sdc->error);
			$form_id=$sdc->insert_id;
	}else{
		$form_id=$row["form_id"];	
		$query=$sdc->query("update sdc_form11 set sub_date='$today',  drug_name='$drug_name',inspection_date='$inspection_date',reg_fees='$reg_fees', file1='$file1', file2='$file2', file3='$file3', file4='$file4', file5='$file5', file6='$file6', file7='$file7', file8='$file8' where form_id=$form_id") OR die("Error: ".$sdc->error);		
	}				
	if($query){
...
if(isset($_POST["save12"])){		
	...
	$row=$sql->fetch_array();			
	if($sql->num_rows<1){   ////////////table is empty//////////////				
			$query=$sdc->query("insert into sdc_form12(user_id,sub_date,drug_name,co_name,reg_fees, file1, file2, file3, file4, file5, file6, file7) values ('$swr_id','$today', '$drug_name','$co_name','$reg_fees', '$file1', '$file2', '$file3', '$file4', '$file5', '$file6', '$file7')") OR die("Error: ".$sdc->error);
			$form_id=$sdc->insert_id;
	}else{
		$form_id=$row["form_id"];	
		$query=$sdc->query("update sdc_form12 set sub_date='$today',  drug_name='$drug_name',co_name='$co_name',reg_fees='$reg_fees', file1='$file1', file2='$file2', file3='$file3', file4='$file4', file5='$file5', file6='$file6', file7='$file7' where form_id=$form_id") OR die("Error: ".$sdc->error);		
	}				
	if($query){
...
if(isset($_POST["save13"])){		
	...
	$row=$sql->fetch_array();			
	if($sql->num_rows<1){   ////////////table is empty//////////////				
			$query=$sdc->query("insert into sdc_form13(user_id,sub_date,drug_name,staff_manuf,reg_fees, file1,file2, file3, file4, file5, file6, file7, file8, file9 ) values ('$swr_id','$today', '$drug_name','$staff_manuf','$reg_fees', '$file1', '$file2', '$file3', '$file4', '$file5', '$file6', '$file7', '$file8', '$file9')") OR die("Error: ".$sdc->error);
			$form_id=$sdc->insert_id;
	}else{
		$form_id=$row["form_id"];	
			$query=$sdc->query("update sdc_form13 set sub_date='$today',  drug_name='$drug_name',staff_manuf='$staff_manuf',reg_fees='$reg_fees', file1='$file1', file2='$file2', file3='$file3', file4='$file4', file5='$file5', file6='$file6', file7='$file7', file8='$file8', file9='$file9' where form_id=$form_id") OR die("Error: ".$sdc->error);			
	}				
	if($query){
...
if(isset($_POST["save14"])){		
	...
	$row=$sql->fetch_array();			
	if($sql->num_rows<1){   ////////////table is empty//////////////				
			$query=$sdc->query("insert into sdc_form14(user_id,sub_date,license_no,license_date,staff_manuf,reg_fees, file1, file2, file3, file4, file5, file6, file7) values ('$swr_id','$today', '$license_no','$license_date','$staff_manuf','$reg_fees', '$file1', '$file2', '$file3', '$file4', '$file5', '$file6', '$file7')") OR die("Error: ".$sdc->error);
			$form_id=$sdc->insert_id;
	}else{
		$form_id=$row["form_id"];	
		$query=$sdc->query("update sdc_form14 set sub_date='$today',  license_no='$license_no',license_date='$license_date',staff_manuf='$staff_manuf',reg_fees='$reg_fees', file1='$file1', file2='$file2', file3='$file3', file4='$file4', file5='$file5', file6='$file6', file7='$file7' where form_id=$form_id") OR die("Error: ".$sdc->error);		
	}				
	if($query){
...
if(isset($_POST["save15"])){		
	...
	$row=$sql->fetch_array();			
	if($sql->num_rows<1){   ////////////table is empty//////////////				
		$query=$sdc->query("insert into sdc_form15(user_id,sub_date,license_no,license_date,inspection,reg_fees, file1, file2, file3, file4, file5, file6) values ('$swr_id','$today', '$license_no','$license_date','$inspection','$reg_fees', '$file1', '$file2', '$file3', '$file4', '$file5', '$file6')") OR die("Error: ".$sdc->error);
		$form_id=$sdc->insert_id;
	}else{
		$form_id=$row["form_id"];	
		$query=$sdc->query("update sdc_form15 set sub_date='$today', license_no='$license_no',license_date='$license_date',inspection='$inspection',reg_fees='$reg_fees', file1='$file1', file2='$file2', file3='$file3', file4='$file4', file5='$file5', file6='$file6' where form_id=$form_id") OR die("Error: ".$sdc->error);		
	}				
	if($query){
...
if(isset($_POST["save16"])){		
	...
	$row=$sql->fetch_array();			
	if($sql->num_rows<1){   ////////////table is empty//////////////				
			$query=$sdc->query("insert into sdc_form16(user_id,sub_date,cosmetics_names,reg_fees, file1, file2, file3, file4) values ('$swr_id','$today', '$cosmetics_names','$reg_fees', '$file1', '$file2', '$file3', '$file4')") OR die("Error: ".$sdc->error);
			$form_id=$sdc->insert_id;
	}else{
		$form_id=$row["form_id"];	
		$query=$sdc->query("update sdc_form16 set sub_date='$today',  cosmetics_names='$cosmetics_names',reg_fees='$reg_fees', file1='$file1', file2='$file2', file3='$file3', file4='$file4' where form_id=$form_id") OR die("Error: ".$sdc->error);		
	}				
	if($query){
...
if(isset($_POST["save17"])){		
	...
	$row=$sql->fetch_array();			
	if($sql->num_rows<1){   ////////////table is empty//////////////				
			$query=$sdc->query("insert into sdc_form17(user_id,sub_date,cosmetics_names,co_name,reg_fees, file1, file2, file3, file4) values ('$swr_id','$today', '$cosmetics_names','$co_name','$reg_fees', '$file1', '$file2', '$file3', '$file4')") OR die("Error: ".$sdc->error);
			$form_id=$sdc->insert_id;
	}else{
		$form_id=$row["form_id"];	
		$query=$sdc->query("update sdc_form17 set sub_date='$today',  cosmetics_names='$cosmetics_names',co_name='$co_name',reg_fees='$reg_fees', file1='$file1', file2='$file2', file3='$file3', file4='$file4' where form_id=$form_id") OR die("Error: ".$sdc->error);		
	}				
	if($query){
...
if(isset($_POST["save18"])){		
	$cosmetics_names=clean($_POST["cosmetics_names"]);$co_name=clean($_POST["co_name"]);	
	$input_size=$_POST["hiddenval"];$reg_fees="40";
	$sql=$sdc->query("select form_id from sdc_form18 where user_id='$swr_id' and active='1'");
	$row=$sql->fetch_array();			
	if($sql->num_rows<1){   ////////////table is empty//////////////				
			$query=$sdc->query("insert into sdc_form18(user_id,sub_date,cosmetics_names,co_name,reg_fees, file1, file2, file3, file4) values ('$swr_id','$today', '$cosmetics_names','$co_name','$reg_fees', '$file1', '$file2', '$file3', '$file4')") OR die("Error: ".$sdc->error);
			$form_id=$sdc->insert_id;
	}else{
		$form_id=$row["form_id"];	
		$query=$sdc->query("update sdc_form18 set sub_date='$today',  cosmetics_names='$cosmetics_names',co_name='$co_name',reg_fees='$reg_fees', file1='$file1', file2='$file2', file3='$file3', file4='$file4' where form_id=$form_id") OR die("Error: ".$sdc->error);		
	}				
	if($query){
		$formFunctions->insert_incomplete_forms('sdc','18'); //sdc-- dept name and 1 -- form no 			
			if($input_size!=0){					
			$k=$sdc->query("delete from sdc_form18_t1 where form_id='$form_id'");
			for($i=1;$i<$input_size;$i++){
				//$vala=$_POST["txtA".$i];		
				$valb=$_POST["txtB".$i];
				$valc=$_POST["txtC".$i];
				$vald=$_POST["txtD".$i];
				$vale=$_POST["txtE".$i];
				$part1=$sdc->query("INSERT INTO sdc_form17_t1(id,form_id,slno,name,qualification,experience,incharge) VALUES ('','$form_id','$i','$valb','$valc','$vald','$vale')") or die("error in insertion sdc_form18_t1".$sdc->error);
				}
			}
		echo "<script>
						alert('Successfully Saved....');
						window.location.href = 'preview.php?token=18';
					</script>";
				}else{
					echo "<script>
						alert('Something went wrong !!!');
						window.location.href ='sdc_form18.php';
					</script>";
				}			
}
if(isset($_POST["save18b"])){		
	$form_id=$sdc->query("select form_id from sdc_form18 where user_id='$swr_id' order by form_id desc LIMIT 1")->fetch_object()->form_id;
		if((isset($_POST["mfile1"]) && empty($_POST["mfile1"])) || (isset($_POST["mfile2"]) && empty($_POST["mfile2"])) || (isset($_POST["mfile3"]) && empty($_POST["mfile3"]))  ||  (isset($_POST["mfile1"]) && $_POST["mfile1"]=='2') || (isset($_POST["mfile2"]) && $_POST["mfile2"]=='2') || (isset($_POST["mfile3"]) && $_POST["mfile3"]=='2') || (isset($_POST["mfile2"]) && $_POST["mfile2"]=='3') || (isset($_POST["mfile3"]) && $_POST["mfile3"]=='3')  ) 
		{
			echo "<script>
				alert('Error in file / You didnot select any option.');
				window.location.href = 'sdc_form18.php?tab=2';
			</script>";
		}else{		
			$file1=clean($_POST["mfile1"]);$file2=clean($_POST["mfile2"]);$file3=clean($_POST["mfile3"]);
			$sql=$excise->query("select form_id from sdc_form18 where user_id='$swr_id' and active='1'");		
			if($sql->num_rows<1){				
				echo "<script>
				...
				$row=$sql->fetch_array();
				$form_id=$row["form_id"];
				$savequery=$excise->query("update sdc_form18 set file1='$file1',file2='$file2',file3='$file3' where form_id='$form_id'") or die($excise->error);
			}		
			if($savequery){
				...
				if($file1=="SC" || $file2=="SC" ||  $file3=="SC" ){
					$save_query=$excise->query("update sdc_form18 set courier_details='1', sub_date='$today',received_date=NULL where form_id='$form_id'") or die($excise->error);
				}else{
					//$courier_details=NULL;
					$save_query=$excise->query("update sdc_form18 set sub_date='$today',courier_details=NULL where form_id='$form_id'") or die($excise->error);
				}
				echo "<script>
					alert('Successfully Saved....');
					window.location.href = 'preview.php?token=18';
...
if(isset($_POST["proceed18"])){
	$query=$sdc->query("select form_id,save_mode,courier_details from sdc_form18 where user_id='$swr_id' and active='1'") or die("Error :". $sdc->error);
	if($query->num_rows<1){
		echo "<script>
				alert('Something went wrong !!!');
				window.location.href = 'sdc_form17.php';
		...
		$row=$query->fetch_array();
		$form_id=$row["form_id"];$save_mode=$row["save_mode"];$courier_details=$row["courier_details"];
		$uain=$formFunctions->create_uain($form_id,'sdc','18');
		if($save_mode=="D" && $courier_details==1){
			$save_query=$sdc->query("update sdc_form18 set sub_date='$today',uain='$uain',save_mode='F' where form_id='$form_id'") or die($sdc->error);
			if($save_query){
				echo "<script>
					alert('Successfully Saved.');
					window.location.href = '../../requires/courier_details.php?dept=sdc&form=18';
				</script>";
			}else{
				echo "<script>
					alert('Something went wrong !!!');
			...
			$save_query=$sdc->query("update sdc_form18 set sub_date='$today',uain='$uain',save_mode='P' where form_id='$form_id'") or die($sdc->error);
			if($save_query){
				echo "<script>
					alert('Successfully Saved.');
					window.location.href = 'payment_section.php?token=18';
				</script>";
			}else{
				echo "<script>
					alert('Something went wrong !!!');
...
if(isset($_POST["payment18"])){	
	$query=$sdc->query("select uain,form_id from sdc_form18 where user_id='$swr_id' and save_mode='P'") or die("Error :". $sdc->error);
	if($query->num_rows<1){
		echo "<script>
				alert('Something went wrong !!!');
				window.location.href = 'payment_section.php?token=18;
		...
		if(empty($_POST["offline_challan"]) || $_POST["offline_challan"]=='2' || $_POST["offline_challan"]=='3'){
			...
			$form_id=$row["form_id"];$uain=$row["uain"];	
			$offline_challan=$_POST["offline_challan"];$payment_mode=0;
			$save_query=$sdc->query("update sdc_form18 set offline_challan='$offline_challan',payment_mode='$payment_mode',save_mode='C',sub_date='$today' where form_id='$form_id'") or die($sdc->error);
			if($save_query){
				$formFunctions->file_update($offline_challan);
				$formFunctions->insert_applications($uain);
				$str=$formFunctions->getEmail_str($uain);
				...
				$user_email=$formFunctions->get_usermail($swr_id);
				$dept_email="esgoa.sdc@gmail.com";
				require_once "sdc_form18_print.php"; 
				$mypdf=uniqid(rand()).".pdf";
				/*---------mpdf logic-----------*/
				require_once "../../../mpdf60/mpdf.php"; 
				$mpdf=new mPDF('c','A4','','' , 10 , 10 , 10 , 10 , 0 , 0); 
