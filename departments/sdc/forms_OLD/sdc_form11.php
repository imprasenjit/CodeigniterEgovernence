...
$check=$formFunctions->is_already_registered('sdc','11');
if($check==1){
	echo "<script>
	...
	echo "<script>				
				window.location.href = '".$server_url."departments/requires/courier_details.php?form=11&dept=sdc';
		</script>";
}else if($check==3){
	echo "<script>window.location.href = 'payment_section.php?token=11';</script>";
}else{
	$showtab="";
}
...
include "save_form.php";
	...
	$owners=explode(",",$Name_of_owner); 
		$q=$sdc->query("select * from sdc_form11 where user_id='$swr_id' and active='1'");
		$results=$q->fetch_array();
		if($q->num_rows<1){	
			$form_id="";$drug_name="";$inspection_date="";
			$courier_details_cn="";$courier_details_rn="";$courier_details_dt="";
			$file1="";$file2="";$file3="";$file4="";$file5="";$file6="";$file7="";$file8="";
		}else{			
			$form_id=$results["form_id"];$drug_name=$results["drug_name"];$inspection_date=$results["inspection_date"];
...
<head>
	...
	<?php include ("sdc_form11_Addmore.php"); ?> <!-- File handles 'Addmore' Operation -->
</head>
						...
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h4 class="text-center text-bold" >
									<?php echo $form_name=$cms->query("select form_name from sdc_form_names where form_no='11'")->fetch_object()->form_name; ?>
								</h4>	
							</div>
								...
								<form name="myform1" id="myform1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
										...
										<tr>
											...
											<table name="objectTable1" id="objectTable1" class="table table-responsive text-center" >
												<tr>
													...
													<th width="25%">Manufacture/Testing</th>
												</tr>
												<?php
													$part1=$sdc->query("SELECT * FROM sdc_form11_t1 WHERE form_id='$form_id'");
													$num = $part1->num_rows;
													if($num>0){
													  $count=1;
										...
										<tr>
											...
											<td><input type="text"  class="dob form-control text-uppercase" name="inspection_date" value="<?php echo $inspection_date;?>"  ></td>
											<td>&nbsp;</td>
											<td>&nbsp;</td>
										</tr>
										...
										<tr>
											<td colspan="2">2. Proof of appointment of approved competent technical staff.</br>
											a. Name of staff responsible for test. </br>
											b. Name of the staff responsible for manufacture.
										...
										<tr>
											<td colspan="2">5. Standard Operation Procedure (SOP).</td>
											<td>
										...
										<tr>
											<td colspan="2">6. Quality Control Facilities.</td>
											<td>
										...
										<tr>
											<td colspan="2">7. Specimens of labels, cartons of the products proposed to be manufacture.</td>
											<td>
										...
										<tr>
											<td colspan="2">8. List of Products to be manufactured.</td>
											<td>
										...
										<tr>
											...
											<td class="text-center" colspan="2">
												<button type="submit" style="font-weight:bold" name="save11" class="btn btn-success">Save and Next</button></td>
											<td></td>
										</tr>
									</table>
								</form>
