...
$check=$formFunctions->is_already_registered('sdc','14');
if($check==1){
	echo "<script>
	...
	echo "<script>				
				window.location.href = '".$server_url."departments/requires/courier_details.php?form=14&dept=sdc';		</script>";
}else if($check==3){
	echo "<script>window.location.href = 'payment_section.php?token=14';</script>";
}else{
	$showtab="";
}
...
include "save_form.php";
	...
	$owners=explode(",",$Name_of_owner); 
		$q=$sdc->query("select * from sdc_form14 where user_id='$swr_id' and active='1'");
		$results=$q->fetch_array();
		if($q->num_rows<1){	
			$form_id="";$license_no="";$license_date="";$staff_manuf="";
...
<head>
	...
	<?php include ("sdc_form14_Addmore.php"); ?> <!-- File handles 'Addmore' Operation -->
</head>
						...
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h4 class="text-center text-bold" >
									<?php echo $form_name=$cms->query("select form_name from sdc_form_names where form_no='14'")->fetch_object()->form_name; ?>
								</h4>	
							</div>
								...
								<form name="myform1" id="myform1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
										...
										<tr>
											...
											<td colspan="2"><table name="objectTable1" id="objectTable1" class="table table-responsive text-center" >
												<tr>
													<th width="5%">Slno</th>
													<th width="35%">Name</th>
												</tr>
												<?php
													$part1=$sdc->query("SELECT * FROM sdc_form14_t1 WHERE form_id='$form_id'");
													$num = $part1->num_rows;
													if($num>0){
													  $count=1;
										...
										<tr>
											...
											<table name="objectTable2" id="objectTable2" class="table table-responsive text-center" >
												...
												<?php
													$part2=$sdc->query("SELECT * FROM sdc_form14_t2 WHERE form_id='$form_id'");
													$num2 = $part2->num_rows;
													if($num2>0){
													  $count=1;
										...
										<tr>
											<td colspan="2">1. Area of 100 sq.mtr and additional area 50 sq.mtr for preparation of blood component.</td>
											<td>
										...
										<tr>
											<td colspan="2">2. Approved plan of premises (with 4 nos. of AC).</td>
											<td>
										...
										<tr>
											<td colspan="2">3. List of machinery and equipments for collection, processing, storage, testing of whole human blood and its component.</td>
											<td>
										...
										<tr>
											<td colspan="2">4. Memorandum of association/ constitution of firm.</td>
											<td>
										...
										<tr>
											<td colspan="2">5. Copies of certificate relating to education qualification and experience of competent technical staff.</td>
											<td>
										...
										<tr>
											<td colspan="2">6. Documents relating to ownership or tenancy of the premises. (Join inspections with CDSCO officials and State officials). Time limit upon the joint inspection of CDSCO official.</td>
											<td>
										...
										<tr>
											<td colspan="2">7. Proof of compliance as per schedule of part XII B of D/C Act, 1940 & Rules.</td>
											<td>
										...
										<tr>
											...
											<td class="text-center" colspan="2">
												<button type="submit" style="font-weight:bold" name="save14" class="btn btn-success">Save and Next</button>
											</td>
											<td></td>
										</tr>
									</table>
