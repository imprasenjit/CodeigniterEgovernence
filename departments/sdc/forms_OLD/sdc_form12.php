...
$check=$formFunctions->is_already_registered('sdc','12');
if($check==1){
	echo "<script>
	...
	echo "<script>				
				window.location.href = '".$server_url."departments/requires/courier_details.php?form=12&dept=sdc';
		</script>";
}else if($check==3){
	echo "<script>window.location.href = 'payment_section.php?token=12';</script>";
}else{
	$showtab="";
}
...
include "save_form.php";
	...
	$owners=explode(",",$Name_of_owner); 
		$q=$sdc->query("select * from sdc_form12 where user_id='$swr_id' and active='1'");
...
<head>
	...
	<?php include ("sdc_form12_Addmore.php"); ?> <!-- File handles 'Addmore' Operation -->
</head>
						...
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h4 class="text-center text-bold" >
									<?php echo $form_name=$cms->query("select form_name from sdc_form_names where form_no='12'")->fetch_object()->form_name; ?>
								</h4>	
							</div>
									...
									<table id="" class="table table-responsive">
										...
										<tr>
											...
											<table name="objectTable1" id="objectTable1" class="table table-responsive text-center" >
												...
												<?php
													$part1=$sdc->query("SELECT * FROM sdc_form12_t1 WHERE form_id='$form_id'");
													$num = $part1->num_rows;
													if($num>0){
													  $count=1;
										...
										<tr>
											<td colspan="2">2. Approved technical expert who is responsible for manufacture.</td>
											<td>
										...
										<tr>
											<td colspan="2">3. Approved technical expert who is responsible for testing.</td>
											<td>
										...
										<tr>
											<td colspan="2">4. True copy of a letter from the manufacturing concern whose manufacturing capacity is intended to be utilized by applicant.</td>
											<td>
										...
										<tr>
											<td colspan="2">5. True copy of a letter from the manufacturing concern that they agree to land the service of their expert staff, equipment and premise for manufacture of each attempt required by the applicant and that will analyse every batch of the finish product and maintain the register of the raw materials finish products and repose of the analysis separately on this behalf.</td>
											<td>
										...
										<tr>
											<td colspan="2">6. Specimens of labels, cartons of the products proposed to be manufacture.</td>
											<td>
										...
										<tr>
											<td colspan="2">7. List of Products to be manufactured.</td>
											<td>
										...
										<tr>
											...
											<td class="text-center" colspan="2">
												<button type="submit" style="font-weight:bold" name="save12" class="btn btn-success">Save and Next</button>
											</td>
											<td></td>
										</tr>
									</table>
