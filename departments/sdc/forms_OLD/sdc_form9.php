...
$check=$formFunctions->is_already_registered('sdc','9');
if($check==1){
	echo "<script>
	...
	echo "<script>				
				window.location.href = '".$server_url."departments/requires/courier_details.php?form=9&dept=sdc';
		</script>";
}else if($check==3){
...
include "save_form.php";
	...
	$owners=explode(",",$Name_of_owner); 
		$q=$sdc->query("select * from sdc_form9 where user_id='$swr_id' and active='1'");
...
<head>
	...
	<?php include ("sdc_form9_Addmore.php"); ?> <!-- File handles 'Addmore' Operation -->
</head>
						...
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h4 class="text-center text-bold" >
									<?php echo $form_name=$cms->query("select form_name from sdc_form_names where form_no='9'")->fetch_object()->form_name; ?>
								</h4>	
							</div>
									...
									<table id="" class="table table-bordered table-responsive">
										...
										<tr>
											...
											<table name="objectTable1" id="objectTable1" class="table table-bordered table-responsive text-center" >
												...
												<?php
													$part1=$sdc->query("SELECT * FROM sdc_form9_t1 WHERE form_id='$form_id'");
													$num = $part1->num_rows;
													if($num>0){
													  $count=1;
										...
										<tr>
											<td colspan="2">1. Approved competent technical staff with Education Qualification Certificate. Approved layout of the premises.</td>
											<td>
										...
										<tr>
											<td colspan="2">2. List of equipments.</td>
											<td>
										...
										<tr>
											<td colspan="2">3. Standard Operation Procedure (SOP).</td>
											<td>
										...
										<tr>
											<td colspan="2">4. Quality Control Facilities.</td>
											<td>
										...
										<tr>
											<td colspan="2">5. Specimens of labels, cartons of the products proposed to be manufacture.</td>
											<td>
										...
										<tr>
											<td colspan="2">6. Proof of compliance of sch. M-of D & C Acct & Rules.</td>
											<td>
