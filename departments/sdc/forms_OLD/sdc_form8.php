...
$check=$formFunctions->is_already_registered('sdc','8');
if($check==1){
	echo "<script>
	...
	echo "<script>				
				window.location.href = '".$server_url."departments/requires/courier_details.php?form=8&dept=sdc';
		</script>";
}else if($check==3){
...
include "save_form.php";
	...
	$owners=explode(",",$Name_of_owner); 
		$q=$sdc->query("select * from sdc_form8 where user_id='$swr_id' and active='1'");
		$results=$q->fetch_array();
		if($q->num_rows<1){	
			$form_id="";$location="";$names_of_drugs="";$particulars="";
			$competent_staff_name="";$competent_staff_quali="";$competent_staff_expc="";
			$courier_details_cn="";$courier_details_rn="";$courier_details_dt="";
			$file1="";$file2="";$file3="";$file4="";$file5="";$file6="";$file7="";$file8="";
			
		}else{			
			$form_id=$results["form_id"];$location=$results["location"];$names_of_drugs=$results["names_of_drugs"];
...
<head>
	...
	<style>
		...
		<?php include ("sdc_form8_Addmore.php"); ?> <!-- File handles 'Addmore' Operation -->
</head>
						...
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h4 class="text-center text-bold" >
									<?php echo $form_name=$cms->query("select form_name from sdc_form_names where form_no='8'")->fetch_object()->form_name; ?>
								</h4>	
							</div>
								...
								<form name="myform1" id="myform1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
										...
										<tr>
											...
											<td width="25%"><textarea name="names_of_drugs" class="form-control text-uppercase"><?php echo  $names_of_drugs; ?></textarea></td>
											<td width="25%"></td>
											<td width="25%"></td>
										</tr>
										<tr>
											...
											<table name="objectTable1" id="objectTable1" class="table table-bordered table-responsive text-center" >
												...
												<?php
													$part1=$sdc->query("SELECT * FROM sdc_form8_t1 WHERE form_id='$form_id'");
													$num = $part1->num_rows;
													if($num>0){
													  $count=1;
										...
										<tr>
											<td colspan="2">2. Proof of appointment of approved competent person with education qualification.</td>
											<td>
										...
										<tr>
											<td colspan="2">3. Approved layout of the premises.</td>
											<td>
										...
										<tr>
											<td class="text-center" colspan="4">
												<button type="submit" style="font-weight:bold" name="save8" class="btn btn-success">Save and Next</button>
											</td>
										</tr>
									</table>
								</form>
