							...
							<div class="panel-body">								
								...
								<form name="myform1" id="myform1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
										...
										<tr>
											<td colspan="2">1. Experience Certificate in Trade with 4 years after matriculation.</td>
											<td>
										...
										<tr>
											<td colspan="2">6. Proof of ownership of the premises/tenancy agreement with proof of the ownership of the owner of the premises.</td>
											<td>
