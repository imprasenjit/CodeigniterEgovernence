							...
							<div class="panel-body">
								...
								<form name="myform1" id="myform1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
										...
										<tr>
											<td colspan="2">1. Registration Certificate of the vehicle.</td>
											<td>
										...
										<tr>
											<td colspan="2">2. Driving licence of the driver.</td>
											<td>
										...
										<tr>
											<td colspan="2">3. Provision of cold storage facility.</td>
											<td>
										...
										<tr>
											<td colspan="2">4. Experience certificate in the trade.</td>
											<td>
										...
										<tr>
											<td colspan="2">5. Stockiest Certificate with valid GMP certificate.</td>
											<td>
										...
										<tr>
											<td colspan="2">6. Education qualification certificate.</td>
											<td>
