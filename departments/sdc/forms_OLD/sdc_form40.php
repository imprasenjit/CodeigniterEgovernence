...
$check=$formFunctions->is_already_registered('sdc','40');
if($check==1){
	echo "<script>
	...
	echo "<script>				
				window.location.href = '".$server_url."departments/requires/courier_details.php?form=40&dept=sdc';	</script>";
}else if($check==3){
	echo "<script>window.location.href = 'payment_section.php?token=40';</script>";
}else{
	$showtab="";
}
...
include "save_form2.php";
	...
	$owners=explode(",",$Name_of_owner); 
		$q=$sdc->query("select * from sdc_form40 where user_id='$swr_id' and active='1'");
	...
	$q1=$sdc->query("select * from sdc_form40_members where form_id='$form_id'");
						...
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h4 class="text-center text-bold" >
									<?php echo $form_name=$cms->query("select form_name from sdc_form_names where form_no='40'")->fetch_object()->form_name; ?>
								</h4>	
							</div>
							<div class="panel-body">
								...
								<form name="myform1" id="myform1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
										...
										<thead>
											...
											<?php 
										$member_results=$sdc->query("select * from sdc_form40_members where form_id='$form_id'") or die("Error : ".$sdc->error);
										...
										<tr>
											...
											<td class="text-center" colspan="2">
												<button type="submit" style="font-weight:bold" name="save40a" class="btn btn-success">Save and Next</button>
											</td>
											<td></td>
										</tr>
									</table>
								...
								<form name="myform1" id="myform1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
										...
										<tr>
											<td colspan="4">40. Name of the trade or professional Association of which the applicant is a member and the date of commencement of memberships : </td>
										</tr>			
										<tr>
											<td >Name :</td>
										...
										<tr>
											<td></td>
											<td class="text-center" colspan="2">
												<a type="button" href="sdc_form40.php?tab=1" class="btn btn-primary avoid_me">Go Back & Edit</a>&nbsp;<button type="submit" style="font-weight:bold" name="save40b" class="btn btn-success">Save and Next</button>
											</td>
											<td></td>
										</tr>
									</table>
