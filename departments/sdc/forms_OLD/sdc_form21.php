...
$check=$formFunctions->is_already_registered('sdc','21');
if($check==1){
	echo "<script>
	...
	echo "<script>				
				window.location.href = '".$server_url."departments/requires/courier_details.php?form=21&dept=sdc';
		</script>";
}else if($check==3){
	echo "<script>window.location.href = 'payment_section.php?token=21';</script>";
}else{
	$showtab="";
}
...
include "save_form.php";
	...
	$owners=explode(",",$Name_of_owner); 
		$q=$sdc->query("select * from sdc_form21 where user_id='$swr_id' and active='1'");
		$results=$q->fetch_array();
		if($q->num_rows<1){	
			$form_id="";$location="";$category="";$particulars="";
						...
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h4 class="text-center text-bold" >
									<?php echo $form_name=$cms->query("select form_name from sdc_form_names where form_no='1'")->fetch_object()->form_name; ?>
								</h4>	
							</div>
							<div class="panel-body">
								...
								<form name="myform1" id="myform1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
										...
										<tr>
											<td width="25%">Name :</td>
											<td width="25%"><input type="text" class="form-control text-uppercase" name="supervision[n1]" value="<?php echo  $supervision_n1; ?>"	></td>
										...
										<tr>
											<td>Name :</td>
											<td><input type="text" class="form-control text-uppercase" name="supervision[n2]" value="<?php echo  $supervision_n2; ?>"></td>
											<td>Qualification :</td>
										...
										<tr>
											<td colspan="2">1. Up to date registration renewal certificate of the registered pharmacy (under section 32 (2)) with two copies of the registered pharmacist.</td>
											<td>
										...
										<tr>
											<td colspan="2">2. Appointment letter and joining report of the pharmacist.</td>
											<td>
										...
										<tr>
											<td colspan="2">3. Consent letter of the pharmacist.</td>
											<td>
										...
										<tr>
											<td colspan="2">4. Court Affidavit, agreement between the owner and registered pharmacist.</td>
											<td>
										...
										<tr>
											<td colspan="2">5. Education qualification certificate.</td>
											<td>
										...
										<tr>
											<td colspan="2">6. Proof of availability of cold storage facility.</td>
											<td>
										...
										<tr>
											<td colspan="2">7. Approved layout premises (10 sq.m -15 sq.m).</td>
											<td>
										...
										<tr>
											<td colspan="2">8. Proof of ownership of the premises/tenancy agreement with proof of the ownership of the owner of the premises.</td>
											<td>
										...
										<tr>
											<td colspan="2">9. Proof of constitution of the firm.</td>
											<td>
											...
											<td width="20%" id="tdfile9">
												<?php if($file9!="" && $file9!="SC" && $file8!="NA"){ echo '<a href="'.$upload.$file9.'" target="_blank"><i class="fa fa-file-text" aria-hidden="true"></i> View</a>'; } else { echo "No File Selected"; } ?>
											</td>
										</tr>
										
										<tr>
											<td colspan="2">10. Residence address of the appliances, etc.</td>
											<td>
										...
										<tr>
											...
											<td class="text-center" colspan="2">
												<button type="submit" style="font-weight:bold" name="save21" class="btn btn-success">Save and Next</button>
											</td>
											<td></td>
										</tr>
									</table>
