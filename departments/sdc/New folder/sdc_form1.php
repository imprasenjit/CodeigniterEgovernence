...
if($check==1){
	...
	echo "<script>				
				window.location.href = '".$server_url."departments/requires/courier_details.php?form=1&dept=sdc';
		</script>";
}else if($check==3){
...
include "save_form.php";
	...
	$owners=explode(",",$Name_of_owner); 
		$q=$sdc->query("select * from sdc_form1 where user_id='$swr_id' and active='1'");
							...
							<div class="panel-body">
								...
								<form name="myform1" id="myform1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
										...
										<tr>
											<td colspan="2">1. Experience Certificate in Trade with 4 years and hold a degree of a recognized university with 1 year experience in dealing with drugs.</td>
											<td>
										...
										<tr>
											<td colspan="2">4. Proof of availability of cold storage facility.</td>
											<td>
										...
										<tr>
											<td colspan="2">5. Approved layout premises (10 sq.m -15 sq.m).</td>
											<td>
										...
										<tr>
											<td colspan="2">6. Proof of ownership of the owner of the premises.</td>
											<td>
										...
										<tr>
											<td colspan="2">7. Proof of constitution of the firm.</td>
											<td>
										...
										<tr>
											<td colspan="2">8. Residence address of the appliances, etc..</td>
											<td>
										...
										<tr>
											...
											<td class="text-center" colspan="2">
												<button type="submit" style="font-weight:bold" name="save1" class="btn btn-success">Save and Next</button>
											</td>
											<td></td>
										</tr>
									</table>
