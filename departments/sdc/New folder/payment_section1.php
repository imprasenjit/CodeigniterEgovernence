										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-inline text-center">
													...
													<input type="radio" name="payment_mode" disabled value="1"> Online Payment
													<input type="radio" name="payment_mode" value="0" checked="checked"> Offline Payment
												</div>
											</div>
										</div>
										<br>
											...
											<div class="row">
												<div class="col-md-6 col-md-offset-4" style="padding-bottom:30px">
													...
													<p>Bank Name : ICICI Bank Limited , fancy Bazaar, Ghy<br/>
														...
														Entity Name : State Drug Controller<br/>
