...
?>
	...
	<?php 
		$part1=$formFunctions->executeQuery($dept,"SELECT * FROM ".$table_name."_t3 WHERE form_id='$form_id'");
		$num3 = $part1->num_rows;
		if($num3>0){
			$hiddenval3=$num3+1;
			$num3=$num3+1;
	...
	<?php 
		$part1=$formFunctions->executeQuery($dept,"SELECT * FROM ".$table_name."_t4 WHERE form_id='$form_id'");
		$num4 = $part1->num_rows;
		if($num4>0){
			$hiddenval4=$num4+1;
			$num4=$num4+1;
...
/*---------FOR TABLE-4------------*/
	...
	<?php 
		$part1=$formFunctions->executeQuery($dept,"SELECT * FROM ".$table_name."_t5 WHERE form_id='$form_id'");
		$num5 = $part1->num_rows;
		if($num5>0){
			$hiddenval5=$num5+1;
			$num5=$num5+1;
...
/*---------FOR TABLE-5------------*/
	...
	<?php 
		$part1=$formFunctions->executeQuery($dept,"SELECT * FROM ".$table_name."_t6 WHERE form_id='$form_id'");
		$num6 = $part1->num_rows;
		if($num6>0){
			$hiddenval6=$num6+1;
			$num6=$num6+1;
