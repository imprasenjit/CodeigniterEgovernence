...
<?php require_once "lc_reg_form" . $form . "_Addmore-operation.php"; ?> <!-- File handles 'Addmore' Operation -->
                                ...
                                <form name="myform1" id="myformHW1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data" >
                                    <table class="table table-responsive">
                                        ...
                                        <tr>
                                            <td>District</td>
                                            <td>
                                                <select name="manager_address[dist]" id="m_dist" class="form-control text-uppercase">
                                                    <?php
                                                    $districts = $ci->GetDistrict_model->getAllDistrict();

                                                    foreach ($districts as $district_values) {
                                                        if ($m_dist == strtoupper($district_values["district"]))
                                                            $s = 'selected';
                                                        else
                                                            $s = '';
                                                        echo '<option value="' . $district_values["district"] . '" ' . $s . '>' . $district_values["district"] . '</option>';
                                                    }
                                                    ?>
                                                </select>
                                            </td>
...
<?php } ?>
                                        <tr>
                                            ...
                                            <td>
                                                <select name="estab_category" required="required" class="form-control text-uppercase">
                                        ...
                                        <tr>
                                            <td colspan="4" >Name of members of the employer's family employed in the establishment and residing with and wholly dependent upon him :
                                                <table  class="table table-responsive " name="objectTable3"  id="objectTable3">
                                                    ...
                                                    <?php
                                                    $part3 = $formFunctions->executeQuery($dept, "SELECT * FROM labour_form" . $form . "_t3 WHERE form_id='$form_id'");
                                                    $num = $part3->num_rows;
                                                    if ($num > 0) {
                                                        $count = 1;
