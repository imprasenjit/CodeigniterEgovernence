...
include "save_form.php";
	...
	if($q->num_rows<1){	 
		...
		if($p->num_rows>0){
			...
			$cert_number=$results["cert_number"];$cert_date=$results["cert_date"];$manager_name=$results["manager_name"];$estab_category=$results["estab_category"];$max_workers=$results["max_workers"];
			...
			$form_id="";$cert_number="";$cert_date="";$situation_office="";$situation_storeroom="";$situation_godown="";$situation_warehouse="";$manager_name="";$m_street_name1="";$m_street_name2="";$m_vill="";$m_dist="";$m_pin="";$estab_category=""; $max_workers=""; $nature_business=""; $date_business="";	
		}
	}else{
...
?>
	...
	<?php require_once "../../requires/header.php";   ?>  
	    <?php include ("lc_renewal_form".$form."_Addmore-operation.php"); ?>
					...
					<div class="col-md-12">
						<div class="panel panel-primary">
							...
							<table class="table table-responsive">
								...
								<tr>
									<td>(a) Office</td>
									<td><textarea class="form-control text-uppercase" name="situation[office]" id="office" ><?php echo $situation_office; ?></textarea></td>
									<td>(b) Store Room</td>
									<td><textarea class="form-control text-uppercase" name="situation[storeroom]" id="storeroom" ><?php echo $situation_storeroom; ?></textarea></td>
								</tr>
								<tr>
									<td>(c) Godown </td>
									<td><textarea class="form-control text-uppercase" name="situation[godown]" id="godown" ><?php echo $situation_godown;?></textarea></td>
									<td>(d) Warehouse or Work Place</td>
									<td><textarea class="form-control text-uppercase" name="situation[warehouse]" id="warehouse" ><?php echo $situation_warehouse; ?></textarea></td>
								</tr>
									<tr>
										<td colspan="4">Number and date of previous Certificate of Registration (certificate to be surrendered with the application for renewal) </td>
									</tr>
									<tr>
										<td>Number :<span class="mandatory_field">*</span></td>
										<td><input type="text" class="form-control text-uppercase" id="cert_number" required="required" name= "cert_number" value="<?php echo $cert_number; ?>" ></td>
										<td>Date :<span class="mandatory_field">*</span></td>
										<td><input type="datetime" class="dob4 form-control text-uppercase" required="required" value="<?php if($cert_date!="" && $cert_date!="0000-00-00") echo $cert_date; else echo ""; ?>" name="cert_date" placeholder="DD/MM/YYYY" readonly="readonly"></td>
									</tr>
							...
							<table class="table table-responsive">
								...
								<tr>
									...
									<td><input type="text" class="form-control text-uppercase" validate="letters" name="manager_name" value="<?php echo $manager_name; ?>" required></td>
                                ...
                                <input type="text" class="form-control text-uppercase" value="<?php echo strtoupper($m_dist);?>"  placeholder="Enter District" name="manager_address[dist]">    
                                </td>
								...
								<td colspan="4">Name of partners and their residential addresses (if it is a partnership concern) :
									<table name="objectTable1" class="table table-responsive" id="objectTable1" >
										...
										<tr>
											...
											<td><input type="text" value="<?php echo $row_1["field7"]; ?>" pattern="[0-9]{6,6}" validate="pincode" maxlength="6" id="txtA<?php echo $count;?>" class="form-control text-uppercase" name="txtG<?php echo $count;?>" size="5" ></td>
										</tr>	
										<?php $count++; } 
										}else{	?>
										<tr>
								...
								<tr>
									<td class="text-center" colspan="4">
										<a href="lc_renewal_form<?php echo $form;?>.php" class="btn btn-primary">Go Back & Edit</a>
											...
											<?php
												...
												if($num>0){
												 ...
												 <tr>
													...
													<td><input type="text" value="<?php echo $row_1["field2"]; ?>" id="textB<?php echo $count;?>" validate="letters" class="form-control text-uppercase" size="20" name="textB<?php echo $count;?>"></td>
													...
													<td><input type="text" value="<?php echo $row_1["field7"]; ?>" id="textA<?php echo $count;?>" validate="pincode" maxlength="6" class="form-control text-uppercase" name="textG<?php echo $count;?>" size="5" ></td>
												</tr>	
											<?php $count++; } 
											}else{	?>
											<tr>
											  <td><input value="1" readonly="readonly" id="textA1" size="1" class="form-control text-uppercase" name="textA1"></td>
											  <td><input type="text" id="textB1" size="20" class="form-control text-uppercase" validate="letters" name="textB1"></td>					
								...
								<?php } ?>
									<tr>
										...
										<select required name="estab_category" required="required" class="form-control text-uppercase">
											<?php 
													...
													$s="";
													$payment_details=$formFunctions->executeQuery($dept,"select shops_category_id,shops_category from payment_details_forms_1_9 GROUP BY shops_category_id ASC ORDER BY id ASC");
													if($payment_details->num_rows>0){
														while($payment_details_rows=$payment_details->fetch_object()){
															$shops_category_id=$payment_details_rows->shops_category_id;
															$shops_category=$payment_details_rows->shops_category;
															if($shops_category_id == $estab_category){
																$s="selected";
															}else{
																$s="";
															} 
															echo '<option '.$s.' value="'. $shops_category_id .'">'. $shops_category .'</option>';
														}															
													}
											?>
										</select>
									...
									<tr>
										<td class="text-center" colspan="4">
											<a href="lc_renewal_form<?php echo $form;?>.php?tab=2" class="btn btn-primary">Go Back & Edit</a>
								...
								<td colspan="4">Total Number of Permanent Employees : 
									...
									<button type="button" href="#" onClick="mydel_addmore4()" class="btn btn-default" value="">Delete</button><input type="hidden" id="hiddenval4" name="hiddenval4" value="<?php echo $hiddenval4; ?>"/></div><br>
									</td>
									</tr>
									<tr>
								...
								<button type="button" href="#" onClick="mydel_addmore6()" class="btn btn-default" value="">Delete</button><input type="hidden" id="hiddenval6" name="hiddenval6" value="<?php echo $hiddenval6; ?>"/></div></td>
									...
									<tr>
										<td class="text-center" colspan="4">
											<a href="lc_renewal_form<?php echo $form;?>.php?tab=3" class="btn btn-primary">Go Back & Edit</a>
