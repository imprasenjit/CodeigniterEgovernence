...
$table_name=getTableName($dept,$form);
	...
	if($q->num_rows>0){	
		...
		if(!empty($results["mt_address"])){
			...
			$mt_address_sn1=$mt_address->sn1;$mt_address_sn2=$mt_address->sn2;$mt_address_vill=$mt_address->vill;$mt_address_pin=$mt_address->pin;$mt_address_mob=$mt_address->mob;$mt_address_email=$mt_address->email;
		}else{
