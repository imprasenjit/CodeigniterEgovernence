...
$printContents=$printContents.'    
    ...
    <table class="table table-bordered table-responsive">         
		<tr>
			<td width="50%" rowspan="7" valign="top">1. Name and address of the contractor (including his father&apos;s/husband&apos;s name in case of individuals) </td>
		...
		<tr>
			...
			<td colspan="2">'.strtoupper($date_of_cert_reg).'</td>
		</tr> 
		...
		<tr>
			...
			<thead>
				<tr>
					<td colspan="7" height="40px">(e)	Names and address of the Directors/Partners in case of companies and firms  </td>
				</tr>
				<tr>
					<td>Sl No.</td>
					<td>Full Name</td>
		...
		<tr>
			...
			<thead>
				<tr>
					<td colspan="7" height="40px">f)	Name(s) and address (es) of the person (s) in-charge of and responsible to the Company/firm for the conduct of the business of the company/firm, as the case may be.</td>
				</tr>
				<tr>
					<td>Sl No.</td>
					<td>Full Name</td>
