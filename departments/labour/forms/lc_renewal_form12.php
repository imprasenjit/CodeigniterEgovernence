							...
							<div class="panel-body">
								...
								<table class="table table-responsive">
									...
									<tr>
										...
										<td>District</td>
										<td>
                                        <input type="text" class="form-control text-uppercase" value="<?php echo strtoupper($mt_address_dist);?>"  placeholder="Enter District" name="mt_address[dist]">    
                                        </td>
									</tr>
									<tr>
										<td>Pincode</td>
									...
									<tr>
										<td>E-Mail ID</td>
										<td><input type="email" class="form-control" name="mt_address[email]" value="<?php echo $mt_address_email; ?>"></td>
										<td></td>
										<td></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><input type="text" class="form-control" required="required" validate="onlyNumbers" name="max_workers" value="<?php echo $max_workers; ?>"></td>
										<td></td>
										<td></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<?php 
										$member_results=$formFunctions->executeQuery($dept,"select * from ".$table_name."_members where form_id='$form_id'") or die("Error : ".$labour->error);
										if($member_results->num_rows==0){
											for($i=1;$i<=count(array($owners));$i++){ ?>
											<tr>
												<td><?php echo $i; ?></td>
												<td><input type="text" name="name<?php echo $i;?>" readonly="readonly" class="form-control text-uppercase" value="" /></td>
										...
										while($rows=$member_results->fetch_object()){ ?>
											<tr>
												<td><?php echo $i; ?></td>
												<td><input type="text" name="name<?php echo $i;?>" readonly="readonly" class="form-control text-uppercase" value="<?php $rows->name; ?>" /></td>
