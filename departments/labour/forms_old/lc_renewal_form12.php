							...
							<div class="panel-body">
								...
								<table class="table table-responsive">
									...
									<tr>
										...
										<?php 
										$member_results=$labour->query("select * from labour_form12_members where form_id='$form_id'") or die("Error : ".$labour->error);
									...
									<tr>
										...
										<td class="text-center" colspan="4">
											<button type="submit" class="btn btn-success submit1" name="save12" title="Save it, if you want to complete it later" rel="tooltip" onclick="return confirm('Do you want to save..?')">Save and Submit</button>
										</td>
