...
<body>';		
	...
	<table width="100%" align="center" class="table table-bordered table-responsive" style="margin:0px auto;border-collapse: collapse" border="1">
		...
		<tr>
            <td valign="top">Situation of Office, store-room, godown, warehouse or work place, if any, attached to the establishment but situated inpremises different from those of the establishment   </td>
            <td>
               <table width="100%" align="center" class="table table-bordered table-responsive" style="margin:0px auto;border-collapse: collapse" border="1">
                    <tbody>
                        <tr>
		...
		<tr>
			<td valign="top" resultsspan="2">Number and date of previous Certificate of Registration (certificate to be surrendered with the application for renewal) </td>
			<td>Number :&nbsp;'.strtoupper($results["cert_number"]).'</td>
		</tr>
		<tr>
			<td>Date :&nbsp; '.date("d-m-Y",strtotime($results["cert_date"])).'</td>
		</tr>
		<tr>
	...
	$printContents=$printContents.'<table width="100%" align="center" class="table table-bordered table-responsive" style="margin:0px auto;border-collapse: collapse" border="1">
		<thead>
	...
	if($owner_type=="PTLC" || $owner_type=="PBLC"){ 
		...
		<tr>
			<td colspan="2"> Signature and Dates :</td>
