...
<!-- add more particulars of all certificate submitted -->
<?php 
	if(isset($form_id)){
		$part1=$labour->query("SELECT id FROM labour_form3_t1 WHERE form_id='$form_id'");
		$num = $part1->num_rows;
	}else{
		$num=0;
	}
...
<?php
	if(isset($form_id)){
		$part2=$labour->query("SELECT id FROM labour_form3_t2 WHERE form_id='$form_id'");
		$num2 = $part2->num_rows;
	}else{
		$num2=0;
	}
