...
if(isset($_GET["token"])){
	...
	if($check==1){
		...
		echo "<script>
				window.location.href = '".$server_url."departments/labour/forms/labour_form".$token.".php';
		</script>";	
	}else{
		$submit_payment=$token;
		$reg_fees=100;
		//$reg_fees=$labour->query("select reg_fees from labour_form".$token." where user_id='$swr_id' and active='1'")->fetch_object()->reg_fees;
	}
}else{
	echo "<script>
			alert('Something went wrong!!!');
										...
										<div id="offlinePayDetials">
											<div class="row">
													...
													<div class="row">
														...
														<div class="col-md-6"><input type="date" class="dob form-control" name="txn_date" required /></div>
													</div>
													<div class="row">
														<div class="col-md-6"><label>Bank Name : </label></div>
														<div class="col-md-6"><input type="text" class="form-control text-uppercase" name="bank_name" required /></div>
													</div>
													<div class="row">
														<div class="col-md-6"><label>Treasury/Ref. No. : </label></div>
														<div class="col-md-6"><input type="text" class="form-control" name="ref_no" validate="OnlyNumbers" required /></div>
													</div>
