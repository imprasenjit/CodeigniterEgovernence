...
<head>
	...
	<?php include ("lc_renewal_form9_Addmore-operation.php"); ?> <!-- File handles 'Addmore' Operation -->
</head>
...
<table class="table table-responsive">
	...
	<td colspan="4">Name of partners and their residential addresses (if it is a partnership concern) :
		<table name="objectTable1" class="table table-responsive" id="objectTable1" >
			...
			<?php
			$part1=$labour->query("SELECT * FROM labour_form9_t1 WHERE form_id='$form_id'");
			$num = $part1->num_rows;
			if($num>0){
			$count=1;
	...
	<tr>
		<td class="text-center" colspan="4">
			<a href="lc_renewal_form9.php" class="btn btn-primary">Go Back & Edit</a>
...
<?php if($owner_type=="PTLC" || $owner_type=="PBLC"){ ?>
	<tr>
		...
		<table name="objectTable2" class="table table-responsive" id="objectTable2" >
			...
			<?php
				$part2=$labour->query("SELECT * FROM labour_form9_t2 WHERE form_id='$form_id'");
				$num = $part2->num_rows;
				if($num>0){
				  $count=1;
...
<?php } ?>
	...
	<tr>
		<td class="text-center" colspan="4">
			<a href="lc_renewal_form9.php?tab=2" class="btn btn-primary">Go Back & Edit</a>
...
<button type="button" href="#" onClick="mydel_addmore6()" class="btn btn-default" value="">Delete</button><input type="hidden" id="hiddenval6" name="hiddenval6" value="<?php echo $hiddenval6; ?>"/></div></td>
	...
	<tr>
		<td class="text-center" colspan="4">
			<a href="lc_renewal_form9.php?tab=3" class="btn btn-primary">Go Back & Edit</a>
