...
##PHP TAB management
	...
	$tabbtn1="";$tabbtn2="";$tabdiv3="";$tabbtn3="";$tabdiv4="";$tabbtn4="";$tabdiv5="";$tabbtn5="";
						...
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h4 class="text-center" >
									<strong><?php echo $form_name=$cms->query("select form_name from labour_form_names where form_no='8'")->fetch_object()->form_name; ?></strong>
								</h4>	
							</div>
								...
								<table id="" class="table table-responsive">						
									...
									<tr>
										...
										<td><?php $dstresult=$mysqli->query("SELECT * FROM district WHERE district !='' GROUP BY district ASC")OR die("Error : ".$mysqli->error); ?>
											<select name="manager[d]" id="m_dist" class="form-control text-uppercase" style="text-transform: uppercase;"><?php
											...
											$part1=$labour->query("SELECT * FROM ".$table_name."_t1 WHERE form_id='$form_id'");
												...
												if($num>0){
													...
													while($row_1=$part1->fetch_array()){	?>
														...
														<td><input type="text" value="<?php echo $row_1["field7"]; ?>" title="Enter 6 Digit Pin Code" id="txtA<?php echo $count;?>" maxlength="6" validate="pincode" class="form-control text-uppercase" name="txtG<?php echo $count;?>" size="5" ></td>
														</tr>
												<?php 
												$count++;
												}
