...
<br/>            
      <div style="text-align:center">	
		...
		<br>
            <table border="1" width="100%" style="margin:0px auto;border-collapse: collapse"  class="table table-bordered table-responsive">         
				...
				<tr>
								...
								<table border="1" width="100%" style="margin:0px auto;border-collapse: collapse"  class="table table-bordered table-responsive">
		<thead>
		<tr><td colspan="7" height="40px">(e)	Names and address of the Directors/Partners in case of companies and firms  </td></tr>
		<tr><td>Sl No.</td>
		<td>Full Name</td>
		<td>Street Name 1</td>
		<td>Street Name 2</td>
		...
		<tr>
					...
					<table border="1" width="100%" style="margin:0px auto;border-collapse: collapse"  class="table table-bordered table-responsive">
		<thead>
		<tr><td colspan="7" height="40px">f)	Name(s) and address (es) of the person (s) in-charge of and responsible to the Company/firm for the conduct of the business of the company/firm, as the case may be.</td></tr>
		<tr><td>Sl No.</td>
		<td>Full Name</td>
		<td>Street Name 1</td>
		<td>Street Name 2</td>
