<?php
if(isset($form_id)){
	$part1=$labour->query("SELECT id FROM labour_form4_t1 WHERE form_id='$form_id'");
	$num = $part1->num_rows;
}else{
	$num=0;
}
...
<?php
if(isset($form_id)){
	$part2=$labour->query("SELECT id FROM labour_form4_t2 WHERE form_id='$form_id'");
	$num2= $part2->num_rows;
}else{
	$num2=0;
}
...
<?php
if(isset($form_id)){
	$part3=$labour->query("SELECT * FROM  labour_form4_t3 WHERE form_id='$form_id'");
	$num3= $part3->num_rows;
}else{
	$num3=0;
}
...
<?php
if(isset($form_id)){
	$part4=$labour->query("SELECT * FROM  labour_form4_t4 WHERE form_id='$form_id'");
	$num4= $part4->num_rows;
}else{
	$num4=0;
}
