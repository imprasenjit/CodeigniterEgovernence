...
include "save_form.php";
	...
	if($q->num_rows<1){	 
		...
		if($p->num_rows>0){
			...
			$fees_description=$results["fees_description"];
			$state_details=$results["state_details"];$reg_no=$results["reg_no"];
			...
			if(!empty($results["reg_date"])){
				$reg_date=json_decode($results["reg_date"]);
				$reg_date_issue_dt=$reg_date->issue_dt;$reg_date_expiry_dt=$reg_date->expiry_dt;
			}else{
				$reg_date_issue_dt="";$reg_date_expiry_dt="";
			}
		}else{
			$form_id="";
			$fees_description="";
			...
			$state_details="";$reg_no="";$reg_date_issue_dt="";$reg_date_expiry_dt="";	
		}			
	}else{	
									...
									<table id="" class="table table-responsive table-bordered">
										...
										<tr>
											...
											<td colspan="2">&nbsp;&nbsp;
												...
												<label class="checkbox-inline"><input type="checkbox" <?php if($specific_invasive_c=="Genetic Clinic") echo "checked"; ?> name="specific_invasive[c]" value="Chromosomal">Chromosomal &nbsp;&nbsp; </label>
										...
										<tr>
											<td>10.(a) Registration No. :</td>
											<td><input type="text" class="form-control" name="reg_no"  value="<?php echo $reg_no; ?>"></td>
										</tr>
										<tr>
											<td colspan="4">(b) Date of issue and date of expiry of existing certificate of registration.</td>
										</tr>
										<tr>
											<td>Date of issue :</td>
											<td><input type="text" class="dobindia form-control text-uppercase" name="reg_date[issue_dt]" value="<?php if($reg_date_issue_dt!="0000-00-00" && $reg_date_issue_dt!="") echo date("d-m-Y",strtotime($reg_date_issue_dt)); else echo "";?>" placeholder="DD-MM-YYYY" ></td>
											<td>Date of expiry :</td>
											<td><input type="text" class="dobindia form-control text-uppercase" name="reg_date[expiry_dt]"  value="<?php if($reg_date_expiry_dt!="0000-00-00" && $reg_date_expiry_dt!="") echo date("d-m-Y",strtotime($reg_date_expiry_dt)); else echo "";?>" placeholder="DD-MM-YYYY" ></td>
										</tr>										
										<tr>
