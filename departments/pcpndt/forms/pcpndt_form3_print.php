...
if(!isset($form_id) && !isset($_GET["ui"]) &&  !isset($_GET["token"]) && !isset($_GET["uain"])){
	...
	if($q->num_rows>0){	
		...
		$state_details=$results["state_details"];$reg_no=$results["reg_no"];$fees_description=$results["fees_description"];
    ...
    <div style="text-align:center">
		...
		<table class="table table-bordered table-responsive">
				   ...
				   <tr>
					...
					<tr>
							<td >(b) Date of issue and date of expiry of existing certificate of registration.</td>
							<td>'.strtoupper($reg_date_issue_dt).' and '.strtoupper($reg_date_expiry_dt).'</td> 
					</tr>
					';
