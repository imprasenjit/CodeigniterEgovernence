					...
					if($rows->form_no==1){ ?> 
						<div class="col-md-4">
							<div class="info-box bg-aqua-active">
								...
								<a href="<?php echo $server_url?>dept_documents/tourism/forms/form1.pdf" target="_blank"><i class="fa fa-download"></i><strong>Download Sample form</strong></a></div>
								<div class="col-md-6 small-box-footer btn btn-primary">
								<a href="../requires/terms.php?form=<?php echo $rows->form_no; ?>&dept=tourism"><i class="fa fa-calendar"></i> <strong>Apply Online</strong></a></div>
