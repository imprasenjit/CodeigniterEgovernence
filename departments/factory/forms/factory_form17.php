...
if($q->num_rows<1){
	...
	if($p->num_rows>0){
		...
		$serial_no=$results['serial_no'];$father_name=$results['father_name'];$first_dt=$results['first_dt'];$letter=$results['letter'];$relay_no=$results['relay_no'];$token_no=$results['token_no'];$remarks=$results['remarks'];
		...
		$form_id="";
		$serial_no="";$father_name="";$first_dt="";$letter="";$relay_no="";$token_no="";$remarks="";
		$worker_name="";$worker_sn1="";$worker_sn2="";$worker_vill="";$worker_dist="";$worker_pin="";$worker_mobile="";
		$certificate_no="";$certificate_dt="";
	}
}else{	
								...
								<form name="myform1" id="myform1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
										...
										<tr>
											...
											<td>5. Date of first employment : </td>
											<td><input type="date" class="dob form-control" name="first_dt" value="<?php echo $first_dt; ?>"></td>
										</tr>																						
										<tr>
											<td>6. No. of certificate and it's date : </td>
