...
include "save_form.php";
	...
	$risk_category_results=$formFunctions->executeQuery("dicc","SELECT * FROM inspection_category WHERE deptcode ='factory' GROUP BY businesstype ASC"); 
	...
	$p=$formFunctions->executeQuery($dept,"select * from ".$table_name." where user_id='$swr_id' and active='0' ORDER BY form_id DESC LIMIT 1");
		...
		$file1="";$file2="";$file3="";$file4="";$file5="";$file6="";$ris_category=""; $ris_category_txt="Select A Category";
       }
 }else{
							...
							<div class="panel-body">
								...
								<table id="tab1" class="table table-responsive">
									...
									<tr>
										...
										<td>District :</td>
									    <td><input type="text" class="form-control text-uppercase" name="communication_address[dist]" value="<?php if($communication_address_dist==NULL){ echo $communication_address_dist;} else { echo $communication_address_dist; }  ?>"></td>
									</tr>
									<tr>
										<td>Pin Code :</td>
									...
									<tr>
										<td>Phone No:</td>
										<td><input type="text" class="form-control text-uppercase" name="communication_address[p_no]" validate="onlyNumbers" maxlength="13" value="<?php if($communication_address_p_no==NULL){ echo $b_landline_std." - ".$b_landline_no;/*$landline_std.$landline_no;*/}else{ echo $communication_address_p_no; }  ?>"></td>
										<td>Email Id:</td>
									...
									<tr>
				                       <td>Nature :<span class="mandatory_field">*</span> </td>
									    ...
									    <td><input type="text" name="power[p]" validate="onlyNumbers" required="required" id="hp2" value="<?php echo $power_p; ?>"/></td>
									</tr>
				                   <tr>
									   ...
									   <td>										
										...
										if($risk_category_results->num_rows>0){
											while($risk_category_rows=$risk_category_results->fetch_object()) { 
                                            $businesstype=$risk_category_rows->businesstype;
                                            $risk_id=$risk_category_rows->id;?>
									...
									<tr>
									    <td>District :</td>
									    <td><input type="text" class="form-control text-uppercase" name="manager[d]" value="<?php if($manager_d==NULL){ echo $vill;}else{ echo $manager_d; } ?>"  required="required"></td>
										<td>Pin Code :</td>
...
<script>
	$("#occupierName").html(occupier_name_value);
