...
include "save_form.php";
	...
	$p=$factory->query("select * from ".$table_name." where user_id='$swr_id' and active='0' ORDER BY form_id DESC LIMIT 1") or  die($factory->error);
		if($p->num_rows>0){
			...
			$managing_agents=$results['managing_agents'];$cah=$results['cah'];
			...
			if(!empty($results["manager"])){
				...
				$manager_name=$manager->name;$manager_sn1=$manager->sn1;
				if(isset($manager->sn2)) $manager_sn2=$manager->sn2;
				$manager_v=$manager->v;$manager_d=$manager->d;$manager_p=$manager->p;
			}else{
			...
			if(!empty($results["occupier"])){
				...
				$occupier_name="";$occupier_sn1="";$occupier_sn2="";$occupier_vill="";$occupier_dist="";$occupier_pin="";				
			}
			...
			if(!empty($results["ref_no"])){
				...
				if(isset($ref_no->approval1)) $ref_no_approval1=$ref_no->approval1;
				if(isset($ref_no->approval2)) $ref_no_approval2=$ref_no->approval2;
			}else{
			...
			$cah="";
			$communication_address_str1="";$communication_address_str2="";$communication_address_vill="";$communication_address_dist="";$communication_address_pin="";$communication_address_m_no="";$communication_address_p_no="";$communication_address_email="";
			$manuf_process_carried="";$manuf_process_car_fac="";$manuf_prod_nv="";$manuf_prod_max_emp1="";$manuf_prod_max_emp2="";$manuf_prod_max_emp="";$manuf_process_nat_fac="";$license_no="";
			...
			$owner_name="";$owner_sn1="";$owner_sn2="";$owner_vill="";$owner_dist="";$owner_pin="";
			$ref_no_approval2="";$ref_no_approval1="";
			$proprietors="";$directors="";$managing_agents="";$risk_category="";
			$ris_category=""; $ris_category_txt="Select A Category";
        }
	}else{
							...
							<div class="panel-body">
								...
								<table id="tab1" class="table table-responsive">
									...
									<tr>
										...
										<td width="25%">License Number :<span class="mandatory_field">*</span>  </td>
										<td width="25%"><input type="text" class="form-control text-uppercase" required="required" name="license_no" value="<?php echo $license_no; ?>" /></td>									
									</tr>
									<tr>
									...
									<tr>
										<td>Street Name1 :</td>
										<td><input type="text" class="form-control text-uppercase" name="communication_address[str1]"  value="<?php if($communication_address_str1==NULL){ echo $street_name1; } else { echo $communication_address_str1; } ?>"></td>
										<td>Street Name2 :</td>
										<td><input type="text" class="form-control text-uppercase" name="communication_address[str2]" value="<?php if($communication_address_str2==NULL){ echo $street_name2; } else { echo $communication_address_str2; }?>" ></td>
									</tr>
									<tr>
										<td>Village/Town :</td>
										<td><input type="text" class="form-control text-uppercase" name="communication_address[vill]" value="<?php if($communication_address_vill==NULL){ echo $vill;} else { echo $communication_address_vill; }  ?>"></td>
										<td>District :</td>
										<td><input type="text" class="form-control text-uppercase" name="communication_address[dist]" value="<?php if($communication_address_dist==NULL){ echo $dist;} else { echo $communication_address_dist; }  ?>"></td>
										
									</tr>
									<tr>
										<td>Pin Code :</td>
										<td><input type="text" class="form-control text-uppercase" name="communication_address[pin]" validate="pincode" maxlength="6" value="<?php if($communication_address_pin==NULL){ echo $pincode; } else { echo $communication_address_pin;}  ?>"></td>
										<td>Mobile No :</td>
										<td><input type="text" class="form-control text-uppercase" name="communication_address[m_no]" validate="mobileNumber" maxlength="10" value="<?php if($communication_address_m_no==NULL){ echo $mobile_no; }else{ echo $communication_address_m_no; } ?>"></td>
									</tr>
									<tr>
										<td>Phone No :</td>
										<td><input type="text" class="form-control text-uppercase" name="communication_address[p_no]" validate="onlyNumbers" maxlength="13" value="<?php if($communication_address_p_no==NULL){ echo  $landline_std.$landline_no; ;}else{ echo $communication_address_p_no; }  ?>"></td>
										<td>Email Id :</td>
										<td><input type="email" class="form-control" name="communication_address[email]" value="<?php if($communication_address_email==NULL){ echo $email; } else { echo $communication_address_email;} ?>"></td>
									</tr>								
									<tr>
									...
									<tr>
				                       <td>Nature :<span class="mandatory_field">*</span> </td>
									    ...
									    <td><input type="text" name="power[p]" validate="onlyNumbers" required="required" id="hp2" <input type="text" class="form-control text-uppercase" value="<?php echo $power_p; ?>"/></td>
									</tr>
				                   <tr>
					                    ...
					                    <td ><input type="text" name="power[mp]" id="hp3" class="form-control text-uppercase" required="required" validate="onlyNumbers" value="<?php echo $power_mp; ?>"/></td>
					                   <td>Risk Category <span class="mandatory_field">*</span></td>
									   <td>										
										<?php $rstresult=$mysqli->query("SELECT * FROM inspection_category WHERE deptcode ='factory' GROUP BY businesstype ASC")OR die("Error : ".$mysqli->error); ?>
									<select name="risk_category" required="required" id="category1" class="form-control text-uppercase">
                                       <option value="">Please Select</option>
                                       <?php while($rstrows=$rstresult->fetch_object()) { 
									...
									<tr>
									    <td>Full Name :</td>
									    <td><input type="text" class="form-control text-uppercase" name="manager[name]" validate="letters" value="<?php if($manager_name==NULL) { echo $key_person;}  echo $manager_name; ?>" required="required"></td>
										<td>Street Name 1 :</td>
									    <td><input type="text" class="form-control text-uppercase"  name="manager[sn1]" value="<?php if($manager_sn1==NULL) { echo $street_name1;}else { echo $manager_sn1; } ?>"  required="required"></td>
									</tr>
									<tr>
									    <td>Street Name 2 :</td>
									    <td><input type="text" class="form-control text-uppercase"  name="manager[sn2]" value="<?php if($manager_sn2==NULL){ echo $street_name2;}else{ echo $manager_sn2; } ?>"  ></td>
										<td>Village/Town :</td>
									    <td><input type="text" class="form-control text-uppercase" name="manager[v]" value="<?php if($manager_v==NULL){ echo $vill;}else{ echo $manager_v; } ?>"  required="required"></td>
									</tr>
									<tr>
									    <td>District :</td>
										<td><input type="text" class="form-control text-uppercase" name="manager[d]" value="<?php if($manager_d==NULL){ echo $dist;}else{ echo $manager_d; } ?>"  required="required"></td>
										<td>Pin Code :</td>
									    <td><input type="text" class="form-control text-uppercase"  validate="pincode" maxlength="6" name="manager[p]" value="<?php if($manager_p==NULL){ echo $pincode; }else{ echo $manager_p; } ?>"  required="required"></td>
									</tr>
								...
								<table id="" class="table table-responsive">
									<tr>
									     <td colspan="4">8. Full name and residential address of occupier:* </td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>Pin Code :*</td>
									    <td><input type="text" disabled="disabled" class="form-control text-uppercase" id="occupier_pin" value="<?php echo $pincode; ?>"></td>
									</tr>
									<tr>
									     <td>(i) The proprietor of the factory in case of private  <br/>firm/proprietory concern :</td>
									     <td><input type="text" class="form-control text-uppercase" readonly="readonly" name="proprietors" id="proprietors" value="<?php if($owner_type=="PR") echo $name_of_owner; ?>" ></td>
									...
									<?php if($owner_type=="HUF" || $owner_type=="PSU"){
									...
									<tr>
									     ...
									     <td><label id="signature" name="signature" class="text-uppercase"><?php echo strtoupper($key_person); ?></label></td>
									     <td>Signature of Manager :</td>
									     <td><label id="signature" name="signature" class="text-uppercase"><?php echo $manager_name; ?></label></td>
									</tr>
									<tr>
									     <td>Date : </td>
...
<script>
	...
	$('#occupier_name').on('change', function(){
			var name=$('#occupier_name').val();
			$("#occupierName").html(name);
	});
