...
if($q->num_rows<1){	 
	...
	if($p->num_rows>0){
		...
		$officer_name="";$officer_phone="";$officer_fax="";$officer_email="";
		// Tab 2 //
		$household_no="";$premise_no="";$election_no="";$source="";$is_stored="";$is_segregated="";$is_segregated_details="";$is_d2d="";
		$quantity_generate="";$quantity_collect="";$quantity_capita="";$quantity_process="";$quantity_dispose="";
		$bins_domestic="";$bins_commercial="";$bins_households="";$bins_premises="";
		$d2d_ward="";$d2d_households="";$d2d_premises="";$d2d_vehicle="";$d2d_handcart="";$d2d_other="";$d2d_method="";$d2d_sweep="";
		// Tab 3 //
		...
		$storage_open="";$storage_masonry="";$storage_concrete="";$storage_dhalao="";$storage_metal="";$storage_bins="";$storage_bins2="";$storage_containers="";$storage_city="";
		// Tab 4 //
		$total_storage="";$total_waste="";$is_facility="";
		$ward_depots="";$ward_number="";$ward_area="";$ward_population="";$ward_bins_no="";$ward_bins_vol="";
		$frequency_daily="";$frequency_days="";$frequency_twice="";$frequency_once="";$frequency_occasion="";
		$number_green="";$number_blue="";$number_black="";
		$lifting_manual="";$lifting_mech="";$lifting_method="";$lifting_transport="";$lifting_specify="";
		// Tab 5 //
		$waste_treatment="";$waste_process="";$waste_process_qty="";
		$transport_daily="";$transport_days="";$transport_twice="";$transport_once="";$transport_occasion="";$transport_qty="";$transport_percent="";
		$vehicles_animal="";$vehicles_tractors="";$vehicles_tipping="";$vehicles_non_tipping="";$vehicles_dumper="";$vehicles_refuse="";$vehicles_compactors="";$vehicles_others="";$vehicles_jcb="";
		$process_available="";$process_utilized="";$process_operation="";$process_construction="";$process_distance="";
		// Tab 6 //
							...
							<div class="tab-content">
									...
									<form name="myform1" id="myform1" class="submit1" method="post" compliance="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
										<table id="" class="table table-responsive">
											...
											<tr>
												...
												<td><input type="text" class="form-control text-uppercase" name="operator[name]" value="<?php echo $operator_name; ?>"></td>
												<td colspan="2"></td>
											</tr>
											<tr>
												<td colspan="4">8. Address of operator of the facility : </td>					
											</tr>
											<tr>
												<td>Street Name1 :</td>
												<td><input type="text" class="form-control text-uppercase" name="operator[sn1]" value="<?php echo $operator_sn1; ?>"></td>
												<td>Street Name2 :</td>
												<td><input type="text" class="form-control text-uppercase" name="operator[sn2]" value="<?php echo $operator_sn2; ?>"></td>
											</tr>
											<tr>
												<td>Village/Town :</td>
												<td><input type="text" class="form-control text-uppercase" name="operator[vill]" value="<?php echo $operator_vill; ?>"></td>
												<td>District :</td>
												<td><input type="text" class="form-control text-uppercase" name="operator[dist]" value="<?php echo $operator_dist; ?>"></td>
											</tr>
											<tr>
												<td>Pin Code :</td>
												<td><input type="text" class="form-control text-uppercase" name="operator[pin]" validate="pincode" maxlength="6" value="<?php echo $operator_pin; ?>" ></td>
												<td>Mobile No. :</td>
												<td><input type="text" class="form-control text-uppercase" name="operator[mobile]" validate="mobileNumber" maxlength="10" value="<?php echo $operator_mobile; ?>" ></td>
											</tr>
											<tr>
											...
											<tr>
												<td colspan="4">10. Details of officer in-charge of the facility : </td>		
											</tr>
											<tr>
												<td>Phone No. : </td>
								...
								<div id="table2" class="tab-pane <?php echo $tabbtn2; ?>" role="tabpanel">
									<form name="myform1" class="myform1 submit1" method="post"  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
										<table class="table table-responsive table-bordered">
											<tr>
												<td width="25%">11. Number of households in the city/town : </td>
												<td width="25%"><input type="text" class="form-control text-uppercase" name="household_no" value="<?php echo $household_no; ?>"></td>
												<td width="25%">12. Number of non-residential premises in the city : </td>
												<td width="25%"><input type="text" class="form-control text-uppercase" name="premise_no" value="<?php echo $premise_no; ?>"></td>
											</tr>
											<tr>
												<td colspan="2">13. Number of election/ administrative wards in the city/town : </td>
												<td><input type="text" class="form-control text-uppercase" name="election_no" value="<?php echo $election_no; ?>"></td>
												<td></td>
											</tr>
											<tr>
												<td colspan="4">14. Quantity of Solid waste : </td>
											</tr>
											<tr>
											...
											<tr>
												<td colspan="2">(e) Quantity of solid waste disposed at landfill : </td>
											...
											<tr>
												<td colspan="4">15. Status of Solid Waste Management (SWM) service : </td>
											</tr>
											<tr>
												<td colspan="2">(a) Segregation and storage of waste at source : </td>
												<td><input type="text" class="form-control text-uppercase" name="source" value="<?php echo $source;?>"></td>
												<td></td>
											</tr>
											<tr>
											...
											<tr>
												<td colspan="4">16. Door to Door Collection of solid waste : </td>
											</tr>
											<tr>
								...
								<div id="table3" class="tab-pane <?php echo $tabbtn3; ?>" role="tabpanel">
									<form name="myform1" class="myform1 submit1" method="post"  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
										<table class="table table-responsive table-bordered">
											<tr>
												<td width="25%">17. Length of roads, streets, lanes, bye-lanes in the city that need to be cleaned (in km) : </td>
												<td width="25%"><input type="text" name="length" class="form-control text-uppercase" value="<?php echo $length; ?>"></td>
												<td width="25%"></td>
												<td width="25%"></td>
											</tr>
											<tr>
												<td colspan="4">18. Frequency of street sweepings and percentage of population covered : </td>
											</tr>
											<tr>
												<td colspan="4">
													<table class="table table-responsive table-bordered">
											...
											<tr>
												<td colspan="4">20. Secondary Waste Storage facilities : </td>
											</tr>
											<tr>
								...
								<div id="table4" class="tab-pane <?php echo $tabbtn4; ?>" role="tabpanel">
									<form name="myform1" class="myform1 submit1" method="post"  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
										<table class="table table-responsive table-bordered">
											<tr>
												<td width="25%">22. Ward wise details of waste storage depots (Please attach) : </td>
											...
											<tr>
												<td colspan="4">25. Give frequency of collection of waste from the depots : </td>
											</tr>
											<tr>
											...
											<tr>
												<td colspan="4">26. Whether lifting of solid waste from storage depots is manual or mechanical. Give percentage : </td>
											</tr>
											<tr>
											...
											<tr>
												<td>27. Whether solid waste is lifted from door to door and transported to treatment plant directly in a segregated form ? <span class="mandatory_field">*</span></td>
												<td>
								...
								<div id="table5" class="tab-pane <?php echo $tabbtn5; ?>" role="tabpanel">
									<form name="myform1" class="myform1 submit1" method="post"  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
										<table class="table table-responsive table-bordered">
											...
											<tr>
												<td width="25%">30. (b) Quantity of waste transported each day : </td>
												...
												<td width="25%">30. (c) Percentage of total waste transported daily (%) : </td>
											...
											<tr>
												<td>32. Whether solid waste is processed ? <span class="mandatory_field">*</span></td>
												<td>
											...
											<tr>
												<td>33. (a) Land(s) available with the local body for waste processing (in Hectares): </td>
								...
								<div id="table6" class="tab-pane <?php echo $tabbtn6; ?>" role="tabpanel">
									<form name="myform1" class="myform1 submit1" method="post"  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
										<table class="table table-responsive table-bordered">
											<tr>
												<td colspan="4">34. Details of technologies adopted : </td>					
											</tr>
											<tr>
											...
											<tr>
												<td width="25%">35. (a) Combustible waste supplied to cement plant : </td>
								...
								<div id="table7" class="tab-pane <?php echo $tabbtn7; ?>" role="tabpanel">
									<form name="myform1" class="myform1 submit1" method="post"  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
										<table class="table table-responsive table-bordered">
											<tr>
												<td width="25%">36. (a) Solid waste disposal facilities : </td>
											...
											<tr>
												<td>37. Whether an Action Plan has been prepared for improving solid waste management practices in the city ? </td>
												<td>
											...
											<tr>
												<td colspan="4">38. What separate provisions are made for : (Attach details on Proposals, Steps taken) </td>
											</tr>
											<tr>
											...
											<tr>
												<td colspan="2">40. How many slums are identified and whether these are provided with Solid Waste Management facilities ? </td>
												<td>
											...
											<tr>
												<td colspan="3">43. Mention briefly, if any innovative idea is implemented to tackle a problem related to solid waste, which could be replicated by other local bodies : </td>
											...
											<tr>
												...
												<td colspan="2" align="right">Signature of Operator : <strong><?php echo strtoupper($key_person)?></strong></td>
											</tr>
											<tr>
												<td class="text-center" colspan="4">
