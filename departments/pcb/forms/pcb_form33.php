...
if($q->num_rows<1){	 
	...
	if($p->num_rows>0){
		...
		if(!empty($results["ind_work"])){
			...
			$ind_work_one="";$ind_work_two="";$ind_work_round="";
		}
		##### PART II ######
						...
						<div class="panel-body">
							...
							<div class="tab-content">
								...
								<table id="" class="table table-responsive">
									...
									<tr>
									     <td width="25%">Name:</td>
									     <td width="25%"><input type="text" name="occupier_add[name]" validate="letters" value="<?php echo $occupier_add_name; ?>" class="form-control text-uppercase"></td>
									...
									<tr>
										<td colspan="4">
											<table name="objectTable2" class=" table table-responsive table-bordered text-center " id="objectTable2" >
												...
												<tr>
													<td><input readonly id="txttA<?php echo $count;?>" class="form-control text-uppercase"; value="<?php echo $row_2["sl_no"]; ?>" name="txttA<?php echo $count;?>" size="1"></td>
													<td><input  id="txttB<?php echo $count;?>" class="form-control text-uppercase"; value="<?php echo $row_2["particulars"]; ?>" name="txttB<?php echo $count;?>" size="20"></td>
													<td><input value="<?php echo $row_2["nature"]; ?>" pattern="[a-zA-Z0-9.\s]+" title="No special characters are allowed except Dot" id="txttC<?php echo $count;?>" class="form-control text-uppercase"; name="txttC<?php echo $count;?>"></td>				
													<td><input value="<?php echo $row_2["qty"]; ?>" id="txttD<?php echo $count;?>" class="form-control text-uppercase"; name="txttD<?php echo $count;?>"></td>
													<td>
													<select  id="txttE<?php echo $count;?>" name="txttE<?php echo $count;?>" class="form-control text-uppercase">
														<option value='' >Select unit</option>
														<option <?php if($row_2["unit"]=="MT") echo "selected"; ?> value='MT' >in metric tonnes / month</option>
														<option <?php if($row_2["unit"]=="K") echo "selected"; ?> value='K' >in kl / month</option>
														<option <?php if($row_1["unit"]=="KG") echo "selected"; ?> value='KG' >in kg / month</option>
													</select></td>
												</tr>	
												<?php $count++; } 
									...
									<tr>
										...
										<td>(b) Whether the industry works:<span class="mandatory_field">*</span></td>
										<td>
								...
								<div id="table2" class="tab-pane <?php echo $tabbtn2; ?>" role="tabpanel">
									...
									<table id="" class="table table-responsive">
										...
										<tr>
											...
											<td colspan="2">
												<label class="radio-inline"><input type="radio" name="is_generator" value="Y"  <?php if(isset($is_generator) && $is_generator=='Y') echo 'checked'; ?> /> Yes</label>
									...
									<table id="is_generator_yes" class="table table-responsive">
												...
												<table name="objectTable3" class=" table table-responsive table-bordered text-center "id="objectTable3" >
													...
													<tr>
														...
														<select id="txxtE<?php echo $count;?>" name="txxtE<?php echo $count;?>" class="form-control text-uppercase">
															...
															<option <?php if($row_3["unit"]=="KG") echo "selected"; ?> value='KG' >in kg / month</option>
														</select></td>
													</tr>	
													<?php $count++; } 
													}else{	?>
										...
										<tr>
											<td colspan="2">(b) Process description including process flow sheet indicating inputs and outputs (raw materials, chemicals, products, by-products, wastes, emissions, waste water etc.) </td>
											<td colspan="2">Upload later in Upload Section</td>
										</tr>
										<tr>
												...
												<table name="objectTable4" class=" table table-responsive table-bordered text-center "id="objectTable4" >
													...
													<tr>
														...
														<select  id="textE<?php echo $count;?>" name="textE<?php echo $count;?>" class="form-control text-uppercase">
															...
															<option <?php if($row_4["unit"]=="KG") echo "selected"; ?> value='KG' >in kg / month</option>
														</select></td>
													</tr>	
													<?php $count++; } 
													}else{	?>
												...
												<table name="objectTable5" class=" table table-responsive table-bordered text-center "id="objectTable5" >
													...
													<tr>
														...
														<select  id="text1E<?php echo $count;?>" name="text1E<?php echo $count;?>" class="form-control text-uppercase">
															...
															<option <?php if($row_5["unit"]=="KG") echo "selected"; ?> value='KG' >in kg / month</option>
														</select></td>
													</tr>	
													<?php $count++; } 
													}else{	?>
								...
								<table id="" class="table table-responsive">
									...
									<tr>
										...
										<td colspan="2">
											<label class="radio-inline"><input type="radio" name="is_operator" value="Y"  <?php if(isset($is_operator) && $is_operator=='Y') echo 'checked'; ?> /> Yes</label>
											<label class="radio-inline"><input type="radio" name="is_operator"  value="N"  <?php if(isset($is_operator) && $is_operator=='N') echo 'checked'; ?>/> No</label></td>
									</tr>
								</table>
								<table id="is_operator_yes" class="table table-responsive">
									...
									<tr>
										<td >(i). Location of site with layout map: </td>
										<td >Upload later in Upload Section</td>
									...
									<tr>
										<td width="25%">(iii) The treatment processes and their capacities: </td>
										<td width="25%">Upload later in Upload Section</td>
										<td width="25%">(iv) Secured landfills:  </td>
										<td width="25%">Upload later in Upload Section</td>
									...
									<tr>
										...
										<td><textarea name="leachate" class="form-control text-uppercase" validate="textarea" maxlength="255"><?php echo $leachate; ?></textarea >255 Characters Only</td>
									</tr>
									<tr>
								...
								<table id="" class="table table-responsive">
									...
									<tr>
										...
										<td colspan="2">
											<label class="radio-inline"><input type="radio" name="is_recycler" value="Y"  <?php if(isset($is_recycler) && $is_recycler=='Y') echo 'checked'; ?> /> Yes</label>
											<label class="radio-inline"><input type="radio" name="is_recycler"  value="N"  <?php if(isset($is_recycler) && $is_recycler=='N') echo 'checked'; ?>/> No</label></td>
									</tr>
								</table>
								<table id="is_recycler_yes" class="table table-responsive">
									...
									<tr>
										...
										<table name="objectTable7" class=" table table-responsive table-bordered text-center" id="objectTable7" >
											...
											<tr>
												...
												<td><input value="<?php echo $row_7["nature"]; ?>" id="textC<?php echo $count;?>" name="textC<?php echo $count;?>" class="form-control text-uppercase"></td>
									...
									<tr>
										<td colspan="4">2. Installed capacity as per registration issued by the District Industries Centre or any other authorised Government agency. Provide copy: (Upload later in Upload Section) </td>
									</tr>
									<tr>
										<td width="25%">Quantity:</td>
										<td width="25%"><input type="text" name="ins_capacity[qty]" value="<?php echo $ins_capacity_qty; ?>" class="form-control text-uppercase"></td>	
										<td width="25%">Unit:</td>
										<td width="25%"><input type="text" name="ins_capacity[unit]" value="<?php echo $ins_capacity_unit; ?>" class="form-control text-uppercase"></td>	
									</tr>
									<tr>
									    <td>3. Provide details of secured storage of wastes including the storage capacity:</td>
									...
									<tr>
										<td>4. Process description including process flow sheet indicating equipment details, inputs and outputs (input wastes, chemicals, products, by-products, waste generated, emissions, waste water, etc.):</td>
												...
												<table name="objectTable8" class=" table table-responsive table-bordered text-center "id="objectTable8" >
													...
													<tr>
														...
														<select  id="txxtE<?php echo $count;?>" name="txxtE<?php echo $count;?>" class="form-control text-uppercase">
															...
															<option <?php if($row_8["unit"]=="KG") echo "selected"; ?> value='KG' >in kg / month</option>
														</select></td>
													</tr>	
													<?php $count++; } 
													}else{	?>
									...
									<tr>
										<td width="25%">6. Provide details of pollution control systems such as Effluent Treatment Plant, scrubbers, etc. including mode of disposal of waste:</td>
										<td width="25%"><textarea name="pcs_detail" class="form-control text-uppercase" validate="textarea" maxlength="255"><?php echo $pcs_detail; ?></textarea> 255 Characters Only</td>
										<td width="25%">7. Provide details of occupational health and safety measures: </td>
									   <td width="25%"><textarea name="health_details" class="form-control text-uppercase" validate="textarea" maxlength="255"><?php echo $health_details; ?></textarea>255 Characters Only</td>
									</tr>
									<tr>
									...
									<tr>
										<td>9. Arrangements for transportation of waste to the facility:</td>
