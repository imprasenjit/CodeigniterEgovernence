...
if($q->num_rows<1){	
	...
	if($p->num_rows>0){
		...
		if(!empty($results["dgset_items"])){
			...
			if(isset($dgset_items->a)) $dgset_items_a=$dgset_items->a; else $dgset_items_a="";
			if(isset($dgset_items->b)) $dgset_items_b=$dgset_items->b; else $dgset_items_b="";
			if(isset($dgset_items->c)) $dgset_items_c=$dgset_items->c; else $dgset_items_c="";
			if(isset($dgset_items->d)) $dgset_items_d=$dgset_items->d; else $dgset_items_d="";
		}else{
	...
	$form_id=$results["form_id"];
	/*$dg_set=$results["dg_set"];$from_year=$results["from_year"];$to_year=$results["to_year"];
	...
	if(!is_numeric($results["investment_cost"]) && !empty($results["investment_cost"])){
		$investment_cost=json_decode($results["investment_cost"]);
        if(isset($investment_cost->a)) $investment_cost_a=$investment_cost->a; else $investment_cost_a="";
        if(isset($investment_cost->b)) $investment_cost_b=$investment_cost->b; else $investment_cost_b="";
							...
							<div class="panel-body">
								...
								<div class="tab-content">
									...
									<form name="myform2" class="myform1 submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
										<!--<input type="hidden" value="<?php// echo $form_type; ?>" name="form_type" class="form-control text-uppercase">-->
										...
										<table class="table table-responsive table-bordered">
											...
											<tr>
												<td>Name</td>
												<td><input type="text" value="<?php echo strtoupper($key_person);?>" class="form-control text-uppercase" disabled></td>
												<td>Designation</td>
												<td><input type="text" value="<?php echo strtoupper($status_applicant);?>" class="form-control text-uppercase" disabled></td>
											</tr>
											<tr>
												<td>Street Name 1</td>
											...
											<tr>												
												...
												<td><input type="text" class="form-control text-uppercase" name="revenue_survey_no" placeholder="Revenue Survey Number or Plot Number" value="<?php echo strtoupper($revenue_survey_no);?>" required="required"></td>											
											</tr>
											<tr>
											...
											<tr>												
												...
												<td><input type="text" validate="jsonObj" name="plan_details[prn]" placeholder="Permission Reference No." value="<?php echo strtoupper($plan_details_prn);?>" class="form-control text-uppercase" ></td>
											...
											<tr>												
												...
												<td><input type="text" name="plan_details[ia]" placeholder="Name of Issuing Authority"" value="<?php echo strtoupper($plan_details_ia);?>" class="form-control text-uppercase" ></td>
											...
											<tr>
												<td>Name</td>
												<td><input type="text" validate="letters" class="form-control text-uppercase" value="<?php echo strtoupper($md_name);?>" placeholder="Name of Officer" name="md_name"></td>
												<td>Designation</td>
											...
											<tr>
												<td>Pincode</td>
												<td><input type="text" validate="pincode" maxlength="6" class="form-control text-uppercase" value="<?php echo strtoupper($m_p);?>" placeholder="Enter 6 digit pincode" name="md_address[pin]"></td>
												<td>Mobile</td>
												<td><input type="text" validate="mobileNumber" maxlength="10" class="form-control text-uppercase" value="<?php echo strtoupper($m_m);?>" placeholder="Enter 10 digit mobile number" name="md_address[mn]"></td>
											</tr>
											<tr>
												<td>Phone Number</td>
									...
									<form name="myform2" class="myform1 submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
										<table class="table table-responsive table-bordered">
											<tr>
												...
												<td colspan="2"><input type="text" class="form-control text-uppercase" name="investment_cost" placeholder="Gross capital investment" date-toogle="tooltip" title="Numbers Only" validate="onlyNumbers" value="<?php echo $investment_cost;?>"></td>	
											</tr>
											<tr>
											...
											<tr>
												...
												<td>
												<input type="text" validate="onlyNumbers" name="site_distance[a]" placeholder="Distance" date-toogle="tooltip" title="Number with 2 digits after decimal point" value="<?php echo $site_distance_a;?>" class="form-control text-uppercase">
											...
											<td colspan="4">
												<table name="objectTable1" class="table table-responsive table-bordered "id="objectTable1" >
													...
													<tr>
														...
														<td><input type="text" value="<?php echo $row_1["name"]; ?>" pattern="[a-zA-Z0-9.\s]+" title="No special characters are allowed except Dot" id="txtB<?php echo $count;?>" class="form-control text-uppercase"; name="txtB<?php echo $count;?>"></td>
														<td>
														...
														<td><input type="text" value="<?php echo $row_1["qty"]; ?>" id="txtD<?php echo $count;?>" class="form-control text-uppercase"; name="txtD<?php echo $count;?>" ></td>
														<td>
													...
													<tr>
														...
														<td><input type="text" id="txtB1" title="No special characters are allowed except Dot" pattern="[a-zA-Z0-9.\s]+" class="form-control text-uppercase";  placeholder="Name of product" name="txtB1"></td>					
														<td><select id="txtC1" name="txtC1" class="form-control text-uppercase">
															<option value='' >Select Type</option>
															<option value='P' >Product</option>
															<option value='B' >By-product</option>
														</select></td>
														<td><input type="text" id="txtD1" class="form-control text-uppercase"; placeholder="Quantity" name="txtD1"></td>
														<td>														
											...
											<tr>
												...
												<table name="objectTable2" class="table table-responsive table-bordered " id="objectTable2" >
													...
													<?php
														...
														if($num>0){
														 ...
														 <tr>
															...
															<td><input type="text" value="<?php echo $row_1["name"]; ?>" id="textB<?php echo $count;?>" class="form-control text-uppercase" size="20" name="textB<?php echo $count;?>"></td>
															<td>
													...
													<tr>
													  ...
													  <td><input type="text" id="textB1" size="20" class="form-control text-uppercase" placeholder="Name of the raw material" name="textB1"></td>					
													  ...
													  <td><input type="text"  id="textD1" size="15" class="form-control text-uppercase" placeholder="Quantity" name="textD1"></td>
											...
											<tr>
												<td class="text-center" colspan="4">
													<a href="form2.php?tab=1" class="btn btn-primary text-bold">Go Back & Edit</a>
									...
									<div id="table3" class="tab-pane <?php echo $tabbtn3; ?>" role="tabpanel">
										...
										<table class="table table-responsive table-bordered">
											...
											<tr>
												...
												<td style="width:25%"><input type="text" validate="decimal" required="required" name="wc_values[a]" placeholder="example : 23.00" value="<?php echo $wc_values_a; ?>" class="form-control text-uppercase wc_sum"></td>
												<td style="width:25%">(ii) Domestic purpose</td>
												<td style="width:25%"><input type="text" validate="decimal" name="wc_values[b]" placeholder="example : 23.00" value="<?php echo $wc_values_b; ?>" class=" form-control text-uppercase wc_sum"></td>
											</tr>
											<tr>
												<td >(iii) Processing whereby water gets polluted and the pollutants are easily biodegradable</td>
												<td><input type="text" validate="decimal" name="wc_values[c]" placeholder="example : 23.00" value="<?php echo $wc_values_c; ?>" class="form-control text-uppercase wc_sum"></td>
												<td>(iv) Processing whereby water gets polluted and the pollutants are not easily bio-degradable and are toxic</td>
												<td><input type="text" validate="decimal" name="wc_values[d]" placeholder="example : 23.00" value="<?php echo $wc_values_d; ?>" class=" form-control text-uppercase wc_sum"></td>
											</tr>
											<tr>
												<td >(v) Others such as agriculture, gardening etc. (specify)</td>
												<td><input type="text" validate="decimal" name="wc_values[e]" placeholder="example : 23.00" value="<?php echo $wc_values_e; ?>" class="form-control text-uppercase wc_sum"></td>
												<td></td>
												<td></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td><input type="text" name="water_source[b]" placeholder="Name of the authority" value="<?php echo $water_source_b;?>" class="form-control text-uppercase"></td>
											</tr>
											<tr>
												<td>Quantity permitted (in m3/day)</td>
												<td><input type="text" name="water_source[c]" validate="decimal" placeholder="example : 23.00"value="<?php echo $water_source_c;?>" class="form-control text-uppercase"></td>
											</tr>
											<tr>
											...
											<tr>
												<td>(i) Domestic </td>
												<td><input type="text" name="ww_qty[a]" validate="decimal" placeholder="example : 23.00" value="<?php echo $ww_qty_a;?>" class="form-control text-uppercase"></td>
												<td>(ii) Industrial</td>
												<td><input type="text" name="ww_qty[b]" validate="decimal" placeholder="example : 23.00" value="<?php echo $ww_qty_b;?>" class="form-control text-uppercase"></td>
											</tr>
											<tr>
												<td>(iii) Process </td>
												<td><input type="text" name="ww_qty[c]" validate="decimal" placeholder="example : 23.00" value="<?php echo $ww_qty_c;?>" class="form-control text-uppercase"></td>
												<td>(iv) Washings </td>
												<td><input type="text" name="ww_qty[d]" validate="decimal" placeholder="example : 23.00" value="<?php echo $ww_qty_d;?>" class="form-control text-uppercase"></td>
											</tr>
											<tr>
												<td>(v) Boiler Blowdown </td>
												<td><input type="text" name="ww_qty[e]" validate="decimal" placeholder="example : 23.00" value="<?php echo $ww_qty_e;?>" class="form-control text-uppercase"></td>
												<td>(vi) Cooling water blowdown </td>
												<td><input type="text" name="ww_qty[f]" validate="decimal" placeholder="example : 23.00" value="<?php echo $ww_qty_f;?>" class="form-control text-uppercase"></td>
											</tr>
											<tr>
												<td>(vii) DM Plant / Softening Plant washings</td>
												<td><input type="text" name="ww_qty[g]" validate="decimal" placeholder="example : 23.00" value="<?php echo $ww_qty_g;?>" class="form-control text-uppercase"></td>
												<td></td>
												<td></td>
											</tr>
											<tr>
												<td>19. Water budget calculations accounting for difference between water consumption and effluent generated. :</td>
												<td><input type="text" name="budget_calc[a]" placeholder="Water budget calculation"value="<?php echo $budget_calc_a; ?>" class="form-control text-uppercase"></td>
												<td>Upload later in upload section</td>
											</tr>
											
											<tr>
												<td colspan="2">20. Present treatment of sewage / canteen effluent (Give sizes / capacities of treatment units).	</td>
												<td colspan="2"><input type="text" name="sewage_treatment" placeholder="sizes / capacities of treatment units"value="<?php echo $sewage_treatment; ?>" class="form-control text-uppercase"></td>
											</tr>
											<tr>
												<td class="text-center" colspan="4">
													<a href="form2.php?tab=2" class="btn btn-primary text-bold">Go Back & Edit</a>
									...
									<div id="table4" class="tab-pane <?php echo $tabbtn4; ?>" role="tabpanel">
										...
										<table class="table table-responsive table-bordered">
											...
											<tr>
												...
												<td><input type="text" name="disposal_mode[a]" placeholder="Mode of disposal" value="<?php echo $disposal_mode_a; ?>" class="form-control text-uppercase"><input type="text" name="disposal_mode[b]" value="<?php echo $disposal_mode_b; ?>" placeholder="Name of river" class="form-control text-uppercase">	</td>
												
												<td>(ii) into creek / estuary (Name of creek/estuary)</td>
												<td><input type="text" name="disposal_mode[c]" placeholder="Mode of disposal" value="<?php echo $disposal_mode_c; ?>" class="form-control text-uppercase"><input type="text" name="disposal_mode[d]" value="<?php echo $disposal_mode_d; ?>" placeholder="Name of creek/estuary" class="form-control text-uppercase"></td>
											</tr>
											<tr>
												<td>(iii) into sea (Name of Sea)</td>
												<td><input type="text" name="disposal_mode[e]" placeholder="Mode of disposal" value="<?php echo $disposal_mode_e; ?>" class="form-control text-uppercase"><input type="text" name="disposal_mode[f]" value="<?php echo $disposal_mode_f; ?>" placeholder="Name of sea" class="form-control text-uppercase"></td>
												
												<td>(iv) into drain / sewer (Owner of sewer) </td>
												<td><input type="text" name="disposal_mode[g]" placeholder="Mode of disposal" value="<?php echo $disposal_mode_g; ?>" class="form-control text-uppercase"><input type="text" name="disposal_mode[h]" value="<?php echo $disposal_mode_h; ?>" placeholder="Owner of sewer" class="form-control text-uppercase"></td>
											</tr>
											<tr>
											...
											<tr>
												<td class="text-center" colspan="4">
													<a href="form2.php?tab=3" class="btn btn-primary text-bold">Go Back & Edit</a>
									...
									<form name="myform2" class="myform1 submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">									
										<table class="table table-responsive table-bordered">
												...
												<td colspan="4">
												 <table class="table table-responsive table-bordered">
													...
													<tr>
													  ...
													  <td><input type="text" class="form-control text-uppercase" name="fc[tpd][cl]"placeholder="Example: 23.00" value="<?php echo $fc_tpd_cl; ?>" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="fc[tpd][ls]" placeholder="Example: 23.00"value="<?php echo $fc_tpd_ls; ?>" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="fc[tpd][fo]" placeholder="Example: 23.00"value="<?php echo $fc_tpd_fo; ?>" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="fc[tpd][ng]" placeholder="Example: 23.00"value="<?php echo $fc_tpd_ng; ?>" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="fc[tpd][ot]" placeholder="Example: 23.00"value="<?php echo $fc_tpd_ot;?>"   validate="decimal"  /></td>
													</tr>
													<tr>
													  <td>Calorific value</td>
													  <td><input type="text" class="form-control text-uppercase" name="fc[cv][cl]" placeholder="Example: 23.00"value="<?php echo $fc_cv_cl; ?>" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="fc[cv][ls]"placeholder="Example: 23.00" value="<?php echo $fc_cv_ls; ?>"  validate="decimal"/></td>
													  <td><input type="text" class="form-control text-uppercase" name="fc[cv][fo]" placeholder="Example: 23.00"value="<?php echo $fc_cv_fo; ?>"  validate="decimal"/></td>
													  <td><input type="text" class="form-control text-uppercase" name="fc[cv][ng]" placeholder="Example: 23.00"value="<?php echo $fc_cv_ng; ?>" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="fc[cv][ot]" placeholder="Example: 23.00"value="<?php echo $fc_cv_ot; ?>" validate="decimal" /></td>
													</tr>
													<tr>
													  <td><p>Ash content % </p></td>
													  <td><input type="text" class="form-control text-uppercase" name="fc[ac][cl]" placeholder="Example: 23.00"value="<?php echo $fc_ac_cl; ?>" validate="decimal"/></td>
													  <td><input type="text" class="form-control text-uppercase" name="fc[ac][ls]" placeholder="Example: 23.00"value="<?php echo $fc_ac_ls; ?>" validate="decimal"/></td>
													  <td><input type="text" class="form-control text-uppercase" name="fc[ac][fo]" placeholder="Example: 23.00"value="<?php echo $fc_ac_fo; ?>"  validate="decimal"/></td>
													  <td><input type="text" class="form-control text-uppercase" name="fc[ac][ng]" placeholder="Example: 23.00"value="<?php echo $fc_ac_ng; ?>" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="fc[ac][ot]" placeholder="Example: 23.00"value="<?php echo $fc_ac_ot; ?>"  validate="decimal" /></td>
													</tr>
													<tr>
													  <td><p>Sulphur content % </p></td>
													  <td><input type="text" class="form-control text-uppercase" name="fc[sc][cl]" placeholder="Example: 23.00"value="<?php echo $fc_sc_cl; ?>" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="fc[sc][ls]" placeholder="Example: 23.00"value="<?php echo $fc_sc_ls; ?>" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="fc[sc][fo]" placeholder="Example: 23.00"value="<?php echo $fc_sc_fo; ?>" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="fc[sc][ng]" placeholder="Example: 23.00"value="<?php echo $fc_sc_ng; ?>" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="fc[sc][ot]" placeholder="Example: 23.00"value="<?php echo $fc_sc_ot; ?>"  validate="decimal"  /></td>
													</tr>
													<tr>
													  <td>Other  (specify) <input type="text" class="form-control text-uppercase" name="fc[ot][sp2]" value="<?php echo $fc_ot_sp2; ?>" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="fc[ot][cl]" placeholder="Example: 23.00"value="<?php echo $fc_ot_cl; ?>" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="fc[ot][ls]" placeholder="Example: 23.00"value="<?php echo $fc_ot_ls; ?>" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="fc[ot][fo]" placeholder="Example: 23.00"value="<?php echo $fc_ot_fo; ?>" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="fc[ot][ng]" placeholder="Example: 23.00"value="<?php echo $fc_ot_ng; ?>" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="fc[ot][ot]" placeholder="Example: 23.00"value="<?php echo $fc_ot_ot; ?>" validate="decimal" /></td>
													</tr>
												  </table>
												</td>
											</tr>
											...
											<tr>
												...
												<table  class="table table-responsive table-bordered">        
													...
													<tr>
													  ...
													  <td><input type="text" class="form-control text-uppercase" name="sd[fq][sn1]" id="textfield124" placeholder="in TPD / KLD"value="<?php echo $sd_fq_sn1; ?>" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[fq][sn2]" id="textfield125" placeholder="in TPD / KLD"value="<?php echo $sd_fq_sn2; ?>" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[fq][sn3]" id="textfield126" placeholder="in TPD / KLD"value="<?php echo $sd_fq_sn3; ?>"  /></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[fq][sn4]" id="textfield127" placeholder="in TPD / KLD"value="<?php echo $sd_fq_sn4; ?>"  /></td>
													</tr>
													<tr>
													...
													<tr>
													  ...
													  <td><input type="text" class="form-control text-uppercase" name="sd[gl][sn1]" id="textfield136" placeholder="in meters"value="<?php echo $sd_gl_sn1; ?>" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[gl][sn2]" id="textfield137" placeholder="in meters"value="<?php echo $sd_gl_sn2; ?>" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[gl][sn3]" id="textfield138" placeholder=" in meters"value="<?php echo $sd_gl_sn3; ?>" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[gl][sn4]" id="textfield139" placeholder="in meters" value="<?php echo $sd_gl_sn4; ?>" validate="decimal" /></td>
													</tr>
													<tr>
													  <td>Diameter / size, in meters </td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[ds][sn1]" id="textfield140" placeholder="in meters"value="<?php echo $sd_ds_sn1; ?>" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[ds][sn2]" id="textfield141" placeholder="in meters"value="<?php echo $sd_ds_sn2; ?>" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[ds][sn3]" id="textfield142" placeholder="in meters"value="<?php echo $sd_ds_sn3; ?>"  validate="decimal"/></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[ds][sn4]" id="textfield143" placeholder="in meters"value="<?php echo $sd_ds_sn4; ?>" validate="decimal" /></td>
													</tr>
													<tr>
													  <td>Gas quantity, Nm3 /  hr</td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[gq][sn1]" id="textfield144" placeholder="in Nm3"title="Please enter a decimal value"value="<?php echo $sd_gq_sn1; ?>" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[gq][sn2]" id="textfield145" placeholder="in Nm3"title="Please enter a decimal value"value="<?php echo $sd_gq_sn2; ?>" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[gq][sn3]" id="textfield146" placeholder="in Nm3"title="Please enter a decimal value"value="<?php echo $sd_gq_sn3; ?>"  /></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[gq][sn4]" id="textfield147" placeholder="in Nm3"title="Please enter a decimal value"value="<?php echo $sd_gq_sn4; ?>" /></td>
													</tr>
													<tr>
													  <td>Gas temperature, (<sup>o</sup>C) </td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[gt][sn1]" id="textfield148" placeholder="in degree celsius"value="<?php echo $sd_gt_sn1; ?>"  validate="decimal"  onchange="number(this.id)" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[gt][sn2]" id="textfield149" placeholder="in degree  celsius"<?php echo $sd_gt_sn2; ?>"  validate="decimal"  onchange="number(this.id)" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[gt][sn3]" id="textfield150" placeholder="in degree celcious"<?php echo $sd_gt_sn3; ?>" validate="decimal"  onchange="number(this.id)" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[gt][sn4]" id="textfield151" placeholder="in degree celcious"value="<?php echo $sd_gt_sn4; ?>"  validate="decimal" onchange="number(this.id)" /></td>
													</tr>
													<tr>
													  <td>Exit gas velocity, m / sec</td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[gv][sn1]" id="textfield152"placeholder="in m/sec"title="Please enter a decimal value" value="<?php echo $sd_gv_sn1; ?>" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[gv][sn2]" id="textfield153"placeholder="in m/sec" value="<?php echo $sd_gv_sn2; ?>" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[gv][sn3]" id="textfield154" placeholder="in m/sec"value="<?php echo $sd_gv_sn3; ?>" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[gv][sn4]" id="textfield155" placeholder="in m/sec"value="<?php echo $sd_gv_sn4; ?>" validate="decimal" /></td>
													</tr>
													<tr>
											...
											<tr>
												<td  style="width:75%" colspan="3">28. Do you have adequate facility for collection of samples of emissions in the form of port holes, platform, ladder etc. as per Central Board Publication "Emission Regulations Part-III"(December 1985)<span class="mandatory_field">*</span></td>
												<td>
											...
											<tr>
												<td class="text-center" colspan="4">
													<a href="form2.php?tab=4" class="btn btn-primary text-bold">Go Back & Edit</a>
									...
									<div id="table6" class="tab-pane <?php echo $tabbtn6; ?>" role="tabpanel">
										...
										<table class="table table-responsive">
											...
											<tr>
												<td colspan="2" rowspan="2">30. (a) Whether the unit is generating hazardous  waste as defined in the Hazardous Waste (Management and handling)  Rules, 1989, as amended.<span class="mandatory_field">*</span></td>
											...
											<tr>
												...
												<td colspan="2"><input type="text" name="haz_qty" placeholder="Quantity of hazardous waste"value="<?php echo $haz_qty;?>" class="form-control text-uppercase"/></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td colspan="2"><input type="text" name="storage_mode" placeholder="describe area, location and methodology"value="<?php echo $storage_mode; ?>"  class="form-control text-uppercase">	</td>
											</tr>
											<tr>
												<td colspan="2">35. Present treatment of hazardous waste,  if any(give type and capacity of treatment units)</td>
												<td colspan="2"><input type="text" name="haz_pres_treatment" placeholder="give type and capacity of treatment units"value="<?php echo $haz_pres_treatment; ?>" class="form-control text-uppercase">	</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td><input type="text" name="haz_qty_dispose[a]" id="textfield176" placeholder="Quantity of hazardous waste"value="<?php echo $haz_qty_dispose_a; ?>" class="form-control text-uppercase">	</td>
												<td >(ii) Outside the factory (Specify location and enclose copies of agreement)	</td>
												<td><input type="text" name="haz_qty_dispose[b]" id="textfield176"placeholder="Quantity of hazardous waste"  value="<?php echo $haz_qty_dispose_b; ?>" class="form-control text-uppercase">	</td>
											</tr>
											<tr>
											...
											<tr>
												<td class="text-center" colspan="4">
													<a href="form2.php?tab=5" class="btn btn-primary text-bold">Go Back & Edit</a>
									...
									<div id="table7" class="tab-pane <?php echo $tabbtn7; ?>" role="tabpanel">
										...
										<table class="table table-responsive table-bordered">
											...
											<tr>
												<td rowspan="4" colspan="3">40. Which of the pollution control items are connected to D.G. set (captive power source) to ensure their running in the event of normal power failure ?</td>
												<td><input type="text" name="dgset_items[a]" value="<?php echo $dgset_items_a; ?>" placeholder="" class="form-control text-uppercase"></td>												
											</tr>
											<tr>
												<td><input type="text" name="dgset_items[b]" value="<?php echo $dgset_items_b; ?>" placeholder="" class="form-control text-uppercase"></td>
											</tr>
											<tr>
												<td><input type="text" name="dgset_items[c]" value="<?php echo $dgset_items_c; ?>" placeholder="" class="form-control text-uppercase"></td>												
											</tr>
											<tr>
												<td><input type="text" name="dgset_items[d]" value="<?php echo $dgset_items_d; ?>" placeholder="" class="form-control text-uppercase"></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td colspan="2" ><input type="text" name="haz_chemicals" placeholder="details of chemicals and quantities"value="<?php echo $haz_chemicals; ?>" class="form-control text-uppercase"/></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td>Is it updated ? <span class="mandatory_field">*</span></td>
                                          ...
                                          <tr>
                                                ...
                                                <td><label class="checkbox-inline"><input type="radio" value="Y" <?php if($dg_set=="Y" || $dg_set=="") echo "checked";?> name="dg_set" >Yes</label>
											...
											<tr>
												<td class="text-center" colspan="4">
													<a href="form2.php?tab=6" class="btn btn-primary text-bold">Go Back & Edit</a>
