									...
									<div id="table6" class="tab-pane <?php echo $tabbtn6; ?>" role="tabpanel">
										...
										<table class="table table-responsive">
											...
											<tr>
												...
												<td colspan="2"><label class="radio-inline"><input type="radio" value="Y" <?php if($is_hazardous=="Y") echo "checked";?> id="inlineRadio1" checked name="is_hazardous"> Yes </label>
											...
											<tr>
												<td colspan="2"><input type="text" value="<?php if($is_hazardous=="Y") echo $haz_cat_no; else "";?>" <?php if($is_hazardous=="N") echo "disabled='disabled'";?> name="haz_cat_no" id="haz_cat_no" placeholder="Category Number" class="form-control text-uppercase"/></td>
											</tr>									
											<tr>
