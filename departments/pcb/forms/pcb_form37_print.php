...
if(!empty($results["uain"])){
    ...
    <div style="text-align:center"><h4>'.$form_name.'</h4></div>  		
	  ...
	  <table class="table table-bordered table-responsive">
		    ...
		    <tr>
                <td colspan="2" style="text-align: left"><b>I. Producer</b></td>
            </tr> 
			<tr>
                <td colspan="2" style="text-align: center"><b>Part - A : General</b></td>
            </tr>
	        <tr>
				...
				<table class="table table-bordered table-responsive">
					...
					while($row_1=$part1->fetch_array()){
						...
						<tr align="center">
							...
							<td align="center">'.strtoupper($row_1["type"]).'</td>
	        ...
	        <tr>
  	        ...
  	        <tr>
    	        <td>5. Status of compliance with these rules- Thickness – fifty micron</td>
    	        <td>'.strtoupper($is_compliance).'</td>
    	    </tr>
  	        <tr>
  	            <td colspan="2" style="text-align: center"><b>PART - B<br/>PERTAINING TO LIQUID EFFLUENT AND GASEOUS EMISSION</b></td>
            </tr> 
            <tr>
		        <td>6.(a) Does the unit have a valid consent under the Water (Prevention and Control of pcb) Act, 1974 (6 of 1974) <br/>If yes, attach a copy</td>	
			...
			<tr>
                <td colspan="2" style="text-align: left"><b>II Brand Owners :</b></td>
            </tr> 
			<tr>
                <td colspan="2" style="text-align: center"><b>Part - A : General</b></td>
            </tr>
				...
				<table class="table table-bordered table-responsive">
					...
					while($row_3=$part3->fetch_array()){
						...
						<tr align="center">
								...
								<td align="center">'.strtoupper($row_3["name"]).'</td>
								<td align="center">'.strtoupper($row_3["type"]).'</td>
								<td align="center">'.strtoupper($row_3["quantum"]).'</td>
						</tr>';
					}
					$printContents=$printContents.'
				</table>
				...
				<table class="table table-bordered table-responsive">
					...
					while($row_4=$part4->fetch_array()){
						...
						<tr align="center">
							...
							<td align="center">'.strtoupper($row_4["raw"]).'</td>
							<td align="center">'.strtoupper($row_4["quantum"]).'</td>
						</tr>';
					}
					$printContents=$printContents.'
				</table>
