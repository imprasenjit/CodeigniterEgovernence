						...
						<div class="panel-body">
							...
							<form name="myform1" id="myformBT1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data" >
								<table class="table table-responsive">
									...
									<tr>
										<td colspan="4">(c) In case of renewal, previous registration number and date ofregistration</td>
									</tr>
									<tr>
										<td>Previous Registration Number</td>
		                            <td><input type="text" class="form-control text-uppercase" name="pre_reg[no]" value="<?php echo $pre_reg_no;?>"></td>
										<td>Date</td>
										<td><input type="text" class="dob form-control text-uppercase" readonly="readonly" name="pre_reg[dt]" value="<?php echo $pre_reg_dt;?>"></td>
									</tr>
									<tr>
										...
										<td>
											<label class="radio-inline"><input type="radio" name="is_unit_registered" value="Y"  <?php if(isset($is_unit_registered) && $is_unit_registered=='Y') echo 'checked'; ?> required="required"/> Yes</label>
											<label class="radio-inline"><input type="radio" name="is_unit_registered"  value="N" <?php if(isset($is_unit_registered) && $is_unit_registered=='N' && $is_unit_registered=='') echo 'checked'; ?>/> No</label>
										</td>
									</tr>									
									<tr>
