...
$table_name=getTableName($dept,$form);
	...
	if($q->num_rows>0){
		...
		##### PART II ######
		$is_generator=$results['is_generator'];
		if($is_generator=="Y"){
			$is_generator="YES";
		}else{
			$is_generator="NO";
		}	
		$env_details=$results['env_details'];
...
if(!empty($results["uain"])){
    ...
    <table class="table table-bordered table-responsive">  
		...
		<tr>
       	...
       	<tr>
			<td valign="top">(b) Name of the occupier of the facility or operator of disposal facility with designation,Tel, Fax and e-mail:</td>
			<td>
				<table class="table table-bordered table-responsive"> 
					<tr>
							<td>Name</td>
