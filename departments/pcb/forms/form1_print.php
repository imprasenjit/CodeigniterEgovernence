...
<table class="table table-bordered table-responsive">
  ...
  <tr>
    <td valign="top">1. Name, designation, office address with  telephone number, e-mail of the Applicant</td>
    <td>
    	<table class="table table-bordered table-responsive">
      		<tr>
        			<td>Name</td>
  	...
  	<tr>
    	<td valign="top">2. (a) Name and location of the industrial unit / premises for which the application is made. (Give revenue Survey Number /plot number, name of Taluka and District also telephone number)
      	&nbsp;</td>
    	<td>
    		<table class="table table-bordered table-responsive">
      		<tr>
  	...
  	<tr>
		<td valign="top">(b) Details of the planning permission obtained from the local body / Town and Country Planning authority / metropolitan development authority / designate authority</td>
		<td>
		<table class="table table-bordered table-responsive">
      		<tr>
  	...
  	<tr>
    	<td valign="top">(c) Name  of the local body under whose jurisdiction  the unit is located and name of  the licence issuing authority</td>
    	<td>
    		<table class="table table-bordered table-responsive">
      		<tr>
  	...
  	<tr>
    	<td valign="top">3. Names, addresses with telephone number of Managing  Director/Managing Partner and officer responsible for matters connected with  pollution control  and / or hazardous waste disposal.
      	&nbsp;</td>
    	<td>
    		<table class="table table-bordered table-responsive">
      		<tr>
	...
	<tr>
    	<td valign="top" >(b) If  yes, give the number and date of registration.</td>
...
<b>Part B : Waste water aspects</b>
  ...
  <table class="table table-bordered table-responsive">
  	<tr>
   	<td width="50%">16. Water  consumption for different uses (in m3 / day)</td>
   ...
   <tr>
	...
	<tr><td colspan="2">
      <table class="table table-bordered table-responsive">
        <tr>
          <td>(i)  Domestic</td>
          <td>'.strtoupper($ww_qty_a).'</td>
		  <td>(v) Boiler Blowdown</td>
          <td>'.strtoupper($ww_qty_e).'</td>
        </tr>
        <tr>
          <td>(ii)  Industrial</td>
...
<table class="table table-bordered table-responsive">
    ...
    <td colspan="2">26. Fuel consumption : 
     <table class="table table-bordered table-responsive">
        <tr>
          ...
          <td>Furnace Oil</td>
          <td>Natural gas</td>
          <td>Others(Specify) : '.$fc_ot_sp1.'</td>
        </tr>
        <tr>
  ...
  <tr>
    <td  width="50%">27.(B) Whether any release of odoriferous compounds such as  Mercaptans, Phorate etc. are coming out</td>
...
<table class="table table-bordered table-responsive">
    <tr>
      <td width="50%">37. (a) Do you have any proposals to upgrade the present system for treatment and disposal of effluent/ emission and / or hazardous waste</td>
	...
	<tr>
        ...
        <table class="table table-bordered table-responsive">
			<thead>
				<tr><th>Pollution Control Equipment</th><th width="30%">Emission/Effluent Type</th><th width="30%">Seperate Meters are installed ?</th></tr>
			</thead>
