...
if($query->num_rows > 0){
	...
	/***********PART 1********/
	$revenue_survey_no=$results["revenue_survey_no"];$lb_name=$results["lb_name"];$lb_auth_name=$results["lb_auth_name"];$md_name=$results["md_name"];$is_registered=$results["is_registered"];$reg_no=$results["reg_no"];$reg_date=$results["reg_date"];$from_year=$results["from_year"];$to_year=$results["to_year"];	
...
<table class="table table-bordered table-responsive">
  	<tr>
		<td colspan="2"><b>Part B : Waste water aspects</b></td>     
   </tr>
  	<tr>
...
<table class="table table-bordered table-responsive">
	<tr>
    <td colspan="2"><b>Part - C : Air emission asp ects</b></td>
	</tr>
	<tr>
...
<!--//////////////////////////////////////section 6///////////////////////////////////--> 
  ...
  <table class="table table-bordered table-responsive">
    <tr>
      <td colspan="2"><b>Part - D : Hazardous waste aspects</b></td>
    </tr>
    <tr>
...
<table class="table table-bordered table-responsive">
    <tr>
      <td colspan="2"><b>Part - E : Additional information</b></td>
    </tr>
    <tr>
    ...
    <tr>
		<td valign="top">40. Which of the pollution control items are connected to D.G. set (captive power source) to ensure their running in the event of normal power failure ?</td>
		<td>'.strtoupper($dgset_items_a).'<br/>'.strtoupper($dgset_items_b).'<br/>'.strtoupper($dgset_items_c).'<br/>'.strtoupper($dgset_items_d).'</td>
    </tr>
	<tr>
