...
$printContents=$printContents.'
	...
	<table class="table table-bordered table-responsive">
		...
		<tr>
  	  	...
  	  	<tr>
		  	<td>'.strtoupper($water_cs_an).' <br/>Analysis of treated waste water for pH, BOD, COD, SS, O&G, <br/>any other parameter stipulated by SPCB/SPCC (attach details)</td>
		</tr>
		<tr>
		...
		<tr>
 		...
 		<tr>  
			<td colspan="2">14. Details of e-waste proposed to be procured through sale, contract or import, as the case may be, for use as raw material</td>
            <td>
			<table class="table table-bordered table-responsive">
				<tr align="center">
					<td>Sl No.</td>
		...
		<tr>
			...
			<table class="table table-bordered table-responsive">
			<tr>
				<td align="left" width="50%">Date: <b>'.date('d-m-Y',strtotime($results["sub_date"])).'</b><br/> Place: <b>'.strtoupper($dist).'</b></td>
				<td>
