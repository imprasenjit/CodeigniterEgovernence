...
if($q->num_rows<1){	
	...
	if($p->num_rows>0){
		...
		$public_hearing_doc="";$is_provided="";	
		$application_for_a="";$application_for_b="";$application_for_c="";	
	}
}else{
                                       ...
                                       <tr>
												<td colspan=4>
													...
													<tr>
														...
														<td>
															<input type="text" class="form-control text-uppercase" id="txxtB<?php echo $count;?>" value="<?php echo $row_3["site_id"]; ?>" name="txxtB<?php echo $count;?>"/>
														</td>				
														<td>
															<input type="text" class="form-control text-uppercase" id="txxtC<?php echo $count;?>" value="<?php echo $row_3["engine_no"]; ?>" name="txxtC<?php echo $count;?>"/>
														</td>
														<td>
														...
														<td>
															<select id="txxtI<?php echo $count;?>" name="txxtI<?php echo $count;?>" class="form-control text-uppercase">
																<option value='' >Select</option>
																<option <?php if($row_3["dg_c_equip"]=="Y") echo "selected"; ?> value='Y' >YES</option>
																<option <?php if($row_3["dg_c_equip"]=="N") echo "selected"; ?> value='N' >NO</option>
															</select>
														</td>	
														
														<td>
															<input type="text" class="form-control text-uppercase" id="txxtJ<?php echo $count;?>" value="<?php echo $row_3["location_address"]; ?>" name="txxtJ<?php echo $count;?>" />
														</td>
													</tr>	
													<?php $count++; 
													} 
													...
													<tr>
														...
														<td>
															<select id="txxtI1" name="txxtI1" class="form-control text-uppercase">
															<option value='' >Select</option>
														...
														<td>
															<input type="text" class="form-control text-uppercase" id="txxtJ1" name="txxtJ1"/>
														</td>
