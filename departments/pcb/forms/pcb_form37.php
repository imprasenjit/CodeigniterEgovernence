...
if($q->num_rows<1){	 
	...
	if($p->num_rows>0){
		...
		$form_id=$results["form_id"];$manuf_capacity=$results["manuf_capacity"];$is_reg_dcssi=$results["is_reg_dcssi"];$water_valid_consent=$results["water_valid_consent"];$air_valid_consent=$results["air_valid_consent"];$is_compliance=$results["is_compliance"];
		...
		/////////Brand owners///////////
		$is_reg_dis=$results["is_reg_dis"];$tot_capital_b=$results["tot_capital_b"];$year_comm_b=$results["year_comm_b"];$water_valid_radio=$results["water_valid_radio"];$air_valid_radio=$results["air_valid_radio"];
						...
						<div class="panel-body">
							...
							<div class="tab-content">
								...
								<table class="table table-responsive "> 
								    <tr>
										<td colspan="4" align="center"><b>PART - A<br/>GENERAL</b></td>
									</tr>
									<tr>
						           ...
						           <tr>
									...
									<tr>
									   <td colspan="3">5. Status of compliance with these rules- Thickness – fifty micron <span class="mandatory_field">*</span></td>
									...
									<tr>
										<td colspan="3">6.(a) Does the unit have a valid consent under the Water (Prevention and Control of Pollution) Act, 1974 (6 of 1974). <span class="mandatory_field">*</span></br>If yes, attach a copy</td>
									...
									<tr>
										<td colspan="4">7. Solid Wastes :</td>
									</tr>
									<tr>
								...
								<tr>
									<td colspan="3">6. Does the unit have a valid consent under the Water (Prevention and control of Pollution) Act, 1974 (6 of 1974)? <span class="mandatory_field">*</span> </br>If yes, attach a copy.</td>
								...
								<tr>
									<td colspan="3">7. Does the unit have a valid consent under the Air (Prevention and Control of Pollution) Act, 1981 (14 of 1981)? <span class="mandatory_field">*</span></br>If yes, attach a copy.</td>	
								...
								<tr>
									<td colspan="4">8. Solid Wastes or rejects : </td>
								</tr>
								<tr>
									<td>(a) Total quantum of generation :</td>
