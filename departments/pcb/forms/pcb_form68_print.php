    ...
    <div style="text-align:center">
		'.$assamSarkarLogo.'<h4>'.$form_name.'</h4>
           ...
           <table class="table table-bordered table-responsive">
				...
				<tr>
                    <td>7.Steps taken to prevent the recurrence
											a. of such an accident</td>
                    <td>'.strtoupper($steps_recurrence).'</td>
                </tr>
				<tr>
                    <td>8.Regular monthly health check up of workers at</td>
                    <td>'.strtoupper($monthly_health).'</td>
                </tr>
				<tr>
                    <td>9. a. Processing / recycling site shall be made</td>
                    <td>'.strtoupper($is_processing).'</td>
                </tr>
				<tr>
                    <td>10. Any accident during the collection ?</td>
                    <td>'.strtoupper($is_collection).'</td>
                </tr>
				<tr>
                    <td>a. Transportation and treatment including</td>
                    <td>'.strtoupper($collection_treatment).'</td>
                </tr>
				<tr>
                    <td>b. Processing and recycling should be informed</td>
                    <td>'.strtoupper($collection_recycling).'</td>
                </tr>
				<tr>
                    <td>c. To the Competent Authority (Local Authority) or</td>
                    <td>'.strtoupper($collection_authority).'</td>
                </tr>
				<tr>
                    <td>d. Prescribed Authority</td>
                    <td>'.strtoupper($collection_authority1).'</td>
                </tr>';
