...
if($q->num_rows<1){	 
	...
	if($p->num_rows>0){
		...
		###### PARTIV ######
		$is_recycler="";$storage_detail="";$process_desc="";$pcs_detail="";$health_details="";$pcb_guidelines="";$trans_arrange="";$ins_capacity_qty="";$ins_capacity_unit="";
	}
}else{
							...
							<div class="tab-content">
								...
								<form name="myform1" id="myform1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
										...
										<tr>
											<td width="25%">Name:</td>
											<td width="25%"><input type="text" name="occupier_add[name]" value="<?php echo $occupier_add_name; ?>" validate="letters" class="form-control text-uppercase"></td>
												...
												<table name="objectTable2" class=" table table-responsive table-bordered text-center " id="objectTable2" >
													...
													<tr>
														...
														<select  id="txttE<?php echo $count;?>" name="txttE<?php echo $count;?>" class="form-control text-uppercase">
															...
															<option <?php if($row_2["unit"]=="KG") echo "selected"; ?> value='KG' >in kg / month</option>
														</select></td>
													</tr>	
													<?php $count++; } 
													}else{	?>
								...
								<form name="myform1" id="myform1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
										...
										<tr>
											...
											<td colspan="2"><label class="radio-inline"><input type="radio" name="is_generator" value="Y"  <?php if(isset($is_generator) && $is_generator=='Y') echo 'checked'; ?> /> Yes</label><label class="radio-inline"><input type="radio" name="is_generator"  value="N"  <?php if(isset($is_generator) && $is_generator=='N') echo 'checked'; ?>/> No</label></td>
										</tr>
									</table>
										...
										<tr>
											<td colspan="4">
												<table name="objectTable3" class=" table table-responsive table-bordered text-center "id="objectTable3" >
													...
													<tr>
														<td><input readonly="readonly" id="txxtA<?php echo $count;?>" class="form-control text-uppercase"; value="<?php echo $row_1["slno"]; ?>" name="txxtA<?php echo $count;?>" size="1"></td>
														<td><input value="<?php echo $row_1["name"]; ?>" pattern="[a-zA-Z0-9.\s]+" title="No special characters are allowed except Dot" id="txxtB<?php echo $count;?>" class="form-control text-uppercase"; name="txxtB<?php echo $count;?>"></td>
														<td>
														...
														<td><input value="<?php echo $row_1["qty"]; ?>" id="txxtD<?php echo $count;?>" class="form-control text-uppercase"; name="txxtD<?php echo $count;?>" ></td>
														<td>
											...
											<table name="objectTable6" class=" table table-responsive table-bordered text-center "id="objectTable6" >
												...
												<tr>
													...
													<select  id="textD<?php echo $count;?>" name="textD<?php echo $count;?>" class="form-control text-uppercase">
														...
														<option <?php if($row_6["unit"]=="KG") echo "selected"; ?> value='KG' >in kg / month</option>
								...
								<form name="myform1" id="myform1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									...
									<table id="is_recycler_yes" class="table table-responsive">
											...
											<td colspan="4">
												<table name="objectTable7" class=" table table-responsive table-bordered text-center" id="objectTable7" >
													...
													<tr>
														...
														<td>
														<input value="<?php echo $row_7["nature"]; ?>" id="textC<?php echo $count;?>" name="textC<?php echo $count;?>" class="form-control text-uppercase">
										...
										<tr>
											<td colspan="2">8.(a) Has the facility been set up as per Central Pollution Control Board guidelines?</td>
										...
										<tr>
											<td colspan="2">(b) If yes, provide a report on the compliance with the guidelines:</td>
											<td>Upload later in Upload Section</td>
										</tr>
										<tr>
