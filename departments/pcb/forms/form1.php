								...
								<div class="tab-content">
									...
									<form name="myform1" class="myform1 submit1" method="post"  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
										<table class="table table-responsive table-bordered">
											...
											<tr>
												...
												<td colspan="2"><input type="text" id="is_provided_yes" name="is_use" value="<?=$is_use;?>" class="form-control text-uppercase"  ></td>	
											</tr>
											<tr>
											...
											<td colspan="4">
												<table name="objectTable1" class="table table-responsive table-bordered "id="objectTable1" >
													...
													<tr>
														...
														<td><input value="<?php echo $row_1["qty"]; ?>" id="txtD<?php echo $count;?>" class="form-control text-uppercase"; name="txtD<?php echo $count;?>" placeholder="Quantity" ></td>
														<td>
													...
													<tr>
														...
														<td><input id="txtD1" class="form-control text-uppercase" name="txtD1" placeholder="Quantity"></td>
														<td>														
									...
									<div id="table3" class="tab-pane <?php echo $tabbtn3; ?>" role="tabpanel">
										...
										<table class="table table-responsive table-bordered">
											...
											<tr>
												...
												<td><input type="text" name="water_source[c]" validate="decimal" value="<?php echo $water_source_c;?>" placeholder="Quantity permitted" title=" Valid number with 2 digits after decimal point" class="form-control text-uppercase"></td>
											</tr>
											<tr>
											...
											<tr>
												<td>(i) Domestic </td>
												<td><input type="text" name="ww_qty[a]" validate="decimal" value="<?php echo $ww_qty_a;?>" placeholder="example : 23.00" title="Please enter a decimal value" class="form-control text-uppercase"></td>
												<td>(ii) Industrial</td>
												<td><input type="text" name="ww_qty[b]" validate="decimal" value="<?php echo $ww_qty_b;?>" placeholder="example : 23.00" title="Please enter a decimal value" class="form-control text-uppercase"></td>
											</tr>
											<tr>
												<td>(iii) Process </td>
												<td><input type="text" name="ww_qty[c]" validate="decimal" value="<?php echo $ww_qty_c;?>" placeholder="example : 23.00" title="Please enter a decimal value" class="form-control text-uppercase"></td>
												<td>(iv) Washings </td>
												<td><input type="text" name="ww_qty[d]" validate="decimal" value="<?php echo $ww_qty_d;?>" placeholder="example : 23.00" title="Please enter a decimal value" class="form-control text-uppercase"></td>
											</tr>
											<tr>
												<td>(v) Boiler Blowdown </td>
												<td><input type="text" name="ww_qty[e]" validate="decimal" value="<?php echo $ww_qty_e;?>" placeholder="example : 23.00" title="Please enter a decimal value" class="form-control text-uppercase"></td>
												<td>(vi) Cooling water blowdown </td>
												<td><input type="text" name="ww_qty[f]" validate="decimal" value="<?php echo $ww_qty_f;?>" placeholder="example : 23.00" title="Please enter a decimal value" class="form-control text-uppercase"></td>
											</tr>
											<tr>
												<td>(vii) DM Plant / Softening Plant washings</td>
												<td><input type="text" name="ww_qty[g]" validate="decimal" value="<?php echo $ww_qty_g;?>" placeholder="example : 23.00" title="Please enter a decimal value" class="form-control text-uppercase"></td>
												<td></td>
												<td></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<table  class="table table-responsive table-bordered">        
													...
													<tr>
													  ...
													  <td><input type="text" class="form-control text-uppercase" name="sd[fq][sn1]" id="textfield124" value="<?php echo $sd_fq_sn1; ?>" placeholder="in TPD / KLD" title="Please enter a decimal value" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[fq][sn2]" id="textfield125" value="<?php echo $sd_fq_sn2; ?>" placeholder="in TPD / KLD" title="Please enter a decimal value" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[fq][sn3]" id="textfield126" value="<?php echo $sd_fq_sn3; ?>"placeholder="in TPD / KLD" title="Please enter a decimal value" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[fq][sn4]" id="textfield127" value="<?php echo $sd_fq_sn4; ?>"placeholder="in TPD / KLD" title="Please enter a decimal value" validate="decimal" /></td>
													</tr>
													<tr>
													...
													<tr>
													  ...
													  <td><input type="text" class="form-control text-uppercase" name="sd[gq][sn1]" id="textfield144" value="<?php echo $sd_gq_sn1; ?>" placeholder="in Nm3" title="Please enter a decimal value"  validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[gq][sn2]" id="textfield145" value="<?php echo $sd_gq_sn2; ?>" placeholder="in Nm3" title="Please enter a decimal value" validate="decimal" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[gq][sn3]" id="textfield146" value="<?php echo $sd_gq_sn3; ?>"  placeholder="in Nm3" title="Please enter a decimal value" validate="decimal"/></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[gq][sn4]" id="textfield147" value="<?php echo $sd_gq_sn4; ?>" placeholder="in Nm3" title="Please enter a decimal value" validate="decimal" /></td>
													</tr>
													<tr>
									...
									<div id="table6" class="tab-pane <?php echo $tabbtn6; ?>" role="tabpanel">
										...
										<table class="table table-responsive">
											...
											<tr>
												<td colspan="2" rowspan="2">30. (a) Whether the unit is generating hazardous  waste as defined in the Hazardous Waste (Management and handling)  Rules, 1989, as amended.<span class="mandatory_field"> *</span></td></td>
