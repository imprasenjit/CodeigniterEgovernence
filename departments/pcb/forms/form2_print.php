...
if($query->num_rows > 0){
	...
	$form_id=$results["form_id"];$from_year=$results["from_year"];$to_year=$results["to_year"];
...
<table class="table table-bordered table-responsive">
	<tr>
		<td>From : <br/>
		'.strtoupper($from).'<br/>Sir,<br/>I / We hereby apply for *<br/>';
...
<table class="table table-bordered table-responsive">
  ...
  <tr>
    <td width="50%">1. Name, designation, office address with  telephone numbers, e-mail of the Applicant</td>
    <td>
    	<table class="table table-bordered table-responsive">
      		<tr>
        			<td>Name</td>
  	...
  	<tr>
    	<td  width="50%">2. (a) Name and location of the industrial unit / premises for which the application is made. (Give revenue Survey Number /plot number, name of Taluka and District also telephone number)
      	&nbsp;
      </td>
    	<td>
    		<table class="table table-bordered table-responsive">
  	...
  	<tr>
		<td width="50%">(b) Details of the planning permission obtained from the local body / Town and Country Planning authority / metropolitan development authority / designate authority</td>
		<td>
		<table class="table table-bordered table-responsive">
      		<tr>
  	...
  	<tr>
    	<td width="50%">(c) Name  of the local body under whose jurisdiction  the unit is located and name of  the licence issuing authority</td>
    	<td>
    		<table class="table table-bordered table-responsive">
      		<tr>
  	...
  	<tr>
    	<td width="50%">3. Names, addresses with telephone number of Managing  Director/Managing Partner and officer responsible for matters connected with  pollution control  and / or hazardous waste disposal.
      	&nbsp;
      </td>
    	<td>
    		<table class="table table-bordered table-responsive">
	...
	<tr>
    	<td valign="top">5. Gross capital investment (in Rupees) of the unit without depreciation till the date of application (Cost of building, land,plant and machinery)</td>
