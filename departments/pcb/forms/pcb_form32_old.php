...
$check=$formFunctions->is_already_registered('pcb','32');
if($check==1){
	echo "<script>
				alert('Already Registered');
				window.location.href = '".$server_url."departments/requires/acknowledgement.php?form=32&dept=pcb';
		</script>";	
}
...
include "save_hw_form.php";
		...
		$q=$pcb->query("select * from pcb_form32 where user_id='$swr_id' and active='1'") or die("Error :".$pcb->error);
						...
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h4 class="text-center" >
									<strong><?php echo $form_name=$cms->query("select form_name from pcb_form_names where form_no='32'")->fetch_object()->form_name; ?></strong>
								</h4>	
							</div>
							<div class="panel-body">
								...
								<table id="" class="table table-responsive">
									<tr>
									    <td colspan="4">1. Name and address of the person making the appeal:</td>
									</tr>
									<tr>
									     <td width="25%">Name :</td>
									     <td width="25%"><input type="text" name="" value="<?php echo $imp_ind_name; ?>" class="form-control text-uppercase"></td>
									     <td width="25%">Street Name 1:</td>
									     <td width="25%"><input type="text"  name="" value="<?php echo $imp_ind_st1; ?>" class="form-control text-uppercase"></td>
									</tr>
									<tr>
									    <td>Street Name 2:</td>
										<td><input type="text"  value="<?php echo $b_street_name2; ?>" class="form-control text-uppercase"></td>
										<td>Village/Town:</td>
									...
									<tr>
										...
										<td>Phone No:</td>
										<td><input type="text"  value="<?php echo $landline_std.$landline_no; ?>" class="form-control text-uppercase"></td>
									</tr>
									<tr>
									    <td>Email Id:</td>
									...
									<tr>
									    <td colspan="4">2. Number, date of order and address of the authority : (certified copy of which passed the order, against which appeal is being the order be attached) made:</td>
									</tr>
									<tr>
									     <td width="25%">Number :</td>
									     <td width="25%"><input type="text" disabled value="<?php echo $key_person; ?>" class="form-control text-uppercase"></td>
									     <td width="25%">Date of Order:</td>
									...
									<tr>
										...
										<td><input type="text" disabled value="<?php echo $email; ?>" class="form-control "></td>
										<td>4. Relief sought for:</td>
										<td><input type="text" disabled value="<?php echo $email; ?>" class="form-control "></td>
									</tr>
									<tr>
									    <td>5. List of enclosures other than the order referred in point 2 against which the appeal is being filed.:</td>
										<td><input type="text" disabled value="<?php echo $email; ?>" class="form-control "></td>
										<td></td>
										<td></td>
									</tr>
