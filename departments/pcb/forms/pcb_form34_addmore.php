<?php
if(isset($form_id)){
	$part1=$formFunctions->executeQuery($dept,"SELECT id FROM ".$table_name."_t1 WHERE form_id='$form_id' order by id desc");
	$num = $part1->num_rows;
}else{
	$num=0;
}
...
<script>	/*---------FOR TABLE-1------------*/
	...
	function addMorefunction1(){
		...
		var array2 = ["select unit","in metric tonnes / month","in kl / month","in kg / month"];
		var array2a = ["","MT","K","KG"];
...
<script>	/*---------FOR TABLE-3------------*/
	...
	function addMorefunction3(){
		...
		cell4.appendChild(t4);		
		var cell5=row.insertCell(4);		
		var array4 = ["select unit","in tonnes / month","in kl / month","in numbers / month","in kg / month"];
...
<script>
	...
	function addMorefunction6(){
		...
		var array2 = ["select unit","in tonnes / month","in kl / month","in numbers / month","in kg / month"];
