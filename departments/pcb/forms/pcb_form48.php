...
if($q->num_rows<1){	
	...
	if($p->num_rows>0){
		...
		/***********PART 1********/
		$revenue_survey_no=$results["revenue_survey_no"];$lb_name=$results["lb_name"];$lb_auth_name=$results["lb_auth_name"];$md_name=$results["md_name"];$is_registered=$results["is_registered"];$reg_no=$results["reg_no"];$reg_date=$results["reg_date"];	
		...
		$form_id="";$lb_name="";$lb_auth_name="";$from_year="";$to_year="";
		$md_name="";$md_address="";$is_registered="";$reg_no="";$reg_date="";$form_id="";
		$u_rsn="";$u_fax_std="";$u_fax_no="";
		$m_desig="";$m_sn1="";$m_sn2="";$m_v="";$m_d="";$m_p="";$m_m="";$m_phn="";$m_e="";
		$revenue_survey_no="";$plan_details_prn="";$plan_details_dt="";$plan_details_ia="";		
		$investment_cost="";$public_hearing_doc="";$is_provided="";$dg_set="";	
		$application_for_a="";$application_for_b="";$application_for_c="";	
	}
}else{
	...
	if(!is_numeric($results["investment_cost"]) && !empty($results["investment_cost"])){
		$investment_cost=json_decode($results["investment_cost"]);
        if(isset($investment_cost->a)) $investment_cost_a=$investment_cost->a;
		else $investment_cost_a="";
        if(isset($investment_cost->b)) $investment_cost_b=$investment_cost->b;
		else $investment_cost_b="";
								...
								<div class="tab-content">
									...
									<form name="myform2" class="myform1 submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
										...
										<table class="table table-responsive table-bordered">
											...
											<tr>												
												...
												<td><input type="text"  name="plan_details[prn]" value="<?php echo strtoupper($plan_details_prn);?>" class="form-control text-uppercase" ></td>
									...
									<form name="myform2" class="myform1 submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
										<table class="table table-responsive table-bordered">
											...
											<tr>
												<td colspan="4">6. If the site is located near sea-shore / river bank / other water bodies; indicate the distance and the name of the water body, if any<span class="mandatory_field">*</span></td>
											</tr>
											<tr>
												<td>Distance</td>
												<td>
									...
									<form name="myform2" id="myform2A" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">	
										<table class="table table-responsive table-bordered">
											<tr>
									...
									<div id="table6" class="tab-pane <?php echo $tabbtn6; ?>" role="tabpanel">
										<form name="myform2" id="myform2A" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data"><table class="table table-responsive">
											<tr>
									...
									<div id="table7" class="tab-pane <?php echo $tabbtn7; ?>" role="tabpanel">
										...
										<table class="table table-responsive table-bordered">
											...
											<tr>
												<td>(v) Has the unit prepared an Off-site Emergency Plan ?<span class="mandatory_field">*</span><span class="mandatory_field">*</span> </td>
                                                ...
                                                <td colspan=4>
                                                    <table name="objectTable3" class="table table-responsive table-bordered "id="objectTable3" >
														...
														<tr>
															...
															<td>
																<input type="nummber" class="form-control text-uppercase" id="txxtF<?php echo $count;?>" value="<?php echo $row_3["dg_invest"]; ?>" name="txxtF<?php echo $count;?>"/>
															</td>				
															<td>
