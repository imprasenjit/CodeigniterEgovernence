...
<table class="table table-bordered table-responsive">
	...
	<tr>
		<td colspan="2">8. Details of officer in-charge dealing with solid waste management (SOLID WASTEM) : </td>
	</tr>
	<tr>
		<td colspan="2">
		<table class="table table-bordered table-responsive">
	...
	<tr>
		...
		<td>'.strtoupper($no_household).'</td>
	</tr>
	<tr>
		<td>(b) Number of non-residential premises in the city </td>
		<td>'.strtoupper($no_premise).'</td>
	</tr>
	<tr>
		<td>(c) Number of election/ administrative wards in the city/town </td>
		<td>'.strtoupper($no_election).'</td>
	</tr>
	<tr>
		<td colspan="2">10. Quantity of Solid waste (solid waste) : </td>
	</tr>
	<tr>
	...
	<tr>
		<td>(e) Quantity of solid waste disposed at dumpsite/landfill </td>
		<td>'.strtoupper($quantity_dispose).'&nbsp;/tpd</td>
	</tr>
	<tr>
		<td colspan="2">11. Status of Solid Waste Management Service : </td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="2">12. Door to Door Collection of solid waste : </td>
	</tr>
	<tr>
	...
	$printContents=$printContents.'
	<tr>
		<td>13. Length of roads, streets, lanes, bye-lanes in the city that need to be cleaned (in km) </td>
		<td>'.strtoupper($length).'&nbsp;km </td>
	</tr>
	<tr>
		<td colspan="2">14. Frequency of street sweepings and percentage of population covered : </td>
	</tr>	
	<tr>
		<td colspan="2">
		<table class="table table-bordered table-responsive">
	...
	<tr>
		<td colspan="2">16. Secondary Waste Storage facilities : </td>
	</tr>	
	<tr>
	...
	<tr>
		<td>18. Ward wise details of waste storage depots (Please attach) : </td>
	...
	<tr>
		<td colspan="2">21. Give frequency of collection of waste from the depots : </td>
	</tr>
	<tr>
	...
	$printContents=$printContents.'
	<tr>
		<td colspan="2">22. Whether lifting of solid waste from storage depots is manual or mechanical. Give percentage : </td>
	</tr>
	<tr>
	...
	<tr>
		<td>23. Whether solid waste is lifted from door to door and transported to treatment plant directly in a segregated form ? <br/>If yes, specify </td>
	...
	<tr>
		<td>27. Quantity of waste transported each day </td>
		<td>'.strtoupper($transport_qty).'&nbsp;/tpd</td>
	</tr>
	<tr>
		<td>28. Percentage of total waste transported daily (%) </td>
	...
	<tr>
		<td>30. Whether solid waste is processed ? <br/>If yes, Quantity of waste processed daily </td>
		<td>'.strtoupper($waste_process).'<br/>'.strtoupper($waste_process_qty).'</td>
	</tr>
	<tr>
		<td>31. Whether treatment is done by local body or through an agency ? </td>
		<td>'.strtoupper($treatment_by).'</td>
	</tr>
	<tr>
		<td colspan="2">
		<table class="table table-bordered table-responsive">
			<tr>
				<td width="50%">32. (a) Land(s) available with the local body for waste processing (in Hectares) </td>
	...
	<tr>
		<td colspan="2">33. Details of technologies adopted : </td>					
	</tr>
	<tr>
	...
	<tr>
		<td>34. (a) Combustible waste supplied to cement plant </td>
	...
	<tr>
		<td>35. (a) Solid waste disposal facilities </td>
	...
	<tr>
		<td>36. Whether an Action Plan has been prepared for improving solid waste management practices in the city ? <br/>If yes, attach Action Plan details </td>
		<td>'.strtoupper($action_plan).'</td>
	</tr>
	<tr>
		<td>37. What separate provisions are made for : <br/>(Attach details on Proposals, Steps taken) </td>
	...
	<tr>
		<td>39. How many slums are identified and whether these are provided with Solid Waste Management facilities ? <br/>If yes, attach details</td>
	...
	<tr>
		<td>42. Mention briefly, if any innovative idea is implemented to tackle a problem related to solid waste, which could be replicated by other local bodies </td>
	...
	<tr>								
		...
		<td align="right">Signature of CEO/Municipal Commissioner/ Executive Officer/Chief Officer : <strong>'.strtoupper($key_person).'</strong></td>
	</tr>
</table>';
?>