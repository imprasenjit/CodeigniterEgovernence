...
if($query->num_rows > 0){
	...
	if(!empty($results["md_address"])){				
		...
		$m_desig=$md_address->desig;
		$m_sn1=$md_address->st1;
		$m_sn2=$md_address->st2;
		$m_v=$md_address->vill;
		$m_d=$md_address->dist;
		$m_p=$md_address->pin;
		$m_m=$md_address->mn;$m_phn=$md_address->phn;$m_e=$md_address->email;				
	}else{
		$m_desig="";$m_sn1="";$m_sn2="";$m_v="";$m_d="";$m_p="";$m_m="";$m_phn="";$m_e="";
	}	
	/******PART 2********/	
	$wb_name=$results["wb_name"];$loc_feedback=$results["loc_feedback"];$is_situated=$results["is_situated"];$is_provided=$results["is_provided"];$is_use=$results["is_use"];$staff_nos=$results["staff_nos"];$is_res_colony=$results["is_res_colony"];$investment_cost=$results["investment_cost"];
	$loc_feedback = wordwrap($results["loc_feedback"], 40, "<br/>", true);
	if(!is_numeric($results["investment_cost"])){
	...
	//$is_adq_facility=($is_adq_facility=="NA")?'Not Applicable': ($is_adq_facility=="Y")? "YES":"NO";
...
<table class="table table-bordered table-responsive">
	<tr>
		<td>From: <br/>'.strtoupper($from).'<br/><br/>
		Sir,<br/>
		I / We hereby apply for *<br/>';
...
<table class="table table-bordered table-responsive">
	...
	<tr>
		<td width="50%">1. Name, designation, office address with  telephone, e-mail of the Applicant </td>
		<td>
			<table class="table table-bordered table-responsive">
      		<tr>
				<td>Name</td>
	...
	<tr>
 	...
 	<tr>
  	...
  	<tr>
    	...
    	<td>Month : '.date("F",strtotime($commission_my_m)).'<br/>Year : '.strtoupper($commission_my_y).'</td>
  	</tr>
  	<tr>
...
<!--//////////////////////////////////////section 3///////////////////////////////////-->
<br/><b>Part B : Waste water aspects</b>
<table class="table table-bordered table-responsive">
  	<tr>
    ...
    <tr>
		<td>21. Present treatment of trade effluent (Give sizes / capacities of treatment units). (A schematic diagram of the treatment scheme with inlet / outlet characteristics of each unit operation / process is to be provided. Include details of residue management system (ETP sludges))</td>
		<td>Document is attached</td>
    </tr>    
    <tr>
    ...
    <tr>
		...
		<td>'.strtoupper($disposal_mode_i).'</td>
    </tr>    
    <tr>
		...
		<td>'.strtoupper($disposal_mode_j).'</td>
    </tr>    
    <tr>
...
<br/><b>Part - C : Air emission asp ects</b>
<table class="table table-bordered table-responsive">
	<tr>
...
<!--//////////////////////////////////////section 6///////////////////////////////////--> 
<br/><b>Part - D : Hazardous waste aspects</b>
<table class="table table-bordered table-responsive">
    <tr>
...
<!--//////////////////////////////////////section 7///////////////////////////////////-->     
<br/><b>Part - E : Additional information</b>
<table class="table table-bordered table-responsive">
    <tr>
	...
	<tr>
		<td colspan="2">39. To which of the pollution control equipment, separate meters for recording consumption of electric energy are installed ?</td>
    </tr>
	<tr>
		<td colspan="2">
			<table class="table table-bordered table-responsive">
    ...
    <tr>
		<td rowspan="4">40. Which of the pollution control items are connected to D.G. set (captive power source) to ensure their running in the event of normal power failure ?</td><td>'.strtoupper($dgset_items_a).'</td>
    </tr>
	<tr>
		...
		<table class="table table-bordered table-responsive">
            <thead>
                <tr>
						...
						<th>Engine No.</th>
						<th>Maker&apos;s Name</th>
						<th>Capacity (KVA/MVA)</th>
						<th>Investment (in Lakhs)</th>
						<th>Fuel Quantity<br/>(Ltr. per Hr.)</th>	
						<th>Stack Height</th>	
						<th>Acoustic Enclosure<br/>(Yes / No)</th>	
            ...
            $num3 = $part3->num_rows;
             if($num3>0){
                ...
                while($row_3=$part3->fetch_array()){
					$dg_c_equip=($row_3["dg_c_equip"]=="Y")?"YES":"NO";
					$printContents=$printContents.'
                    <tr>
                        <td>'.strtoupper($sl).'</td>
                        <td>'.strtoupper($row_3["site_id"]).'</td>
                        <td>'.strtoupper($row_3["engine_no"]).'</td>
						...
						<th>'.strtoupper($row_3["location_address"]).'</th>
                    </tr>';
                    $sl++;
                }
            }else{
...
<table class="table table-bordered table-responsive">
    <tr>
		<td colspan="2">47. I / We further declare that the information furnished above is correct to the best of my / our knowledge.</td>
    </tr>
    <tr>
