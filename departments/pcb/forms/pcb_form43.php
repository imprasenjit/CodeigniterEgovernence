...
if($q->num_rows<1){	 
	...
	if(!empty($results["health_care"])){
		$health_care=json_decode($results["health_care"]);
		$health_care_sn1=$health_care->sn1;$health_care_sn2=$health_care->sn2;$health_care_vt=$health_care->vt;$health_care_pin=$health_care->pin;
        if(isset($health_care->dist)) $health_care_dist=$health_care->dist;
		else $health_care_dist="";
	}else{
		$health_care_sn1="";$health_care_sn2="";$health_care_vt="";$health_care_dist="";$health_care_pin="";
	}
	if(!empty($results["hcf"])){
						...
						<div class="panel-body">
							...
							<div class="tab-content">
								...
								<table id="" class="table table-responsive">
									...
									<tr>
										<td></td>
										<td width="10%"><input type="CheckBox" id="D1" name="fresh_renew" value="F" <?php if(isset($fresh_renew) && $fresh_renew=='F') echo 'checked'; ?> onClick="checkData(this)">Fresh</td>
										<td width="20%"><input type="CheckBox" id="D2" name="fresh_renew" value="R" <?php if(isset($fresh_renew) && $fresh_renew=='R') echo 'checked'; ?> onClick="checkData(this)">Renewal</td>	
										<td></td>
									</tr>
									<tr>
										<td>(i) Applied for CTO/CTE :<span class= "mandatory_field">*</span></td>
								...
								<table id="" class="table table-responsive">
									...
									<tr>
										<td>Street Name 1:</td>
										<td><input type="text" name="health_care[sn1]" value="<?php echo $health_care_sn1; ?>" validate="jsonObj" class="form-control text-uppercase"></td>
										<td>Street Name 2:</td>
										<td><input type="text" name="health_care[sn2]" value="<?php echo $health_care_sn2; ?>" validate="jsonObj" class="form-control text-uppercase"></td>
									</tr>
									<tr>
										<td>Village/Town:</td>
									...
									<tr>
										<td width="25%">(ii) GPS coordinates of health care facility (HCF) or common bio-medical waste treatment facility (CBWTF):</td>
									...
									<tr>
										<td width="25%">(i) Number of beds of HCF:</td>
										<td width="25%"><input type="text" name="hcf[num_bed]" value="<?php echo $hcf_num_bed; ?>" validate="jsonObj" class="form-control"></td>
										<td width="25%">(ii) Number of patients treated per month by HCF:</td>
										<td width="25%"><input type="text" name="hcf[pt]" value="<?php echo $hcf_pt; ?>" validate="jsonObj" class="form-control"></td>
									</tr>
									<tr>
										<td width="25%">(iii) Number healthcare facilities covered by CBMWTF:</td>
										<td width="25%"><input type="text" name="hcf[fac]" value="<?php echo $hcf_fac; ?>" validate="jsonObj" class="form-control"></td>
										<td width="25%">(iv) No of beds covered by CBMWTF:</td>
										<td width="25%"><input type="text" name="cbmwtf[num_bed]" value="<?php echo $cbmwtf_num_bed; ?>" validate="jsonObj" class="form-control"></td>
									</tr>
									<tr>
										<td width="25%">(v) Installed treatment and disposal capacity of CBMWTF(Kg per day):</td>
										<td width="25%"><input type="text" name="cbmwtf[capacity]" value="<?php  echo $cbmwtf_capacity; ?>" validate="jsonObj" class="form-control"></td>
										<td width="25%">(vi) Quantity of biomedical waste treated or disposed by CBMWTF (Kg per day) :</td>
										<td width="25%"><input type="text" name="cbmwtf[quantity]" value="<?php echo $cbmwtf_quantity; ?>" validate="jsonObj" class="form-control"></td>
									</tr>
									<tr>
										<td width="25%">(vii) Area or distance covered by CBMWTF:(pl. attach map a map with GPS locations of CBMWTF and area of coverage)</td>
										<td width="25%"><input type="text" name="cbmwtf[area]" value="<?php echo $cbmwtf_area; ?>" validate="jsonObj" class="form-control"></td>
										<td width="25%"></td>
										<td width="25%"></td>
									</tr>
									<tr>
								...
								<table id="" class="table table-responsive">
									...
									<tr>
										<td width="25%">(i) Mode of transportation (if any) of bio-medical waste:</td>
