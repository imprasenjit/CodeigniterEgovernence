...
if(!empty($results["uain"])){
	...
	<table class="table table-bordered table-responsive">
		...
		<tr>
			<td width="50%">(i) Name of the Applicant:</td>
		...
		<tr>
			...
			<td>
				...
				<tr>
						...
						<td>'.strtoupper($prev_auth_no).'</td>
				</tr>
				<tr>
						<td>Date</td>
						<td>'.strtoupper($renew_date).'</td>
				</tr>
				</table>
			</td>
		</tr>
				...
				<table class="table table-bordered table-responsive"> 
					...
					<tbody>
						...
						<tr>
							...
							<td width="25%">'.strtoupper($yellow_meth_discard).'</td>
						</tr>
						<tr>
			...
			<td colspan="2">
				<table class="table table-bordered table-responsive"> 
					<thead>
					  <tr>
						<th width="50%"></th>
						<th width="25%">No of units</th>
						<th>Capacity of each unit</th>
					  </tr>
					</thead>
					<tbody>
						<tr>
							<td width="50%">Incinerators</td>
							<td width="25%">'.strtoupper($num_incnrat).'</td>
