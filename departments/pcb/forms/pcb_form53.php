								...
								<div class="tab-content">
									...
									<table class="table table-responsive table-bordered">
										...
										<tr>
										   ...
										   <td><input type="text" class="dob form-control" name="consent_val[water]"  value="<?php  echo $consent_val_water; ?>"  /></td>
										   <td>b. Air (Prevention & Control of Pollution) Act, 1981;Valid up to </td>
										   <td><input type="text" class="dob form-control" name="consent_val[air]"  value="<?php  echo $consent_val_air; ?>" /></td>
										</tr>
										<tr>
												   ...
												   <?php
													...
													if($num2>0){
														...
														<tr>
															...
															<td><input value="<?php echo $row_2["year"]; ?>" id="textB<?php echo $count;?>"  class="form-control text-uppercase" name="textB<?php echo $count;?>" size="20"></td>	
															...
															<td><input value="<?php echo $row_2["qty"]; ?>"  id="textD<?php echo $count;?>" validate="specialChar" class="form-control text-uppercase" size="20" name="textD<?php echo $count;?>" ></td>
														</tr>	
													<?php $count++; } 
													}else{	?>
													<tr>
												...
												<tbody>
												   ...
												   <?php
													...
													<tr>
														...
														<td><input value="<?php echo $row_3["year"]; ?>" id="ttxtB<?php echo $count;?>"  class="form-control text-uppercase" name="ttxtB<?php echo $count;?>" size="20"></td>	
									...
									<table class="table table-responsive table-bordered">
										...
										<tr>
											<td>Water Cess paid up to (if applicable)(Rs.)</td>
											<td class="form-inline"><input type="text" class="form-control" validate="onlyNumbers" name="water_cs[cess]" value="<?php  echo $water_cs_cess; ?>" /></td>
											<td>Waste water generation as per consent</td>
											<td class="form-inline"><input type="text" name="water_cs[waste_water]" class="form-control" validate="onlyNumbers" value="<?php echo $water_cs_waste_water; ?>"/>m<sup>3</sup>/day</td>
										</tr>
										<tr>
											<td colspan="4">Actual (avg., of last 3 months)</td>
										</tr>
										<tr>
											<td>Industrial </td>
											<td class="form-inline"><input type="text" class="form-control" name="water_cs[i2]"  value="<?php echo $water_cs_i2; ?>"/> m<sup>3</sup>/day</td>
											<td>Domestic</td>
											<td class="form-inline"><input type="text" class="form-control" name="water_cs[d2]" value="<?php  echo $water_cs_d2; ?>"/> m<sup>3</sup>/day</td>
										</tr>
										<tr>					
										...
										<tr>
											...
											<td class="form-inline"><input type="text" class="form-control" name="water_cs[an]"  value="<?php  echo $water_cs_an; ?>"/></td>
										</tr>
										<tr>
											<td colspan="4">12. Air Pollution Control</td>
										</tr>
										<tr>
											<td valign="top" colspan="3">a. Provide flow diagram for emission control system(s) installed for each process unit, utilities etc.</td>
											<td>(Upload Later in Upload Section)</td>
										</tr>
										<tr>
									   ...
									   <tr>
										...
										<tr>
											<td colspan="2">d. Name of Treatment Storage and Disposal Facility utilized for</td>
											<td colspan="2"><input type="text" class="form-control text-uppercase"name="treatment_storage" id="textfield88" value="<?php echo $treatment_storage; ?>"/></td>
										</tr>
										<tr>
											<td colspan="2">e. Please attach analysis report of characterization of hazardous waste generated (including leachate test if applicable)</td>
								   ...
								   <tr>
									...
									<tr>	
										<td colspan="2">15. Occupational safety and health aspects</td>
										<td colspan="2">Please provide details of facilities(Upload Later in Upload Section)</td>
									</tr> 
									<tr>
										<td colspan="4">16. Remarks</td>
									</tr>   	
									<tr>
										<td colspan="2">Whether industry has provided adequate pollution control system / equipment to meet the standards of emission / effluent.<span class="mandatory_field">*</span></td>
										<td colspan="2"><label class="radio-inline"><input type="radio" required name="is_indus_provided" value="Y"  <?php if(isset($is_indus_provided) && $is_indus_provided=='Y') echo 'checked'; ?> /> Yes</label>
									...
									<tr>
										<td>If Yes, please furnish details<br/></td>
									...
									<tr>
										<td colspan="2">Whether industry is in compliance with conditions laid down in the Authorization :<span class="mandatory_field">*</span></td>
