...
if($q->num_rows<1){	 
	...
	if($p->num_rows>0){
		...
		$address_authority=$results['address_authority'];$appeal_made=$results['appeal_made'];$email=$results['email'];
		
	}else{
		$form_id="";$address_authority="";$appeal_made="";$email="";
						...
						<div class="panel-body">
							<div id="table1" class="tab-pane" role="tabpanel">
								<form name="myform1" id="myform1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									...
									<tr>
										<td width="25%">1.Name and address of the person making the appeal  </td>
									</tr>
									<tr>
									...
									<tr>
										<td>E-Mail ID</td>
										<td><input type="text" name="email" class="form-control" disabled="disabled" value="<?php echo $email; ?>"></td>
										<td></td>
										<td></td>
									</tr>
										<tr>
