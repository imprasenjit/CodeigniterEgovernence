...
if($q->num_rows<1){		
	$p=$formFunctions->executeQuery($dept,"select * from ".$table_name." a,".$table_name."_part1 b, ".$table_name."_part2 c, ".$table_name."_upload d where a.user_id='$swr_id' and a.active='0' and b.form_id=a.form_id and c.form_id=a.form_id and d.form_id=a.form_id ORDER BY a.form_id DESC LIMIT 1");	
	if($p->num_rows>0){
								...
								<div class="tab-content">
									...
									<form name="myform2" class="myform1 submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
										<table class="table table-responsive table-bordered">
											...
											<tr>
												<td colspan="3">(To be supported by an affidavit, Annual Report or certificate from a Chartered Accountant.For proposed unit(s), give estimated figure)</td>
												<td>Upload later in upload section</td>
											</tr>
											<tr>
											...
											<td colspan="4">
												<table name="objectTable1" class="table table-responsive table-bordered "id="objectTable1" >
													...
													<tr>
														...
														<td><input type="text" value="<?php echo $row_1["name"]; ?>" validate="letters" title="No special characters are allowed except Dot" id="txtB<?php echo $count;?>" class="form-control text-uppercase"; name="txtB<?php echo $count;?>"></td>
														<td>
													...
													<tr>
														...
														<td><input type="text" id="txtB1" title="No special characters are allowed except Dot" pattern="[a-zA-Z0-9.\s]+" class="form-control text-uppercase"; name="txtB1"></td>					
													...
													<?php
														...
														if($num>0){
														 ...
														 <tr>
															...
															<td><input type="text" validate="letters" value="<?php echo $row_1["name"]; ?>" id="textB<?php echo $count;?>" class="form-control text-uppercase" size="20" name="textB<?php echo $count;?>"></td>
															<td>
											...
											<tr>
												<td colspan="3">15. Description of process of manufacture for each of the products showing input, output, quality and quantity of solid, liquid and gaseous wastes, if any from each unit process. (To be supported by flow sheet and / or material balance and water balance sheet).</td>
												<td>Upload later in upload section</td>
											</tr>
											<tr>
												<td class="text-center" colspan="4">
									...
									<div id="table4" class="tab-pane <?php echo $tabbtn4; ?>" role="tabpanel">
										...
										<table class="table table-responsive table-bordered">
											<tr>
												<td colspan="3">21. Present treatment of trade effluent (Give sizes / capacities of treatment units). (A schematic diagram of the treatment scheme with inlet / outlet characteristics of each unit operation / process is to be provided. Include details of residue management system (ETP sludges)) </td>
												<td>Upload later in upload section</td>
											</tr>
											<tr>
											...
											<tr>
												<td colspan="3">(b) Enclose a copy of the latest report of analysis from the laboratory approved by State Board / Committee / Central Board / Central Government in the Ministry of Environment & Forests. For proposed unit furnish expected characteristics of the untreated / treated effluent. </td>
												<td>Upload later in upload section</td>
											</tr>
											<tr>
												<td class="text-center" colspan="4">
									...
									<form name="myform2" class="myform1 submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">									
										<table class="table table-responsive table-bordered">
											...
											<tr>
												 <td colspan="3">Attach specifications including residue management systems of each of the control equipment indicating inlet / outlet concentrations of relevant pollutants</td>
												 <td>Upload later in upload section</td>
											</tr>
											<tr>
											...
											<tr>
												<td colspan="3">29. Quality of treated effluent gas emissions and process emissions.(Specify concentration of criteria pollutants and industry / process-specific pollutants stack-wise.) Enclose a copy of the latest report of analysis from the approved laboratory by State Board / Central Board / Central Government in the Ministry of Environment and Forests. For proposed units furnish the expected characteristics of the emission.</td>
												<td>Upload later in upload section</td>
											</tr>
											<tr>
												<td class="text-center" colspan="4">
									...
									<div id="table6" class="tab-pane <?php echo $tabbtn6; ?>" role="tabpanel">
										...
										<table class="table table-responsive">
											...
											<tr>
												<td colspan="3" rowspan="2">30. (a) Whether the unit is generating hazardous  waste as defined in the Hazardous Waste (Management and handling)  Rules, 1989, as amended.*</td>
									...
									<div id="table7" class="tab-pane <?php echo $tabbtn7; ?>" role="tabpanel">
										...
										<table class="table table-responsive table-bordered">
											...
											<tr>
												<td  colspan="2">37. (a) Do you have any proposals to upgrade the present system for treatment and disposal of effluent/ emission and / or hazardous waste</td>
											...
											<tr>
												<td colspan="3">38. Capital and recurring (O & M) expenditure on various aspects of environment protection such as effluent, emission ,hazardous waste, solid waste, tree plantation, monitoring, date acquisition etc. (give figures separately for items implemented / to be implemented).</td>
												<td>Upload later in upload section</td>
											</tr>
											<tr>
											...
											<tr>
												<td colspan="3">43. Brief details of tree plantation / green belt development within applicant's premises (in hectares).</td>
												<td>Upload later in upload section</td>
											</tr>
											<tr>
