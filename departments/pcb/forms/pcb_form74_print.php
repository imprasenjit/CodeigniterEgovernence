...
<table class="table table-bordered table-responsive">
	...
	<tr>
		<td colspan="2">7. In case of renewal of authorisation : </td>
	</tr>
	<tr>
		<td colspan="2">
		<table class="table table-bordered table-responsive">
			<tr>
				<td width="50%">Previous authorisation number</td>
				<td>'.strtoupper($prev_auth_num).'</td>
			</tr>
			<tr>
				<td>Previous authorisation date</td>
				<td>'.strtoupper($prev_auth_dt).'</td>
			</tr>
			<tr>
				<td>Details of annual returns</td>
				<td>'.strtoupper($annual_returns).'</td>
			</tr>
		</table>
		</td>
	</tr>';
