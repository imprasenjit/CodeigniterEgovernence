...
if($query->num_rows > 0){
	...
	$key_person=$row1['Key_person'];$status_applicant=$row1['status_applicant'];$street_name1=$row1['Street_name1'];$street_name2=$row1['Street_name2'];$vill=$row1['Vill'];$dist=$row1['Dist'];$block=$row1['block'];$pincode=$row1['Pincode'];$mobile_no=$row1['Mobile_no'];$landline_std=$row1['Landline_std'];$landline_no=$row1['Landline_no'];
	$unit_name=$row1['Name'];$b_street_name1=$row1['b_street_name1'];$b_street_name2=$row1['b_street_name2'];$b_vill=$row1['b_vill'];$b_dist=$row1['b_dist'];$b_block=$row1['b_block'];$b_pincode=$row1['b_pincode'];$b_mobile_no=$row1['b_mobile_no'];$b_landline_std=$row1['b_landline_std'];$b_landline_no=$row1['b_landline_no'];$b_email=$row1['b_email']; 
	...
	if(!empty($results["ww_qty"])){
		...
		if(!empty($results["auth_req_value"])){
			...
			if(isset($auth_req->f)) $auth_req_value=$auth_req_value." Disposal of the hazardous waste";
		}else{
			$auth_req_value="";
		}
	...
	if($site_distance_a=="") $site_distance_a = "0";
	if($total_area_pa=="") $total_area_pa = "0";
	if($total_area_ba=="") $total_area_ba = "0";
	if($total_area_sa=="") $total_area_sa = "0";
		
	if($site_distance_b=="F"){
		$site_distance_b=$site_distance_a*0.3048;
		$site_distance_b=round($site_distance_a, 2);
	...
	$sub_date=date("d-m-Y",strtotime($results["sub_date"]));
}
...
<table width="99%" border="1" class="table table-bordered table-resposive" style="border-collapse: collapse">
	<tr>
		<td valign="top">From : <br>'.strtoupper($from).'
		<br>
		Sir,<br>
		I / We hereby apply for *<br/>(i) Consent to Establish under section 25 and 26 of the Water (Prevention and Control of Pollution) Act, 1974, as amended.<br/>(ii) Consent to Establish under Section 21 of the Air (Prevention and Control of Pollution) Act, 1981, as amended.<br/>(iii) Authorisation under rule 5 of the Hazardous Wastes (Management and Handling) Rules, 1989, as amended in connection with my / our existing / proposed / altered / additional manufacturing / processing activity from the premises as per the details given below.<br/>
		</td>
	</tr>
...
<table class="table table-bordered table-responsive">
  ...
  <tr>
    <td valign="top" style="width:50%">1. Name, designation, office address with  telephone, fax numbers, e-mail of the Applicant 
    </td>
    <td style="width:50%">
    	<table class="table table-bordered table-responsive">
      		<tr>
  	...
  	<tr>
    	<td valign="top">2. (a) Name and location of the industrial unit / premises for which the application is made. (Give revenue Survey Number /plot number, name of Taluka and District also telephone and fax number)
      	&nbsp;
      </td>
    	<td>
    		<table class="table table-bordered table-responsive">
  	...
  	<tr>
		<td valign="top" style="text-indent:14px">(b) Details of the planning permission obtained from the local body / Town and Country Planning authority / metropolitan development authority / designate authority</td>
		<td>
		<table class="table table-bordered table-responsive">
      		<tr>
  	...
  	<tr>
    	<td valign="top" style="text-indent:14px">(c) Name  of the local body under whose jurisdiction  the unit is located and name of  the licence issuing authority</td>
    	<td>
    		<table class="table table-bordered table-responsive">
      		<tr>
        			<td>Local Body Name</td>
        			<td>'.strtoupper($lb_name).'</td>
      		</tr>
      		<tr>
        			<td>Licence Issuing Authority</td>
        			<td>'.strtoupper($lb_auth_name).'</td>
      		</tr>
    		</table>
    	</td>
  	</tr>  	
  	<tr>
    	<td valign="top">3. Names, addresses with telephone and fax number of Managing  Director/Managing Partner and officer responsible for matters connected with  pollution control  and / or hazardous waste disposal.
      	&nbsp;
      </td>
    	<td>
    		<table class="table table-bordered table-responsive">
  	...
  	<tr>
    	<td valign="top">4. (a) Are you registered as a small-scale industrial unit ?</td>
    	<td>'.$is_registered.'	</td>
  	</tr> 
	<tr>
    	<td valign="top" style="text-indent:14px">(b) If  yes, give the number and date of registration.</td>
    	<td>Reg. No. : '.strtoupper($reg_no).'<br/>Date of Registration : '.$reg_date.'</td>
  	</tr>
	<tr>
    	<td valign="top">5. Gross capital investment of the unit without depreciation till the date of application (Cost of building, land,plant and machinery)</td>
    	<td>'.strtoupper($investment_cost).'</td>
  	</tr>
  
  
	<tr>
    	<td style="text-indent:14px;">(To be supported by an affidavit, Annual Report or certificate from a Chartered Accountant. For proposed unit(s), give estimated figure)</td>
    	<td>Document is attached</td>
  	</tr>

  	<tr>
    	<td valign="top">6. If  the site is located near sea-shore / river bank / other water bodies; indicate the distance and the name of  the water body, if any</td>
    	<td>Distance :  '.strtoupper($site_distance_b).' meters<br/>
    	Name of the water body :  '.strtoupper($wb_name).'</td>
  	</tr>  	  	
  	<tr>
    	<td valign="top">7. Does  the location satisfy the requirements under relevant Central / State Govt. notifications such as Coastal Regulation Zone, Notification on Ecologically  Fragile Area, Industrial location policy, etc. If so, give  details.</td>
    	<td>'.strtoupper($loc_feedback).'</td>
  	</tr>
	<tr>
		<td valign="top">8. If the site is situated in notified industrial estate </td><td>'.$is_situated.'</td>
	</tr>
	<tr>
  	...
  	<tr>
   	<td valign="top" style="text-indent:14px;">(b) will the applicant utilise the system, if provided</td>
    	<td>'.strtoupper($is_use).'</td>
  	</tr>
  	<tr>
   	<td valign="top" style="text-indent:14px;">(c) if not provided, details of proposed arrangement.</td>
    	<td>Document is attached</td>
  	</tr>  	
 	<tr>
    	<td valign="top">9. Total plot area, built-up area and area available for the use of treated sewage / trade effluent</td>
  	...
  	<tr>
    	<td valign="top">10. Month and year of proposed commissioning of the unit</td>
    	<td>Month : '.strtoupper($commission_my_m).' &nbsp;&nbsp;&nbsp;&nbsp; Year : '.strtoupper($commission_my_y).'</td>
  	</tr>
  	<tr>
    	<td valign="top">11. Number  of workers and office staff.</td>
    	<td>'.strtoupper($staff_nos).'</td>
  	</tr>
  <tr>
    	<td valign="top">12.(a) Do you have a residential colony within the premises in respect of which the present application is	made ?</td>
    	<td>'.strtoupper($is_res_colony).'</td>
  </tr>  
  <tr>
    	<td valign="top" style="text-indent:14px;">(b) If yes, please state population staying</td>
    	<td>'.strtoupper($colony_details_pop).'</td>
  </tr>  
  <tr>
    	<td valign="top" style="text-indent:14px;">(c) Indicate its location and distance with reference to plant site.</td>
    	<td>Location :  '.strtoupper($colony_details_loc).'<br/>
    	Distance :  '.strtoupper($colony_details_dis).'</td>
  </tr>  
  <tr>
    	<td valign="top" colspan="2">13. List of products and by-products manufactured in tonnes / month,kl / month or numbers / month (Give figure corresponding to maximum installed production capacity)</td>
  </tr>
	<tr>
	<td colspan="2">
		<table class="table table-bordered table-responsive">
  ...
  <tr>
    	<td valign="top" colspan="2">14. List of raw materials and process chemicals with annual consumption corresponding to above stated production figures, in tonnes / month or kl / month or numbers / month.</td>
...
<b>Part B : Waste water aspects</b>
  ...
  <table width="99%" border="1" class="table table-bordered table-resposive" style="border-collapse: collapse">
  	<tr>
	   ...
	   <tr>
		  <td width="50%">(i) Industrial cooling, spraying - in mine pits or boiler feeds.</td>
    ...
    <tr><td colspan="2">18. Quantity of waste water (effluent) generated (in m3 / day)</td></tr>
	<tr><td colspan="2">
      <table class="table table-bordered table-responsive">
        <tr>
    ...
    <tr>
      <td valign="top">19.  Water budget calculations accounting for difference between water consumption and effluent generated. : </td>
      <td>'.strtoupper($budget_calc_a).' <br/>Document is attached</td>
    </tr>
    
    <tr>
      <td valign="top">20.	Present treatment of sewage / canteen effluent (Give sizes / capacities of treatment units).</td>
    ...
    <tr>
      <td valign="top">22. (a) Are sewage and trade effluents mixed together ?	</td>
    ...
    <tr>
      <td valign="top">23. Capacity of treated effluent sump. Guard Pond if any.</td>
      <td>'.strtoupper($sump_capacity).'</td>
    </tr>
    
    
    <tr>
      <td valign="top" colspan="2" >24. Mode of disposal of treated effluents, with respective quantity, in m3 / day</td>     
    </tr>
    <tr>
      <td valign="top" style="text-indent:14px;">(i) into stream / river (Name of river : '.strtoupper($disposal_mode_a).')</td>
       <td>'.strtoupper($disposal_mode_b).'</td>
    </tr>
    
    
    <tr>
      <td valign="top" style="text-indent:14px;">(ii)	into creek / estuary (Name of creek/estuary : '.strtoupper($disposal_mode_c).')</td>
       <td>'.strtoupper($disposal_mode_d).'</td>
    </tr>
    
    <tr>
      <td valign="top" style="text-indent:14px;">(iii) into sea (Name of sea: '.strtoupper($disposal_mode_e).')</td>
       <td>'.strtoupper($disposal_mode_f).'</td>
    </tr>
    
    <tr>
      <td valign="top" style="text-indent:14px;">(iv)	into drain / sewer (Owner of sewer : '.strtoupper($disposal_mode_g).')	</td>
       <td>'.strtoupper($disposal_mode_h).'</td>
    </tr>
    
    <tr>
      <td valign="top" style="text-indent:14px;">(v) On land for irrigation on owned land / lease land. Specify cropped area.</td>
       <td>'.strtoupper($disposal_mode_i).'<br/></td>
    </tr>
    
    <tr>
      <td valign="top" style="text-indent:14px;">(vi)	Quantity of treated effluent reused / recycled, m3 / day Provide a location map of disposal arrangement indicating the outlet (s) for sampling</td>
       <td>'.strtoupper($disposal_mode_j).'<br/></td>
    </tr>
    
    <tr>
      <td valign="top" style="text-indent:14px;">(vii) Provide a location map of disposal arrangement indicating the outlet (s) for sampling</td>
       <td>Document is attached</td>
    </tr>
    
    <tr>
    	<td valign="top" colspan="2">25. (a) Quality of untreated / treated effluents (Specify pH and concentration of SS, BOD, COD and specific pollutants relevant to the  industry. TDS to be reported</td>
  	</tr>
	<tr>
	...
	<tr>
  	...
  	<tr>
    	<td style="text-indent:14px;">(b) Enclose a copy of the latest report of analysis from the laboratory approved by State Board / Committee / Central Board / Central Government in the Ministry of Environment &amp; Forests. For proposed unit furnish expected characteristics of the untreated / treated effluent. </td>
    	<td>Document is attached</td>
  	</tr>  
</table>  
...
<table width="99%" border="1" class="table table-bordered table-resposive" style="border-collapse: collapse">
    ...
    <td colspan="2">26. Fuel consumption : 
     <table class="table table-bordered table-responsive">
        <tr>
          ...
          <td width="16%">Coal</td>
          <td width="16%">LSHS</td>
          <td width="16%">Furnace Oil</td>
          <td width="16%">Natural gas</td>
          <td width="16%">Others(Specify) : '.$fc_ot_sp1.'</td>
        </tr>
        <tr>
  ...
  <tr>
    <td colspan="2" valign="top">27. (A) Details  of stack (process &amp; fuel stacks):<br/><br/>
      <table class="table table-bordered table-responsive">
    ...
    <tr>
    	<td>Attach  specifications including residue management systems of each of the control  equipment indicating inlet / outlet concentrations of relevant pollutants)</td>
    	<td>Document is attached</td>
    </tr>
  <tr>
    <td  width="50%" valign="top">27.(B) Whether any release of odoriferous compounds such as  Mercaptans, Phorate etc. are coming out</td>
  ...
  <tr>
    ...
    <td valign="top">'.strtoupper($is_adq_facility).'</td>
  </tr>  
  <tr>
    <td valign="top">29. Quality of treated flue gas emissions and process emissions.(Specify concentration of criteria pollutants and industry / process-specific pollutants stack-wise. Enclose a copy of the latest report of analysis from the approved laboratory by State Board / Central Board / Central Government in the Ministry of Environment and Forests. For proposed units furnish the expected characteristics of the emission</td>
    <td>Document is attached</td>
  </tr>
  </table>
<!--//////////////////////////////////////section 6///////////////////////////////////--> 
<b>Part - D : Hazardous waste aspects</b>
  <table width="99%" border="1" class="table table-bordered table-resposive" style="border-collapse: collapse">
    <tr>
      <td width="50%" valign="top">30. (a) Whether the unit is generating hazardous waste as defined in the Hazardous Waste (Management and handling) Rules, 1989, as amended.</td>
      <td>'.strtoupper($is_hazardous).'</td>
    </tr>        
    <tr>
      <td valign="top" style="text-indent:15px;">(b) If so, the category No.:</td>
      <td>'.strtoupper($haz_cat_no).'</td>
    </tr>
    <tr>
      <td valign="top">31. Authorization required for *</td>
      <td>'.strtoupper($auth_req_value).'</td>
    </tr>    
    <tr>
		<td valign="top">32. Quantity of hazardous waste generated (in kg / day) or (in mt / month)</td>
       <td>'.strtoupper($haz_qty).'</td>
    </tr>
    <tr>
      <td valign="top">33. Characteristics of the hazardous waste(s).Specify concentration of relevant pollutants. Enclose a copy of the latest report of analysis from the laboratory approved by State Board/Central Board/ Central Government in the Ministry of Environment and Forests ). For proposed units furnish expected characteristics.</td>
      <td>Document is attached</td>
    </tr>    
    <tr>
      <td valign="top">34. Mode of storage (intermediate or final) (describe area, location and methodology).</td>
       <td>'.strtoupper($storage_mode).'</td>
    </tr>    
    <tr>
    	<td valign="top">35. Present treatment of hazardous waste, if any (give type and capacity of treatment units)</td>
    	<td>'.strtoupper($haz_pres_treatment).'</td>
  	</tr>  
  	<tr>
      <td valign="top">36. Quantity of hazardous waste disposed<br/>
      <p style="text-indent:14px;">(i) Within the factory</p></td>
      <td><br/>'.strtoupper($haz_qty_dispose_a).'</td>
    </tr>    
    <tr>
      <td valign="top" style="text-indent:14px;">(ii) Outside the factory (Specify location and enclose copies of agreement)</td>
      <td>'.strtoupper($haz_qty_dispose_b).'</td>
    </tr>   
    <tr>
      <td valign="top" style="text-indent:14px;">(iii) Through sale (Enclose documentary proof and copies of agreement)</td>
      <td>Document is attached</td>
    </tr>    
    <tr>
      <td valign="top" style="text-indent:14px;">(iv) Outside State / Union Territory , if yes particulars of (i) & (iii) above</td>
       <td>'.strtoupper($haz_qty_dispose_d).'</td>
    </tr>
    <tr>
      <td valign="top" style="text-indent:14px;">(v) Other (specify)</td>
...
<table width="99%" border="1" class="table table-bordered table-resposive" style="border-collapse: collapse">
    <tr>
      <td width="50%" valign="top">37. (a) Do you have any proposals to upgrade the present system for treatment and disposal of effluent/ emission and / or hazardous waste</td>
      <td>'.strtoupper($is_sys_upg).'</td>
    </tr>	
    <tr>
      <td valign="top">37. (b) If yes, give the details with time-schedule for the implementation and approximate expenditure to be incurred on it.</td>
      <td>'.strtoupper($sys_upg_details).'</td>
    </tr>
    
    <tr>
      <td valign="top">38. Capital and recurring (O & M) expenditure on various aspects of environment protection such as effluent, emission ,hazardous waste, solid waste, tree plantation, monitoring, date acquisition etc. (give figures separately for items implemented / to be implemented).</td>
      <td>Document is attached</td>
    </tr>
     <tr>
	...
	<tr>
		<td colspan="2"><table class="table table-bordered table-responsive">
			<thead>
				<tr><th width="40%">Pollution Control Equipment</th><th width="30%">Emission/Effluent Type</th><th width="30%">Seperate Meters are installed ?</th></tr>
			</thead>
    ...
    <tr>
      <td valign="top">41. Nature, quantity and method of disposal of non-hazardous solid waste generated separately from the process of manufacture and waste treatment. (Give details of area / capacity available in applicants land)</td>
      <td>'.strtoupper($nonhaz_details).'</td>
    </tr>
    
    <tr>
      <td valign="top">42. Hazardous Chemicals - Give details of chemicals and quantities handled and stored.</td>
      <td>'.strtoupper($haz_chemicals).'</td>
    </tr>
    <tr>
      <td valign="top" style="text-indent:14px;">(i) Is the unit a Major Accident Hazard unit as per MSIHC Rules ?</td>
      <td>'.strtoupper($haz_chemicals_details_a).'</td>
    </tr>
    
    
    <tr>
      <td valign="top" style="text-indent:14px;">(ii) Is the unit an isolated storage as defined under the MSIHC Rules ?</td>
      <td>'.strtoupper($haz_chemicals_details_b).'</td>
    </tr>
    
    <tr>
      <td valign="top" style="text-indent:14px;">(iii) Indicate status of compliance of Rules 5, 7, 10, 11, 1 2, 13 and 18 of the MSIHC Rules.</td>
      <td>'.strtoupper($haz_chemicals_details_c).'</td>
    </tr>
    
    <tr>
      <td valign="top" style="text-indent:14px;">(iv) Has approval of site been obtained from the concerned authority ?</td>
       <td>'.strtoupper($haz_chemicals_details_d).'</td>
    </tr>
    
    
    <tr>
      <td valign="top" style="text-indent:14px;">(v) Has the unit prepared an Off-site Emergency Plan ? </td>
       <td>'.strtoupper($haz_chemicals_details_e).'<br/>Is it updated ? '.strtoupper($haz_chemicals_details_f).'</td>
    </tr>
    
     <tr>
      <td valign="top" style="text-indent:14px;">(vi) Has information on imports of chemicals been provided to the concerned authority ?</td>
       <td>'.strtoupper($haz_chemicals_details_g).'</td>
    </tr>
     <tr>
      <td valign="top" style="text-indent:14px;">(vii) Does the unit posses a policy under the PLI Act?</td>
       <td>'.strtoupper($haz_chemicals_details_h).'</td>
    </tr>
     
    
    <tr>
      <td valign="top">43. Brief details of tree plantation / green belt development within applicants premises (in hectares).</td>
       <td>Document is attached</td>
    </tr>
    
    <tr>
      <td valign="top">44. Information of schemes for waste minimisation, resource recovery and recycling - implemented and to be implemented, separately.</td>
       <td>Document is attached</td>
    </tr>
 
    <tr>
      <td valign="top">45. (a) The applicant shall indicate whether industry comes under Public Hearing, if so, the relevant documents such as EIA, EMP, Risk Analysis etc. shall be submitted, if so, the relevant documents enclosed shall be indicated accordingly</td>
       <td>'.strtoupper($public_hearing_doc).'</td>
    </tr>
    
    <tr>
      <td valign="top" style="text-indent:15px">(b) Any other additional information that the applicant desires to give.</td>
       <td>'.strtoupper($other_info).'</td>
    </tr>
    <tr>
         <td valign="top">46. Do You Have DG Set?</td>
...
<table width="99%" border="1" class="table table-bordered table-resposive" style="border-collapse: collapse">
    ...
    <tr>
      <td valign="top" colspan="2">48. I / We hereby submit that in case of any change from what is stated in this application in respect of raw materials, products, process of manufacture and treatment and / or disposal of effluent, emissions, hazardous wastes etc. in quality and quantity; a fresh application for Consent / Authorisation shall be made and until the grant of fresh Consent / Authorisation no change shall be made.</td>
    </tr>
    
    <tr>
      <td valign="top" colspan="2">49. I / We undertake to furnish any other information within one month of its being called by
the Board / Committee.</td>
    </tr>
    
 	 <tr>
      <td valign="top" colspan="2">50. I / We agree to submit to the Board an application for renewal of consent / authorisation in two months in advance before the date of expiry of the consent / authorisation validity period:</td>
    </tr>
     ';
    ...
    <tr>
		...
		<table class="table table-bordered table-responsive">
				<tr>
					<td>Place : '.strtoupper($dist).'<br/> Date : '.$sub_date.'</td>
