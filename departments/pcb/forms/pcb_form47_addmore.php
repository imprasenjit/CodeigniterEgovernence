<?php
if(isset($form_id)){
	$part1=$formFunctions->executeQuery($dept,"SELECT id FROM pcb_form47_products WHERE form_id='$form_id'");
	$num = $part1->num_rows;
}else{
	$num=0;
}
...
if(isset($form_id)){
	$part2=$formFunctions->executeQuery($dept,"SELECT id FROM pcb_form47_materials WHERE form_id='$form_id'");
	$num2 = $part2->num_rows;
}else{
	$num2=0;
}
...
<?php 
if(isset($form_id)){
	$part3=$formFunctions->executeQuery($dept,"SELECT id FROM pcb_form47_dgsets WHERE form_id='$form_id'");
	$num3 = $part3->num_rows;
}else{
	$num3=0;
}
