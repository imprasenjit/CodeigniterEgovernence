...
if($q->num_rows<1){	
	...
	if($p->num_rows>0){
		...
		if(!empty($results["haz_chemicals_details"])){
			...
			$haz_chemicals_details_a=$haz_chemicals_details->a;$haz_chemicals_details_b=$haz_chemicals_details->b;$haz_chemicals_details_c=$haz_chemicals_details->c;$haz_chemicals_details_d=$haz_chemicals_details->d;$haz_chemicals_details_e=$haz_chemicals_details->e;$haz_chemicals_details_f=$haz_chemicals_details->f;$haz_chemicals_details_g=$haz_chemicals_details->g;$haz_chemicals_details_h=$haz_chemicals_details->h;
		}else{
							...
							<div class="panel-body">
								...
								<div class="tab-content">
									...
									<form name="myform1" class="myform1 submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
										...
										<table class="table table-responsive table-bordered">
											...
											<tr>
												...
												(i) Consent to Establish under section 25 and 26 of the Water (Prevention and Control of Pollution) Act, 1974, as amended.<br/>
												(ii) Consent to establish under Section 21 of the Air (Prevention and Control of Pollution) Act, 1981, as amended.<br/>
											...
											<tr>
												<td colspan="4">1. Name, Designation and Address with telephone number, e-mail of the Applicant :</td>
											</tr>
											<tr>
												<td width="25%">Name</td>
											...
											<tr>
												<td colspan="4">2. (a) Name and location of the industrial unit / premises for which the application is made. (Give revenue Survey Number /plot number, name of Taluka and District also telephone number)</td>
											</tr>
											<tr>
												<td>Name</td>
											...
											<tr>												
												...
												<td>Revenue Survey Number /<br/>Plot Number<span class="mandatory_field">*</span></td>
												<td><input type="text" class="form-control text-uppercase" name="revenue_survey_no"  value="<?php echo strtoupper($revenue_survey_no);?>" required="required"></td>											
											</tr>
											<tr>
											...
											<tr>												
												...
												<td><input type="text" validate="jsonObj" name="plan_details[prn]" value="<?php echo strtoupper($plan_details_prn);?>" class="form-control text-uppercase" ></td>
											...
											<tr>												
												...
												<td><input type="text"  name="plan_details[ia]" value="<?php echo strtoupper($plan_details_ia);?>" class="form-control text-uppercase" ></td>
											...
											<tr>
												<td>Name</td>
												<td><input type="text" class="form-control text-uppercase" validate="letters" value="<?php echo strtoupper($md_name);?>" name="md_name"></td>
												<td>Designation</td>
											...
											<tr>
												<td>Pincode</td>
												<td><input type="text" class="form-control text-uppercase" value="<?php echo strtoupper($m_p);?>" validate="pincode" maxlength="6" name="md_address[pin]"></td>
												<td>Mobile</td>
												<td><input type="text" class="form-control text-uppercase" validate="mobileNumber" maxlength="10" value="<?php echo strtoupper($m_m);?>" name="md_address[mn]"></td>
											</tr>
											<tr>
												<td>Phone Number</td>
											...
											<tr>
												...
												<td><input type="text" class="is_registered form-control text-uppercase" name="reg_no"  validate="jsonObj" value="<?php echo $reg_no; ?>" <?php if($is_registered=='N') echo 'disabled'; ?> ></td>
									...
									<form name="myform1" class="myform1 submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
										<table class="table table-responsive table-bordered">
											<tr>
												<td colspan="3">5. Gross capital investment of the unit without depreciation till the date of application(Cost of building, land,plant and machinery)<span class="mandatory_field">*</span></td>
											...
											<tr>
												<td width="25%">Distance<span class="mandatory_field">*</span></td>
												<td width="25%">
												<input type="text" name="site_distance[a]" validate="decimal" value="<?php echo $site_distance_a;?>" class="form-control text-uppercase">
												...
												<td width="25%">Name of the water body</td>
												<td width="25%"><input type="text" name="wb_name" placeholder="Name of the water body"   value="<?php echo $wb_name?>" class="form-control text-uppercase"></td>										
											</tr>
											<tr>
												<td colspan="2">7. Does the location satisfy the requirements under relevant Central / State Govt. <br/>notifications such as Coastal Regulation Zone, Notification on Ecologically Fragile Area,<br/> Industrial location policy, etc. If so, give details.<span class="mandatory_field">*</span></td>
												<td>
											...
											<tr>
												<td colspan="3">(b) will the applicant utilise the system, if provided</td>
												<td ><input type="text" id="is_provided_yes" name="is_use" value="<?=$is_use;?>" class="form-control text-uppercase"  ></td>	
											</tr>
											<tr>
											...
											<td colspan="4">
												<table name="objectTable1" class="table table-responsive table-bordered "id="objectTable1" >
													...
													<tr>
														...
														<td><input value="<?php echo $row_1["name"]; ?>" pattern="[a-zA-Z0-9.\s]+" title="No special characters are allowed except Dot" id="txtB<?php echo $count;?>" class="form-control text-uppercase"; name="txtB<?php echo $count;?>"></td>
														<td>
													...
													<?php
														...
														if($num>0){
														 ...
														 <tr>
															...
															<td><input value="<?php echo $row_1["name"]; ?>" id="textB<?php echo $count;?>" class="form-control text-uppercase" size="20" name="textB<?php echo $count;?>"></td>
															<td>
															...
															<td><input value="<?php echo $row_1["qty"]; ?>" id="textD<?php echo $count;?>" class="form-control text-uppercase" name="textD<?php echo $count;?>" size="15"></td>
									...
									<div id="table3" class="tab-pane <?php echo $tabbtn3; ?>" role="tabpanel">
										...
										<table class="table table-responsive table-bordered">
											...
											<tr>
												...
												<td><input type="text" name="water_source[c]" validate="decimal" value="<?php echo $water_source_c;?>" class="form-control text-uppercase"></td>
											</tr>
											<tr>
									...
									<div id="table4" class="tab-pane <?php echo $tabbtn4; ?>" role="tabpanel">
										...
										<table class="table table-responsive table-bordered">
											...
											<tr>
												...
												<td>(b) If yes, state at which stage - whether  <br/>before, intermittentlyor after treatment.</td>
											...
											<tr>
												...
												<td><input type="text" name="disposal_mode[j]" validate="onlyNumbers" placeholder="Quantity" value="<?php echo $disposal_mode_j; ?>" class="form-control text-uppercase"></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td><input type="text" name="effluents_quality[b]" validate="onlyNumbers" value="<?php echo $effluents_quality_b;?>" placeholder="Concentration of Suspended Solid" class="form-control text-uppercase"></td>
											</tr>
											<tr>
												<td><input type="text" name="effluents_quality[c]" validate="onlyNumbers" value="<?php echo $effluents_quality_c;?>" placeholder="Biochemical Oxygen Demand" class="form-control text-uppercase"></td>
												<td><input type="text" name="effluents_quality[d]" validate="onlyNumbers" value="<?php echo $effluents_quality_d;?>" placeholder="Chemical Oxygen Demand" class="form-control text-uppercase"></td>
											</tr>
											<tr>
												<td><input type="text" name="effluents_quality[e]" validate="onlyNumbers" value="<?php echo $effluents_quality_e;?>" placeholder="Specific Pollutants" class="form-control text-uppercase"></td>
												<td><input type="text" name="effluents_quality[f]" validate="onlyNumbers" value="<?php echo $effluents_quality_f;?>" placeholder="Total Disolved Solids" class="form-control text-uppercase"></td>
											</tr>
											<tr>
									...
									<form name="myform1" class="myform1 submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">									
										<table class="table table-responsive table-bordered">
											...
											<tr>
												...
												<table  class="table table-responsive table-bordered">        
													...
													<tr>
													  ...
													  <td><input type="text" class="form-control text-uppercase" name="sd[gq][sn1]" id="textfield144" value="<?php echo $sd_gq_sn1; ?>" /></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[gq][sn2]" id="textfield145" value="<?php echo $sd_gq_sn2; ?>"  /></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[gq][sn3]" id="textfield146" value="<?php echo $sd_gq_sn3; ?>"  /></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[gq][sn4]" id="textfield147" value="<?php echo $sd_gq_sn4; ?>"  /></td>
													</tr>
													<tr>
													  <td>Gas temperature, (<sup>0</sup>C) </td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[gt][sn1]" id="textfield148" value="<?php echo $sd_gt_sn1; ?>" onchange="number(this.id)"  validate="decimal"/></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[gt][sn2]" id="textfield149" value="<?php echo $sd_gt_sn2; ?>" onchange="number(this.id)"  validate="decimal"/></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[gt][sn3]" id="textfield150" value="<?php echo $sd_gt_sn3; ?>" onchange="number(this.id)"  validate="decimal"/></td>
													  <td><input type="text" class="form-control text-uppercase" name="sd[gt][sn4]" id="textfield151" value="<?php echo $sd_gt_sn4; ?>" onchange="number(this.id)"  validate="decimal"/></td>
													</tr>
													<tr>
											...
											<tr>
												<td  style="width:75%" colspan="3">28. Do you have adequate facility for collection of samples of emissions in the form of port holes, platform, ladder etc. as per Central Board Publication "Emission Regulations Part-III"(December 1985)<font color="red">*</font></td>
												<td>
											...
											<tr>
												<td colspan="2">29. Quality of treated effluent gas emissions and process emissions.(Specify concentration of criteria pollutants and industry / process-specific pollutants stack-wise.) Enclose a copy of the latest report of analysis from the approved laboratory by State Board / Central Board / Central Government in the Ministry of Environment and Forests. For proposed units furnish the expected characteristics of the emission.</td>
												<td colspan="2">Upload later in upload section</td>
											</tr>
											<tr>
												<td class="text-center" colspan="4">
									...
									<div id="table6" class="tab-pane <?php echo $tabbtn6; ?>" role="tabpanel">
										...
										<table class="table table-responsive">
											...
											<tr>
												<td width="25%">(i) Within the factory</td>
												<td width="25%"><input type="text" name="haz_qty_dispose[a]" id="textfield176" value="<?php echo $haz_qty_dispose_a; ?>" class="form-control text-uppercase">	</td>
												<td width="25%">(ii) Outside the factory (Specify location and enclose copies of agreement)	</td>
												<td width="25%"><input type="text" name="haz_qty_dispose[b]" id="textfield176" value="<?php echo $haz_qty_dispose_b; ?>" class="form-control text-uppercase">	</td>
											</tr>
											<tr>
									...
									<div id="table7" class="tab-pane <?php echo $tabbtn7; ?>" role="tabpanel">
										...
										<table class="table table-responsive table-bordered">
											...
											<tr>
												<td >(i) Is the unit a Major Accident Hazard unit  as per MSIHC Rules ?<span class="mandatory_field">*</span></td>
												<td ><label class="radio-inline"><input type="radio" value="Y" <?php if($haz_chemicals_details_a == 'Y') echo 'checked'; ?> id="inlineRadio1" name="haz_chemicals_details[a]" required="required"> Yes </label>
											...
											<tr>
												<td >(ii) Is the unit an isolated storage as  defined under the MSIHC Rules ?<span class="mandatory_field">*</span></td>
												<td ><label class="radio-inline"><input type="radio" value="Y" <?php if($haz_chemicals_details_b == 'Y') echo 'checked'; ?> id="inlineRadio1" name="haz_chemicals_details[b]" required="required"> Yes </label>
											...
											<tr>
												<td>(v) Has the unit prepared an Off-site Emergency Plan ?<span class="mandatory_field">*</span></td> 
											...
											<tr>
												<td colspan="2">44. Information of schemes for waste minimisation, resource
												recovery and recycling - implemented and to be implemented, separately.</td>
												<td colspan="2">Upload later in upload section</td>
											</tr>
                                          <tr>
                                                <td>45. Do You Have DG Set?</td>
                                            ...
                                            <tr>
                                                <td colspan=4>
                                                    <table name="objectTable3" class="table table-responsive table-bordered "id="objectTable3" >
                                                        ...
                                                        <?php
                                                        $part3=$formFunctions->executeQuery($dept,"select * from pcb_form3_dgsets where form_id='$form_id'");
                                                        $num3 = $part3->num_rows;
                                                        if($num3>0){
                                                        $count=1;
											...
											<tr>
												<td colspan="2">46. (a) The applicant shall indicate whether industry comes under Public Hearing, if so, the relevant documents such as EIA, EMP, Risk Analysis etc. shall be submitted, if so, the relevant documents enclosed shall be indicated accordingly</td>
