 ...
 $table_name=getTableName($dept,$form);	
	...
	if($q->num_rows>0){
		...
		$address_change_values="";		
		  ...
		  if($address_change_c=="F") $address_change_values=$address_change_values. '<span class="tickmark">&#10004;</span>Fertilizer';
		  if($address_change_d=="Ot") $address_change_values=$address_change_values. '<span class="tickmark">&#10004;</span>Others';
    ...
    <div style="text-align:center">
  	...
  	<table class="table table-bordered table-responsive">
			...
			<tr>
				<td>4. Existing Valid Fertilizer License No. & Dated :</td>
				<td><table class="table table-bordered table-responsive">
			...
			<tr>
				<td colspan="2">8. For Amendment in Fertilizers :</td>
			</tr>
			<tr>
				<td colspan="2">
					<table class="table table-bordered table-responsive">
						<thead>
							<tr>
								<td>Sl no.</td>
								<td><b>Existing Fertilizer(s)</b></td>
								<td><b>New Fertilizer(s)</b></td>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td>1.</td>
								<td>'.strtoupper($fertilizer_amendment_existing1).'</td>
								<td>'.strtoupper($fertilizer_amendment_new1).'</td>
							</tr>
							<tr>
								<td>2.</td>
								<td>'.strtoupper($fertilizer_amendment_existing2).'</td>
								<td>'.strtoupper($fertilizer_amendment_new2).'</td>
							</tr>
							<tr>
								<td>3.</td>
								<td>'.strtoupper($fertilizer_amendment_existing3).'</td>
								<td>'.strtoupper($fertilizer_amendment_new3).'</td>
							</tr>
							<tr>
								<td>4.</td>
								<td>'.strtoupper($fertilizer_amendment_existing4).'</td>
								<td>'.strtoupper($fertilizer_amendment_new4).'</td>
							</tr>
							</tbody>
					</table>
				</td>
			...
			<tr>
				<td colspan="2">9. For amendment in any other categories</td>
			</tr>
			<tr>
				<td>Existing  :</td>
				<td>'.strtoupper($existing_other_categories).'</td>
			</tr>
			<tr>
				<td>New :</td>
				<td>'.strtoupper($new_other_categories).'</td>
			</tr>
			<tr>
