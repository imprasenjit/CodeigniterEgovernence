								...
								<form name="myform1" id="myform1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
										...
										<tr>
                                            ...
                                            <td><input type="text" class="form-control text-uppercase"   name="sale[d]" value="<?php echo $sale_d;?>"/></td>
										...
										<tr>
											...
											<td>District :<span class="mandatory_field">*</span></td>
                                            <td><input type="text" class="form-control text-uppercase"  name="storage[d]" value="<?php echo $storage_d;?>" /></td>
