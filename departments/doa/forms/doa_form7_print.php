...
<html>
    ...
    <div style="text-align:center">
  	...
  	<table class="table table-bordered table-responsive">
		...
		<tr>
			<td colspan="2">
				...
				<tr align="center" >
					...
					<th width="55%" align="center">Name of fertilizer</th>
					<th width="40%" align="center">Whether certificate of source in Form "O" is attached</th>
				</tr>';
		...
		<tr>
			<td>Date : <strong>'.date('d-m-Y',strtotime($results["sub_date"])).'<br/></strong> 
