		...
		$p=$formFunctions->executeQuery($dept,"select * from ".$table_name." where user_id='$swr_id' and active='0' ORDER BY form_id DESC LIMIT 1");
			if($p->num_rows>0){
				...
				if(!empty($results["address_change"])){
					...
					if(isset($address_change->c)) $address_change_c=$address_change->c; else $address_change_c="";
					if(isset($address_change->d)) $address_change_d=$address_change->d; else $address_change_d="";
				}else{
					$address_change_a="";$address_change_b="";$address_change_c="";$address_change_d="";
				}
				...
				if(!empty($results["fertilizer_amendment"])){
					$fertilizer_amendment=json_decode($results["fertilizer_amendment"]);
					$fertilizer_amendment_safety_equipment=$fertilizer_amendment->safety_equipment;$fertilizer_amendment_antidotes=$fertilizer_amendment->antidotes;$fertilizer_amendment_other_facilities=$fertilizer_amendment->other_facilities;
				}else{				
					 $fertilizer_amendment_existing1="";$fertilizer_amendment_new1="";$fertilizer_amendment_existing2="";$fertilizer_amendment_new2="";$fertilizer_amendment_existing3="";$fertilizer_amendment_new3="";$fertilizer_amendment_existing4="";$fertilizer_amendment_new4="";
				}
				
				$existing_other_categories=$results["existing_other_categories"];
				$new_other_categories=$results["new_other_categories"];
				...
				$existing_other_categories="";$new_other_categories="";$is_affidavit="";
			}
	}else{			
			...
			$existing_godown_add=$results["existing_godown_add"];$new_godown_add=$results["new_godown_add"];
				...
				if(!empty($results["fertilizer_amendment"])){
					$fertilizer_amendment=json_decode($results["fertilizer_amendment"]);
					$fertilizer_amendment_existing1=$fertilizer_amendment->existing1;$fertilizer_amendment_new1=$fertilizer_amendment->new1;$fertilizer_amendment_existing2=$fertilizer_amendment->existing2;$fertilizer_amendment_new2=$fertilizer_amendment->new2;$fertilizer_amendment_existing3=$fertilizer_amendment->existing3;$fertilizer_amendment_new3=$fertilizer_amendment->new3;$fertilizer_amendment_existing4=$fertilizer_amendment->existing4;$fertilizer_amendment_new4=$fertilizer_amendment->new4;
				}else{				
					 $fertilizer_amendment_existing1="";$fertilizer_amendment_new1="";$fertilizer_amendment_existing2="";$fertilizer_amendment_new2="";$fertilizer_amendment_existing3="";$fertilizer_amendment_new3="";$fertilizer_amendment_existing4="";$fertilizer_amendment_new4="";
				}
							...
							<div class="tab-content">
								...
								<table class="table table-responsive table-bordered">
									...
									<tr>
										...
										<td>Mobile No. :</td>
										<td><input type="text" name="godown_add[mno]" value="<?php echo $godown_add_mno; ?>" class="form-control" validate="mobileNumber" maxlength="10"></td>
									</tr>
									<tr>
										<td>E-mail id :</td>
										<td><input type="email" class="form-control" name="godown_add[email]" value="<?php echo  $godown_add_email; ?>"></td>
									...
									<tr>
										<td colspan="4">4. Existing Valid Fertilizer License No. & Dated :</td>
									</tr>
									<tr>
									...
									<tr>
										<td>5. Which address/fertilizer to amend :</td>
										<td colspan="3">
											<label class="checkbox-inline"><input type="checkbox" <?php if($address_change_a=="O") echo "checked"; ?> name="address_change[a]" value="O">Office&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </label>
											<label class="checkbox-inline"><input type="checkbox" <?php if($address_change_b=="G") echo "checked"; ?> name="address_change[b]" value="G">Godown&nbsp;&nbsp;</label><br/>
											<label class="checkbox-inline"><input type="checkbox" <?php if($address_change_c=="F") echo "checked"; ?> name="address_change[c]" value="F">Fertilizer&nbsp;&nbsp;</label>
											<label class="checkbox-inline"><input type="checkbox" <?php if($address_change_d=="Ot") echo "checked"; ?> name="address_change[d]" value="Ot">Others&nbsp;&nbsp;</label>
										</td>
									</tr>
									<tr>
									...
									<tr>
											...
											<td><textarea class="form-control text-uppercase" name="existing_office_add" validate="textarea"><?php echo $existing_office_add;?></textarea></td>
											<td>New Office Address :</td>
											<td><textarea class="form-control text-uppercase" name="new_office_add" validate="textarea"><?php echo $new_office_add;?></textarea></td>
									</tr>
								...
								<form name="myform1" class="submit1" id="" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
									<table class="table table-responsive table-bordered">
										...
										<tr>
												<td width="25%">Existing Godown Address  :</td>
												<td width="25%"><textarea class="form-control text-uppercase" name="existing_godown_add" validate="textarea"><?php echo $existing_godown_add;?></textarea></td>
												<td width="25%">New Godown Address :</td>
												<td width="25%"><textarea class="form-control text-uppercase" name="new_godown_add" validate="textarea"><?php echo $new_godown_add;?></textarea></td>
										</tr>
										<tr>
											 <td colspan="4">8. For Amendment in Fertilizers :</td>
										</tr>
										<tr>
											<td colspan="4">
											...
											<table class="table table-responsive table-bordered">
												<tr>
													<td><b>Sl no.</b></td>
													<td align="center"><b>Existing Fertilizer(s)</b></td>
													<td align="center"><b>New Fertilizer(s)</b></td>
												</tr>
												<tr>
													<td>1.</td>
													<td><input type="text" class="form-control text-uppercase" name="fertilizer_amendment[existing1]"  value="<?php echo $fertilizer_amendment_existing1;?>"></td>
													<td><input type="text" class="form-control text-uppercase" name="fertilizer_amendment[new1]"  value="<?php echo $fertilizer_amendment_new1;?>"></td>
												</tr>
												<tr>
													<td>2.</td>
													<td><input type="text" class="form-control text-uppercase" name="fertilizer_amendment[existing2]"  value="<?php echo $fertilizer_amendment_existing2;?>"></td>
													<td><input type="text" class="form-control text-uppercase" name="fertilizer_amendment[new2]"  value="<?php echo $fertilizer_amendment_new2;?>"></td>
												</tr>
												<tr>
													<td>3.</td>
													<td><input type="text" class="form-control text-uppercase" name="fertilizer_amendment[existing3]"  value="<?php echo $fertilizer_amendment_existing3;?>"></td>
													<td><input type="text" class="form-control text-uppercase" name="fertilizer_amendment[new3]"  value="<?php echo $fertilizer_amendment_new3;?>"></td>
												</tr>
												<tr>
													<td>4.</td>
													<td><input type="text" class="form-control text-uppercase" name="fertilizer_amendment[existing4]"  value="<?php echo $fertilizer_amendment_existing4;?>"></td>
													<td><input type="text" class="form-control text-uppercase" name="fertilizer_amendment[new4]"  value="<?php echo $fertilizer_amendment_new4;?>"></td>
												</tr>
											</table></td>
										</tr>
										<tr>
												<td colspan="4">9. For amendment in any other categories :</td>
										</tr>
										<tr>
												<td width="25%">Existing :</td>
												<td width="25%"><textarea class="form-control text-uppercase" name="existing_other_categories" validate="textarea"><?php echo $existing_other_categories;?></textarea></td>
												<td width="25%">New :</td>
												<td width="25%"><textarea class="form-control text-uppercase" name="new_other_categories" validate="textarea"><?php echo $new_other_categories;?></textarea></td>
										</tr>
										<tr>
											<td>10. Court Affidavit of address change submitted :</td>
