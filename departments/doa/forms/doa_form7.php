							...
							<div class="panel-body">
								...
								<form name="myform1" id="myform1" class="submit1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
									<table id="" class="table table-responsive">
										...
										<tr>
											<td>Pincode :</td>
											<td><input type="text" class="form-control text-uppercase"  name="sale[p]" value="<?php echo $sale_p;?>" validate="pincode" maxlength="6"></td>
											<td>Mobile No. :</td>
											<td><input  type="text" name="sale[mno]" value="<?php echo $sale_mno; ?>" class="form-control" validate="mobileNumber" maxlength="10"></td>
										</tr>
										<tr>
										...
										<tr>
											<td>Pincode :</td>
											<td><input type="text" value="<?php echo $storage_p; ?>" class="form-control text-uppercase" name="storage[p]" validate="pincode" maxlength="6"></td>
											<td>Mobile No. :</td>
											<td><input  type="text" name="storage[mno]" value="<?php echo $storage_mno; ?>" class="form-control" validate="mobileNumber" maxlength="10"></td>
										</tr>
										<tr>
