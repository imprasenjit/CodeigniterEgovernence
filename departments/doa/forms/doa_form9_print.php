...
<html>
    ...
    <div style="text-align:center">
  	...
  	<table class="table table-bordered table-responsive">
  	    ...
  	    <tr>
            <td >1. Details of the Notified Authority to whom applicant is submitted </td>
			<td width="50%">Designation of Notified Authority :&nbsp;'.strtoupper($auth_desig).'<br/>
		...
		<tr>
			<td v>c. Postal address with telephone number</td>
			<td >
				<table class="table table-bordered table-responsive">
					<tr>
						<td >Street name 1 </td>
		...
		<tr>
			<td colspan="2">
				...
				<tr align="center" >
					...
					<th width="25%" align="center">Name of fertilizer</th>
					<th width="20%" align="center">Whether certificate of source in Form "O" is attached</th>
				</tr>';
		...
		<tr>
				<td align="top">5. Whether the intimation is for an authorization letter or a renewal thereof. (Note: In case the intimation is for renewal of authorization letter, the acknowledgement in Form A2 should be submitted for necessary endorsement their on).</td>
				<td align="top">'.strtoupper($is_intimate).'</td>
		</tr>
		<tr>
		...
		<tr>
				<td colspan="2">
					I have read terms and conditions of eligibility for submission of memorandum of intimation and undertake the same will be accompanied by me and in token of the same; I have signed the same and is enclosed herewith.</td>
		</tr>
		<tr>
