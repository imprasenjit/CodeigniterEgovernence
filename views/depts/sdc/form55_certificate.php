...
<!--copied from sdc_certificate55.php-->
<div align="center" style="padding: 10px 30px;width:99%; border:2px solid black;">	
	...
	<img src="<?=base_url('public/imgs/assam.png')?>" class="alomlogoimg" />		
		...
		<h4><b>FORM 28&ndash;A</b></h4>
		<h4><b>[See Rule 76&ndash;A]</b></h4>
		<h4><b><em>Licence to manufacture for sale [or for distribution of]drugs specified in Schedule C and C (1) [excluding those Specified in Sch. X]</em></b></h4>
		<br/>
		<table width="100%">
			<tr>
		...
		<div align="justify">
			<ol>
			    ...
			    <li>			    	
			        M/s <b><?=strtoupper($companyName);?></b> of <b><?=strtoupper($key_person);?></b> is hereby granted a loan licence to manufacture on the Premises situated at <b><?=strtoupper($address);?></b> the following drugs being drugs specified in Schedule C and C(1) [excluding those specified in Schedule X] to the drugs and Cosmetics Rule, 1945.<br/>
			    ...
			    <li>
			    	The licence authorizes the sale by way of wholesale dealing by the licence and storage for sale by the licence of the drugs manufactured under the licence subject to the conditions applicable to licence for sale.
			    </li>
			    <li>
			    	The licence is subjected to the conditions stated below and to such other conditions as may be specified in the Rules for the time being in force under the Drugs and Cosmetics Act,1940.
			    </li>
			</ol>
		</div>
