...
if(!empty($row["supervision"])){

		$supervision=json_decode($row["supervision"]);
            ...
            <div class="content-wrapper">
                <div class="box box-primary box-alm">
                    ...
                    <div class="box-body">
                        ...
                        <!-- copied from sdc_form9_certificate_print.php -->
...
<div align="center" style="padding: 10px 20px;width:99%; border:2px solid black;">
   ...
   <img src="<?=base_url('public/imgs/assam.png')?>" class="alomlogoimg" />		<br/>
		...
		<h4><b>FORM 25</b></h4>
		<h4><b>(See Rule 70)</b></h4>
		<h4><b>Licence to manufacture for sale or for distribution of drugs other than those specified in Scheduled C, C (I) and X.</b></h4>
		<br/>
		<table width="100%"  >
			<tr>
		...
		<br/>
		<p align="justify">Number of licence and date of issue: <b><?php echo $license_no; ?></b>, <b><?=date('d-m-Y',strtotime($issue_date)); ?></b></p>
		<div align="justify">
			<ol>
			    <li>			    	
                    M/S <b><?=strtoupper($companyName); ?></b> is hereby licensed to manufacture the following categories of drugs being drugs other than those specified in Schedule C and C(I) and X to the Drugs and Cosmetics Rules, 1945 on the premises situated at <b><?=strtoupper($address); ?></b> under the direction and supervision of the following Expert staff &ndash;<br/>
                    <ol type="a">
                    	<li>
                    		Expert Staff (names)<br/>
                    	...
                    	<li>
                    		Names of drugs each item to be separately specified <br/>
                    		<b><?=strtoupper($drug_name); ?></b>
                    	</li>
                    </ol>
			    </li>
			    <li>
			    	The Licence authorize the sale by way of wholesale dealing and storage for sale by the Licenses of the drugs manufactured under the Licence, subject to the conditions applicable to licence for sale.
			    </li>
			    <li>			    	
			    ...
			    <li>The licence is subject to the conditions started below and to such other conditions as may be specified in the rules for the time being in force under the Drugs and Cosmetics Act, 1949.</li>
			</ol>
		</div>
		<br/>
		<div class="col-sm-12" style="padding:0;">
			...
			<div class="col-sm-6 pull-right" >
				<p align="right"><?php echo strtoupper($sign); ?><br/>Licensing Authority</p>
			</div>	
		</div>
		<br/>
		<table width="100%">
		...
		<div align="justify">
		    <ol>
		    	...
		    	<li>If the licensee wants to manufacture for sale additional items of drugs not induled above he should apply to the Licensing Authority for the necessary endorsement as provided in Rule 69-(5). This licence will be deemed to extend to the categories so endorsed.</li>
