            ...
            <div class="content-wrapper">
                <div class="box box-primary box-alm">
                    ...
                    <div class="box-body">
						...
						<!-- copied from sdc_form8_certificate_print -->
...
<div align="center" style="padding: 10px 20px;width:99%; border:2px solid black;">
   ...
   <img src="<?=base_url('public/imgs/assam.png')?>" class="alomlogoimg" />		<br/>
		...
		<h4><b>FORM 20&ndash;C</b></h4>
		<h4><b>[See Rule 67&ndash;C]</b></h4>
		<h4><b>Licence to sell, stock or exhibit [or offer] for sale, or distribute Homoeopathic medicines by retail</b></h4>
		<br/>
		<table width="100%"  >
			<tr>
		...
		<div align="justify">
			<ol>
			    <li><b><?=strtoupper($companyName); ?></b> is hereby licensed to sell , stock or exhibit [ or offer] for sale, or distribute by retail Homoeopathic medicines on the premise situated at <b><?=strtoupper($address); ?></b> Subject to the conditions specified below and the provisions of the Drug and Cosmetics Act, 1940 and Rules made there under. </li>
				<li>The licence shall be in force from <b><?=date('d-m-Y',strtotime($issue_date)); ?></b> to <b><?=date('d-m-Y',strtotime($valid_upto)); ?></b>
				</li>
				<li>Name of the competent person-in-charge. <br/>
                    <b><?=strtoupper($key_person);?></b>
				</li>
			</ol>
		</div>
		<br/>
		...
		<div align="justify">
		    <ol>
		    	<li>The licence shall be displayed in prominent place in a part of the premises open to the public.</li>
		    	<li>The Licensee shall comply with the provisions applicable Homeopathic medicines under the Drugs and Cosmetics Act, 1940 and the Rules made there under for the time being in force.</li>
		    	<li>The licensee shall report to the Licensing Authority may change in the competent staff with one month of such change.</li>
		    	<li>This licence authorizes the sale of Homeopathic medicines made from one earlier potency up to a quantity of 30ml. at a time</li>
		    	<li>Where any change in the constitution of the firm takes place, a licensee shall inform the Licensing Authority in writing about the same and the current licence shall be valid only for a period of three months from the date on which the change takes place unless, in the meantime, a fresh licence has been taken from the Licensing Authority in the name of the firm with the changed constitution.</li>
		    </ol>
	</div>
	<!-- copied from sdc_form8_certificate_print -->
</div>
