...
<!--copied from sdc_certificate44.php-->
	 <div align="center" style="padding: 10px 30px;width:99%; border:2px solid black;">	
		...
		<h4><b>FORM 26&ndash;H</b></h4>
		<h4>(Rules 68&ndash;A,76,77,78)</h4>
		<h4><b>Certificate of Renewal of licence to manufacture for sale of [Large Parenterals/Sera and Vaccine/Recombinant DNA (r&ndash;DNA) derived drugs] specified in schedules C and C&ndash;1 excluding thos specified in schedule X</b></h4>
		<br/>
		<table width="100%"  >
			<tr>
		...
		<div align="justify">
			<ol>
				<li>Certified that licence No. <?=strtoupper($prev_lic_no);?> granted on the <?=date('d-m-Y',strtotime($prev_issue_date)); ?> to <?=strtoupper($companyName);?> for the manufacture of following [Large Parenterals/Sera and Vaccine/Recombinant DNA (r&ndash;DNA) derived drugs] at the premises situated at <?=strtoupper($address);?> has been renewed from <?=date('d-m-Y',strtotime($issue_date)); ?> to <?=date('d-m-Y',strtotime($valid_upto)); ?>.
				</li>
				<li>Name(s) of items.<br/><?=strtoupper($drug_name);?>
				</li>
