            ...
            <div class="content-wrapper">
                <div class="box box-primary box-alm">
                    ...
                    <div class="box-body">
						...
						<!-- copied from sdc_form53_certificate.php -->
<div align="center" style="padding: 10px 30px;width:99%; border:2px solid black;">	
	<img src="<?=base_url('public/imgs/assam.png')?>" class="alomlogoimg" />		
		...
		<h4><b>Form 25 &ndash; F</b></h4>
		<h4><b>[Rule 70]</b></h4>
		<h4><b><em>Licence to manufacture for sale [or for distribution] of drugs specified in Schedule X and not specified in Schedule X and not specified in Schedule C and C(1)</em></b></h4>
		<br/>
		<table width="100%">
			<tr>
		...
		<div align="justify">
			<ol>
			    <li>
			    	<b><?=strtoupper($companyName);?></b> of <b><?=strtoupper($key_person);?></b> is hereby licensed to manufacture at the premises situated at <b><?=strtoupper($address);?></b> the following drugs specified in schedule X to the Drugs and Cosmetics Rules 1945.
			    </li>
			    <li>Name of Drugs : <b><?=strtoupper($drug);?></b></li>			    
			    <li>Number of licence and date of issue <b><?=strtoupper($license_no);?></b>, <b><?=date('d-m-Y',strtotime($issue_date)); ?></b></li>
			    <li>Names of approved [Competent Technical Staff]
			    	<table>
			    ...
			    <li>
			    	The licence authorizes the sale by way of wholesale dealing and storage for sale by the licensee of the drug manufactured under the licence subject to the conditions applicable to licence for sale.
			    </li>
			    <li>
			    ...
			    <li>
			    	The licence is subjected to the conditions stated below and to other conditions as my be specified in the Rules for the time being in force under the Drugs and Cosmetics Act, 1940.
			    </li>
			</ol>
		</div>
	    ...
	    <div align="justify">
	        <ol>
	           <li>This licence and any certificate of renewal in force shall be kept on the licensed premises and shall be produced at the request of an Inspector appointed under the Drugs and Cosmetics Act, 1940.</li>
	           <li>If the licensee wants to undertake during the currency of the licence to manufacture of any drug specified in Schedule X not included above, he should apply to the Licensing A sale additional drugs he should apply to the Licensing Authority for the necessary endorsement to the licence as provided in Rule 69-A. This licence will be deemed to extend to the drugs so endorse.</li> 	           
