...
<html>
	...
	<div align="center" style="padding: 10px 20px;width:99%; border:2px solid black;">	
						...
						<!--copied from sdc_certificate13.php-->
	<img src="<?=base_url('public/imgs/assam.png')?>" class="alomlogoimg" />		<br/>
		<h2 class="text-uppercase"><?php echo $this->dept_name; ?></h2>
		<h4><em>License to manufacture for sale or for distribution of drugs specified in Schedule X and not specified in Schedule C and C (1)</em></h4>
		<br/>
		<table width="100%"  >
			<tr>
		...
		<br/>
		<p align="justify">1. <?php echo strtoupper($companyName);?> is hereby licensed to manufacture at the premises situated at <?php echo strtoupper($address);?> the following drugs specified in Schedule X to the Drugs and Cosmetics Rules, 1945.</p>
		<br/>
		<p align="justify">2. Name of drugs.<br/><?php echo strtoupper($drug_name);?></p>
		<br/>
		<p align="justify">3. Names of approved [Competent Technical Staff]<br/>
		 <?php 
		...
		<br/>
		<p align="justify">4. The license authorizes the sale by way of wholesale dealing and storage for sale by the licensee of the drugs manufactured under the license subject to the conditions applicable to license for sale.</p>
		<br/>
		<p align="justify">5. The licence, unless sooner suspended or cancelled, shall remain perpetually. However, the compliance with the conditions of licence and the provisions of the Drugs & Cosmetics Act,1940 (23 of 1940) and the Drugs & Cosmetics Rules, 1945 shall be assessed not less than once in three years or as needed as per risk based approach.</p>
		<br/>
		<p align="justify">6. The license is subject to the conditions stated below and to other conditions as may be specified in the Rules for the time being in force under the Drugs and Cosmetics Act, 1940.</p>
		<br/>
		<table width="100%">
			<tr>
				<td>Date of issue : <?php echo date("d-m-Y",strtotime($issue_date)); ?></td>
				<td align="right">Signature : <?=strtoupper($sign);?></td>
			</tr>
			<tr>
				<td>License No: <?=strtoupper($license_no);?></td>
				<td align="right">Designation : <?=strtoupper($design);?></td>
			</tr>
			<tr>
				<td></td>
				<td align="right">[Licensing Authority/ Central License Approving Authority]</td>
			</tr>
		</table>
		<br/>
		...
		<div align="justify">
		    <ol>
		    	<li>This licence and any certificate of renewal in force shall be kept on the premises and shall be produced at the request of an inspector appointed under the Drugs and Cosmetic Act ,1940.</li>
		    	<li>Any change in the technical staff named in the licence shall be forthwith reported to the licensing authority.</li>
