...
<!--copied from sdc_certificate59.php-->
	...
	<img src="<?=base_url('public/imgs/assam.png')?>" class="alomlogoimg" />		
		...
		<div align="justify">
			<ol>
			    ...
			    <li><b><?=strtoupper($companyName); ?></b> of <b><?=strtoupper($key_person); ?></b> is hereby granted a loan license to manufacture the following cosmetics on the premises situated at <b><?=strtoupper($address); ?></b> C/o <b><?=strtoupper($co_name); ?></b> under the direction and proposal supervision of the following technical staff.</li>
			    <li>
			    	<ol type="a">
