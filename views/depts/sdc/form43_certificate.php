...
<html>
    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
                ...
                <div class="box box-primary box-alm">
                    ...
                    <div class="box-body">
                        <div class="alomcertbl printcontent">
                          <!-- copied codes from sdc_form43_certificate_print.php -->
		...
		<h4><b>[FORM 26&ndash;G]</b></h4>
		<h4>(Rule 122&ndash;F)</h4>
		<h4><b>Certificate of Renewal of licence to Operate a Blood Bank for processing of Whole Human Blood and/or for sale or distribution of its components</b></h4>
		<br/>
		<table width="100%"  >
			<tr>
		...
		<div align="justify">
			<ol>
				<li>Certified that licence No. <?=strtoupper($license_no);?> granted on the <?=date('d-m-Y',strtotime($license_date)); ?> to M/S&ndash;<?=strtoupper($companyName);?> for the operation of a Blood Bank for preocessing of Whole Human Blood and/or preparation of its components at the premises situated at <?=strtoupper($address);?> is hereby renewed with the effect from <?=date('d-m-Y',strtotime($issue_date)); ?> to <?=date('d-m-Y',strtotime($valid_upto)); ?>.
				</li>
				<li>Name(s) of items.<br/>
		...
		<div class="col-sm-12" style="padding:0;">
			<div class="col-sm-6">
				<p align="center"><br/>Central Licence Approving Authority</p>
			</div>					
			<div class="col-sm-6 pull-right" >
				<p align="center"><?=strtoupper($sign); ?><br/>
				State Licencing Authority</p>
			</div>	
		</div>
		<br/>
		<table width="100%">
