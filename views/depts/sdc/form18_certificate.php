    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
             ...
             <!--copied from sdc_form18_certificate.php-->
		...
		<h4><b>Licence to manufacture for sale or for distribution of Large Volume Parenterals / Sera and Vaccines specified in Schedule C and C-1 excluding those specified in Schedule X.</b></h4>
		<br/>
		<table width="100%"  >
			<tr>
			...
			<tr>
				<td>Number of licence <b><?=strtoupper($license_no); ?></b> and Date of issue <b><?=date('d-m-Y',strtotime($issue_date)); ?></b></td>
		...
		<div align="justify">
			<ol>
			    <li>M/S <b><?=strtoupper($companyName); ?></b> is hereby licensed to manufacture at the premises    situated at <b><?=strtoupper($address); ?></b>. The following large Volume Parenterals / Sera and Vaccines specified in Schedule C and C (1) excluding those specified in Schedule X to the Drugs and Cosmetics Rules, 1945.</li>
			    <li>Name(s) of Drugs (s) Large Volume Parenterals (LVP) (each item to be separately specified)<br/>
                ...
                <li>The licence authorizes the sale by way of wholesale dealing and storage of sale by the licensee of the drugs manufactured under the licence, subject to the conditions applicable to licence for sale.</li>
                ...
                <li>The licence shall be subject to the conditions stated below and to such other conditions as shall be specified in the Rules for the time being in force under Drugs and Cosmetics Act, 1940.</li>
			</ol>
		</div>
		<br/>
