    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
				...
				<!-- copied codes from sdc_form47_certificate_print.php -->  
<div align="center" style="padding: 10px 30px;width:99%; border:2px solid black;">	
		...
		<h4><b>[FORM 33]</b></h4>
		<h4>[See Rule 141&ndash;A]</h4>
		<h4><b>Certificate of Renewal of loan licence to manufacture cosmetics for sale</b></h4>
		<br/>
		<table width="100%"  >
			<tr>
		...
		<div align="justify">
			<ol>
				<li>Certified that loan licence No. <?=strtoupper($prev_lic_no);?> granted on the <?=date('d-m-Y',strtotime($prev_issue_date)); ?> to <?=strtoupper($companyName);?> for the manufacture for sale of following cosmetics at the premises situated at C/o <?=strtoupper($address);?> has been renewed from <?=date('d-m-Y',strtotime($issue_date)); ?> to <?=date('d-m-Y',strtotime($valid_upto)); ?>.
				</li>
				<li>Name of Cosmetics :<br/>
				<?=strtoupper($cosmetics_names);?>
				</li>
