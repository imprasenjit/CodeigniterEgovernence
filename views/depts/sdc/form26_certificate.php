...
<html>
    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
        <div class="wrapper">
            ...
            <!--copied from sdc_certificate24.php-->
	<div align="center" style="padding: 10px 20px;width:99%; border:2px solid black;">	
		...
		<h4><b>Certificate of renewal of [licence to sell, stock, of exhibit or offer for sale by wholesale, or distribute ] drugs from a motor vehicle</b></h4>
		<br/>
		<table width="100%">
			<tr>
		...
		<div align="justify">
			<ol>
			    <li>Certified that license No. <b><?=strtoupper($prev_lic_no); ?></b> in Form 20&ndash;BB or Form 21&ndash;BB granted on the <?=date('d-m-Y',strtotime($prev_issue_date)); ?> to <b><?=strtoupper($companyName); ?></b> for sale by wholesale or distribution on the following drugs from the vehicle bearing registration No. <b><?=strtoupper($reg_no); ?></b> assigned under the motor Vehicle Act, 1939 has been renewed for a periond from <b><?=date('d-m-Y',strtotime($issue_date)); ?></b> to <b><?=date('d-m-Y',strtotime($valid_upto)); ?></b></li>
			    <li>Catagories of the drugs : <b><?=strtoupper($catrgories); ?></b>
			    </li>
			</ol>
		</div>
		<br/>
