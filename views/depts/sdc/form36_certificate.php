...
<!--copied from sdc_certificate36.php-->
   	<div align="center" style="padding: 10px 30px;width:99%; border:2px solid black;">	
		...
		<h4>[Rules 73&ndash;A and 83&ndash;A]</h4>
		...
		<div align="justify">
			<ol>
				<li>Certified that a loan licence No. <?=strtoupper($prev_lic_no);?> granted on the <?=date('d-m-Y',strtotime($prev_issue_date)); ?> for the manufature of the &ast;drugs other than those specified in Schedules C, C(1) and X <?=strtoupper($drug_name);?> under the mentioned drugs being drugs specified in Schedules C and C(1) excluding those specified in Schedule X, to the Drugs and Cosmetics Rules, 1945, at the premises situated at <?=strtoupper($address);?> C/o <?=strtoupper($co_name);?> has been renewed from <?=date('d-m-Y',strtotime($issue_date)); ?> to <?=date('d-m-Y',strtotime($valid_upto)); ?>.
				</li>
			</ol>
		</div>
