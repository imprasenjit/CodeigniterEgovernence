...
$formRow = $this->forms_model->get_row($this->dept_code, $form_table, $form_id);
	...
	//	$drug_name = $formCertRow->names_of_drugs;
...
<div align="center" style="padding: 10px 20px;width:99%; border:2px solid black;">
	...
	<img src="<?=base_url('public/imgs/assam.png')?>" class="alomlogoimg" />		<br/>
		...
		<h4><b>Licence to manufacture for sale or for distribution of drugs specified in Schedule C and C-1 excluding those specified in Schedule X</b></h4>
		<br/>
		<table width="100%"  >
			<tr>
		...
		<div align="justify">
			<ol>
			    <li>M/s <b><?=strtoupper($companyName); ?></b> Is hereby licensed to manufacture at the premises situated at the <b><?=strtoupper($address); ?></b> The following drugs , being drugs specified in Schedule C and C(1) excluding those specified in Schedule X to the Drugs and Cosmetics Rules, 1945<br/>
			    Name of drugs:- <b><?=strtoupper($drug_name); ?></b>
			    </li>
                ...
                <li>The licence authorises the sale way of wholesale dealing and storage for sale by the licences of the drugs manufactured under the licence subject to the condition applicable to licences for sale.</li>
			    ...
			    <li>The licence is subject to the conditions stated below and to such other conditions as may be specified to the Rules for the time being in force under the Drugs and Cosmetics Act, 1940.</li>
			</ol>
		</div>
		<br/>
		...
		<div align="justify">
		    <ol>
		    	<li>This licence and any certificate of renewal inforce shall be kept on the approved premises and shall be product at the request if an Inspector appointed under Drugs and Cosmetics Act, 1940.</li>
		    	<li>If the licensee wishes to undertake during the currency of the licence the manufacture if any drug specified in Schedule C and C (1) excluding those specified in schedule X not included above, he should apply to the licensing authority for the necessary endorsement as provided in Rule 75(3). This licence will be deemed to extend to the items so endorsed.</li>
		    	<li>Any change in the [Competent Technical Staff] shall be forthwith reported to the Licensing Authority.</li>
	...
	<!---copied from sdc_certificate14.php----->
