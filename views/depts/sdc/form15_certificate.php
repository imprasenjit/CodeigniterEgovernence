...
<html>
                ...
                <div class="box box-primary box-alm">
                    ...
                    <div class="box-body">
                        <div class="alomcertbl printcontent">
                            <!---copied from sdc_certificate15.php--->
	<div align="center" style="padding: 10px 20px;width:99%; border:2px solid black;">	
		...
		<h4><b>Licence to manufacture for sale [or for distribution of]drugs specified in Schedule C and C (1) [excluding those Specified in Sch. X] </b></h4>
		<br/>
		<table width="100%"  >
			<tr>
		...
		<div align="justify">
			<ol>
			    ...
			    Name of drugs <b><?=strtoupper($drug_name); ?></b></b>
			    </li>
                ...
                <li>The licence authorizes the sale by way of wholesale dealing by the licence and storage for sale by the licence of the drugs manufactured under the licence subject to the conditions applicable to licence for sale.</li>
			    <li>The licence is subjected to the conditions stated below and to such other conditions as may be specified in the Rules for the time being in force under the Drugs and Cosmetics Act,1940.</li>
			</ol>
		</div>
		<br/>
