...
<html>
    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
            ...
            <div class="content-wrapper">
                <div class="box box-primary box-alm">
                    ...
                    <div class="box-body">
                        ...
                        <!-- copied codes from sdc_form51_certificate.php -->   
		...
		<h4><b><em>License to manufacture drugs for the purpose of Examination test or analysis</em></b></h4>
		<br/>
		<table width="100%"  >
			<tr>
		...
		<div align="justify">
			<ol>
			    <li>
			    	<b><?=strtoupper($companyName);?></b> of <b><?=strtoupper($key_person);?></b> is hereby licensed to manufacture the drugs specified below for the purpose of examination, test or analysis at <b><?=strtoupper($address);?></b>
			    </li>
			    <li>
			    	This licence is subjected to conditions prescribed in Part-VIII of the Drugs and Cosmetic Rules, 1945
			    </li>
			    <li>This Licence shall be in force for one year from the date spacified below :-
			        <br/>
			        <b><?php echo date('d-m-Y',strtotime($issue_date)); ?></b>
			    </li>
				 <li>Name of drugs : <b><?=strtoupper($drugs_name); ?></b></li>
