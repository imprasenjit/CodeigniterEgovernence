...
<html>
    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
        ...
        <!-- copied codes from sdc_form35_certificate_print.php -->
   	<div align="center" style="padding: 10px 30px;width:99%; border:2px solid black;">	
		...
		<h4><b>FORM 26</b></h4>
		<h4><b>(See Rules 73 and 83)</b></h4>
		<h4><b>Certificate of Renewal of licence to manufacture for sale of drugs other than those specified in Schedule X</b></h4>
		<br/>
		<table width="100%"  >
			<tr>
		...
		<div align="justify">
			<ol>
				<li>Certified that licence No. <?=strtoupper($prev_lic_no);?> granted on the <?=date('d-m-Y',strtotime($prev_issue_date)); ?> to M/s <?=strtoupper($companyName);?> for the manufature of follwoing catagories of drugs being drugs other than those specified in Schedules C, C(1) and X.<br/>
				 <?=strtoupper($drug_name);?> drugs specified in Schedule C and C (1) excluding those specified in Schedule X to the Drugs & Cosmetics Rules 1945, at the premises situated at <?=strtoupper($address);?> has been renewed from <?=date('d-m-Y',strtotime($issue_date)); ?> to <?=date('d-m-Y',strtotime($valid_upto)); ?></li>
				<li>Name(s) of approved Competent Technical staff<br/>
				<table>
				...
				<li>Name of drugs (each item to be separately specified)<br/>
				<?=strtoupper($drug_name);?></li>
			</ol>
		</div>
