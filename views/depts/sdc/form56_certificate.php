...
<!--copied from sdc_certificate56.php-->
<div align="center" style="padding: 10px 30px;width:99%; border:2px solid black;">	
	...
	<img src="<?=base_url('public/imgs/assam.png')?>" class="alomlogoimg" />		
		...
		<h4><b>FORM 28&ndash;B</b></h4>
		<h4><b>[See Rule 76]</b></h4>
		<h4><b><em>Licence to manufacture for sale [or for distribution of]drugs specified in Schedule C and C (1) and X</em></b></h4>
		<br/>
		<table width="100%">
			<tr>
		...
		<div align="justify">
			<ol>
			    <li>
			        Number of licence and date of issue <b><?=strtoupper($license_no);?></b>, <b><?=date('d-m-Y',strtotime($issue_date)); ?></b>
			    </li>
			    <li>
                    <b><?=strtoupper($companyName);?></b> Is hereby licensed to manufacture at the premises situated at <b><?=strtoupper($address);?></b> the following drugs specified in Schedule C, C(1) and X to the Drugs and Cosmetics Rules, 1945.
			    </li>
			    <li>
			    ...
			    <li>
			    	The licence authority the sale by way of wholesale dealing and storage for sale by the licensee of the drugs manufactured under the licence subject to the conditions applicable to licence for sale.
			    </li>
	        	<li>
			    ...
			    <li>
			    	The licence is subject to the conditions stated below and to such other conditions as may be specified in the Rules for the time being in force under the Drugs and Cosmetics Act,1940 
			    </li>
			</ol>
		</div>
	    ...
	    <div align="justify">
	        <ol>
	           ...
	           <li>If the licensee wants to undertake during the currency of the licence to manufacture for sale additional drugs he should apply to the Licensing Authority for the necessary endorsement to the licence as provided in Rule 75(4).
	           <br/>
	           This licence will be deemed to extend to the drugs so endorse.</li> 	           
	           ...
	           <li>The licensee shall not manufacture drugs specified in Schedule X covered by this licence for use as  Physicians Samples.</li>
	        </ol>
	    </div>
