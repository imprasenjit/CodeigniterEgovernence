        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="box box-primary box-alm">
                   ...
                   <!-- copied codes from sdc_form39_certificate_print.php -->  
<div align="center" style="padding: 10px 30px;width:99%; border:2px solid black;">	
		...
		<h4><b>FORM 26&ndash;F</b></h4>
		<h4>[Rules 73 and 83]</h4>
		<h4><b>Certificate of Renewal of licence to manufacture for sale of drugs specified in Schedule X</b></h4>
		<br/>
		<table width="100%"  >
			<tr>
		...
		<div align="justify">
			<ol>
				<li>Certified that licence No. <?=strtoupper($prev_lic_no);?> granted on the <?=date('d-m-Y',strtotime($prev_issue_date)); ?> to <?=strtoupper($companyName);?> for the manufacturing of drugs specified in Schedule X to the Drugs and Cosmetics Rules, 1945, at the premises situated at <?=strtoupper($address);?> has been renewed from <?=date('d-m-Y',strtotime($issue_date)); ?> to <?=date('d-m-Y',strtotime($valid_upto)); ?>.
				</li>
				<li>Names of the drugs (each substance should be separately specified).<br/>
				<?=strtoupper($drug);?>
				</li>
				<li>Names of approved [Competent Technical Staff] : <br/>
