...
<table id="table-5" style="display:none" class="table table-bordered table-responsive">
    ...
    <tbody>
        ...
        <tr>
			<td>License No. of Form 20B</td>
			<td><input type="text" class="form-control text-uppercase" name="license_no" id="license_no" value=""/></td>
			<td>License No. of Form 21B</td>
			<td><input type="text" class="form-control text-uppercase" name="license_no21" id="license_no21" value=""/></td>	
		</tr>	
...
<script type="text/javascript">
	...
	$(document).on("click", "#btn-issuecer", function () {
            ...
            $.ajax({
                type: "POST",
                url: "<?=base_url('staffs/issuecertificates/sdc_issue_certificate_form1')?>",
                data: { 
                    uain: uain,
