...
<!--copied from sdc_certificate48.php-->
...
<div align="center" style="padding: 10px 30px;width:99%; border:2px solid black;">	
		...
		<h4><b>FORM 33A</b></h4>
		<h4><b>(See rule 141&ndash;A)</b></h4>
		<h4><b><em>Certificate of renewal of loan licence to manufacture cosmetic for sale</em></b></h4>
		<br/>
		<table width="100%"  >
			<tr>
		...
		<div align="justify">
			<ol>
			    <li>
			        Certified that loan licence No. <b><?=strtoupper($prev_lic_no);?></b> granted on the <b><?=date('d-m-Y',strtotime($prev_issue_date)); ?></b> to <b><?=strtoupper($companyName);?></b> for the manufacture for sale of the following cosmetics at the premises situated at C/o <b><?=strtoupper($co_name);?></b> has been renewed from <b><?=date('d-m-Y',strtotime($issue_date)); ?></b> to <b><?=date('d-m-Y',strtotime($valid_upto)); ?></b>.
			    </li>
			    <li>
			    	Names of cosmetics.<br/>
