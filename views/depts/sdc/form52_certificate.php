...
<div align="center" style="padding: 10px 30px;width:99%; border:2px solid black;">	
	...
	<img src="<?=base_url('public/imgs/assam.png')?>" class="alomlogoimg" />		
		...
		<h4><b><em>Loan licence to manufacture for sale [ or distribution of] drugs other than those specified in [ Schedule C, C(I) and X]</em></b></h4>
		<br/>
		<table width="100%">
			<tr>
			...
			<ol>
			    ...
			    <li>
			        ...
			        <ol type="a">
			        	...
			        	<li>Names of drugs<br/>
                            <b><?=strtoupper($drug_name);?></b>
			        	</li>
			        </ol>
			    </li>
			    <li>
			        The licence authorize the sale by way of wholesale dealing by the licensee and storage for sale by the licensee of the drug manufactured under the licence subject to the conditions applicable to licences for sale.
			    </li>
			    <li>
