...
<!--copied from sdc_certificate38.php-->
		...
		<h4><b>FORM 26&ndash;C</b></h4>
		<h4>[Rule 85&ndash;G]</h4>
		<h4><b><em>Certificate of Renewal of licence to manufacture for sale of Homoeopathic medicine</em></b></h4>
		<br/>
		<table width="100%"  >
			<tr>
		...
		<div align="justify">
			<ol>
				<li>Certified that licence No. <?=strtoupper($license_no);?> granted on the <?=date('d-m-Y',strtotime($prev_issue_date)); ?> to <?=strtoupper($companyName);?> for the manufacture for sale of the Homoeopathic Mother Tinctures/ potentised preparations at the premises situated at <?=strtoupper($address);?> has been renewed from <?=date('d-m-Y',strtotime($issue_date)); ?> to <?=date('d-m-Y',strtotime($valid_upto)); ?>.
				</li>
