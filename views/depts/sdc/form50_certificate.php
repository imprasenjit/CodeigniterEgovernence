...
<html>
	...
	<div align="center" style="padding: 10px 30px;width:99%; border:2px solid black;">	
		...
		<h4><b>FORM&ndash;29</b></h4>
		<h4><b>[See Rule 89]</b></h4>
		<h4><b><em>Licence to manufacture drugs for purposes of examination, test or analysis</em></b></h4>
		<br/>
		<table width="100%"  >
			<tr>
		...
		<br/>
		<p align="center">Drugs and Cosmetics Rules 1945</p>
		<div align="justify">
			<p>1. <b><?=strtoupper($companyOwner);?></b> of <b><?=strtoupper($companyName);?></b> is hereby licensed to
			manufacture the drugs specified below for purposes of examination, test or analysis at <b><?=strtoupper($address);?></b>.</p>
			<p>2. This licence is subject to the conditions prescribed in Part VIII of the Drugs and Cosmetics Rules, 1945.</p>
			<p>3. This licence shall be in force for three years from date specified below.<br/>
			<?php echo date('d-m-Y',strtotime($issue_date)); ?></p>
			<p>Name of drugs :</p>			
			<table width="100%" class="table table-bordered">
				<tr>
					<th width="5%">Sl No</th>
					<th width="30%">Dosage Form</th>
					<th width="60%">Composition</th>
				</tr>
				
				<?php
											$formRows = $this->forms_model->get_frmrows($this->dept_code, "sdc_form50_t1", $form_id);
