...
<html>
    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
       ...
       <!-- copied codes from sdc_form41_certificate.php -->
	 ...
	 <div align="center" style="padding: 10px 30px;width:99%; border:2px solid black;">	
		...
		<h4><b>[FORM 26 &ndash; A]</b></h4>
		<h4><b>[Rules 73&ndash;A and 83&ndash;A]</b></h4>
		<h4><b>Certificate of renewal of loan licence to Manufacture for sale of drugs other than those specified in Schedule X</b></h4>
		<br/>
		<table width="100%">
			<tr>
		...
		<div align="justify">
			<ol>
			    <li>
			    	Certify that a loan licence No <b><?=strtoupper($prev_lic_no);?></b> granted on the <b><?=date('d-m-Y',strtotime($prev_issue_date)); ?></b> for the manufacture of the *drugs other than those specified in Schedules C, C(1) and X <b><?=strtoupper($companyName);?></b> the under mentioned drugs being drugs specified in Schedules C, C(1) excluding those specified in Schedule X , to the Drugs and Cosmetics Rule , 1945, at the premises situated at <b><?=strtoupper($address);?></b> C/o <b><?=strtoupper($co_name);?></b> has been renewed from <b><?=date('d-m-Y',strtotime($issue_date)); ?></b> to <b><?=date('d-m-Y',strtotime($valid_upto)); ?></b>.
			    </li>
			</ol>
		</div>
