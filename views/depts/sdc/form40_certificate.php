...
<!--copied from sdc_certificate40.php-->
<div align="center" style="padding: 10px 30px;width:99%; border:2px solid black;">	
		...
		<h4><b>Certified of renewal of licence to manufacture for sale of drugs other than those specified in Schedule X.</b></h4>
		<br/>
		<table width="100%"  >
			<tr>
		...
		<div align="justify">
			<ol>
			    <li>
			    	Certified that licence No <b><?=strtoupper($prev_lic_no);?></b> granted on the <b><?=date('d-m-Y',strtotime($prev_issue_date)); ?></b> To M/s <b><?=strtoupper($companyName);?></b> for the manufacture of the following categories of drugs being drugs other than those specified in Schedules C, C (1) and X
			    	<br/>
			    	Drugs specified in Schedule C and C (1) excluding those specified in Schedule X to the Drugs & Cosmetics Rules 1945 , at the premises situated at <b><?=strtoupper($address);?></b> has been renewed from <b><?=date('d-m-Y',strtotime($issue_date)); ?></b> to <b><?=date('d-m-Y',strtotime($valid_upto)); ?></b>.
			    </li>
			    <li>
			    	Name (s) of approved Competent Technical Staff:-
			    ...
			    <li>
			        Name of drugs (each item to be separately specified):-	<b><?=strtoupper($drug_name);?></b>
			    </li>
			</ol>
		</div>
