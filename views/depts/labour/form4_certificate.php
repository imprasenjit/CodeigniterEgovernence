...
<html>
            ...
            <div class="content-wrapper">
                <div class="box box-primary box-alm">
                    ...
                    <div class="box-body">
						...
						<!--copied from labour_form4_certificate.php-->
	...
	<img src="<?=base_url('public/imgs/assam.png')?>" class="alomlogoimg" />	
		<br/>
		<h4><b>Certificate of Registration to Run a Plantation.</b></h4>
		<br/>
		<table width="100%"  >
            <tr>
		...
		<br/>
		<p align="justify">Registration No : <?php echo strtoupper($reg_no); ?> </p></br></br>
		<p align="justify">Certificate of Registration is hereby granted to <?=strtoupper($companyName); ?> to run the Plantation subject to the provisions of the Plantations Labour Act, 1951 and the Rules made thereunder. </p>
		<br/>
		...
		<table width="100%">
			...
			<tr>
				...
				<td align="right">Signature of Chief Inspector</td>
			</tr> 
		</table>
		<br/>
