...
<table id="table-5" style="display:none" class="table table-bordered table-responsive">
    ...
    <tbody>
      ...
      <tr class="text-bold">
		<td>Regsitration number</td>
		<td><input type="text" name="reg_no" id="reg_no" class="form-control text-uppercase" /></td>
		<td></td>
		<td></td>			
	</tr>
        <tr>
...
<script type="text/javascript">
	...
	$(document).on("click", "#btn-issuecer", function () {
            ...
            $.ajax({
                type: "POST",
                url: "<?=base_url('staffs/issuecertificates/labour_form4')?>",
                data: { 
                    uain: uain,
