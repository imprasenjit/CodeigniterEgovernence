...
<table id="table-5" style="display:none" class="table table-bordered table-responsive">
    ...
    <tbody>
     ...
     <tr class="text-bold">
		<td colspan="3">Other particulars relevant to the employment of migrant workmen</td>
		<td><textarea type="text" class="form-control text-uppercase" name="other_particlr" id="other_particlr"></textarea></td>		
	</tr>
        <tr>
...
<script type="text/javascript">
	...
	$(document).on("click", "#btn-issuecer", function () {
            var other_particlr = $("#other_particlr").val();
            ...
            $.ajax({
                type: "POST",
                url: "<?=base_url('staffs/Issuecertificates/labour_form2')?>",
                data: { 
                    uain: uain,
                    form_table:form_table,
                    form_id:form_id,
                    other_particlr: other_particlr
                },
                beforeSend: function () {
