...
<!--copied from labour_form7_certificate.php-->                         
			...
			<div style="text-align:justify;">
				<ol>
				   ...
				   conditions specified in the annexure.</li>
					<li>This licence is for doing the work of (nature of work to be indicated) in the establishment of (Name of principal employer to be indicated) at (place of work to be indicated).</li>
					<li>The licence shall remain in force till (date to be indicated).</li>
				</ol>
			</div>
		</td>
	</tr>
