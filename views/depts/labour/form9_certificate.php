...
<html>
            ...
            <div class="content-wrapper">
                <div class="box box-primary box-alm">
                    ...
                    <div class="box-body">
						...
						<!--copied from labou_form9_certificate.php-->
	...
	<img src="<?=base_url('public/imgs/assam.png')?>" class="alomlogoimg" />	
		<br/>
		<h4><b>Office of the Assistant Labour Commissioner &ndash; Cum Licensing  Officer</b></h4>
		<h4><b>FORM &ndash; Q</b></h4>
		<p>(See Rule 47)</p>
		...
		<br/>
		<p align="justify">Name of Establishment : <?php echo strtoupper($companyName); ?> </p>
		...
		<p align="justify">Nature of Business : <?php echo strtoupper($companyName); ?> </p>
		<p align="justify">Certified that under the Assam Shop and Establishment Act and the Rules framed thereunder :<br/>
		<p align="justify"> The establishment bearing the above particulars has been registered on this <?=date('jS F, Y',strtotime($issue_date));?> for a period of twelve months upto <?php echo date('jS F',strtotime($issue_date)); ?>, <?php echo date('Y',strtotime($issue_date))+1; ?> and the Registration number is <?=strtoupper($reg_no);?>
		</p>
		<br/>
		<p align="justify">The validity of the Certificate of Registration shall expire unless renewed before the expiry date.</p>
		<br/>
		<table width="100%">
