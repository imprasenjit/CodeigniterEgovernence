...
if(!empty($formRow->contract_labour)){
	...
	$employer_name=$formRow->employer_name;
...
<html>
            ...
            <div class="content-wrapper">
                <div class="box box-primary box-alm">
                    ...
                    <div class="box-body">
						...
						<!--copied from labour_form6_certificate.php-->
	...
	<img src="<?=base_url('public/imgs/assam.png')?>" class="alomlogoimg" />	
		...
		<h4>LICENSE OF A CONTRACTOR(S) IN FORM IV UNDER SECTION 12 OF THE CONTRACT LABOUR (R & A)ACT,1970 AND RULE 21 (1) OF THE ASSAM RULES</h4>
		<br/>
		<table width="100%"  >
            <tr>
		...
		<p align="justify">
			...
			2. This licence is for doing the work of <?=strtoupper($contract_labour_a);?> in the establishment of <?=strtoupper($employer_name);?> at <?=strtoupper($address);?> </br>
