...
<html>
            ...
            <div class="content-wrapper">
                <div class="box box-primary box-alm">
                    ...
                    <div class="box-body">
						...
						<!---copied from labour_form12_certificate.php--->
	...
	<img src="<?=base_url('public/imgs/assam.png')?>" class="alomlogoimg" />	
		...
		<br/>
		<p align="justify">Registration No: <?=strtoupper($reg_no);?> </p>
		
		<p align="justify">Certificate of Registration is hereby granted to <?=strtoupper($key_person);?> to operate Motor Transport services <?=strtoupper($companyName);?> employing not more than <?=strtoupper($total_employee);?> persons on any one day during the year subject to provisions of the Motor Transport Workers Act, 1961 and the Rules made thereunder.
		</p>
		<p align="justify">The Certificate of Registration shall remain in force till the 31st day of December, <?=date('Y',strtotime($issue_date))+1;?>. </p>
		<br/>
		<table width="100%">
			<tr>
			...
			<tr>
				...
				<td align="right"><center><?=strtoupper($sign);?><br/>Chief Inspector/ Authorised Inspector </br>of </br>Motor Transport Undertakings</center></td>
			</tr> 
		</table>
		<br/>
