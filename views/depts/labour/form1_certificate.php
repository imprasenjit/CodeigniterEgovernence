        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <td align="right"><?php if($total_fees!=""){?>Fees Paid : <b><?php echo "Rs. ".$total_fees; ?><?php }?></b></td>
                            ...
                            <p align="justify">Name of Employer : <?php echo strtoupper($companyOwner); ?> </p>
                            <p align="justify">Address and location of the Establishment : <?php echo strtoupper($address); ?> </p>
                            <p align="justify">Number of Employees : --<?=strtoupper($max_workers);?> </p>
                            <p align="justify">Nature of Business : -- <?=strtoupper($companyName);?></p>
                            <p align="justify">Certified that under the Assam Shop and Establishment Act and the Rules framed thereunder :<br/>
                            <p> The establishment bearing the above particulars has been registered on this <?= date('jS F, Y',strtotime($issue_date)); ?> for a period of twelve months upto --<?=date("Y",strtotime($issue_date))+1?> and the Registration number is --<?=strtoupper($reg_no);?>
                            </p>
                            <br/>
