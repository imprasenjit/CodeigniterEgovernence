...
<html>
            ...
            <div class="content-wrapper">
                <div class="box box-primary box-alm">
                    ...
                    <div class="box-body">
						...
						<!--copied from labour_form11_certificate.php-->
	...
	<tr>
		<td colspan="4">
		<p align="justify" style="text-indent:14px;">
			Licence is hereby granted<?=strtoupper($companyName);?> uunder Section 8(1) of the Inter-State Migrant Workman (Regulation of Employment and Conditions of Service) Act, 1979, subject to the
           conditions specified in the annexure.</br>
		   
		   2. This licence is for doing the work of (nature of work to be indicated) in the establishment of (Name of principal employer to be indicated) at (place of work to be indicated).</br>
