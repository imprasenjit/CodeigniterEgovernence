...
<table id="table-5" style="display:none" class="table table-bordered table-responsive">
    <thead>
        <tr class="info">
            <th class="text-center text-bold" colspan="4">ISSUE CERTIFICATE-2</th>
        </tr>
    </thead>
    <tbody>
        <tr>
        ...
        <tr>
            ...
            <td><input id="lic_no" class="form-control text-uppercase" type="text"></td>
             <td>Consist of: </td>
        ...
        <tr>
            ...
            <td><input id="plan_no" class="form-control text-uppercase" type="text"></td>
             <td>Plan number date : </td>
            <td><input id="plan_no_date" class="dp form-control" type="date"></td>
        </tr>
...
<script type="text/javascript">
	...
	$(document).on("click", "#btn-issuecer", function () {
            ...
            var plan_no_date = $("#plan_no_date").val(); //alert(file_auth_num+", "+consist_of+", "+plan_no+", "+plan_no_date);
            ...
            $.ajax({
                type: "POST",
                url: "<?=base_url('staffs/issuecertificates/factory_form2')?>",
                data: { 
                    uain: uain,
