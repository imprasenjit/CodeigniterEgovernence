       ...
       <tr>
		...
		<td><div class="form-group">
			<select id="licence_type" name="licence_type" class="form-control">
				<option value="G">General (1 Year)</option>
				<option value="P">Provisional (1 Year)</option>
			</select>
		</div></td>
		<td>Registration No. :</td>
		<td>
			<div class="form-group">
				<input type="text" id="reg_no" name="reg_no" class="form-control text-uppercase">
			</div>
		</td>
	</tr>
        <tr>
...
<script type="text/javascript">
	...
	$(document).on("click", "#btn-issuecer", function () {
            ...
            $.ajax({
                type: "POST",
                url: "<?=base_url('staffs/issuecertificates/gmc_form1')?>",
                data: { 
                    uain: uain,
