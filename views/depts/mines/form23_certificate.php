...
$formRow = $this->forms_model->get_row($this->dept_code, "mines_form2_t1", $form_id);
if($formRow) {
  $district = $formRow->district;
} else {
	$district = "Not found";
}//End of if else
    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
		...
		<div class="col-sm-12" style="padding:0;">
			<div class="col-sm-6 pull-right">
				...
				<p>Mineral Dealer License No :<?php echo $file_auth_num; ?></p>
