    ...
    <tbody>
        ...
        <tr>
		 ...
		 <tr>
			...
			<td>Under Section :</td>
			<td><input id="act" class="form-control text-uppercase" type="text"></td>
			
		</tr>
       
		<tr>
			<td>Inspection Type :</td>
			<td><input type="text" value="" class="form-control text-uppercase" id="inspection_category"/></td>
		</tr> 
		<tr>
...
<script type="text/javascript">
	...
	$(document).on("click", "#btn-issuecer", function () {
            ...
            var act = $("#act").val();
			var inspection_category = $("#inspection_category").val();
            var terms = $("#terms").val();
            ...
            $.ajax({
                type: "POST",
                url: "<?=base_url('staffs/issuecertificates/dmedu_form1')?>",
                data: { 
                    uain: uain,
