...
<html>
    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
            ...
            <div class="content-wrapper">
                <div class="box box-primary box-alm">
                    ...
                    <div class="box-body">
						...
						<!---copied from ayush_form4_certificate.php--->
                           ...
                           <img src="<?=base_url('public/imgs/assam.png')?>" width="110px" height="140px" alt="Ashok">
                            <br/>
		<h4><b>FORM 26&ndash;D</b></h4>
		<h4>[See Rule 155]</h4>
		<h4><b>DIRECTORATE OF AYUSH</b></h4>
		<h4><b><em>Certificate of renewal of license to manufacture for sale of Ayurvedic / Siddha or Unani drugs</em></b></h4>
		<br/>
		<table width="100%">
			<tr>
		...
		<div align="justify">
			<ol type="1">
				<li>
					Certified that license No <?=strtoupper($lic_no);?> granted on the <?=date('d-m-Y',strtotime($sub_date)); ?> to Shri / Messrs <?=strtoupper($companyName);?> for the manufacture of Ayurvedic/Siddha/Unani drugs at the premises situated at <?=strtoupper($address);?> has been renewed from <?=date('d-m-Y',strtotime($valid_from)); ?> to <?=date('d-m-Y',strtotime($valid_upto)); ?>.
				</li>
				<li>Name of Technical Staff<br/>
					<table  width="100%" class="table table-responsive">
						...
						<tbody>
							<?php
				$formRows = $this->forms_model->get_frmrows($this->dept_code, "ayush_form4_t2", $form_id);

									//$part2=$ayush->query("SELECT * FROM ayush_form4_t2 WHERE form_id='$form_id'");
									//$num2 = $part2->num_rows;
									if($formRows){
													  $count=1;
				...
				<li>Name of Drugs with details
					<table width="100%" class="table table-responsive">				
						...
						<tbody>
							<?php
							$formRows = $this->forms_model->get_frmrows($this->dept_code, "ayush_form4_t1", $form_id);
                           //$part1=$ayush->query("SELECT * FROM ayush_form4_t1 WHERE form_id='$form_id'");
							//	$num = $part1->num_rows;
