...
<html>
 ...
 <table width="100%" id="paddingdone">
	...
	<tr>
		...
		<tr><td align="right" colspan="4">	Fee Rs. <?=strtoupper($total_fees)?> Paid.</td>
   </tr>
	<tr>
		<td colspan="4">&nbsp;</td>
	</tr>
	...
	<!--	<td>Type of Boiler</td>
		<td><?php if($row_certs["boiler_type"]!=NULL){ echo strtoupper($boiler_type_a)." - ".strtoupper($boiler_type_b);}else{ echo strtoupper($certificate_boiler_type); }?></td>
	</tr>
	<tr>
		<td>Boiler Rating </td>
		<td><?=strtoupper($heating_value); ?> m<sup>2</sup></td>-->
		
		
		<td>Maximum Continuous Evaporation </td>
		<td colspan="3"><?=strtoupper($max_evaporation); ?></td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="4"> Hydraulically Tested on <?=strtoupper($tested_on); ?> to <?=strtoupper($ibs_no); ?> Kg/cm<sup>2</sup></td>

	</tr>
	<tr>
		<td colspan="4">
			<p align="justify" style="padding:30px;">
				I hereby certify that the above described boiler is permitted by me/the Chief Inspector under the provisions of Section 7/8 of the Indian Boilers Act,No.V of 1923, to be worked at maximum pressure of <?=strtoupper($ibs_no); ?> Ibs. to the square inch from the period from  <?=date("d-m-Y",strtotime($sub_date)); ?>
