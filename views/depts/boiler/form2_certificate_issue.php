...
<table id="table-5" style="display:none" class="table table-bordered table-responsive">
	...
	<tr class="text-bold">
		...
		<td><input type="text"  id="valid_from" class="dobindia form-control text-uppercase dp" required="required"></td>
			
			<td>Valid upto</td>
		<td><input type="text"  id="valid_upto" class="dobindia form-control text-uppercase dp" required="required"></td>
				
	</tr>		
	<tr>		
		<td><b>Registratiion Number</b></td>
		<td><input type="text" name="reg_number" class="form-control text-uppercase" id="reg_number"></td>
	...
	<tr>		
		...
		<td><input type="text" name="boiler_type" id="boiler_type" class="form-control text-uppercase"></td>
		<td colspan="2"></td>
	</tr>				
	<tr>
		<td><b>Repairs :</b></td>
		...
		<td><b>Remarks </b></td>
		<td><div class="form-group"><textarea name="remarks" id="remarks" class="form-control classy-editor text-uppercase" id="remarks" style="" placeholder="Your Remarks"></textarea></div></td>
	</tr>
	<tr>
...
<script type="text/javascript">
	...
	$(document).on("click", "#btn-issuecer", function () {
           ...
           // var valid_from = $("#valid_from").val();
			...
			var boiler_type = $("#boiler_type").val();
            ...
            $.ajax({
                type: "POST",
               url: "<?=base_url('staffs/issuecertificates/boiler_form2')?>",
                data: { 
                    uain: uain,
