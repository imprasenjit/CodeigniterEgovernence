...
<div align="center" style="padding: 10px; border:2px solid black;">				
 ...
 <table width="100%" id="paddingdone">
	...
	<!--<tr>
		...
		<td><?=strtoupper($boiler_type_a)." - ".strtoupper($boiler_type_b); ?></td>
		<td>Boiler Rating </td>
	...
	<td>Maximum Continuous Evaporation </td>
		<td><?=strtoupper($max_evaporation); ?></td></tr>
		<tr>
		<td> Name of Owner </td>
	...
	<tr>
		<td colspan="4">
			...
			to <?php echo $year=date("Y",strtotime($sub_date))+2;?>, i.e.; <?php echo date("d",strtotime($sub_date))."-".date("m",strtotime($sub_date))."-".$year; ?>. <br/>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br/></p>
		</td>
	</tr>
</table>
