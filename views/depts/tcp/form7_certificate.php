...
<html>
    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
            ...
            <div class="content-wrapper">
                <div class="box box-primary box-alm">
                    ...
                    <div class="box-body">
						...
						<!--copied from tcp_form7_certificate.php-->
	 ...
	 <div align="center" style="padding: 10px 30px;width:85%; border:2px solid black;">		
		...
		With reference to your above application for FORMS FOR COMPLIANCE - FOR MOBILE TOWERS at <?=strtoupper($address);?> is hereby accorded and you are required  to comply with the conditions mentioned overleaf in accordance with plan submitted with / without modification.</p>
		<br/>
		<table width="100%">
			<tr>
