...
<table id="table-5" style="display:none" class="table table-bordered table-responsive">
    ...
    <tbody>
        ...
        <tr>
            <td><b>Details of completed work floor wise</b></td>
            <td colspan="3"><textarea class="form-control text-uppercase" id="work_details" name="work_details" ></textarea></td>
        </tr>											
        <tr>
            <td>Approved Built Plan</td>
            <td colspan="3">
                <div class="form-group">
                    <input id="a_built_plan" name="a_built_plan" type="file" />
                </div>
            </td>
        </tr>
        <tr>
...
<script type="text/javascript">
	...
	$(document).on("click", "#btn-issuecer", function () {
            ...
            var a_built_plan = $("#a_built_plan").val();
            ...
            $.ajax({
                type: "POST",
                url: "<?=base_url('staffs/issuecertificates/tcp_form6')?>",
                data: { 
                    uain: uain,
