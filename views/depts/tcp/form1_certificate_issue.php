...
<table id="table-5" style="display:none" class="table table-bordered table-responsive">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><input id="sub_date" class="form-control text-uppercase dp" type="text"></td>
            <td colspan="2"></td>
			<td>Approved Built Plan : </td>
            <td><input id="a_built_plan" name="a_built_plan" type="file"></td>
            <td colspan="2"></td>
        </tr>
        <tr>
            <td colspan="4">
...
<script type="text/javascript">
	...
	$(document).on("click", "#btn-issuecer", function () {
            ...
            $.ajax({
                type: "POST",
                url: "<?=base_url('staffs/issuecertificates/tcp_form1')?>",
                data: { 
                    uain: uain,
