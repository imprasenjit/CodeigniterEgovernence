...
<html>
    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
            ...
            <div class="content-wrapper">
                <div class="box box-primary box-alm">
                    ...
                    <div class="box-body">
						...
						<!--copied from tcp_form9_certificate.php-->
		...
		<table width="100%">
				...
				<tr>
				<!--<td>
					REF : Your application dated <?php echo date("d-m-Y",strtotime($received_date)); ?>
				</td>-->
				</tr>
		...
		With reference to your above application for APPLICATION FOR ENROLLMENT AS COMPETENT TECHNICAL PERSONNEL IN THE AGENCY at <?=strtoupper($address);?> is hereby accorded and you are required  to comply with the conditions mentioned overleaf in accordance with plan submitted with / without modification.</p>
		<br/>
		<table width="100%">
