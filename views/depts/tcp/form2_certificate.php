...
<html>
    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
		...
		With reference to your above application for PROGRESS CERTIFICATE at <?=strtoupper($address);?> is hereby accorded and you are required  to comply with the conditions mentioned overleaf in accordance with plan submitted with / without modification.</p>
		<br/>
		<table width="100%">
