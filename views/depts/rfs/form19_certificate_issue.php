...
<input type="text" class="dob_year text-uppercase" name="from_the_year" id="from_the_year" >
	...
	<tr class="text-bold">
		...
		<td><input type="text" class="form-control text-uppercase dobindia dp " name="reg_date" id="reg_date"/></td>
	...
	<tr class="text-bold">
		...
		<td><input type="text" class="form-control text-uppercase dobindia dp" name="validity_extended_upto" id="validity_extended_upto"/> </td>
		<td colspan="2"></td>
	</tr>
        <tr>
