...
<table id="table-5" style="display:none" class="table table-bordered table-responsive">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><input id="license_no" class="form-control text-uppercase" type="text"></td>
            <td colspan="2"></td>
			</tr>
			<tr>
			<td>License place</td>
		<td><input type="text" class="form-control text-uppercase" id="lic_place"/></td>
		<td>Valid Upto</td>
		<td><input type="text" class="dob form-control text-uppercase dp" id="valid_upto" /></td>
...
<script type="text/javascript">
	...
	$(document).on("click", "#btn-issuecer", function () {
            ...
            $.ajax({
                type: "POST",
               url: "<?=base_url('staffs/issuecertificates/rfs_form12')?>",
                data: { 
                    uain: uain,
