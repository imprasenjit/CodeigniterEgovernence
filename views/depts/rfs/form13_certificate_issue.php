...
<table id="table-5" style="display:none" class="table table-bordered table-responsive">
    ...
    <tbody>
      ...
      <tr>
		...
		<td><input type="text" class="form-control text-uppercase" name="reg_number"/></td>		
		<td>Of the year</td>
		<td>
			<input type="text" class="dob_year text-uppercase" name="from_the_year" id="from_the_year">
			 - <input type="text" class="dob_year text-uppercase" name="to_the_year" id="to_the_year">
			</td>
		</td>
	...
	<tr>
		...
		<td><input type="text" class="dob form-control text-uppercase dp" name="reg_date"/></td>	
	...
	<tr>
		...
		<td>Valid upto</td>
		<td><input type="text" class="dobindia form-control text-uppercase dp" name="valid_upto"/></td>
		
	</tr>
	<tr>
		<td>Validity extended upto</td>
		<td><input type="text" class="dobindia form-control text-uppercase dp" name="validity_extended_upto"/></td>
	</tr>
	<tr>
        <tr>
...
<script type="text/javascript">
	...
	$(document).on("click", "#btn-issuecer", function () {
            ...
            $.ajax({
                type: "POST",
                url: "<?=base_url('staffs/issuecertificates/rfs_form13')?>",
                data: { 
                    uain: uain,
