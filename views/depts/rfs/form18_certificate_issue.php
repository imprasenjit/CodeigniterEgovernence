...
<table id="table-5" style="display:none" class="table table-bordered table-responsive">
	...
	<tr class="text-bold">
		...
		<td><input type="text" class="form-control text-uppercase" name="reg_date" id="reg_date"/></td>
	...
	<tr class="text-bold">
		...
		<td>Valid Upto</td>
		<td><input type="date" class="form-control text-uppercase dobindia dp" name="valid_upto" id="valid_upto"/><//></td>
	</tr>
	<tr class="text-bold">
		<td>Validity Extended Upto</td>
		<td><input type="date" class="form-control text-uppercase dobindia" name="validity_extended_upto" id="validity_extended_upto"/></td>
		<td colspan="2"></td>
	</tr>
        <tr>
