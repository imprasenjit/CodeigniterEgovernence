...
<html>
    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
            ...
            <div class="content-wrapper">
                <div class="box box-primary box-alm">
                    ...
                    <div class="box-body">
						...
						<!--copied from rfs_form19_certificate.php-->
		...
		<br/>
			<p align="center"><em>I hereby Certify that</em> the address of the Society, <b><?=strtoupper($companyName); ?></b> has been changed a <b><?=strtoupper($address); ?></b> instead of 
	
			<!--new address-->
	
							<em>has this day been registered under the Societies Registration Act XXI of 1860.</em></p>
		...
		<table width="100%">
			...
			<tr>
				<td width="50%">
					<p style="margin-top:10px;text-indent:20px; font-size:12px"><sup>**</sup> The change in Address of the society is allowed U/S 12(A) read with sec.12 (B) and 12(C) of the Assam Start Amendment etc. (Vide Assam Act-14 of 1943 section 2.) W.E.F <?php echo date("d/m/Y",strtotime($sub_date)); ?> by <?php echo strtoupper($reg_name); ?>, REGISTRAR OF SOCIETIES, GUWAHATI, ASSAM</p>
				</td>
				<td><center><b><?php echo strtoupper($reg_name); ?></b><br/>REGISTRAR OF SOCIETIES<br/>ASSAM, GUWAHATI</center></td>
			</tr>
		</table>
		<br/><br/>
