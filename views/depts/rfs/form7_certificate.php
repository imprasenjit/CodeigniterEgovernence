...
<html>
    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
        ...
        <br/>
            <p align="center">This certificate of registration is issued to <?php echo $companyName; ?> bearing registration number on the regsiter if Firms <?php echo $reg_number; ?> OF <?php echo date("Y",strtotime($p_date))?> - <?php echo date("Y",strtotime($p_date))+1;?> for carrying out the business of Construction Material Supply.</p>
        ...
        <table width="100%" class="table table-responsive" border="1">
            <thead>
                <tr>
                    ...
                    <th width="20%">Partners address</th>
                   
                </tr>
            </thead>
            <tbody>
                <?php 
                    $formRows = $this->forms_model->get_frmrows($this->dept_code, "rfs_form7_members", $form_id);
