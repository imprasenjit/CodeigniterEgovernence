...
<html>
    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
                ...
                <div class="box box-primary box-alm">
                    ...
                    <div class="box-body">
                        <div class="alomcertbl printcontent">
                            <!--copied from rfs_form11_certificate.php-->
		...
		<br/>
			...
			<p align="center">Given under my hand at <?=strtoupper($dist);?>this <?php echo date('jS',strtotime($sub_date));?> <em>day of</em><b> <?php echo date('F',strtotime($sub_date));?> <?php echo(date('Y',strtotime($sub_date)));?>.</p>
			<p align="left">Valid upto <?php echo$valid_upto; ?></p>
