...
<!--copied from rfs_form5_certificate.php-->            
		...
		<h3><b>DISSOLUTION CERTIFICATE</b></h3>
		<h4>Under Section 63(1) of Indian Partnership Act 1932</h4>
		<br/>
		<table width="100%"  >		
			<tr>
				<td></td>
				<td align="right">Issue No. : <b><?=strtoupper($issue_number)?></b></td>
			</tr>
			<tr>
		...
		<br/>
		<p align="center">
			I hereby Certify that the firm named "<b><?php echo $companyName; ?></b>", <b><?=strtoupper($address)?></b>, Assam bearing Regn. No <b><?=strtoupper($reg_number)?></b> of <b><?=$from_the_year?>-<?=$to_the_year?></b> stands dissolved w.e.f. <?php echo date("Y",strtotime($p_date))+1;?>.
		</p>
		<p>The certificate is issued as per provision under Section 63(1) of Indian partnership Act 1932.</p>
		<br/>
		<table width="100%">
			<tr>
				<td width="50%"></td>
				<td align="right"><center><b><?=strtoupper($key_person)?></b><br/>REGISTRAR OF FIRMS<br/>ASSAM, GUWAHATI</center></td>
			</tr>
		</table>
		<br/>
		<table width="100%">
