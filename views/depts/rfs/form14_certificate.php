...
<html>
    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="box box-primary box-alm">
                   ...
                   <!--copied from rfs_form14_certificate.php-->
		...
		<br/>
			<p align="center">I hereby Certify that <?php echo strtoupper($trade_name); ?> <?php echo strtoupper($address); ?> has this day been registered under the Societies Registration Act, XXI of 1860.</p>
			<p align="center">Given under my hand at <?=strtoupper($dist);?> this <?php echo date('jS',strtotime($p_date));?> day of <?php echo date('F',strtotime($p_date));?>, <?php echo ucwords(strtolower(convertNumberToWord(date('Y',strtotime($p_date)))));?>.</p>
			<p align="left">Valid upto <?php echo date('d-m',strtotime($p_date)); ?>&#45;<?php echo date('Y',strtotime($p_date))+3;?></p>
		<br/>
		<table width="100%">
			<tr>
