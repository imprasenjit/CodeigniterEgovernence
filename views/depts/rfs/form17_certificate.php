...
//} else {
  //  $sub_date = $valid_upto = $lic_exp_year = "Not found";
//Emd of if else
?>
<!DOCTYPE html>
<html>
...
?>
                ...
                <div class="box box-primary box-alm">
                    ...
                    <div class="box-body">
                        <div class="alomcertbl printcontent">
                            <!--copied from rfs_form17_certificate.php-->
           <div align="center" style="padding: 10px; border:2px solid black;">                                <table width="100%"  >
                               ...
                               <br/>
			<p align="center"><em>I hereby Certify that</em> <b><?=strtoupper($companyName); ?>, </b> <em>has this day been registered under the Societies Registration Act XXI of 1860.</em></p>
                                ...
                                <table width="100%">
                                    <tr>
                                        <td width="50%">
                                            ...
                                            License No.: <?php echo$license_no; ?>
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>
