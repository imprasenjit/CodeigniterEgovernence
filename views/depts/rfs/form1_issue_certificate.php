...
<table id="table-5" style="display:none" class="table table-bordered table-responsive">
	...
	<tr class="text-bold">
		<td>Of the year</td>
		<td>
			<select class="dob_year text-uppercase" name="from_the_year" id="from_the_year" readonly="readonly">
			</select> - <select class="dob_year text-uppercase" name="to_the_year" id="to_the_year" readonly="readonly">
			</select>
		</td>		
		<td colspan="2"></td>
	</tr>
