...
<table id="table-5" style="display:none" class="table table-bordered table-responsive">
    ...
    <tbody>
       ...
       <tr class="text-bold">
		...
		<td><input type="text" class="form-control text-uppercase" id="reg_number"/></td>
		<td>Issue Number</td>
		<td><input type="text" class="form-control text-uppercase" id="issue_number"/></td>
	</tr>
	<tr class="text-bold">
		<td>Registration Date</td>
		<td><input type="text" class="form-control text-uppercase dp" id="reg_date"/></td>
		<td>Registrar Name</td>
		<td><input type="text" class="form-control text-uppercase" id="reg_name"/></td>
	</tr>
	<tr class="text-bold">
		<td>Of the year</td>
		<td>
		  <input type="text" class="form-control text-uppercase" id="from_the_year"></td>
     <td>
		 <input type="text" class="form-control text-uppercase" id="to_the_year"></td>
     </td>
		
		<td>Valid Upto</td>
		<td><input type="text" class="form-control text-uppercase dp" id="valid_upto"/></td>
	</tr>
	<tr class="text-bold">
		<td>Validity Extended Upto</td>
		<td><input type="text" class="form-control text-uppercase dobindia" id="validity_extended_upto"/></td>
		<td colspan="2"></td>
	</tr>
        <tr>
