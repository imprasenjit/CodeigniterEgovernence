...
<html>
    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
                ...
                <div class="box box-primary box-alm">
                    ...
                    <div class="box-body">
                        <div class="alomcertbl printcontent">
                            <!--copied from rfs_form12_certificate.php-->
		...
		<table width="100%"  >
			...
			<h3><b>REGISTRATION OF SOCIETY</b></h3>
			<br/>
			<table width="100%"  >
				<tr>
			...
			<br/>
				<p align="center">I hereby Certify that <?php echo strtoupper($companyName); ?>, <?php echo strtoupper($address); ?> has this day been registered under the Societies Registration Act, XXI of 1860.</p>
				<p align="center">Given under my hand at <?=strtoupper($dist);?> this <?php echo date('jS',strtotime($sub_date));?> day of <?php echo date('F',strtotime($sub_date));?>, <?php echo date('Y',strtotime($sub_date));?>.</p>
				<p align="left">Valid upto <?php echo date('d-m',strtotime($valid_upto)); ?>&#45;<?php echo date('Y',strtotime($valid_upto))+3;?></p>
			    <p align="left">License No.:<?php echo $license_no; ?></p>
			<br/>
			<table width="100%">
				<tr>
					<td align="left">Registrar of Firms and Societies,<br/>ASSAM<br/>Guwahati-06</td>
