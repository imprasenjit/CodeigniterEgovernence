...
if($formRow) {
    $permission = json_decode($formRow->permission);
    $road_details = json_decode($formRow->road_details);
    $overhead_type = $formRow->overhead_type;
    $license_no = $formRow->license_no;
    $licensee_name = $formRow->licensee_name;
} else {
    $permission=$road_details=$overhead_type=$license_no=$licensee_name="Not found";
}//End of if else
?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="box-body">
                        <div class="alomcertbl printcontent" style="padding:20px">
                            ...
                            <p align="justify">
                                ...
                                <b><?= strtoupper($permission->a.", ".$permission->a)?></b> at 
                                <b>
                                    <?= strtoupper($road_details->road_name.",".$road_details->vill.",".$road_details->mouza.",".$road_details->revenue_circle.",".$road_details->dist)?>
                                </b>.
                            </p>
                            <p align="justify">
                                The permission granted is for laying of / drawing of 
                                <b><?= strtoupper($overhead_type)?></b> by the authorized contractor mentioned below:<br/>
                                License No. of Authorized Contractor : <b><?= strtoupper($license_no)?></b><br/>
                                Name of Authorized Contractor : <b><?= strtoupper($licensee_name)?></b>
                            </p>
