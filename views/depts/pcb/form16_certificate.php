...
/*$formCertRow = $this->unit_model->getunitdetails($this->id);
if($formCertRow) {
	$unit_name = $formCertRow->unit_name;
                           ...
                           <img src="<?=base_url('public/imgs/assam.png')?>" width="110px" height="140px">
                            ...
                            <tbody>
                             <tr>
                                ...
                                <h5>FORM 1(bb)</h5>
                                <h5><em>[See rules 4(2), 8(2)(a), 13(2) (iii) and 13(4)(ii)]</em></h5>
                                <h4 style="text-align: center;">FORMAT FOR GRANTING AUTHORISATION FOR GENERATION OR STORAGE OR TREATMENT OR REFURBISHING OR DISPOSAL OF E-WASTE BY MANUFACTURER OR REFURBISHER</h4>
                                <br/>
                                
                                <p style="font-size:15px;"><b>Ref:   Your application for Grant of Authorisation</b></p><br/>
                                <table width="100%"  >
                                    <tr>
                                        <td>UBIN : <b><?= $ubin; ?></b></td>				
                            ...
                            <br/>
                           <table align="center" style="width:99%;font-family:sanserif; font-size: 16px;">
                                <tr>
                                        <td style="font-size: 16px; line-height: 24px">
                                            Place of issue : GUWAHATI<br/>
                                            Date of issue :  <strong><?=date("d-m-Y", strtotime($issue_date))?></strong>
                                        </td>
                            ...
                            <p style="font-size: 16px;"><b>Terms and conditions of authorisation</b></p>
                            <div align="justify" style="font-size: 16px;">
                                <ol type="1">
