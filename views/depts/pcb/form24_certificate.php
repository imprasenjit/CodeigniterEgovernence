                    ...
                    <div class="box-body">
                        <div class="alomcertbl printcontent">
                             <div id="header">
                                ...
                                <table width="90%" align="center">
                                    ...
                                    <tr>				
                                        ...
                                        <td style="text-align:right;">Date of Issue : <?php echo date("d-m-Y",strtotime($p_date)); ?></td>
                                    </tr>
                                ...
                                <table width="95%" align="center" class="table table-bordered table-responsive text-center" style="border-collapse: collapse" border="1">			
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td><?php echo strtoupper($auth_details->a); ?></td>
                                            <td><?php echo strtoupper($auth_details->b); ?></td>
                                            <td><?php echo strtoupper($auth_details->c); ?></td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            <td><?php echo strtoupper($auth_details->d); ?></td>
                                            <td><?php echo strtoupper($auth_details->e); ?></td>
                                            <td><?php echo strtoupper($auth_details->f); ?></td>
                                        </tr>
                                        <tr>
                                            <td>3</td>
                                            <td><?php echo strtoupper($auth_details->g); ?></td>
                                            <td><?php echo strtoupper($auth_details->h); ?></td>
                                            <td><?php echo strtoupper($auth_details->i); ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table align="center" style="width:99%;font-family:sanserif;">
                                        <tr>
                                            <td style="width:50%;padding-left:40px;">Place : Guwahati<br/>Date : <?php echo date("d-m-Y",strtotime($p_date)); ?></td>
                                            <td style="width:50%;padding-right:40px;text-align:right;"><?php echo strtoupper($user_name) ?><br/><br/>Authorized Signatory</td>
                                        </tr>                    
                                </table>
                                <br/>
                            ...
                            <div class="border">
                                <div id="header">
                                    <div style="font-family:lucidacalligraphy">
                                        <img class="logo" style="margin-left:30px;margin-top:10px;float:left;" src="<?php echo $admin_url; ?>departments/pcb/images/logo.jpg"/>
                                        <h1 align="left" style="margin-top:10px;padding-left:190px">Pollution Control Board</h1>
                                        <h1 align="left" style="padding-left:300px">Assam</h1>
                                        <br/>
                                    </div>
