                            ...
                            <tbody>   
                                <tr>
                                    <td colspan="3" style="padding: 1px 30px;">
                                        ...
                                        <p align="justify" style="padding:0px 20px 5px 20px;font-family:lucidacalligraphy;font-size:1.3em;line-height:32px">            
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            "<strong>CONSENT TO ESTABLISH</strong>" is hereby granted to <strong><?= $companyName ?></strong>for setting up a <strong><?= $l_o_business; ?></strong> unit with production capacity of <strong><?= $production_capacity; ?></strong> to be located at <strong><?= $address; ?></strong> under section <strong><?= $act; ?></strong> as amended under the concerned terms & conditions according to type of industry.
                                        </p>
                                        <p align="justify" style="padding:20px 30px 5px 30px;font-size: 15px;font-family:lucidacalligraphy;font-size:1.3em;line-height:25px">            
                                        ...
                                        <div class="row" style="padding-left:5%;padding-bottom:20px;">
                                            <div style="width:70%;position:relative;float:left">
                                                <span class="details" style="padding-bottom:5px; font-size:15px;"><strong><u>Details of Fees Paid</u></strong></span>
