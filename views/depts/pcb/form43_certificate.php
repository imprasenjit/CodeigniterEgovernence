...
if($formCertRow) {
	...
	if($arrear_fees_details!=""){
	 ...
	 $file_auth_num= $sub_date= $total_fees= $lic_exp_year= $regular_fees= $arrear_fees_details= $penalty_charge= "Not Found!";
}
                                   ...
                                   <table width="100%"  >
                                    ...
                                    <table align="center" style="width:99%;font-family:sanserif;">
                                            <tr>
                                                ...
                                                <td style="width:50%;padding-right:40px;text-align:right;"><?php echo strtoupper($companyOwner) ?><br/>Authorized Signatory</td>
                                            </tr>                    
                                    </table>
                                    <br/>
                                    <div class="row" style="padding-left:5%;padding-bottom:20px;">
                                        ...
                                        <div style="width:70%;position:relative;float:left;text-align:left">
                                            ...
                                            <p style="margin-top:5px;font-family:sans-serif;font-size:14px;">
                                                2. Arrear Fees for the year <?=$arrear_fees_details_y1;?> to <?=$arrear_fees_details_y2;?>: 
                                                        Rs. <?=$arrear_fees_details_fees;?>.00</p>
