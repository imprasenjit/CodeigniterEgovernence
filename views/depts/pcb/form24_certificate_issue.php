...
<table id="table-5" style="display:none" class="table table-bordered table-responsive">
    <thead>
        <tr class="info">
            <th class="text-center text-bold" colspan="4">ISSUE CERTIFICATE-24</th>
        </tr>
    </thead>
    <tbody>
        <tr>
        ...
        <tr>
            ...
            <td><input id="file_no" class="form-control text-uppercase" type="text"></td>
            <td colspan="2"></td>
        </tr>
...
<script type="text/javascript">
	...
	$(document).on("click", "#btn-issuecer", function () {
            ...
            $.ajax({
                type: "POST",
                url: "<?=base_url('staffs/issuecertificates/factory_form1')?>",
                data: { 
                    uain: uain,
