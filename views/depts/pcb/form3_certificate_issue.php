...
<table id="table-5" style="display:none" class="table table-bordered table-responsive">
    <thead>
        <tr class="info">
            <th class="text-center text-bold" colspan="4">ISSUE CERTIFICATE-3</th>
        </tr>
    </thead>
    <tbody>
        <tr>
        ...
        <tr>
			...
			<td><input id="lic_exp_year" class="form-control text-uppercase" type="text"></td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>	
		</tr>
        <tr>
		...
		<tr>
			<td>Validity date :</td>
            <td><input id="valid_date" class="text-uppercase form-control dobindia dp"  type="date"></td>
          
			
			<td>Industry Type :</td>
			<td><input type="text" class="form-control text-uppercase" id="industry_category"/></td>
		</tr> 
	
		<tr>
			<td>Number of Authorization</td>
			<td><input id="annexure" type="text" class="text-uppercase form-control approveAppField" name="annexure" placeholder=""/></td>
