...
<table id="table-5" style="display:none" class="table table-bordered table-responsive">
    ...
    <tbody>
        ...
        <tr class="text-bold">
            ...
            <td><input type="text" name="autho_no" required="required" id="autho_no" class="form-control text-uppercase"/></td>
            <td>Validity Date</td>
            <td class="form-inline">
                <input type="text" class="form-control dp" name="validity_date_from" id="validity_date_from"/> 
                -to- 
                <input type="text" class="form-control dp" name="validity_date_to" id="validity_date_to"/></td>			
        </tr>
        <tr>
...
<script type="text/javascript">
	...
	$(document).on("click", "#btn-issuecer", function () {
            ...
            $.ajax({
                type: "POST",
                url: "<?=base_url('staffs/issuecertificates/cei_form6')?>",
                data: { 
                    uain: uain,
