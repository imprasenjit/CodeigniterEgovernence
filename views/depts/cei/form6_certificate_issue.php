...
<table id="table-5" style="display:none" class="table table-bordered table-responsive">
    ...
    <tbody>
        ...
        <tr class="text-bold">
            ...
            <td><input type="text" name="license_no" id="license_no" required="required" class="form-control text-uppercase"/></td>
            <td>Validity Date</td>
            <td class="form-inline">
                <input type="text" class="form-control dp" name="validity_date_from" id="validity_date_from"/>
                -to- 
                <input type="text" class="form-control dp" name="validity_date_to" id="validity_date_to"/>
            </td>			
        </tr>
        <tr>
