...
<html>
    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
		...
		<p style="text-indent: 14px;" align="justify">Is granted to M/s <?php echo strtoupper($companyName);?> as specified hereunder </p>
		...
		<tbody>
											<?php
											$formRows = $this->forms_model->get_frmrows($this->dept_code, "doa_form21_t2", $form_id);
