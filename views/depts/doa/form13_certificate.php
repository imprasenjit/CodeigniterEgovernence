...
<div align="center" style="padding: 10px; border:2px solid black;">			
		...
		<div class="col-sm-12" style="padding:0;">
			...
			<div class="col-sm-6 pull-right">
				<p align="right">Date <?php echo date('d-m-Y',strtotime($sub_date)); ?></p>
			</div>	
		</div>
		<p style="text-indent: 14px;" align="justify">1. Subject to the provisions of the seeds (Control) order, 1983 and to the terms and conditions of this Licence Shri/M/s<?php echo strtoupper($key_person);?>is hereby granted licence to sell and store for the said purposes of seeds (List of Seeds at overleaf).</p>
	...
	<!--	<p align="justify"><b>LIST OF SEEDS TO BE DEALT STATED BELOW:</b><br/><br/><?php echo strtoupper($seeds_detail);?></p>
		...
		<div class="col-sm-12" style="padding:0;">
			...
			<div class="col-sm-6 pull-right">
			    <br/><br/><br/><br/>
				<p align="center"><?php echo strtoupper($companyOwner) ?><br/>Directorate of Agriculture<br/>Govt. of Assam</p>
			</div>	
		</div>
		<br/>
		<table width="100%">
