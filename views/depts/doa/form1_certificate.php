                    ...
                    <div class="box-body">
                        <div class="alomcertbl printcontent">
                           ...
                           <img src="<?=base_url('public/imgs/assam.png')?>" width="110px" height="140px">
                            ...
                            <br/>
                            <p align="center"><h4><b>FORM "B"<br/>LICENCE TO CARRY ON THE BUSINESS OF A DEALER IN SEEDS</b></h4></p>
                            <br/>
                            ...
                            <p style="text-indent: 14px;" align="justify">1. Subject to the provisions of the seeds (Control) order, 1983 and to the terms and conditions of this Licence Shri/M/s<?=$companyOwner?>is hereby granted licence to sell and store for the said purposes of seeds (List of Seeds at overleaf).</p>
                            <p style="text-indent: 14px;" align="justify">2. The Licence shall carry on the aforesaid business at&nbsp;<?php echo strtoupper($address);?> &nbsp;(Place for storage for sale)&nbsp;<?php echo strtoupper($dist);?></p>
                            </br>	   
                            </br>
                            <p align="justify"><b>LIST OF SEEDS TO BE DEALT STATED BELOW:</b><br/><br/>--</p>
                            ...
                            <div class="col-sm-12" style="padding:0;">
                                ...
                                <div class="col-sm-6 pull-right">
                                    <br/><br/><br/><br/>
                                    <p align="center">---<br/>Directorate of Agriculture<br/>Govt. of Assam</p>
                                </div>	
                            </div>
                            <br/>
                            <table width="100%">
				...
				<img src="<?=base_url('storage/temps/qrcode.png')?>?d=<?php echo $uain; ?>" style="width: 120px; height: 120px"/>
                            ...
                            <div align="justify">
                                <ol type="i">
                                    ...
                                    <li>This licence comes into force with immediate effect and shall be valid up to&nbsp;<?=date('d-m-Y'); ?>&nbsp;unless previously cancelled or suspended.</li>
