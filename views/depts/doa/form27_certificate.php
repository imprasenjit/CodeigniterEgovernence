...
<html>
    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
	 ...
	 <div align="center" style="padding: 10px; border:2px solid black;">
		...
		<p style="text-indent: 14px;" align="justify"> Received from &nbsp;<?php echo strtoupper($companyName);?>&nbsp;a complete Memorandum of Intimation along with Form "O", fee of Rs. <?php echo strtoupper($total_fees);?> by Treasury Challan bearing number <?php echo strtoupper($challan_number);?> for issue of renewel of license dated <?=date("d-m-Y",strtotime($sub_date)); ?>.
		
		<p style="text-indent: 14px;" align="justify"> This acknowledgment shall be deemed to be letter of authorization entitling the applicant to carry on the business as applied for, (as per Annexure overleaf) for a period of <u>3 years from the date of issue</u> of this Memo of acknowledgment unless suspended or revoked by the competent authority.</p>
		<br/>
		<div class="col-sm-12" style="padding:0;">
			<div class="col-sm-6">
				<table width="100%">
					<tr>
						<td>Date : <?php echo date('d-m-Y',strtotime($sub_date)); ?><br/>Place : <?php echo $dist;?></td>
					</tr>
					<tr>
			...
			<div class="col-sm-6 pull-right" >
				<p align="right"><?php echo strtoupper($key_person) ?><br/>Directorate of Agriculture<br/>Govt. of Assam</p>
				<p align="right">Signature of Notified Authority :<?php echo $key_person;?><br/>(DA:Assam)</p>
			</div>	
		</div>
		<br/>
