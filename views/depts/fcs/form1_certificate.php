...
<html>
    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
		...
		<h4><b>THE ASSAM PUBLISH DISTRIBUTION OF ARTICLES ORDERS, 1982 LICENSE</b></h4>
		<br/>
		<table width="100%">
			<tr>
        ...
        <br/>
		 <div align="justify">
			<ol type="1">
				...
				<li>This licence shall be valid upto 31<sup>st</sup> March, <?=date('Y',strtotime($issue_date));?></li>
			</ol>
		 </div>
		<table width="100%">
			<tr>
