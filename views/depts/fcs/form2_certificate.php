...
if($formCertRow) {
	...
	//$lic_exp_year = $formCertRow->$lic_exp_year;
		...
		$validity_date_from = $formCertRow->validity_date_from;
		$validity_date_to = $formCertRow->validity_date_to;
...
<html>
            ...
            <div class="content-wrapper">
                <div class="box box-primary box-alm">
                    ...
                    <div class="box-body">
						...
						<!--copied from fcs_form2_certificate.php-->
	<div align="center" style="padding: 10px 30px;width:99%; border:2px solid black;">	
		...
		<br/>
		<p align="justify">License No: <?=strtoupper($license_no);?> Wholesale</p>
		<br/>		
        ...
        <p align="center">This Licence is valid upto <?=strtoupper($validity_date_to);?> </p>
		<p align="justify">
		...
		<h4 class="newpage"><b>Terms & Conditions</b></h4>
			<div align="justify">
				<ol>
					...
					<li>This Licensee shall be valid upto  <?=strtoupper($validity_date_to);?></li>
				</ol>
			</div>
		</div>
	</div>
