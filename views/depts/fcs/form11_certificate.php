...
<html>
    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
            ...
            <div class="content-wrapper">
                <div class="box box-primary box-alm">
                    ...
                    <div class="box-body">
						...
						<!--copied from fcs_form11_certificate.php-->
        ...
        <p align="center">This Licence is valid upto 31st December of<?php echo ($lic_exp_year);?> </p>
		<p align="justify">
		...
		<h4 class="newpage"><b>Terms & Conditions</b></h4>
			<div align="justify">
				<ol>
					...
					<li>This Licensee shall be valid upto 31st December, <?php echo ($lic_exp_year);?></li>
				</ol>
			</div>
		</div>
	</div>
