...
<html>
    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
            ...
            <div class="content-wrapper">
                <div class="box box-primary box-alm">
                    ...
                    <div class="box-body">
						...
						<!--copied from fcs_form4_certificate.php-->
		...
		<br/>
		<p align="justify">License No: <?=strtoupper($license_no);?> Importer</p>
		<br/>		
        ...
        <p align="center">This Licence is valid upto 31<sup>st</sup> December of <?php echo ($lic_exp_year);?> </p>
		<p align="justify">
		...
		<div class="row">
			...
			<div align="justify">
				<ol>
					...
					<li>This Licensee shall be valid upto 31<sup>st</sup> December, <?php echo $lic_exp_year;?></li>
				</ol>
			</div>
		</div>
	</div>
