...
<table id="table-5" style="display:none" class="table table-bordered table-responsive">
    ...
    <tbody>
        ...
        <tr>
		 ...
		 <tr>
            <td>Godown Place : </td>
            <td><input id="godown_place" class="form-control text-uppercase" type="text"></td>
            <td colspan="2"></td>
        </tr>
		 <tr>
		...
		<tr>
            <td>licence place : </td>
            <td><input id="lic_place" class="form-control text-uppercase" type="text"></td>
            <td colspan="2"></td>
        </tr>
        <tr>
            <td colspan="4">
...
<script type="text/javascript">
	...
	$(document).on("click", "#btn-issuecer", function () {
            ...
            $.ajax({
                type: "POST",
                url: "<?=base_url('staffs/issuecertificates/fcs_form1')?>",
                data: { 
                    uain: uain,
