...
<html>
    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
            ...
            <div class="content-wrapper">
                <div class="box box-primary box-alm">
                    ...
                    <div class="box-body">
						...
						<!--copied from fcs_form5_certificate.php-->
        ...
        <p align="center">This Licence is valid upto 31<sup>st</sup> December of <?=date('Y',strtotime($issue_date));?> </p>
		<p align="justify">
		...
		<div class="row">
			...
			<div align="justify">
				<ol>
					...
					<li>This Licensee shall be valid upto 31<sup>st</sup> December, <?php echo ($issue_date);?></li>
				</ol>
			</div>
		</div>
	</div>
