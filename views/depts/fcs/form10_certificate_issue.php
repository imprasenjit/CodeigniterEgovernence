    ...
    <tbody>
        ...
        <tr>
			...
			<tr>
				...
				<td class="text-bold">Valid upto.</td>
				<td><input class="dob form-control text-uppercase" id="valid_upto" placeholder="DD-MM-YYYY" required="required" name="valid_upto"/></td>
			</tr>	
...
<script type="text/javascript">
	...
	$(document).on("click", "#btn-issuecer", function () {
            ...
            $.ajax({
                type: "POST",
                url: "<?=base_url('staffs/issuecertificates/fcs_form10')?>",
                data: { 
                    uain: uain,
