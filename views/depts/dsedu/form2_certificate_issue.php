...
<table id="table-5" style="display:none" class="table table-bordered table-responsive">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><input id="file_auth_no" class="form-control text-uppercase" type="text"></td>
            <td colspan="2"></td>
        </tr>
...
<script type="text/javascript">
	...
	$(document).on("click", "#btn-issuecer", function () {
            ...
            var file_auth_no = $("#file_auth_no").val();

            $.ajax({
                type: "POST",
                url: "<?=base_url('staffs/issuecertificates/dsedu_form1')?>",
                data: { 
                    uain: uain,
                    form_table:form_table,
                    form_id:form_id,
                    file_auth_no: file_auth_no
                },
                beforeSend: function () {
