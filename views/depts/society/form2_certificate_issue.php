...
<table id="table-5" style="display:none" class="table table-bordered table-responsive">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><input id="reg_no" class="form-control text-uppercase" type="text"></td>
            <td colspan="2"></td>
			<td>Area of Operation : </td>
            <td><input id="opp_area" class="form-control text-uppercase" type="text"></td>
          <td colspan="2"></td>
			<td>Valid Upto</td>
...
<script type="text/javascript">
	...
	$(document).on("click", "#btn-issuecer", function () {
            ...
            $.ajax({
                type: "POST",
              url: "<?=base_url('staffs/issuecertificates/society_form2')?>",
