      ...
      <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
		...
		<table width="100%"  >
			<tr>
				...
				<td align="right">Total Fee : <b><?php echo "Rs. ".$total_fees; ?></b></td>
			</tr>
			<tr>
				<td>UAIN : <b><?php echo $uain; ?></b></td>
				<td align="right">License No. :<b><?php echo $license_no;?></b></td>
			</tr>
		</table>
		<br/>
		...
		<div class="row" style="padding-left:5%;padding-bottom:20px;">
			<div style="width:70%;position:relative;float:left;text-align:left">
				...
				<p style="margin-top:5px;font-family:sans-serif;font-size:14px;">2. Arrear Fees for the year <?php echo $arrear_fees_details_y1." - ".substr( $arrear_fees_details_y2, -2 );?> : Rs. 0.00</p>
