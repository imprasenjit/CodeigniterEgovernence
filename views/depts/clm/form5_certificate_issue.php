...
<table id="table-5" style="display:none" class="table table-bordered table-responsive">
    ...
    <tbody>
		...
		<tr>
			...
			<td><input class="form-control text-uppercase" name="lic_no" id="lic_no"/></td>
			<td></td>
			<td></td>
		</tr>
	<tr>
	...
	<tr>
		<td colspan="4"><textarea type="text" class="form-control text-uppercase" name="licensed_area" id="licensed_area"></textarea></td>
	</tr>
        <tr>
...
<script type="text/javascript">
	...
	$(document).on("click", "#btn-issuecer", function () {
            ...
            $.ajax({
                type: "POST",
                url: "<?=base_url('staffs/issuecertificates/clm_form1')?>",
                data: { 
                    uain: uain,
