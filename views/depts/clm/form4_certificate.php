...
<html>
    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
		...
		<p style="text-indent: 14px;" align="justify">1. The Controller of Legal Metrology hereby grants to <?php echo strtoupper($companyOwner);?> a licence to manufacture the following :-</p>
		<p style="text-indent: 14px;" align="justify">(i) Weights : <?php echo strtoupper($pcs->weight);?></p>
		<p style="text-indent: 14px;" align="justify">(ii) Measures : <?php echo strtoupper($pcs->measures);?></p>
		<p style="text-indent: 14px;" align="justify">(iii) Weighing Instruments : <?php echo strtoupper($pcs->instrument);?></p>
		<p style="text-indent: 14px;" align="justify">(iv) Measuring Instruments with details in each case : <?php  echo strtoupper($pcs->details);?></p>
		<p style="text-indent: 14px;" align="justify">2. The licence is valid for the party named above in respect of his workshop located at <?php echo strtoupper($address);?></p>
		...
		<p style="text-indent: 14px;" align="justify">4. The manufacturer shall comply with the conditions noted below. If he fails to comply with anyone of these, his licence is liable to be cancelled.</p>
		<p style="text-indent: 14px;" align="justify">5. The trade mark monogram being used by the manufacturer is as under.</p>
		<br/>
		<div class="col-sm-12" style="padding:0;">
			<div class="col-sm-6">
				<p align="justify"></p>
