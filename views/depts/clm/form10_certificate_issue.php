...
<table id="table-5" style="display:none" class="table table-bordered table-responsive">
	...
	<tr>
		<td>Date and time for hearing</td>
		<td><input type="text" class="form-control text-uppercase" name="hear_dt" id="hear_dt"></td>
	</tr>
        <tr>
...
<script type="text/javascript">
	...
	$(document).on("click", "#btn-issuecer", function () {
            ...
            $.ajax({
                type: "POST",
                url: "<?=base_url('staffs/issuecertificates/clm_form10')?>",
                data: { 
                    uain: uain,
