...
if($formCertRow) {
	...
	$arrear_fees_details_fees = $formCertRow->arrear_fees_details;
	$penalty_charge = $formCertRow->penalty_charge;
	$afd = json_decode($arrear_fees_details_fees);
} else {
	$lic_no = "Not found";
	$sub_date = "Not found";
	...
	$arrear_fees_details_fees = "Not found";
	$penalty_charge = "Not found";
}
$formRow = $this->forms_model->get_row($this->dept_code, $form_table, $form_id);
if($formRow) {
	$weights_measure = $formRow->weights_measure;
} else {
	$weights_measure = "Not found";
}
...
<html>
    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
		...
		<p style="text-indent: 14px;" align="justify"><?php echo strtoupper($weights_measure);?></p>
		<p style="text-indent: 14px;" align="justify">2. The licence is valid for the party named above in respect of his premises located at <?php echo $address;?>. </p>
