...
if($formRow) {
	$type_wm = $formRow->type_wm;
    $type = json_decode($type_wm);
} else {
	$type_wm = "Not found";
}
?>
...
<html>
    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
		...
		<p style="text-indent: 14px;" align="justify">1. The Controller of Legal Metrology hereby grants to <?php echo strtoupper($companyOwner);?> a licence to repair the following :-</p>
		<p style="text-indent: 14px;" align="justify">(i) Weights : <?php echo strtoupper($type->w);?></p>
		<p style="text-indent: 14px;" align="justify">(ii) Measures : <?php echo strtoupper($type->m);?></p>
		<p style="text-indent: 14px;" align="justify">(iii) Weighing Instruments : <?php echo strtoupper($type->wi);?></p>
		<p style="text-indent: 14px;" align="justify">(iv) Measuring Instruments with details in each case : <?php  echo strtoupper($type->mi);?></p>
