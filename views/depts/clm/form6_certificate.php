...
<html>
    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
		...
		<br/>
		<p><b>LICENCE TO A DEALER IN WEIGHTS, MEASURES, WEIGHING INSTRUMENTS OR MEASURING INSTRUMENTS</b></p>
		<br/>
		...
		<p style="text-indent: 14px;" align="justify">1. The Controller of Legal Metrology hereby grants to <?php echo strtoupper($companyOwner);?> a licence to deal in the following :-</p>
		<p style="text-indent: 14px;" align="justify">(i) Weights : <?php echo strtoupper($cat->w);?></p>
		<p style="text-indent: 14px;" align="justify">(ii) Measures : <?php echo strtoupper($cat->m);?></p>
		<p style="text-indent: 14px;" align="justify">(iii) Weighing Instruments : <?php echo strtoupper($cat->wi);?></p>
		<p style="text-indent: 14px;" align="justify">(iv) Measuring Instruments with details in each case : <?php  echo strtoupper($cat->mi);?></p>
		<p style="text-indent: 14px;" align="justify">2. The licence is valid for the party named above in respect of his premises located at <?php echo strtoupper($address);?></p>
		...
		<p style="text-indent: 14px;" align="justify">4. The dealer shall comply with the conditions noted below. If he fails to comply with any one of those his licence is liable to be cancelled.</p>
		<br/>
		<div class="col-sm-12" style="padding:0;">
			<div class="col-sm-6">
				<p align="justify"></p>
		...
		<p style="text-indent: 14px;" align="justify">(f) Submit the application for renewal of this licence as required under the rules within ninety days of expiry of the validity of the licence.</p>
		...
		<p style="text-indent: 14px;" align="justify">(g) Not sell or offer, expose or possess for sale any non-standard weight or measure.</p>
	</div>
