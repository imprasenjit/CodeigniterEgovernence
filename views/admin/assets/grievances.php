...
<div class="box box-primary box-alm">
    ...
    <div class="box-body">
        <div class="col-md-6" style="padding: 0px; padding-right:2px">
            ...
            <table class="table table-bordered table-responsive dtbl">
                <thead>
                    <tr class="success">
                        <th>Applicant</th>
                        <th>Subject</th>
                        ...
                        foreach ($this->publicgrivances_model->get_rows() as $rows) {
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?=base_url('admin/grievances/details/').encodeme($gid)?>" class="btn btn-warning">
                    ...
                    if ($this->publicgrivances_model->get_urgr()) {
                        foreach ($this->publicgrivances_model->get_urgr() as $rows) {
                            ...
                            <tr>
                                ...
                                <td><?= $gdate ?></td>
                                <td class="text-center">
                                    <a href="<?=base_url('admin/grievances/details/').$gid?>" class="btn btn-warning">
                                        <i class="fa fa-folder-open-o">View</i>
                                    </a>
                                </td>
                            </tr>
