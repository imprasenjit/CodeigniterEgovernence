            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Unverified Users  <span data-toggle="tooltip" title="" data-placement="right" class="badge bg-yellow" data-original-title="<?php //echo $total;    ?> Pending Applications"><?php //echo $total;    ?></span></h3> 
                        <!-- /.box-tools -->
                    </div>
                    <!-- End of Search -->
...
<script type="text/javascript">
    $(document).ready(function () {
        var table = $("#approvedunit").DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?= base_url("cms/users/getunverifiedusers"); ?>",
                "dataType": "json",
                "type": "POST"
            },
            language: {
