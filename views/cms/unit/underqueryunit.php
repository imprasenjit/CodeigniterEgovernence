        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <!-- End of Search -->
                    <table id="underqueryunit" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th>Sl No.</th>
                                <th>Unit Name</th>
...
<script type="text/javascript">
    $(document).ready(function () {
        var table = $("#underqueryunit").DataTable({
            "columns": [
                {"data": "unit_id"},
                {"data": "unitname"},
                {"data": "entpname"},
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?= base_url("cms/unit/getunderqueryunit"); ?>",
                "dataType": "json",
                "type": "POST"
            },
            language: {
