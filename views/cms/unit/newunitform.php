    ...
    ?>    <div class="modal fade" tabindex="-1" role="dialog" id="myModal1">
                    ...
                    <form id="form1"  class="form-horizontal">
                        ...
                        <div class="form-group address-group">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <input type="text" class="form-control requiredinput" name="unit_house_no" id="unit_house_no" data-error="Please enter unit House no / Building name" placeholder="Enter house no" />
                            </div>
                            <label class="col-md-3 col-sm-6">
                                Street/Locality <font class="mandatory_field">*</font> :
                            </label>
                            <div class="col-md-3 col-sm-6">
                                <input type="text" class="form-control requiredinput" name="unit_street" id="unit_street" data-error="Please enter unit street." placeholder="Enter street" />
                            </div>
                        </div>
                        <div class="form-group address-group">
                            <label class="col-md-3 col-sm-6">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <input type="text" class="form-control requiredinput" name="unit_village" id="unit_village" data-error="Please enter village / Town" placeholder="Enter village" />
                            </div>
                            <label class="col-md-3 col-sm-6">
                                State <font class="mandatory_field">*</font> :
                            </label>
                            <div class="col-md-3 col-sm-6">
                                <input type="text" class="form-control requiredinput" value="Assam" readonly="readonly" />
                                <input type="hidden" name="unit_state" value="4" readonly="readonly" />
                            </div>
                        </div>
                        <div class="form-group address-group">
                            <label class="col-md-3 col-sm-6">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <select class="form-control requiredinput" name="unit_dist" data-error="Please select District" id="unit_dist">
                                    <option value="">Select</option>
                                    <?php foreach ($this->getDistrict_model->getAllDistrict() as $district) { ?>
                                        <option value="<?= $district['dist_id']; ?>"><?= $district['district']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <label class="col-md-3 col-sm-6">
                        ...
                        <div class="form-group address-group">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <input type="text" class="form-control requiredinput" name="unit_pin" id="unit_pin" data-error="Please enter Pincode" placeholder="Enter 6-digit PIN" maxlength="6" />
                            </div>
                            <label class="col-md-3 col-sm-6">
     ...
     <script>
        function getunitdetails() {
            ...
            $.ajax({
                type: "GET",
                url: "<?= base_url(); ?>cms/unit/getunitdetails/",
                dataType: "html",
                beforeSend: function () {},
        ...
        $(document).ready(function () {
            ...
            $("#submitunitdetails").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?= base_url(); ?>cms/unit/storedetails/",
                    data: data,
                    dataType: "json",
                    beforeSend: function () {},
                    success: function (res) {
                ...
                <div class="modal-body">
                    ...
                    <form id="form1"  class="form-horizontal">
                        ...
                        <div class="form-group address-group">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <input type="text" class="form-control requiredinput" value="<?php if ($row->address->type_of_address != "registered_office") echo $row->address->house_no; ?>" name="unit_house_no" id="unit_house_no" data-error="Please enter unit House no / Building name" placeholder="Enter house no" />
                            </div>
                            <label class="col-md-3 col-sm-6">
                                Street/Locality <font class="mandatory_field">*</font> :
                            </label>
                            <div class="col-md-3 col-sm-6">
                                <input type="text" class="form-control requiredinput" value="<?php if ($row->address->type_of_address != "registered_office") echo $row->address->street; ?>"  name="unit_street" id="unit_street" data-error="Please enter unit street." placeholder="Enter street" />
                            </div>
                        </div>
                        <div class="form-group address-group">
                            <label class="col-md-3 col-sm-6">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <input type="text" class="form-control requiredinput" name="unit_village" value="<?php if ($row->address->type_of_address != "registered_office") echo $row->address->village; ?>"  id="unit_village" data-error="Please enter village / Town" placeholder="Enter village" />
                            </div>
                            <label class="col-md-3 col-sm-6">
                                State <font class="mandatory_field">*</font> :
                            </label>
                        ...
                        <div class="form-group address-group">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <select class="form-control requiredinput" name="unit_dist" data-error="Please select District" id="unit_dist">
									...
									foreach (get_district_by_state(4) as $district) { ?>
                                        <option value="<?=$district->dist_id;?>" <?php if ($district->dist_id == $row->address->dist) echo "selected"; ?>><?= $district->dist_name; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <label class="col-md-3 col-sm-6">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <input type="text" class="form-control requiredinput" value="<?php if ($row->address->type_of_address != "registered_office") echo $row->address->block; ?>" name="unit_block" id="unit_block" data-error="Please enter Block/ Ward No" placeholder="Enter block" />
                            </div>
                        </div>
                        <div class="form-group address-group">
                            <label class="col-md-3 col-sm-6">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <input type="text" class="form-control requiredinput" value="<?php if ($row->address->type_of_address != "registered_office") echo $row->address->pin; ?>" name="unit_pin" id="unit_pin" data-error="Please enter Pincode" placeholder="Enter 6-digit PIN" maxlength="6" />
                            </div>
                            <label class="col-md-3 col-sm-6">
                                Revenue Circle <font class="mandatory_field">*</font> :
                            </label>
                            <div class="col-md-3 col-sm-6">
                                <input type="text" class="form-control requiredinput" value="<?php if ($row->address->type_of_address != "registered_office") echo $row->address->revenue_circle; ?>" name="revenue_circle" data-error="Please enter Revenue Circle." value="" id="revenue_circle" />
                            </div>
                        </div>
