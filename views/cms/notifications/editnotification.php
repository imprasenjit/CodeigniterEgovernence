...
$this->session->set_userdata("notification_no",$id);
                ...
                <form action="#!" id="addnotification">
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <select name="dept" id="dept" class="form-control">
                                ...
                                <?php foreach ($this->getDepartments_model->get() as $depts) { ?>
                                    <option value="<?php echo $depts["id"]; ?>" <?php if($notification->dept==$depts["id"])echo 'selected="selected"';?>><?php echo $depts["name"]; ?></option>
                                <?php } // End of foreach ?>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select name="sub_dept" id="sub_dept" class="form-control">
                                <option value="<?= $notification->sub_dept;?>"><?= $this->getSubDepartment_model->get_deptbyid($notification->sub_dept)->name;?></option>
                            </select>
                        </div>
                    </div> <!-- End of .row -->
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <label class="radio-inline">
                                <input type="radio" value="2" name="notification_type" <?php  if($notification->type==0)echo 'checked="checked" ';?>>Draft / Policies
                            </label>
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            <input type="text" id="notification_date" name="notification_date" value="<?=date("d/m/Y", strtotime($notification->Noti_date)) ;?>" class="form-control" > 
                        </div>
                        <div class="col-md-3 form-group" id="endDate" style="display:none">
                            <label>End Date <span class="text-danger">*</span></label>
                            <input type="text" name="valid_date" id="valid_date" value="<?=date("d/m/Y", strtotime($notification->valid_date)) ;?>" class="form-control dp_forward" />
                        </div>
                    </div> <!-- End of .row -->
                    ...
                    <div class="row">
                        <div class=" col-md-6 form-group">
                            ...
                            <input type="text" name="notification_no" value="<?=$notification->Noti_no;?>" class="form-control" />
                        </div>

                        <div class="col-md-6 form-group">
                            <label>Issuing Authority <span class="text-danger">*</span></label>
                            <input type="text" name="issuing_authority" value="<?=$notification->issue_by;?>" class="form-control" />
                        </div>
                    </div> <!-- End of .row -->
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group">
                            ...
                            <input type="text" name="sub" value="<?=$notification->post_name;?>" class="form-control" />
                        </div>
                    </div> <!-- End of .row -->
                    ...
                    <div class="row">
                        <div class=" col-md-12 form-group">
                            ...
                            <textarea name="dsc" class="form-control usetinymce" rows="3"><?=$notification->post;?></textarea>
                        </div>
                    </div> <!-- End of .row -->
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#submit").click(function () {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url(); ?>cms/notifications/updatenotification/",
                data: data,
                dataType: "json",
                beforeSend: function () {
