    ...
    <section class="content">
        ...
        <div class="box box-primary"> 
            ...
            <div class="box-header with-border">
                ...
                <h2>New Feedbacks</h2>
                <?php echo anchor(site_url('cms/feedback/activefeedbacks'), 'Active Feedbacks', 'class="btn btn-primary"'); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        var table = $("#feedbacks").DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?= base_url("cms/feedback/newfeedbacks"); ?>",
                "dataType": "json",
                "type": "POST",
                "complete": function (jsn, type) {
                    $('.activate').click(function (e) {
                        if (!confirm("Are you sure You want to activate this feedback?")) {
                            e.preventDefault();
                        } 
                    });
                }
