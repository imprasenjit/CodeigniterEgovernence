            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Unverified Common Application Forms  <span data-toggle="tooltip" title="" data-placement="right" class="badge bg-yellow" data-original-title="<?php //echo $total;     ?> Pending Applications"><?php //echo $total;     ?></span></h3> 
                        <!-- /.box-tools -->
                    </div>
                    <!-- Start of Search -->
...
<script type="text/javascript">
    $(document).ready(function () {
        var table = $("#approvedcaf").DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?= base_url("cms/caf/getunverified"); ?>",
                "dataType": "json",
                "type": "POST"
            },
            language: {
