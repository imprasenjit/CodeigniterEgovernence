            ...
            <div class="modal-body">
                ...
                <form id="form5"  class="form-horizontal">
                    <div class="form-group">
                        <label for="address_proof_of_unit" class="col-sm-6 control-label">Proof of Address of the Unit (Occupancy Certificate / Property Tax Payment Receipt / Rent Agreement / Lease Agreement etc.)
                            : </label>
                        <div class="col-sm-6">
                            <input type="file" name="address_proof_of_unit" class="requiredinput" id="address_proof_of_unit" data-error="Please upload proof of Address of the Unit.">
                            <span class="filetype_Error"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="applicant_id_proof" class="col-sm-6 control-label">Applicant ID Proof : </label>
                        <div class="col-sm-6">
                            <input type="file" name="applicant_id_proof" id="applicant_id_proof" class="requiredinput" data-error="Please upload Applicant ID Proof.">
                            <span class="filetype_Error"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="applicant_address_proof" class="col-sm-6 control-label">Applicant Address Proof : </label>
                        <div class="col-sm-6">
                            <input type="file" name="applicant_address_proof" id="applicant_address_proof" class="requiredinput" data-error="Please upload Applicant Address Proof.">
                            <span class="filetype_Error"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="gst_registration" class="col-sm-6 control-label">GST Registration : </label>
                        <div class="col-sm-6">
                            <input type="file" name="gst_registration" id="gst_registration" class="requiredinput" data-error="Please upload GST Registration .">
                            <span class="filetype_Error"></span>
                        </div>
                    </div>
...
<script>
    function getunitdocuments() {
        ...
        $.ajax({
            type: "GET",
            url: "<?= base_url(); ?>users/unit/getunitdocuments/",
            dataType: "html",
            beforeSend: function () {},
    ...
    $("#address_proof_of_unit").pekeUpload({
        bootstrap: true,
        url: "<?php echo base_url(); ?>upload/",
        data: {file: "address_proof_of_unit"},
        limit: 1,
        allowedExtensions: "JPG|JPEG|GIF|PNG|PDF|jpg|jpeg|gif|png|pdf|txt"
    });
    $("#applicant_id_proof").pekeUpload({
        bootstrap: true,
        url: "<?php echo base_url(); ?>upload/",
    ...
    $("#applicant_address_proof").pekeUpload({
        bootstrap: true,
        url: "<?php echo base_url(); ?>upload/",
   ...
   $(document).ready(function(){
    ...
    $("#submitdocuments").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url(); ?>users/unit/storedocuments/",
            data: data,
            dataType: "json",
            beforeSend: function () {},
            success: function (res) {
