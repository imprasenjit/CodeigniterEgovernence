...
if($staffRow) {
    ...
    $results = $this->applicationsir_model->get_officerows($this->dept_code, $office_id);
} else {         
    //$results = $this->applicationsir_model->get_staffrows($this->dept_code, $this->staff_id);
    $results = NULL;
}//End of if else
?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <title>Staff Dashboard :: Completed Applications </title>
                    ...
                    <table class="table table-bordered table-responsive" id="dtbl">
                        ...
                        <tbody>
                            ...
                            foreach($results as $rows) {
                                ...
                                $deptuserRow = $this->deptusers_model->get_row($processed_by, $this->dept_code);
                                if($deptuserRow) {
