...
<html>
    <head>
        ...
        <title>Staff Dashboard :: Under processed Applications </title>
    ...
    <body class="hold-transition skin-blue fixed" data-target="#scrollspy" data-spy="scroll">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <?php $this->load->view("staffs/assets/underprocessedapplications"); ?>
            </div>
            <?php
            $this->load->view("staffs/requires/queryModal");
            ?>
