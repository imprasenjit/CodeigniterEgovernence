...
<div class="box box-primary box-alm">
    ...
    <table class="table table-bordered table-responsive" id="appstbl">
        ...
        <tbody>
            <?php
            if($this->applicationreports_model->get_rejectedApplications($dept_code)) {
            $sl=1;
            foreach($this->applicationreports_model->get_rejectedApplications($dept_code) as $rows) {
                $frmtbl = $rows["frmtbl"];
