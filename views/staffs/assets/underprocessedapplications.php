...
<div class="box box-primary box-alm">
    <h3 class="boxalm-head">
        Under processed applications forms
    ...
    <table class="table table-bordered table-responsive" id="appstbl">
        ...
        <tbody>
            <?php
            if($this->applicationreports_model->get_underprocessedApplications($dept_code)) {
            $sl=1;
            foreach($this->applicationreports_model->get_underprocessedApplications($dept_code) as $rows) {
                $frmtbl = $rows["frmtbl"];
