...
<div class="box box-primary box-alm">
    ...
    <table class="table table-bordered table-responsive" id="cortbl">
        ...
        <tbody>
            <?php
            $courier_applications = $this->applicationreports_model->get_sentonqueryApplications($dept_code);
            if($courier_applications) {
                ...
                foreach($courier_applications as $rows) {
                    ...
                    $unit_name = $this->cafs_model->get_enterprise_details($unit_id)? $this->cafs_model->get_enterprise_details($user_id)->unit_name:"Not found!";
