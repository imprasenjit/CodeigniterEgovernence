        ...
        <div class="modal-content">
            <div class="box box-success">
                ...
                <div class="modal-body">
                    <input type="hidden" id="ids" style="width: 100%" />
                    <div class="form-group">
                        <label>Query Subject</label>
                        <select id="query_subject" class="form-control" required="required">
                            <option value="query_general">General Query</option>
                            <option value="query_fees">Fees and Payment Related</option>
                            <option value="query_document">Documents Related</option>
                        </select>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    ...
    $(document).on("click", "#query_submit", function () {
        ...
        $.ajax({
            ...
            data: {ids: ids, qsub: qsub, qmsg: qmsg, qfamnt: qfamnt, query_docs: qdocs},
            beforeSend: function () {
            ...
            success: function (res) { //alert(res);
                ...
                $.notify(
                        "Application has been successfully querued!!!",
