        ...
        <div class="col-sm-6 col-md-4 col-md-offset-4" style="padding:0px">
            <div class="panel panel-default" style="margin-top: 120px">
                <div class="panel-heading" style="padding:0px 2px">
                    <div align="center">
                        <strong><h2 style="color:#2086bf; margin-top:0px;  padding-top:5px">User Login</h2></strong>
                ...
                <div class="panel-body" style="padding-top:5px">
                    <form id="loginfrm" action="<?= base_url('site/'); ?>login/process" method="post" style="text-align: center">                        
