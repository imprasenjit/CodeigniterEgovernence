						...
						<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
							...
							if($application_details != NULL){
								foreach ($application_details as $app) {
									...
									$dept_id = $dept_name_array["dept_id"];
									$form=get_uainForm($uain);
									$form_name_row=$this->ovs_model->get_form_name22($dept_id,$form);
									$form_name = $form_name_row?$form_name_row->service_name:"Not Found!";
									//die("sub_dept : ".$dept_id."form_no: ".$form." => ".$form_name_row);
								...
								?>
									...
									<tr>
										...
										<td><?php echo "<a href='ovs?token=".$uain."' target='_blank' class='btn btn-warning btn-sm'>View Status</a>"; ?></td>
									</tr>
							<?php $sl++;
								}
							}
